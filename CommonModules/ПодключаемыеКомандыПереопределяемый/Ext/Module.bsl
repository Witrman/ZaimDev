...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если НастройкиФормы.ИмяФормы = "Обработка.РасчетПоСреднемуЗаработку.Форма.ФормаРасчетОтпуска"
		ИЛИ НастройкиФормы.ИмяФормы = "Обработка.РасчетПоСреднемуЗаработку.Форма.ФормаРасчетБольничного"
		ИЛИ НастройкиФормы.ИмяФормы = "Обработка.ВыплатаЗарплатыРасходнымиОрдерами.Форма.Форма" Тогда
		
		МассивКомандПечати = Команды.НайтиСтроки(Новый Структура("Вид", "Печать"));
		Для Каждого Команда Из МассивКомандПечати Цикл
			Команда.ТипПараметра = Неопределено;
		КонецЦикла;
