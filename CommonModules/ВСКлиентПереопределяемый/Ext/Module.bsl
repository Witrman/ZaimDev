...
Функция КодТНВЭДНачалоВыбора(КодТНВЭД, Форма) Экспорт
	...
	ОткрытьФорму("Справочник.НоменклатураГСВС.ФормаВыбора", ПараметрыФормы, Форма, Истина);
...
Процедура ОткрытьФормуОбработкиТабличнойЧастиДокументов(ПараметрыФормы = Неопределено, Знач ФормаЭДВС, Знач УникальныйИдентификатор) Экспорт
	ОткрытьФорму("Обработка.ОбработкаТабличнойЧастиДокументов.Форма.Форма", ПараметрыФормы,
			ФормаЭДВС, УникальныйИдентификатор);	
КонецПроцедуры
...
Функция ПроверитьМожноЛиОткрыватьФормуНовогоДокумента(ТипДокумента) Экспорт
	Если ТипДокумента = Тип("ДокументСсылка.ПоступлениеИзПереработки") Тогда
		Возврат Ложь;
	Иначе
		Возврат Истина;
	КонецЕсли;	
...
Процедура ОткрытьФормуВыбораСправочникаТипыЦенНоменклатуры(Оповещение) Экспорт
	...
	ОткрытьФорму("Справочник.ТипыЦенНоменклатуры.ФормаВыбора", ,,,,,Оповещение,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);;
