...
Функция ОткрытьСессию(Знач ПрофильИСЭСФ, ВерсияВС = Неопределено) Экспорт
	...
	Если ЭСФВызовСервера.ИспользоватьОткрытиеСессииСПодписью() Тогда
		Возврат ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ОткрытьСессиюВСПоТикету(ПрофильИСЭСФ, ВерсияВС);
	Иначе
...
Функция ОткрытьСессиюСПодписью(Знач ПрофильИСЭСФ, ВерсияВС = Неопределено, ПодписанныйАвторизационныйТикет) Экспорт
	...
	Возврат ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ОткрытьСессиюСПодписьюВС(ПрофильИСЭСФ, ВерсияВС, ПодписанныйАвторизационныйТикет);
...
Функция ОткрытьСессиюСПодписьюПредварительно(Знач ПрофильИСЭСФ, ПараметрыОткрытияСессии) Экспорт
	...
	Возврат ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ОткрытьСессиюСПодписьюПредварительноВС(ПрофильИСЭСФ, ПараметрыОткрытияСессии);
	
КонецФункции

Функция ПолучитьАвторизационныйТикет(Знач ПрофильИСЭСФ, ВерсияИСЭСФ = Неопределено) Экспорт
	
	Возврат ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ПолучитьАвторизационныйТикетВС(ПрофильИСЭСФ, ВерсияИСЭСФ);
...
Процедура ЗакрытьСессиюПоДаннымПрофиля(ДанныеПрофиля, Пароль) Экспорт
	...
	ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ЗакрытьСессиюВСПоДаннымПрофиля(ДанныеПрофиля, Пароль);
...
Функция ПолучитьДанныеНовыхУТТН(Знач ПрофильИСЭСФ, Знач ПолучитьОднуПорцию, Знач ТолькоСоздатьОбновитьФайлы, ИдентификаторСессии, ВерсияИСЭСФ, ПараметрыМетодаЭСФ, МассивИдентификаторовДляОбновленияСтатусаПриема) Экспорт
	                          
	Возврат ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ПолучитьДанныеНовыхУТТН(ПрофильИСЭСФ, ПолучитьОднуПорцию, ТолькоСоздатьОбновитьФайлы, ИдентификаторСессии, ВерсияИСЭСФ, ПараметрыМетодаЭСФ, МассивИдентификаторовДляОбновленияСтатусаПриема);
...
Функция ДополнитьТекстЗапросЗаполненияЭДВС(ТекстЗапроса) Экспорт
	...
	|ИЗ
	|	ВТ_ДанныеДокумента КАК ДанныеИсточникиПроисхождения
	|		ГДЕ НЕ ДанныеИсточникиПроисхождения.ИсточникПроисхождения ЕСТЬ NULL
	|		И НЕ ДанныеИсточникиПроисхождения.ИсточникПроисхождения.ГСВС.КодГСВС ЕСТЬ NULL
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ТОГДА ЕСТЬNULL(КодыГСВАктуальныеПоНоменклатуре.КодГСВС, вт_ДанныеДокумента.КодТНВЭД)
	...
	|			ТОГДА ЕСТЬNULL(КодыГСВАктуальныеПоНоменклатуре.НоменклатураГСВС, ЗНАЧЕНИЕ(Справочник.НоменклатураГСВС.ПустаяСсылка))
	|		ИНАЧЕ КодыГСВСАктуальныеПоИсточнику.НоменклатураГСВС
	|	КОНЕЦ КАК ГСВС,
	|	ВЫБОР
	|		КОГДА КодыГСВСАктуальныеПоИсточнику.ПолныйКодГСВС ЕСТЬ NULL
	|			ТОГДА ЕСТЬNULL(КодыГСВАктуальныеПоНоменклатуре.ПолныйКодГСВС, """")
	|		ИНАЧЕ КодыГСВСАктуальныеПоИсточнику.ПолныйКодГСВС
	|	КОНЕЦ КАК СоставнойКодГСВС,
	|	ВЫБОР
	|		КОГДА вт_ДанныеДокумента.ТипФормы = ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.ДетализацияИмпорта)
	|				ИЛИ вт_ДанныеДокумента.ТипФормы = ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.СписаниеТоваровНеВС)
	|				ИЛИ вт_ДанныеДокумента.ИмяДокумента = ""СНТ""
	|					И вт_ДанныеДокумента.ВидДетализации = ЗНАЧЕНИЕ(Перечисление.ВидДетализации.КонвертацияМеждуЕИ)
	|				ИЛИ вт_ДанныеДокумента.ИмяДокумента = ""СНТ""
	|					И вт_ДанныеДокумента.ТипФормы = ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.ВнутреннееПеремещение)
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ВЫБОР
	|				КОГДА КодыГСВСАктуальныеПоИсточнику.ПризнакУчетаНаВиртуальномСкладе ЕСТЬ NULL
	|					ТОГДА ЕСТЬNULL(КодыГСВАктуальныеПоНоменклатуре.ПризнакУчетаНаВиртуальномСкладе, ЛОЖЬ)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_КодыГСВСАктуальные КАК КодыГСВАктуальныеПоНоменклатуре
	|		ПО вт_ДанныеДокумента.КодТНВЭД = КодыГСВАктуальныеПоНоменклатуре.КодГСВСПервичный
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ИсточникиПроисхождения КАК ИсточникиПроисхождения
	|		ПО (вт_ДанныеДокумента.ИсточникПроисхождения = ИсточникиПроисхождения.Ссылка)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_КодыГСВСАктуальные КАК КодыГСВСАктуальныеПоИсточнику    //смотрим записи по коду ГСВС из источника
	|		ПО (вт_ДанныеДокумента.ИсточникПроисхождения.ГСВС.КодГСВС = КодыГСВСАктуальныеПоИсточнику.КодГСВСПервичный)
...
Функция ДополнитьТекстЗапросЗаполненияЭДВС_Расход(ТекстЗапроса) Экспорт
	...
	|	%ДатаДокументПартии%ТоварыНаВиртуальныхСкладах% КАК ДатаДокументПартии,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ОстаткиГТД.ИсточникПроисхождения КАК ИсточникПроисхождения,
	...
	|		ПО ОстаткиГТД.ГСВС = СведенияОНоменклатуреГСВС.НоменклатураГСВС
	|		И ОстаткиГТД.ДатаДокументПартии >= СведенияОНоменклатуреГСВС.Период
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ИсточникПроисхождения,
	|	Период
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СведенияОНоменклатуреГСВС.ИсточникПроисхождения КАК ИсточникПроисхождения,
	...
	|СГРУППИРОВАТЬ ПО
	|	СведенияОНоменклатуреГСВС.ИсточникПроисхождения
	|ИНДЕКСИРОВАТЬ ПО
	|	ИсточникПроисхождения,
	|	Период
	|;
	...
	|				ПО СведенияОНоменклатуреГСВС.ИсточникПроисхождения = СведенияОНоменклатуреГСВССвернуто.ИсточникПроисхождения
	|				И СведенияОНоменклатуреГСВС.Период = СведенияОНоменклатуреГСВССвернуто.Период
	|			ПО СведенияОНоменклатуреГСВССвернуто.ИсточникПроисхождения = ОстаткиГТД.ИсточникПроисхождения
	...
	ДополнитьТекстЗапросаДатойДокументаПартии(ТекстЗапроса);
...
Функция ПодготовитьТаблицыДанныхДляЗаполненияЭДВС(ПараметрыЗаполнения) Экспорт 
	...
	Запрос.УстановитьПараметр("ТекущаяДата", ДатаОформления); // Для получения сведений ГСВС проверяем их на дату оформления
...
Функция ПодготовитьТаблицыДанныхДляЗаполненияЭДВС_Расход(ПараметрыЗаполнения) Экспорт 
	...
	Запрос.УстановитьПараметр("ТекущаяДата", ТекущаяДатаСеанса()); // Для получения сведений ГСВс проверяем их на дату оформления
	...
	ТаблицыДанныхДляЗаполненияЭДВС.Вставить("ТаблицаРеквизитов"		, РезультатЗапроса[КоличествоПакетов - 8].Выгрузить());
	ТаблицыДанныхДляЗаполненияЭДВС.Вставить("ТаблицаТовары"			, РезультатЗапроса[КоличествоПакетов - 7].Выгрузить());
	ТаблицыДанныхДляЗаполненияЭДВС.Вставить("ТаблицаИсходныеТовары"	, РезультатЗапроса[КоличествоПакетов - 6].Выгрузить());
			...
			Если ПодбиратьИсточникиПроисхождения И СтрокаРеквизитов.РаспределятьТоварыПоИП Тогда
				...
				Для Каждого СтрокаИП Из МассивСтрокОстатков Цикл
					...
					Если ЗначениеЗаполнено(СтрокаИП.ИсточникПроисхождения) Тогда
						...
						КонецЕсли;
						НоваяСтрока.СоставнойКодГСВС = СтрокаИП.СоставнойКодГСВС;
						НоваяСтрока.ГСВС             = СтрокаИП.ГСВС;
					КонецЕсли;
					...
					Если Не ЗначениеЗаполнено(НоваяСтрока.СоставнойКодГСВС) Тогда // не переопределяем, могло быть уже заполнено по историческим данным о кодах
...
#Область РазбиениеДокументаЭДВС
...
Функция РазбитьЭлектронныеДокументыВС(ПараметрыСоздания) Экспорт
	...
	ПроверитьНеобходимостьРазбиенияСтрок(ПараметрыСоздания, Отказ);
	
	Если Не Отказ Тогда
		
		МассивДанныхДляЗаполнения = ПодготовитьДанныеДляЗаполненияЭДВС_РазбиениеСтрок(ПараметрыСоздания);
		
		ПараметрыЗаполненияЭДВС = ПолучитьПараметрыЗаполненияЭДВСПоУмолчанию();
		ПараметрыЗаполненияЭДВС.ФормироватьСписокДокументов = Истина;
		ОбработатьИсходныйДокументЭДВС(ПараметрыЗаполненияЭДВС, ПараметрыСоздания.МассивДокументовЭДВС, МассивДанныхДляЗаполнения, СписокЭДВС);
		ЗаполнитьМассивЭДВС(ПараметрыЗаполненияЭДВС, МассивДанныхДляЗаполнения, СписокЭДВС, Отказ);
	КонецЕсли;
...
Функция ПроверитьНеобходимостьРазбиенияСтрок(ПараметрыЗаполнения, Отказ)
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ЭлектронныйДокументВСТоварыВС.Ссылка,
	|	КОЛИЧЕСТВО(ЭлектронныйДокументВСТоварыВС.НомерСтроки) КАК КоличествоСтрок,
	|	ЭлектронныйДокументВСТоварыВС.Ссылка.Представление КАК ПредставлениеЭДВС
	|ИЗ
	|	Документ.ЭлектронныйДокументВС.ТоварыВС КАК ЭлектронныйДокументВСТоварыВС
	|ГДЕ
	|	ЭлектронныйДокументВСТоварыВС.Ссылка В(&ДокументыЭДВС)
	|
	|СГРУППИРОВАТЬ ПО
	|	ЭлектронныйДокументВСТоварыВС.Ссылка";
	
	Запрос.УстановитьПараметр("ДокументыЭДВС", ПараметрыЗаполнения.МассивДокументовЭДВС);
	
	РезультатЗапроса = Запрос.Выполнить();
	Выборка = РезультатЗапроса.Выбрать();
	МаксКоличествоСтрок = ВСКлиентСервер.МаксимальноеКоличествоСтрокДокументаЭДВС();
	Пока Выборка.Следующий() Цикл
		Если Выборка.КоличествоСтрок < МаксКоличествоСтрок Тогда
			Отказ = Истина;
			ТекстСообщения = НСтр("ru = 'Разбиение документа ""%1"" невозможно. Разбиение доступно только для документов в которых присутствует более %2 строк.'");
			ТекстСообщения = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстСообщения, Выборка.ПредставлениеЭДВС, МаксКоличествоСтрок);
			ЭСФКлиентСерверПереопределяемый.СообщитьПользователю(ТекстСообщения);
		КонецЕсли;
	КонецЦикла;
...
Функция ПодготовитьДанныеДляЗаполненияЭДВС_РазбиениеСтрок(ПараметрыЗаполнения) Экспорт
	
	ДанныеДляЗаполнения = Новый Массив;
	
	ТаблицыДанныхДляЗаполненияЭДВС = ПодготовитьТаблицыДанныхДляЗаполненияЭДВСДляРазбиенияСтрок(ПараметрыЗаполнения.МассивДокументовЭДВС);
	Если ТаблицыДанныхДляЗаполненияЭДВС = Неопределено Тогда
		Возврат ДанныеДляЗаполнения;
	КонецЕсли;
	
	ТаблицаРеквизитов 	  = ТаблицыДанныхДляЗаполненияЭДВС.ТаблицаРеквизитов;
	ТаблицаТоварыВС       = ТаблицыДанныхДляЗаполненияЭДВС.ТаблицаТоварыВС;
	СтруктураДокумента 	  = ВССерверПовтИсп.ПолучитьПустуюСтруктуруДокументаЭДВС();
	...
	Для Каждого СтрокаРеквизитов ИЗ ТаблицаРеквизитов Цикл
		...
		НоваяСтрокаРеквизитов.Дата = СтрокаРеквизитов.Дата;
		НоваяСтрокаРеквизитов.НомерУчетногоДокумента = "";
		НоваяСтрокаРеквизитов.ПрефиксВидаДокумента 	 = "";
		НоваяСтрокаРеквизитов.НомерПакета 			 = ПолучитьНомерПакетаФорматированный(1);
		
		ПараметрыОтбора = Новый Структура;
		ПараметрыОтбора.Вставить("Ссылка"		, СтрокаРеквизитов.Ссылка);
		
		МассивСтрокТовары = ТаблицаТоварыВС.НайтиСтроки(ПараметрыОтбора);
		
		НомерСтроки = 0;
		НомерПакета = 1;
		ЕстьТовары	= Ложь;
		
		МаксКоличествоСтрокЭДВС = ВСКлиентСервер.МаксимальноеКоличествоСтрокДокументаЭДВС();
		МаксНомерСтрокиТЧ = 10000;
		НомерСтрокиТЧ = 0;
		...
		Для Каждого СтрокаМассива Из МассивСтрокТовары Цикл
			...
			Если НомерСтроки >= МаксКоличествоСтрокЭДВС Или НомерСтрокиТЧ = МаксНомерСтрокиТЧ Тогда
				ЕстьТовары 	= Ложь;
				НомерСтроки = 0;
				НомерПакета = НомерПакета + 1;
				СтруктураДляПередачи = Новый Структура;
...
Функция ПодготовитьТаблицыДанныхДляЗаполненияЭДВСДляРазбиенияСтрок(МассивДокументовЭДВС) Экспорт
	...
	|	ЭлектронныйДокументВС.ПрефиксВидаДокумента,
	|	ЭлектронныйДокументВС.НомерУчетногоДокумента,
	|	ЭлектронныйДокументВС.НомерПакета,
	|	ЭлектронныйДокументВС.СтруктурноеПодразделение,
	|	ЭлектронныйДокументВС.ДатаДоговораСРПОтправитель,
	|	ЭлектронныйДокументВС.НомерДоговораСРПОтправитель,
	|	ЭлектронныйДокументВС.Автор
	|ИЗ
	|	Документ.ЭлектронныйДокументВС КАК ЭлектронныйДокументВС
	|ГДЕ
	|	ЭлектронныйДокументВС.Ссылка В (&ДокументыЭДВС)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ЭлектронныйДокументВСТоварыВС.СоставнойКодГСВС,
	|	ЭлектронныйДокументВСТоварыВС.ФизическаяМетка,
	...
	|	ЭлектронныйДокументВСТоварыВС.ВозможенЭкспорт,
	|	ЭлектронныйДокументВСТоварыВС.ТипПошлины,
	|	ЭлектронныйДокументВСТоварыВС.СтранаПроисхожденияТовараКод,
	|	ЭлектронныйДокументВСТоварыВС.НомерЗаявленияВРамкахТС,
	|	ЭлектронныйДокументВСТоварыВС.ДатаСертификатаПроисхождения,
	|	ЭлектронныйДокументВСТоварыВС.ПризнакПроисхождения,
	|	ЭлектронныйДокументВСТоварыВС.ТоварНаименованиеВРамкахТС,
	|	ЭлектронныйДокументВСТоварыВС.НомерПозицииВДекларацииИлиЗаявлении,
	|	ЭлектронныйДокументВСТоварыВС.Крепость,
	|	ЭлектронныйДокументВСТоварыВС.ПинКод,
	|	ЭлектронныйДокументВСТоварыВС.ЕдиницаИзмеренияКод,
	|	ЭлектронныйДокументВСТоварыВС.Сумма,
	|	ЭлектронныйДокументВСТоварыВС.ГСВС,
	|	ЭлектронныйДокументВСТоварыВС.ИсточникПроисхождения,
	|	ЭлектронныйДокументВСТоварыВС.ТипПроисхождения,
	|	ЭлектронныйДокументВСТоварыВС.СтранаПроисхожденияТовара,
	|	ЭлектронныйДокументВСТоварыВС.ДополнительныйИдентификатор,
	|	ЭлектронныйДокументВСТоварыВС.ИсточникПроисхожденияПолучатель,
	|	ЭлектронныйДокументВСТоварыВС.ДополнительныйИдентификаторПолучатель,
	|	ЭлектронныйДокументВСТоварыВС.GTIN
	|ИЗ
	|	Документ.ЭлектронныйДокументВС.ТоварыВС КАК ЭлектронныйДокументВСТоварыВС
	|ГДЕ
	|	ЭлектронныйДокументВСТоварыВС.Ссылка В (&ДокументыЭДВС)";
	
	Запрос.УстановитьПараметр("ДокументыЭДВС", МассивДокументовЭДВС);
	...
	ТаблицыДанныхДляЗаполненияЭДВС = Новый Структура;
	ТаблицыДанныхДляЗаполненияЭДВС.Вставить("ТаблицаРеквизитов"		, РезультатЗапроса[КоличествоПакетов-2].Выгрузить());
	ТаблицыДанныхДляЗаполненияЭДВС.Вставить("ТаблицаТоварыВС"		, РезультатЗапроса[КоличествоПакетов-1].Выгрузить());
	
	Возврат ТаблицыДанныхДляЗаполненияЭДВС;
	
КонецФункции

Функция ОбработатьИсходныйДокументЭДВС(ПараметрыСоздания, МассивДокументов, МассивДанныхДляЗаполнения, СписокЭДВС)
	
	ИсходныхДокументЭДВС = МассивДокументов[0];
	ПроводитьСозданныеДокументы = ПараметрыСоздания.ПроводитьСозданныеДокументы;
	ФормироватьСписокДокументов = ПараметрыСоздания.ФормироватьСписокДокументов;
	Отказ = Ложь;
	...
	Если ЗначениеЗаполнено(МассивДанныхДляЗаполнения) И МассивДанныхДляЗаполнения.Количество() > 0 Тогда
		...
		Попытка
			...
			//Необходимо перазаполнить только табличную часть ТоварыВС документа, шапку и другие реквизиты менять не нужно
			//Заполняем табличную часть "Товары ВС"
			ЭДВС = ИсходныхДокументЭДВС.ПолучитьОбъект();
		...
		Если ПроводитьСозданныеДокументы  И Не ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ЗапрещеноПроводитьЭДВС(ЭДВС) Тогда
			...
			Если Отказ Тогда
				ТекстСообщения = НСтр("ru = 'При проведении документа ""%1"" произошла ошибка.'");
				ТекстСообщения = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстСообщения, ЭДВС);
				ЭСФКлиентСерверПереопределяемый.СообщитьПользователю(ТекстСообщения);
...
//Процедура заполняет признак возможен экспорт в документах ЭДВС
Процедура ЗаполнитьПустыеПризнакиЭкспорт(ДанныеДляЗаполненияПЭ, ДокументОбъект) Экспорт
	
	ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ЗаполнитьПустыеПризнакиЭкспорт(ДанныеДляЗаполненияПЭ, ДокументОбъект);
...
Процедура ПриПроведенииСтатусОформленияДокументовОбработчик(Источник) Экспорт
	...
	Если ИспользоватьСНТ() Тогда
		...
		Если ТипЗнч(Источник) = Тип("ДокументОбъект.ЭСФ") Тогда
			Если ЗначениеЗаполнено(Источник.СНТ) ИЛИ СтрНайти(Источник.ДокументПодтверждающийПоставкуНомер, "SNT") > 0 
				ИЛИ СтрНайти(Источник.ДокументПодтверждающийПоставкуАВРНомер, "SNT") Тогда 
...
Функция ЗаполнитьИсточникиПроисхождения(Параметры, Отказ)  Экспорт
	...
	ЭтоЭДВССписания = (ТипЗнч(Параметры.Регистратор) = Тип("ДокументСсылка.ЭлектронныйДокументВС"));//Не ЭтоЭСФ;
	
	Если ЭтоЭСФ Тогда
		Запрос.УстановитьПараметр("ДатаОборота", Параметры.ДатаОборота);
	Иначе
		Запрос.УстановитьПараметр("ДатаОборота", Параметры.Дата);
	КонецЕсли;
	...
	//что при подборе остатков когда формируем документ ЭСФ из первичного документа, что при нажатие на кнопку над ТЧ "Заполнить источник происхождения".
	...
	ПризнакРозничныйПокупатель = Ложь;
	Если ТипЗнч(Параметры.Регистратор) = Тип("ДокументСсылка.СчетФактураВыданный") Тогда
		СчетФактура = Параметры.Регистратор;
		РозничныйПокупательСсылка = ЭСФСерверПереопределяемый.ПолучитьРозничныйПокупательСсылка(Параметры.Регистратор);//Параметры.Регистратор.Покупатель;
	ИначеЕсли ТипЗнч(Параметры.Регистратор) = Тип("ДокументСсылка.ЭСФ") Тогда
		Если Параметры.Свойство("Объект") И ТипЗнч(Параметры.Объект) = Тип("ДокументОбъект.ЭСФ") Тогда
			СчетФактура = Параметры.Объект.СчетФактура;
			РозничныйПокупательСсылка = ?(Параметры.Объект.Получатели.Количество() > 0, Параметры.Объект.Получатели[0].Получатель, Неопределено);
			ПризнакРозничныйПокупатель = ?(Параметры.Объект.Получатели.Количество() > 0, Параметры.Объект.Получатели[0].РозничнаяРеализация, Ложь);
		ИначеЕсли Параметры.Регистратор <> Документы.ЭСФ.ПустаяСсылка() Тогда
			СчетФактура = Параметры.Регистратор.СчетФактура;
			РозничныйПокупательСсылка = ?(Параметры.Регистратор.Получатели.Количество() > 0, Параметры.Регистратор.Получатели[0].Получатель, Неопределено);
			ПризнакРозничныйПокупатель = ?(Параметры.Регистратор.Получатели.Количество() > 0, Параметры.Регистратор.Получатели[0].РозничнаяРеализация, Ложь);
		КонецЕсли;
	КонецЕсли;
	
	Если ЗначениеЗаполнено(СчетФактура) Тогда
		ДанныеСНТ = ВССерверПереопределяемый.ПроверитьНаличиеСвязанногоСНТ(СчетФактура.ДокументОснование);
	Иначе
		ДанныеСНТ = Неопределено;
	КонецЕсли;
	
	Если РозничныйПокупательСсылка <> Неопределено Тогда
		РозничныйПокупатель = ЭСФСерверПереопределяемый.ПолучитьРозничногоКонтрагента(РозничныйПокупательСсылка, ПризнакРозничныйПокупатель);
	КонецЕсли;
	
	Если ТипЗнч(ДанныеСНТ) = Тип("Структура") Тогда
		Если ДанныеСНТ.Свойство("Ссылка", СвязанныйСНТ) Тогда
			УчитыватьТоварыИсправленногоСНТ = Истина;
		Иначе
			УчитыватьТоварыИсправленногоСНТ = Ложь;
		КонецЕсли;
	Иначе
		УчитыватьТоварыИсправленногоСНТ = Ложь;
	КонецЕсли;
	...
	Запрос.УстановитьПараметр("УчитыватьТоварыИсправленногоСНТ", УчитыватьТоварыИсправленногоСНТ);
	
	ТекстЗапросаДанныеСНТ = ДополнитьТекстЗапросаСвязаннымиДанными(УчитыватьТоварыИсправленногоСНТ);
	
	ТекстЗапроса = ТекстЗапросаДанныеСНТ + ТекстЗапросаЗаполненияИсточниковПроисхождения(ЭтоЭДВССписания);
	...
	Для Каждого СтрокаТовары Из  ТаблицаТовары Цикл 
		...
		Иначе
			...
			Если ЭтоЭСФ И НЕ УчитыватьТоварыИсправленногоСНТ И НЕ РозничныйПокупатель Тогда
				Если ТаблицаИП.Количество() > 0 Тогда
					ТаблицаИП.Сортировать("ПризнакУчетаНаВиртуальномСкладе Возр, ДатаДокументПартии Возр");
				КонецЕсли;
			КонецЕсли;
			...
			Для Каждого СтрокаИП Из СтрокиИП Цикл
				...
				Если ЭтоЭСФ Тогда
					Если СтрокаИП.ПризнакУчетаНаВиртуальномСкладе Тогда
						...
						Если НЕ ЗначениеЗаполнено(СтрокаИП.КодТНВЭД) Тогда
							КодГСВС = "";
						Иначе
						...
						Если КлючевыеПоляЗаполнены Тогда
							ЭтоЭСФНаОсновеСНТ = Ложь;
							Если ИспользоватьСНТ() Тогда
								Если ТипЗнч(Параметры.Регистратор) = Тип("ДокументСсылка.ЭСФ") Тогда
									Если Параметры.Свойство("Объект") И ТипЗнч(Параметры.Объект) = Тип("ДокументОбъект.ЭСФ") Тогда
										Если ЗначениеЗаполнено(Параметры.Объект.СНТ) Тогда
											ЭтоЭСФНаОсновеСНТ = Истина;
										КонецЕсли;
									ИначеЕсли Параметры.Регистратор <> Документы.ЭСФ.ПустаяСсылка() Тогда
										Если ЗначениеЗаполнено(ЭСФСерверПереопределяемый.ЗначениеРеквизитаОбъекта(Параметры.Регистратор, "СНТ")) Тогда 
											ЭтоЭСФНаОсновеСНТ = Истина;
										КонецЕсли;
									КонецЕсли;
								КонецЕсли;
							КонецЕсли;
							ИдентификаторТовара = ?(НЕ ЭтоЭСФНаОсновеСНТ,"%1%2%3(%4)", "%1%2%3");
			...
			Если НоваяСтрока <> Неопределено Тогда
				...
				Если ЭтоЭСФ Тогда
					...
					КонецЕсли;
					Если ОбщаяСуммаБезНалоговРаспределенных > 0 И (СтрокаТовары.Сумма - СтрокаТовары.СуммаАкциза - СтрокаТовары.СуммаНДС) <> ОбщаяСуммаБезНалоговРаспределенных Тогда
...
Функция ДополнитьТекстЗапросаСвязаннымиДанными(УчитыватьТоварыИсправленногоСНТ) Экспорт
	
	Если Не УчитыватьТоварыИсправленногоСНТ Тогда
		
		ТекстЗапроса =		
		"ВЫБРАТЬ
		|	НЕОПРЕДЕЛЕНО КАК Товар,
		|	НЕОПРЕДЕЛЕНО КАК ИсточникПроисхождения,
	...
	Иначе 		
		...
		ТекстЗапроса =  ВССерверПереопределяемый.ДополнитьТекстЗапросаДаннымиСвязанногоСНТ();
		
	КонецЕсли;

	ТекстЗапроса = ТекстЗапроса + ВСВызовСервера.ТекстРазделителяЗапросовПакета();		   
	
	Возврат ТекстЗапроса;
КонецФункции

Функция ТекстЗапросаЗаполненияИсточниковПроисхождения(ЭтоЭДВССписания)
	...
	|	ТаблицаТовары.Номенклатура.КодТНВЭД КАК КодТНВЭДНоменклатура,
	|	ТаблицаТовары.Количество,
	|	ТаблицаТовары.ЕдиницаИзмерения,
	|	ТаблицаТовары.ЕдиницаИзмеренияКод КАК ЕдиницаИзмеренияКод,
	|	ТаблицаТовары.ИсточникПроисхождения,
	|	ТаблицаТовары.ИсточникПроисхождения.КодТНВЭД КАК КодТНВЭД
	|ПОМЕСТИТЬ вт_Товары
	|ИЗ
	|	вт_ТоварыНоменклатура КАК ТаблицаТовары
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТаблицаТовары.Номенклатура, 
	|	ТаблицаТовары.КодТНВЭДНоменклатура КАК КодТНВЭДНоменклатура,
	...
	|СГРУППИРОВАТЬ ПО
	|	ТаблицаТовары.Номенклатура,
	|	ТаблицаТовары.КодТНВЭДНоменклатура,
	...
	|	%ДатаДокументПартии%ТоварыВиртуальногоСкладаВРезерве% КАК ДатаДокументПартии,
	|	- ТоварыВиртуальногоСкладаВРезерве.КоличествоОстаток КАК КоличествоОстаток,
	|	ТоварыВиртуальногоСкладаВРезерве.Номенклатура.КодТНВЭД КАК КодТНВЭДНоменклатура,
	|	1 КАК Приоритет
	|ИЗ
	...
	|	ТоварыИсправляемогоЭСФ.Товар.КодТНВЭД КАК КодТНВЭДНоменклатура,
	|	1 КАК Приоритет
	|ИЗ
	...
	|	%ДатаДокументПартии%ИсточникиПроисхождения%,
	|	ТоварыИсправляемогоСНТ.КоличествоОстаток,
	|	"""" КАК КодТНВЭДНоменклатура,
	|	0 КАК Приоритет
	|ИЗ
	|	ВТ_ДанныеСвязанногоСНТ КАК ТоварыИсправляемогоСНТ
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ИсточникиПроисхождения КАК ИсточникиПроисхождения
	|		ПО ТоварыИсправляемогоСНТ.ИсточникПроисхождения = ИсточникиПроисхождения.Ссылка 
	|ГДЕ
	|	&УчитыватьТоварыИсправленногоСНТ
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Номенклатура,
	|	ЕдиницаИзмерения,
	...
	|	ОстаткиГТДПромежуточный.КодТНВЭДНоменклатура КАК КодТНВЭДНоменклатура,
	...
	|	ОстаткиГТДПромежуточный.Приоритет КАК Приоритет,
	...
	Если ЭтоЭДВССписания = Истина Тогда
		...
		|	ОстаткиГТД КАК ОстаткиГТД
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.СведенияОНоменклатуреГСВС КАК СведенияОНоменклатуреГСВС
		|		ПО ОстаткиГТД.ИсточникПроисхождения.ГСВС = СведенияОНоменклатуреГСВС.НоменклатураГСВС
		|		И ОстаткиГТД.ДатаДокументПартии >= СведенияОНоменклатуреГСВС.Период
		|ИНДЕКСИРОВАТЬ ПО
		|	ИсточникПроисхождения,
		|	Период
	...
	Иначе
		...
		|		ПО (ИсточникиПроисхождения.Ссылка = ДанныеИсточникиПроисхождения.ИсточникПроисхождения)
		|ГДЕ
		|	НЕ ИсточникиПроисхождения.ГСВС.КодГСВС ЕСТЬ NULL
		...
		|	НоменклатураГСВС.КодГСВС В
		|			(ВЫБРАТЬ
		|				ДанныеДокумента.КодТНВЭДНоменклатура
		|			ИЗ
		|				Товары КАК ДанныеДокумента
		|			ГДЕ
		|				НЕ ДанныеДокумента.КодТНВЭД = """")
		|	И НоменклатураГСВС.ТипКодаГСВС = ЗНАЧЕНИЕ(Перечисление.ТипыКодовГСВС.ТНВЭД)
		|
		|ОБЪЕДИНИТЬ
		...
		|		ПО (ПОДСТРОКА(СведенияОНоменклатуреГСВС.ПолныйКодГСВС, 13, 10) = ДанныеДокументаОбъекта.КодТНВЭДНоменклатура)
		|			И (СведенияОНоменклатуреГСВС.НоменклатураГСВС.ТипКодаГСВС = ЗНАЧЕНИЕ(Перечисление.ТипыКодовГСВС.ТНВЭД))
		|			И (СведенияОНоменклатуреГСВС.Период <= &ДатаОборота)
		|			И (НЕ ДанныеДокументаОбъекта.КодТНВЭД = """")
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ПриоритетПоискаНоменклатурыГСВС,
		|	КодГСВС
		...
		|	ВЫБОР
		|		КОГДА КодыГСВСАктуальные.НоменклатураГСВС ЕСТЬ NULL
		|			ТОГДА ЕСТЬNULL(СведенияОНоменклатуреГСВСПоКодуИзНоменклатуры.НоменклатураГСВС, ЗНАЧЕНИЕ(Справочник.НоменклатураГСВС.ПустаяСсылка))
		|		ИНАЧЕ КодыГСВСАктуальные.НоменклатураГСВС
		|	КОНЕЦ КАК ГСВС,
		|	ВЫБОР
		|		КОГДА КодыГСВСАктуальные.КодГСВС ЕСТЬ NULL
		|			ТОГДА ЕСТЬNULL(СведенияОНоменклатуреГСВСПоКодуИзНоменклатуры.КодГСВС, Товары.КодТНВЭДНоменклатура)
		|		ИНАЧЕ КодыГСВСАктуальные.КодГСВС
		|	КОНЕЦ КАК КодТНВЭД,
		|	ЕСТЬNULL(ИсточникиПроисхождения.МеткаТовара, """") КАК ФизическаяМетка,
		|	ЕСТЬNULL(ИсточникиПроисхождения.НомерЗаявленияВРамкахТС, """") КАК НомерЗаявленияВРамкахТС,
		|	ЕСТЬNULL(ИсточникиПроисхождения.НомерПозицииВДекларацииИлиЗаявлении, """") КАК НомерПозицииВДекларацииИлиЗаявлении,
		...
		|	ЕСТЬNULL(ИсточникиПроисхождения.ПризнакУчетаНаВиртуальномСкладе,Ложь) КАК ПризнакУчетаНаВиртуальномСкладе,
		|	ВЫБОР
		|		КОГДА КодыГСВСАктуальные.ПризнакПеречняИзьятий ЕСТЬ NULL
		|			ТОГДА ЕСТЬNULL(СведенияОНоменклатуреГСВСПоКодуИзНоменклатуры.ПризнакПеречняИзьятий, ЛОЖЬ)
		|		ИНАЧЕ КодыГСВСАктуальные.ПризнакПеречняИзьятий
		|	КОНЕЦ КАК ГСВСВходитВПеречень,
		|	ВЫБОР
		|		КОГДА ГСВСнеАктивенНетНаследника.ПолныйКодГСВСизИП ЕСТЬ NULL
		|			ТОГДА ВЫБОР
		|					КОГДА КодыГСВСАктуальные.ПолныйКодГСВС ЕСТЬ NULL
		|						ТОГДА ЕСТЬNULL(СведенияОНоменклатуреГСВСПоКодуИзНоменклатуры.ПолныйКодГСВС, """")
		|					ИНАЧЕ КодыГСВСАктуальные.ПолныйКодГСВС
		|				КОНЕЦ
		...
		|ИЗ
		|	Товары КАК Товары
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_КодыГСВСАктуальные КАК СведенияОНоменклатуреГСВСПоКодуИзНоменклатуры  // смотрим записи по коду ТНВЭД из номенклатуры
		|		ПО Товары.КодТНВЭДНоменклатура = СведенияОНоменклатуреГСВСПоКодуИзНоменклатуры.КодГСВСПервичный
		|		ЛЕВОЕ СОЕДИНЕНИЕ ОстаткиГТД КАК ОстаткиГТД
		|		ПО Товары.Номенклатура = ОстаткиГТД.Номенклатура
		|			И Товары.ЕдиницаИзмерения = ОстаткиГТД.ЕдиницаИзмерения
		|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ИсточникиПроисхождения КАК ИсточникиПроисхождения
		|		ПО (ОстаткиГТД.ИсточникПроисхождения = ИсточникиПроисхождения.Ссылка)
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_КодыГСВСАктуальные КАК КодыГСВСАктуальные    //смотрим записи по коду ГСВС из источника
		|		ПО (ИсточникиПроисхождения.ГСВС.КодГСВС = КодыГСВСАктуальные.КодГСВСПервичный)
...
//Получить данные по ГСВС если код закрыт и у него нет преемника, 
//в СНТ/ЭСФ в поле G4 указываете новый код (если код устарел на дату отгрузки),
//в поле G13/G17 - старый код с идентификатором, в такой ситуации при создании ИП в ссылочное поле ГСВС
//должны записаться новые данные по коду ТНВэД
Функция ПолучитьДанныеПоГСВС(ДатаОтгрузкиТовара, КодГСВСПолный, КодТНВЭД) Экспорт

	//Выбираем все записи по кодам ТНВЭД из номенклатуры/объекта. Если запись активна, 
	//то приоритет 1, иначе 2 (означает, что будем смотреть потомка)
	...
	Запрос.Текст = 
		...
		|	СведенияОНоменклатуреГСВС.Период КАК Период,
		|	СведенияОНоменклатуреГСВС.ПризнакАктивности КАК ПризнакАктивности,
		|	СведенияОНоменклатуреГСВС.ДействиеЗаписиНачальнаяДата КАК ДействиеЗаписиНачальнаяДата,
		|	СведенияОНоменклатуреГСВС.ДействиеЗаписиКонечнаяДата КАК ДействиеЗаписиКонечнаяДата,
		|	ВЫБОР
		|		КОГДА СведенияОНоменклатуреГСВС.ПризнакАктивности
		...
		|					ИНАЧЕ СведенияОНоменклатуреГСВС.ДействиеЗаписиКонечнаяДата
		|				КОНЕЦ
		|				И СведенияОНоменклатуреГСВС.ПолныйКодГСВС = &КодГСВСПолный
		|			ТОГДА 1
		|		КОГДА СведенияОНоменклатуреГСВС.ПризнакАктивности
		|				И &ДатаНачала >= НАЧАЛОПЕРИОДА(СведенияОНоменклатуреГСВС.ДействиеЗаписиНачальнаяДата, ДЕНЬ)
		|				И &ДатаНачала <= ВЫБОР
		...
		|					ИНАЧЕ СведенияОНоменклатуреГСВС.ДействиеЗаписиКонечнаяДата
		|				КОНЕЦ
		|				И ПОДСТРОКА(СведенияОНоменклатуреГСВС.ПолныйКодГСВС, 13, 10) = &КодТНВЭД
		|			ТОГДА 2
		|		ИНАЧЕ 3
		|	КОНЕЦ КАК ПриоритетПоискаНоменклатурыГСВС,
		|	ПОДСТРОКА(СведенияОНоменклатуреГСВС.ПолныйКодГСВС, 13, 10) КАК КодГСВС
		|ПОМЕСТИТЬ ВТ_НоменклатураГСВС
		|ИЗ
		|	РегистрСведений.СведенияОНоменклатуреГСВС.СрезПоследних(
		|			&ДатаНачала,
		|			(ПолныйКодГСВС = &КодГСВСПолный
		|				ИЛИ ПОДСТРОКА(ПолныйКодГСВС, 13, 10) = &КодТНВЭД)
		|				И НоменклатураГСВС.ТипКодаГСВС = ЗНАЧЕНИЕ(Перечисление.ТипыКодовГСВС.ТНВЭД)) КАК СведенияОНоменклатуреГСВС
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	ПриоритетПоискаНоменклатурыГСВС,
		|	КодГСВС
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	МИНИМУМ(ВТ_НоменклатураГСВС.ПриоритетПоискаНоменклатурыГСВС) КАК Приоритет
		|ПОМЕСТИТЬ ВТ_НоменклатураПриоритет
		|ИЗ
		|	ВТ_НоменклатураГСВС КАК ВТ_НоменклатураГСВС
		|;
		|
		...
		|ВЫБРАТЬ
		|	ВТ_НоменклатураГСВС.КодГСВС КАК КодГСВС,
		|	ВТ_НоменклатураГСВС.ПриоритетПоискаНоменклатурыГСВС КАК ПриоритетПоискаНоменклатурыГСВС
		|ПОМЕСТИТЬ ВТ_НоменклатураГСВСМинимум
		|ИЗ
		|	ВТ_НоменклатураГСВС КАК ВТ_НоменклатураГСВС
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_НоменклатураПриоритет КАК ВТ_НоменклатураПриоритет
		|		ПО ВТ_НоменклатураГСВС.ПриоритетПоискаНоменклатурыГСВС = ВТ_НоменклатураПриоритет.Приоритет
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	КодГСВС,
		|	ПриоритетПоискаНоменклатурыГСВС
		...
		|	НоменклатураГСВССгруппированная.КодГСВСПервичный КАК КодГСВСПервичный
		|ИЗ
		|	РегистрСведений.СведенияОНоменклатуреГСВС.СрезПоследних(&ДатаНачала, ) КАК СведенияОНоменклатуреГСВССрезПоследних
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_НоменклатураГСВССгруппированная КАК НоменклатураГСВССгруппированная
		|		ПО (НоменклатураГСВССгруппированная.НоменклатураГСВС = СведенияОНоменклатуреГСВССрезПоследних.НоменклатураГСВС)
		|			И (&ДатаНачала >= НАЧАЛОПЕРИОДА(СведенияОНоменклатуреГСВССрезПоследних.ДействиеЗаписиНачальнаяДата, ДЕНЬ))";
	
	Запрос.УстановитьПараметр("ДатаНачала", ДатаОтгрузкиТовара);
	Запрос.УстановитьПараметр("КодГСВСПолный", КодГСВСПолный);
	Запрос.УстановитьПараметр("КодТНВЭД", КодТНВЭД);
	
	РезультатЗапроса = Запрос.Выполнить();
	ВыборкаДетальныеЗаписи = РезультатЗапроса.Выбрать();
	
	ДанныеПоГСВС = Неопределено;
	
	Если ВыборкаДетальныеЗаписи.Следующий() Тогда 
		ДанныеПоГСВС = Новый Структура();
		ДанныеПоГСВС.Вставить("НоменклатураГСВС",					ВыборкаДетальныеЗаписи.НоменклатураГСВС); 
		ДанныеПоГСВС.Вставить("ПолныйКодГСВС",						ВыборкаДетальныеЗаписи.ПолныйКодГСВС);
		ДанныеПоГСВС.Вставить("КодГСВС",							ВыборкаДетальныеЗаписи.КодГСВС); 
		ДанныеПоГСВС.Вставить("КодГСВСПервичный",					ВыборкаДетальныеЗаписи.КодГСВСПервичный);
		ДанныеПоГСВС.Вставить("ПризнакАктивности",					ВыборкаДетальныеЗаписи.ПризнакАктивности); 
		ДанныеПоГСВС.Вставить("ПризнакПеречняИзьятий",				ВыборкаДетальныеЗаписи.ПризнакПеречняИзьятий);
		ДанныеПоГСВС.Вставить("ПризнакУчетаНаВиртуальномСкладе",	ВыборкаДетальныеЗаписи.ПризнакУчетаНаВиртуальномСкладе);
	КонецЕсли;
	
	Возврат ДанныеПоГСВС;
...
Функция ПустаяТаблицаИсточниковПроисхождения() Экспорт
	...
	ТипСтрока115 = Новый ОписаниеТипов("Строка", , Новый КвалификаторыСтроки(115));
	...
	ТаблицаИсточниковПроисхождения.Колонки.Добавить("ГСВСТоварПартии", ТипСтрока115);//реквизит чтоб сохранять ГСВС(выделенный из идентификатора товара) поставщика
...
Процедура ЗаполнитьНовыйИсточникПроисхождения(ОбъектИсточникПроисхождения, СтрокаИсточника, ТаблицаИсточникиПроисхождения)
	...
	ОбъектИсточникПроисхождения.Наименование = ?(ТипЗнч(СтрокаИсточника.ДокументПартии) = Тип("ДокументСсылка.ЭСФ"),"ЭСФ","")
	+ ?(ТипЗнч(СтрокаИсточника.ДокументПартии) = Тип("ДокументСсылка.ЭлектронныйДокументВС"),"ЭДВС","")
	+ ?(ТипЗнч(СтрокаИсточника.ДокументПартии) = ВССерверПереопределяемый.ТипДокументаСопоставлениеСНТиФНО(),"СопоставлениеСНТиФНО","")
	+ ?(ТипЗнч(СтрокаИсточника.ДокументПартии) = ВССерверПереопределяемый.ТипДокументаСНТ(),"СНТ","")
	+ "/" + СтрокаИсточника.Номенклатура.Наименование  + "/" +  СтрокаИсточника.КодТНВЭД  
	...
	+ ?(ЗначениеЗаполнено(СтрокаИсточника.ДополнительныйИдентификатор), "/" + СокрЛП(СтрокаИсточника.ДополнительныйИдентификатор), "");
	...
	ПараметрыПоиска.Вставить("ГСВСТоварПартии", СтрокаИсточника.ГСВСТоварПартии);//реквизит чтоб сохранять ГСВС(выделенный из идентификатора товара) поставщика
...
Функция МассивОбновляемыхРеквизитовИсточника() Экспорт
	...
	МассивРеквизитов.Добавить("GTIN");
...
Функция ПодготовитьТаблицуТоварыНаВС(ТаблицаРеквизиты, ТаблицаТовары, Отказ) Экспорт
	...
	Если ТипЗнч(ТаблицаРеквизиты) = Тип("ТаблицаЗначений") Тогда
		...
		Если ТаблицаРеквизиты.Колонки.Найти("ВидПеремещения") <> Неопределено Тогда
			СписокОбязательныхКолонок = СписокОбязательныхКолонок + ",ВидПеремещения";
		КонецЕсли;
...
Процедура ВыполнитьКонтрольТоварыОрганизацийНаВС(ТаблицаРеквизиты, ТаблицаТовары, Отказ) Экспорт
	...
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("ТаблицаТовары", 					ТаблицаТовары);
	Запрос.УстановитьПараметр("ДатаОстатка"	 , 					Новый Граница(Реквизиты.Регистратор.МоментВремени(), ВидГраницы.Исключая));
	...
	УчитыватьТоварыВРезерве = Истина;
	Если ТипЗнч(Реквизиты.Регистратор) = Тип("ДокументСсылка.ЭлектронныйДокументВС") Тогда
		ТипФормы = Реквизиты.ТипФормы;
		Если ТипФормы = Перечисления.ТипыФормВС.КорректировкаДанных Тогда
			ВидКорректировки = ЭСФСерверПереопределяемый.ЗначениеРеквизитаОбъекта(Реквизиты.Регистратор, "ВидКорректировкиДанных");
			Если ВидКорректировки = Перечисления.ВидыКорректировкиДанных.СписаниеРезервов Тогда
				УчитыватьТоварыВРезерве = Ложь;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
	Запрос.УстановитьПараметр("УчитыватьТоварыВРезерве", УчитыватьТоварыВРезерве);
...
Процедура СформироватьДвиженияТоваровНаВСВРезерве(ТаблицаРеквизиты, ТаблицаТовары, Движения, Отказ, ПериодДвижения = Неопределено, ВидДвижения = Неопределено) Экспорт
	
	Если ТаблицаТовары = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Параметры = ВССервер.ПодготовитьТаблицуТоварыНаВСВРезерве(ТаблицаРеквизиты, ТаблицаТовары, Отказ);
	...
	Для Каждого СтрокаТаблицы Из Параметры.ТаблицаТовары Цикл
		...
		Движение.Организация 	          =  Реквизиты.Организация;
		Движение.Период      	          =  ПериодДвижения;
		Движение.СпособВыписки  		  =  СтрокаТаблицы.СпособВыписки;
		Движение.СтруктурноеПодразделение =  Реквизиты.СтруктурноеПодразделение;
	КонецЦикла;

	Движения.ТоварыВиртуальногоСкладаВРезерве.Записывать = Истина;
	Движения.ТоварыВиртуальногоСкладаВРезерве.Записать();
	
КонецПроцедуры

Функция ПодготовитьТаблицуТоварыНаВСВРезерве(ТаблицаРеквизиты, ТаблицаТовары, Отказ) Экспорт
...
Процедура ВыполнитьКонтрольТоваровНаВСВРезерве(ТаблицаРеквизиты, ТаблицаТовары, Отказ) Экспорт
	
	Параметры =  ПодготовитьТаблицуТоварыНаВСВРезерве(ТаблицаРеквизиты, ТаблицаТовары, Отказ);
	Если Параметры.ТаблицаТовары.Количество() = 0 
		ИЛИ Параметры.Реквизиты.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
	...
	|	ТаблицаТовары.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	ТаблицаТовары.ИсточникПроисхождения КАК ИсточникПроисхождения,
	|	ТаблицаТовары.СпособВыписки КАК СпособВыписки
	|ПОМЕСТИТЬ Вт_Товары
	|ИЗ
	|	&ТаблицаТовары КАК ТаблицаТовары
	|
	...
	|	ТоварыВиртуальногоСкладаВРезерве.ИсточникПроисхождения КАК ИсточникПроисхождения,
	|	ТоварыВиртуальногоСкладаВРезерве.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	ТоварыВиртуальногоСкладаВРезерве.СпособВыписки КАК СпособВыписки,
	|	ТоварыВиртуальногоСкладаВРезерве.КоличествоОстаток КАК КоличествоОстаток
	|ПОМЕСТИТЬ ВТ_Остатки
	|ИЗ
	|	РегистрНакопления.ТоварыВиртуальногоСкладаВРезерве.Остатки(
	...
	|				И Склад = &Склад
	|				И СтруктурноеПодразделение = &СтруктурноеПодразделение
	|				И (Номенклатура, ЕдиницаИзмерения, ИсточникПроисхождения, СпособВыписки) В
	|					(ВЫБРАТЬ
	|						Вт_Товары.Номенклатура,
	|						Вт_Товары.ЕдиницаИзмерения,
	|						Вт_Товары.ИсточникПроисхождения,
	|						Вт_Товары.СпособВыписки
	|					ИЗ
	|						Вт_Товары)) КАК ТоварыВиртуальногоСкладаВРезерве
	|;
	|
	...
	Для Каждого СтрокаДокумента Из ТаблицаТовары Цикл
		...
		СтруктураПоиска.Вставить("ЕдиницаИзмерения"		, СтрокаДокумента.ЕдиницаИзмерения);
		СтруктураПоиска.Вставить("ИсточникПроисхождения", СтрокаДокумента.ИсточникПроисхождения);
		СтруктураПоиска.Вставить("СпособВыписки"		, СтрокаДокумента.СпособВыписки);
		...
		Если КоличествоОсталосьПогасить > 0  Тогда
			...
			ТекстОшибки = НСтр("ru='Товары виртуального склада в резерве. Строка: %1. По организации <%2>,структурному подразделению <%3>, складу <%4> не списано %5 %6 товара <%7>, источник происхождения - %8, способ выписки - %9' ");
			ТекстОшибки = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстОшибки, СтрокаДокумента.НомерСтроки,Реквизиты.Организация,Реквизиты.СтруктурноеПодразделение, СтрокаДокумента.Склад, КоличествоОсталосьПогасить, СтрокаДокумента.ЕдиницаИзмерения,
						СтрокаДокумента.Номенклатура, СтрокаДокумента.ИсточникПроисхождения, СтрокаДокумента.СпособВыписки);
			ПолеКоличество	= СтрокаДокумента.ИмяСписка + "[" + Формат(СтрокаДокумента.НомерСтроки - 1, "ЧН=0; ЧГ=") + "].Количество";		
...
// Выполняется контроль остатков в РН "Товары на виртуальном складе" при виде движения "Расход"
//  для формы ЭДВС "Корректировка данных" - "Ручная корректировка"
Процедура ВыполнитьКонтрольТоваровНаВСРучнаяКорректировка(ТаблицаРеквизиты, ТаблицаТовары, Отказ) Экспорт
	...
	|	Вт_Товары КАК ТаблицаТовары
	|ГДЕ
	|	ТаблицаТовары.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Расход)
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Номенклатура,
	|	ЕдиницаИзмерения,
	...
	|	Остатки.ИсточникПроисхождения КАК ИсточникПроисхождения,
	...
	Для Каждого СтрокаДокумента Из ТаблицаТовары Цикл
		...
		Если КоличествоОсталосьПогасить > 0 И СтрокаДокумента.ВидДвижения = ВидДвиженияНакопления.Расход Тогда
...
// Выполняется контроль остатков в РН "Товары на виртуальном складе в резерве" при виде движения "Расход"
//  для формы ЭДВС "Корректировка данных" - "Ручная корректировка"
Процедура ВыполнитьКонтрольТоваровНаВСВРезервеРучнаяКорректировка(ТаблицаРеквизиты, ТаблицаТовары, Отказ) Экспорт
	...
	|	Остатки.ИсточникПроисхождения КАК ИсточникПроисхождения,
	|	Остатки.ЕдиницаИзмерения КАК ЕдиницаИзмерения,
	|	Остатки.СпособВыписки КАК СпособВыписки,
	|	СУММА(Остатки.КоличествоОстаток) КАК КоличествоОстаток
	|ИЗ
	|	ВТ_Остатки КАК Остатки
	|
...
Функция ПроверитьВозможностьОтправкиДокументовЭДВС(МассивЭДВС, ДополнительныеПараметры) Экспорт
	...
	Запрос.УстановитьПараметр("ПустойИсточникПроисхождения", Справочники.ИсточникиПроисхождения.ПустаяСсылка());
	...
	//список типов форм, которые нельзя отправлять с пустыми источниками в таблице ТоварыВС
	МассивТиповФорм = Новый Массив;
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.ВнутреннееПеремещение);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.Списание);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.ПеремещениеМеждуФилиалами);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.СписаниеТоваровНеВС);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.ВводОстатковНаВС);
	Запрос.УстановитьПараметр("ТипыФорм", МассивТиповФорм);
	
	//список типов форм, которые нельзя отправлять с пустыми источниками в таблице ИсходныеТоварыВС
	МассивТиповФормИсходныеТовары = Новый Массив;
	МассивТиповФормИсходныеТовары.Добавить(Перечисления.ТипыФормВС.Детализация);
	МассивТиповФормИсходныеТовары.Добавить(Перечисления.ТипыФормВС.ФизическаяМетка);
	Запрос.УстановитьПараметр("ТипыФормИсходныеТовары", МассивТиповФормИсходныеТовары);
	Запрос.УстановитьПараметр("МаксимальноеКоличествоСтрок", ВСКлиентСервер.МаксимальноеКоличествоСтрокДокументаЭДВС());
	
	//список типов форм, для которых обязательно заполнение ГСВС в тч Товары и ТоварыВС
	МассивТиповФорм = Новый Массив;
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.ДекларацияНаТовары);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.Производство);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.Остатки);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.КорректировкаОстатков);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.ДетализацияИмпорта);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.Детализация);
	МассивТиповФорм.Добавить(Перечисления.ТипыФормВС.ФизическаяМетка);
	Запрос.УстановитьПараметр("ТипыФормОбязательноЗаполнениеГСВС", МассивТиповФорм);
	...
	Запрос.Текст = 
		...
		|	ЭлектронныйДокументВС.ВидДетализации КАК ВидДетализации,
		...
		|;	
		|ВЫБРАТЬ
		|	КОЛИЧЕСТВО(ЭлектронныйДокументВСТовары.НомерСтроки) КАК КоличествоПустыхИП,
		|	ЭлектронныйДокументВСТовары.Ссылка
		|ПОМЕСТИТЬ ВТ_ЭДВСПустыеИП
		|ИЗ
		|	Документ.ЭлектронныйДокументВС.ТоварыВС КАК ЭлектронныйДокументВСТовары
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЭлектронныйДокументВС КАК ЭДВС
		|		ПО ЭлектронныйДокументВСТовары.Ссылка = ЭДВС.Ссылка
		|ГДЕ
		|	ЭлектронныйДокументВСТовары.Ссылка В(&МассивЭДВС)
		|	И ЭлектронныйДокументВСТовары.ИсточникПроисхождения = &ПустойИсточникПроисхождения
		|	И ЭДВС.ТипФормы В (&ТипыФорм)
		|
		|СГРУППИРОВАТЬ ПО
		|	ЭлектронныйДокументВСТовары.Ссылка
		|
		...
		|	ЭлектронныйДокументВСТовары.Ссылка
		|ИЗ
		|	Документ.ЭлектронныйДокументВС.ИсходныеТоварыВС КАК ЭлектронныйДокументВСТовары
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЭлектронныйДокументВС КАК ЭДВС
		|		ПО ЭлектронныйДокументВСТовары.Ссылка = ЭДВС.Ссылка
		|ГДЕ
		|	ЭлектронныйДокументВСТовары.Ссылка В(&МассивЭДВС)
		|	И ЭлектронныйДокументВСТовары.ИсточникПроисхождения = &ПустойИсточникПроисхождения
		|	И ЭДВС.ТипФормы В (&ТипыФормИсходныеТовары)
		|
		|СГРУППИРОВАТЬ ПО
		|	ЭлектронныйДокументВСТовары.Ссылка
		|;	
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЭлектронныйДокументВСТоварыВС.Ссылка КАК Ссылка
		|ПОМЕСТИТЬ ВТ_ЭДВС_НеЗаполненГСВС
		|ИЗ
		|	Документ.ЭлектронныйДокументВС.ТоварыВС КАК ЭлектронныйДокументВСТоварыВС
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЭлектронныйДокументВС КАК ЭДВС
		|		ПО ЭлектронныйДокументВСТоварыВС.Ссылка = ЭДВС.Ссылка
		|ГДЕ
		|	ЭлектронныйДокументВСТоварыВС.Ссылка В(&МассивЭДВС)
		|	И ЭлектронныйДокументВСТоварыВС.ГСВС = ЗНАЧЕНИЕ(Справочник.НоменклатураГСВС.ПустаяСсылка)
		|	И (ЭДВС.ТипФормы В (&ТипыФормОбязательноЗаполнениеГСВС)
		|			ИЛИ ЭДВС.ТипФормы В (ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.ПеремещениеМеждуФилиалами), ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.СписаниеТоваровНеВС), ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.ВводОстатковНаВС))
		|				И ЭДВС.ВидДетализации <> ЗНАЧЕНИЕ(Перечисление.ВидДетализации.КонвертацияМеждуЕИ))
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|	ЕстьNULL(ЭДВСПустыеИП.КоличествоПустыхИП, 0) КАК КоличествоПустыхИП,
		|	НЕ ЭДВС_НеЗаполненГСВС.Ссылка Есть NULL КАК НеЗаполненГСВС
		|
		|ИЗ
		|	ВТ_ЭДВС КАК ЭДВС
		|		ЛЕВОЕ СОЕДИНЕНИЕ ЭДВССТоварамиВС КАК ЭДВССТоварамиВС
		|		ПО ЭДВС.Ссылка = ЭДВССТоварамиВС.Ссылка
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЭДВСПустыеИП КАК ЭДВСПустыеИП
		|		ПО ЭДВС.Ссылка = ЭДВСПустыеИП.Ссылка
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_ЭДВС_НеЗаполненГСВС КАК ЭДВС_НеЗаполненГСВС
		|		ПО ЭДВС.Ссылка = ЭДВС_НеЗаполненГСВС.Ссылка
		|
		|ГДЕ
		|	ЭДВС.Статус В (&Статусы)
		|		ИЛИ ЭДВС.КорректировкаИП = ИСТИНА
		|		ИЛИ ЭДВССТоварамиВС.МаксимальныйНомерСтроки > &МаксимальноеКоличествоСтрок
		...
		|		ИЛИ ЕстьNULL(ЭДВСПустыеИП.КоличествоПустыхИП, 0) > 0
		|		ИЛИ НЕ ЭДВС_НеЗаполненГСВС.Ссылка Есть NULL
		|";
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ИначеЕсли ВыборкаДетальныеЗаписи.КоличествоПустыхИП > 0 Тогда
			
			ТекстСообщения = НСтр("ru = 'Документ ""%1"" исключен из пакета отправки. В документе обнаружены строки, в которых не заполнен источник происхождения. Воспользуйтесь командой Проверить.'");
			ТекстСообщения = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстСообщения,
			ВыборкаДетальныеЗаписи.ЭДВС);
			
			ЭСФКлиентСерверПереопределяемый.СообщитьПользователю(ТекстСообщения);
			
		ИначеЕсли ВыборкаДетальныеЗаписи.НеЗаполненГСВС = Истина Тогда
			
			ТекстСообщения = НСтр("ru = 'Документ ""%1"" исключен из пакета отправки. В документе обнаружены строки, в которых не заполнен ГСВС. Воспользуйтесь командой Проверить.'");
			ТекстСообщения = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстСообщения,
			ВыборкаДетальныеЗаписи.ЭДВС);
...
Функция ПустыеПараметрыЭДВС() Экспорт
	...
	ПустыеПараметрыЭДВС.Вставить("ВремяЖизниТикетаВС"	, 0);
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "2.0.6.24";
	Обработчик.Процедура           = "Справочники.НоменклатураГСВС.ЗаполнитьПолныеКодыГСВСДляGTIN";
	Обработчик.ОбщиеДанные         = Ложь;
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения     = "Отложенно";
...
Процедура ПолучитьИдентификаторыТоваровПоРегНомерамДокументов(МассивЭДВСДляПолученияИдентификаторовТоваров, Знач ПрофильИСЭСФ, ИдентификаторСессии, Знач ПроводитьИзмененныеДокументы) Экспорт
	
	ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().ПолучитьИдентификаторыТоваровПоРегНомерамДокументов(МассивЭДВСДляПолученияИдентификаторовТоваров, ПрофильИСЭСФ, ИдентификаторСессии, ПроводитьИзмененныеДокументы);
...
Процедура ДополнитьТекстЗапросаДатойДокументаПартии(ТекстЗапроса) Экспорт
	
	ЗаменяемоеПоле = "%ДатаДокументПартии%";
	
	ПозицияПоля = СтрНайти(ТекстЗапроса, ЗаменяемоеПоле);
	Пока ПозицияПоля <> 0 Цикл
		
		ЧастьТекстаЗапроса = Сред(ТекстЗапроса, ПозицияПоля + СтрДлина(ЗаменяемоеПоле));
		
		ПозицияЗнака = СтрНайти(ЧастьТекстаЗапроса, "%");
		
		ИмяТаблицы = Лев(ЧастьТекстаЗапроса, ПозицияЗнака - 1);
		
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса,
			ЗаменяемоеПоле + ИмяТаблицы + "%", СтрЗаменить(
			"ВЫБОР
			|		КОГДА ИсточникиПроисхождения.ДокументПартии Ссылка Документ.ЭСФ
			|			ТОГДА ИсточникиПроисхождения.ДокументПартии.ДатаОборота" +
			?(ИспользоватьСНТ(), "
			|		КОГДА ИсточникиПроисхождения.ДокументПартии Ссылка Документ.СНТ
			|			ТОГДА ВЫБОР
			|				КОГДА ИсточникиПроисхождения.ДокументПартии.ДатаОтгрузкиТовара = ДатаВремя(1, 1, 1)
			|					ТОГДА ИсточникиПроисхождения.ДокументПартии.Дата
			|				ИНАЧЕ ИсточникиПроисхождения.ДокументПартии.ДатаОтгрузкиТовара
			|			КОНЕЦ", "") + "
			|		ИНАЧЕ ИсточникиПроисхождения.ДокументПартии.Дата
			|	КОНЕЦ", "ИсточникиПроисхождения", ИмяТаблицы));
