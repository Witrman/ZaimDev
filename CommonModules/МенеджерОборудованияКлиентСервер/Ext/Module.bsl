...
Функция ПараметрыДанныеКодаТоварнойНоменклатуры() Экспорт
	...
	Параметры.Вставить("КодМаркировки"); // Строка,Необязательно - Полное значение кода товара.   
	Возврат Параметры; 
...
Функция ПараметрыФискальнойСтрокиЧека() Экспорт;
	...
	ПараметрыСтроки.Вставить("КодЕдиницыИзмерения", 0);       // Число,Необязательно, Единица измерения код. 
