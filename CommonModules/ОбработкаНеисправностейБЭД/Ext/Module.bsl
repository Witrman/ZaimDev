...
Функция АрхивСИнформациейДляТехПоддержки(КонтекстДиагностики, ТехническаяИнформация) Экспорт
	...
	Для Каждого ИмяДобавляемогоФайла Из ФайлыАрхива Цикл
		ЗаписьАрхива.Добавить(ИмяДобавляемогоФайла);
	КонецЦикла;
	ДвоичныеДанныеАрхива = ЗаписьАрхива.ПолучитьДвоичныеДанные();
