...
Процедура ПриЗаполненииТиповОбщихДанныхПоддерживающихСопоставлениеСсылокПриЗагрузке(Типы) Экспорт
	...
	Типы.Добавить(Метаданные.Справочники.ДвиженияДенежныхСредств);
	Типы.Добавить(Метаданные.Справочники.ВидыУчетаНУ);
	Типы.Добавить(Метаданные.Справочники.ГруппыНалоговогоУчетаФА);
