...
Функция ДанныеСовпадают(Данные1, Данные2) Экспорт
	...
	ИначеЕсли ТипЗнч(Данные1) = Тип("СписокЗначений") Тогда
		...
		Индекс = Данные1.Количество()-1;
		Пока Индекс >= 0 Цикл
			НовоеЗначение  = Данные1.Получить(Индекс);
			СтароеЗначение = Данные2.Получить(Индекс);
			Если НЕ ДанныеСовпадают(НовоеЗначение.Значение,      СтароеЗначение.Значение)
			 ИЛИ НЕ ДанныеСовпадают(НовоеЗначение.Картинка,      СтароеЗначение.Картинка)
			 ИЛИ НЕ ДанныеСовпадают(НовоеЗначение.Пометка,       СтароеЗначение.Пометка)
			 ИЛИ НЕ ДанныеСовпадают(НовоеЗначение.Представление, СтароеЗначение.Представление) Тогда
