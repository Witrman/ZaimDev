...
//                      - Структура - сохраняет переданные настройки в хранилище общих настроек. Формат:
//    см. ПолучениеОбновленийПрограммы.НовыйНастройкиАвтоматическогоОбновления().
//
// Возвращаемое значение:
//  Структура:
//    * ОписаниеЗадания - Неопределено - возвращается если обновление программы не доступно, длительная операция
//        отменена или возникла модульная ошибка.
...
//    * ПараметрыОповещения - Неопределено - возвращается если 
//        см. ПолучениеОбновленийПрограммы.ОпределитьПараметрыОповещенияОДоступномОбновлении().
//
Функция СохранитьНастройкиОбновленияИНачатьПроверкуНаличияОбновления(Знач НастройкиОбновления = Неопределено) Экспорт
	...
	Если ОписаниеЗадания <> Неопределено Тогда
		Если ОписаниеЗадания.Выполнено Тогда
			ПараметрыОповещения = ПолучениеОбновленийПрограммы.ОпределитьПараметрыОповещенияОДоступномОбновлении(ОписаниеЗадания);
		КонецЕсли;
		ОписаниеЗадания.Вставить("ПараметрыОповещения", ПараметрыОповещения);
	КонецЕсли;
...
Функция РезультатЗаданияПроверкиНаличияОбновлений(Знач ОписаниеЗадания) Экспорт
	...
	Возврат ПолучениеОбновленийПрограммы.ОпределитьПараметрыОповещенияОДоступномОбновлении(ОписаниеЗадания);
