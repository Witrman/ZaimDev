					...
					Если ПоддержкаРаботыСоСтруктурнымиПодразделениями Тогда
						...
						Иначе
							...
							Если ЗначениеЗаполнено(ВладелецГоловногоПодразделения) Тогда
								СписокПодразделений.Добавить(Отбор.Значение, "Головное подразделение");
...
Процедура СохранитьСписокСчетовИсключаемыхИзРасчетаЗадолженности(СписокСчетов, Тип = 1) Экспорт
	...
	Иначе
		Описание    = "Счета, исключаемые из расчета";
	КонецЕсли;
...
Процедура СохранитьСписокСчетовПользователяДляРасчетаЗадолженности(СписокСчетов, Тип = 1) Экспорт
	...
	Если Тип = 1 Тогда
		Описание    = "Счета, добавленные пользователем для расчета задолженности покупателей";
	ИначеЕсли Тип = 2 Тогда
		Описание    = "Счета, добавленные пользователем для расчета задолженности поставщикам";
	КонецЕсли;
