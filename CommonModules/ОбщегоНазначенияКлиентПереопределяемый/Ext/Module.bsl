...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	ОбщегоНазначенияБККлиент.ПередНачаломРаботыСистемы(Параметры);
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	ОбщегоНазначенияБККлиент.ПриНачалеРаботыСистемы(Параметры);
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	ОбщегоНазначенияБККлиент.ПослеНачалаРаботыСистемы();
