&НаКлиенте
Процедура ОбработатьИзмененияПоКнопкеЦеныИВалюты(Форма, ЭтоДокументРозничнойТорговли = Ложь) Экспорт
	...
	Если ОткрыватьИзМеню Тогда
		...
		КонецЕсли; 
	Иначе
		УправлениеЦенообразованиемКлиент.ОткрытьФормуЦеныИВалюта(Форма,,,,, ЭтоДокументРозничнойТорговли);
	КонецЕсли;
