...
Процедура ПриОпределенииВозможныхПредметов(ТипыПредметов) Экспорт
	...
	ТипыПредметов.Добавить("СправочникСсылка.ДоговорыКонтрагентов");
	ТипыПредметов.Добавить("ДокументСсылка.АктСверкиВзаиморасчетов");
	ТипыПредметов.Добавить("ДокументСсылка.ПоступлениеТоваровУслуг");
	ТипыПредметов.Добавить("ДокументСсылка.РеализацияТоваровУслуг");
	ТипыПредметов.Добавить("ДокументСсылка.СчетНаОплатуПокупателю");
...
Процедура ПриОпределенииВозможныхКонтактов(ТипыКонтактов) Экспорт
	...
	Контакт.Тип = Тип("СправочникСсылка.Контрагенты");
	Контакт.Имя = "Контрагенты";
	Контакт.Представление = НСтр("ru = 'Контрагенты'");
	Контакт.Иерархический = Истина;
	ТипыКонтактов.Добавить(Контакт);
		
	Контакт = ВзаимодействияКлиентСервер.НовоеОписаниеКонтакта();
	Контакт.Тип = Тип("СправочникСсылка.КонтактныеЛица");
	Контакт.Имя = "КонтактныеЛица";
	Контакт.Представление = НСтр("ru = 'Контактные лица'");
	ТипыКонтактов.Добавить(Контакт);
		
	Контакт = ВзаимодействияКлиентСервер.НовоеОписаниеКонтакта();
	Контакт.Тип = Тип("СправочникСсылка.Организации");
	Контакт.Имя = "Организации";
	Контакт.Представление = НСтр("ru = 'Организации'");
	ТипыКонтактов.Добавить(Контакт);
		
	Контакт = ВзаимодействияКлиентСервер.НовоеОписаниеКонтакта();
	Контакт.Тип = Тип("СправочникСсылка.ПодразделенияОрганизаций");
	Контакт.Имя = "ПодразделенияОрганизаций";
	Контакт.Представление = НСтр("ru = 'Подразделения организаций'");
	ТипыКонтактов.Добавить(Контакт);
		
	Контакт = ВзаимодействияКлиентСервер.НовоеОписаниеКонтакта();
	Контакт.Тип = Тип("СправочникСсылка.ФизическиеЛица");
	Контакт.Имя = "ФизическиеЛица";
	Контакт.Представление = НСтр("ru = 'Физические лица'");
	Контакт.Иерархический = Истина;
	ТипыКонтактов.Добавить(Контакт);
