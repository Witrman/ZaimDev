...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.Зарплата.Подсистемы.Отчеты, НСтр("ru = 'Отчеты по зарплате'"));
	Разделы.Добавить(Метаданные.Подсистемы.КадровыйУчет.Подсистемы.Отчеты, НСтр("ru = 'Отчеты по кадровому учету'"));
	Разделы.Добавить(Метаданные.Подсистемы.Руководителю, НСтр("ru = 'Отчеты руководителя'"));
	Разделы.Добавить(Метаданные.Подсистемы.Продажа, НСтр("ru = 'Отчеты по продажам'"));
	Разделы.Добавить(Метаданные.Подсистемы.ОсновныеСредстваИНМА, НСтр("ru = 'Отчеты по ОС и НМА'"));
	Разделы.Добавить(Метаданные.Подсистемы.Отчеты.Подсистемы.СтандартныеОтчеты.Подсистемы.НалоговыйУчет, НСтр("ru = 'Регистры налогового учета'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	Для Каждого ОтчетПодсистемы из СписокОтчетов Цикл
		ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты[ОтчетПодсистемы.Значение]);
	КонецЦикла;
	
	// Для отчета "Расчетные листки организаций" очистим Размещение,
	// чтобы при обновлении не создавалась запись об ошибке
	НастройкиОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты["РасчетныеЛисткиОрганизаций"]);
	НастройкиОтчета.Размещение.Очистить();
