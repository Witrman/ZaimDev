...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("ОбщиеЗначения", "ОбщегоНазначенияБК.УстановитьПараметрыСеансаОбщиеЗначения");
	
	Обработчики.Вставить("УдалитьИспользоватьОграниченияПравДоступаНаУровнеЗаписей", "ОбщегоНазначенияБК.УстановитьПараметрыСеансаИспользоватьОграниченияПравДоступаНаУровнеЗаписей");
	Обработчики.Вставить("УдалитьИспользоватьОграничениеПо*", "ОбщегоНазначенияБК.УстановитьПараметрыМеханизмаОграниченияПравДоступа");
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	ОбщегоНазначенияБК.ПараметрыРаботыКлиентаПриЗапуске(Параметры);
...
Процедура ПриОпределенииОтключенныхПодсистем(ОтключенныеПодсистемы) Экспорт
	...
	ОтключенныеПодсистемы.Вставить("СтандартныеПодсистемы.ВнешниеКомпоненты", Истина);
