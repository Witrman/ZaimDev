...
Процедура ПолучитьДанныеВыпискиБанкаТекстовыйФормат(
	...
	Текст = Новый ЗаписьДанных(Поток, КодировкаТекста.UTF8);

	Текст.ЗаписатьСтроку("1CClientBankExchange");
	Текст.ЗаписатьСтроку("ВерсияФормата=2.00");
	...
	Для Каждого СтруктураДанных Из МассивДанных Цикл
		...
		Для Каждого СтрокаТЧ Из СтрокиТЧ Цикл
			...
			Текст.ЗаписатьСтроку("НомерДокумента=" + Номер);
			Дата = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "Дата");
			Текст.ЗаписатьСтроку("ДатаДокумента=" + Формат(Дата, ОбменСБанкамиСлужебный.ФорматДатыРоссия()));
			...
			Текст.ЗаписатьСтроку("ПлательщикИИК=" + ПлательщикСчет);
			...
			КонецЕсли;
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикНаименование", "ПлательщикНаименование");
			ПлательщикИНН = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "ПлательщикИНН");
			Текст.ЗаписатьСтроку("ПлательщикБИН_ИИН=" + ПлательщикИНН);
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикКБЕ");
			
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикРасчСчет", "ПлательщикСчет");
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикБанкНаименование", "ПлательщикНаименованиеБанка");
			//ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикБанк2", "ПлательщикГородБанка");
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПлательщикБанкБИК", "ПлательщикБИКБанка");
			...
			Текст.ЗаписатьСтроку("ПолучательИИК=" + ПолучательСчет);
			...
			КонецЕсли;
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательНаименование", "ПолучательНаименование");
			ПолучательИНН = ЗначениеРеквизитаСтрокиДереваРазбора(
				ДеревоРазбора, СтрокаТЧ, "ПолучательИНН");
			Текст.ЗаписатьСтроку("ПолучательБИН_ИИН=" + ПолучательИНН);
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательКБЕ");
			
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательРасчСчет", "ПолучательСчет");
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательБанкНаименование", "ПолучательНаименованиеБанка");
			//ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательБанк2", "ПолучательГородБанка");
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ПолучательБанкБИК", "ПолучательБИКБанка");
			...
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "КодНазначенияПлатежа");
			...
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ДатаВалютирования");
			ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "ДатаПолученияТовара");
			...
			Если ЭтоПлатежВБюджет = Истина Тогда
				ДобавитьНеПустойПараметр(ДеревоРазбора, СтрокаТЧ, Текст, "КодБюджетнойКлассификации", "ПоказательКБК");
			КонецЕсли;
...
#Область ЭлектронноеВзаимодействие_Справочники_НастройкиОбменСБанками_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.ЧитаемыеОбъекты = "Справочник.ДополнительныеОтчетыИОбработки,"
		+ "Справочник.НастройкиОбменСБанками";
	Обработчик.ИзменяемыеОбъекты = "Справочник.ДополнительныеОтчетыИОбработки,"
