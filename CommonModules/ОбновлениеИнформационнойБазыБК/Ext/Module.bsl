...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Комментарий = 
		НСтр("ru = 'В справочнике ""Ставки НДС"" для ставок с признаком ""без НДС - не РК""убирает установленный признак ""Для освобожденного оборота""'");
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Комментарий         = НСтр("ru = 'Обновление справочника ""Вычеты ИПН"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.33.1";
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыБК.ЗаполнитьРесурсыУчетнаяПолитикаНалоговыйУчет";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Комментарий         = НСтр("ru = 'Заполнение ресурсов регистра  ""Учетная политика (налоговый учет)"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.33.1";
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыБК.ОбновитьСведенияОСтавкахОСМС";
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Комментарий         = НСтр("ru = 'Обновление ставок ОСМС в регистре ""Сведения о ставках ОСМС"".'");
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Комментарий         = НСтр("ru = 'Обновление ИБ. Документ ""Акт об оказании производственных услуг"". Заполнение даты подписания ГЗ.'");
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Комментарий         = НСтр("ru = 'Обновление ИБ. Документ ""Реализация услуг по переработке"". Заполнение даты подписания ГЗ.'");
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Комментарий         = НСтр("ru = 'Обновление ИБ. Документ ""Реализация ТМЗ и услуг"". Заполнение даты подписания ГЗ.'");
...
#Область Функциональность_3_0_37
	...
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Комментарий         = НСтр("ru = 'Обновление ставок ОПВ в регистре ""Сведения о ставках налогов, сборов и отчислений"".'");
...
#Область Функциональность_3_0_39
    ...
    Обработчик.Процедура           = "ОбновлениеИнформационнойБазыБК.ЗаполнитьРесурсыУчетнаяПолитикаНалоговыйУчет2020";
   	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Комментарий         = НСтр("ru = 'Обновление регистра сведений ""Учетная политика (налоговый учет)"".'");
...
#Область Функциональность_3_0_41
	...
	Обработчик.НачальноеЗаполнение = Ложь;
	Обработчик.Комментарий         = НСтр("ru = 'Обновление ставки ООСМС в регистре ""Сведения о ставках ОСМС"".'");
	...
	Обработчик.НачальноеЗаполнение = Истина; // В противном случае процедура не запустится при переходе с 2БК на 3БК 
	Обработчик.Комментарий = 
		НСтр("ru = 'заполнение реквизита ""Документ партии"" в элементах справочника ""Источники происхождения"", в записях регистра ""Товары на виртуальных складах"", для которых ранее была сформирована некорректная ссылка ""<Объект не найден>"".'");
...
Процедура ПервыйЗапускОбщиеДанные() Экспорт
	...
	НайтиСоздатьСтавкуНДС(НСтр("ru = 'без НДС'"), 0, Истина);
...
Процедура ПервыйЗапускРазделенныеДанные() Экспорт
	...
	ЕдиницаИзмеренияВеса = НайтиСоздатьЕдиницу("166", НСтр("ru = 'кг'"), НСтр("ru = 'Килограмм'"));
	ЕдиницаПоУмолчанию   = НайтиСоздатьЕдиницу("796", НСтр("ru = 'шт'"), НСтр("ru = 'Штука'"));
...
Процедура ЗаполнитьНалогиСборыОтчисления()
	...
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Индивидуальный подоходный налог за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомБУ = Типовой.ИндивидуальныйПодоходныйНалог;
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомНУ = Налоговый.ИндивидуальныйПодоходныйНалог;
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Индивидуальный подоходный налог за иностранных граждан за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Социальный налог за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Обязательные пенсионные взносы за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомБУ = Типовой.ОбязательстваПоПенсионнымОтчислениям;
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомНУ = Налоговый.ОбязательстваПоПенсионнымОтчислениям;
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Обязательные пенсионные взносы работодателя за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомБУ = Типовой.ОбязательстваПоПенсионнымОтчислениям;
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомНУ = Налоговый.ОбязательстваПоПенсионнымОтчислениям;
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Обязательные профессиональные пенсионные взносы за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Обязательные социальные отчисления за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Корпоративный подоходный налог подлежащий уплате за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомНУ = Налоговый.ПрочиеНалоги;
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Налог на имущество подлежащий уплате за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомНУ = Налоговый.ПрочиеНалоги;
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'Налог на транспорт подлежащий уплате за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'НДС на товары таможенного союза, ввозимые с территории РФ, подлежащий уплате за '");
	СправочникОбъект.Записать();
	...
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомБУ = Типовой.НалогНаДобавленнуюСтоимость;
	СправочникОбъект.СчетУчетаРасчетовСКонтрагентомНУ = Налоговый.НалогНаДобавленнуюСтоимость;
	СправочникОбъект.НазначениеПлатежа 				  = НСтр("ru = 'НДС на товары таможенного союза, ввозимые с территории РБ, подлежащий уплате за '");
	СправочникОбъект.Записать();
...
Процедура ЗаполнитьОснованияУвольнения()
	...
	Если ЭлементСпр.Пустая() Тогда
		...
		ЭлементСпр.Наименование 				  = НСтр("ru = 'п. 1) ст. 51 Трудового Кодекса РК. Расторжение трудового договора по соглашению сторон.'");
	...
	Если ЭлементСпр.Пустая() Тогда
		...
		ЭлементСпр.Наименование					  = НСтр("ru = 'п. 2) ст. 51 Трудового Кодекса РК. Истечение срока трудового договора.'");
		ЭлементСпр.ПричинаУвольненияИзОрганизации = Перечисления.ПричиныУвольненияИзОрганизации.ПоПричинамТекучести;
		ЭлементСпр.Записать();
	КонецЕсли;
	...
	Если ЭлементСпр.Пустая() Тогда
		...
		ЭлементСпр.Наименование 				  = НСтр("ru = 'п. 1 ст. 57 Трудового Кодекса РК. По инициативе работника.'");
		ЭлементСпр.ПричинаУвольненияИзОрганизации = Перечисления.ПричиныУвольненияИзОрганизации.ПоПричинамТекучести;
		ЭлементСпр.Записать();
	КонецЕсли;
...
Процедура ЗаполнитьПланыВидовРасчетаОрганизации() 
	...
	СпособУчетаИЛ = ДобавитьСпособУчетаРегЗарплаты(НСтр("ru = 'Удержания по исполнительным документам'"), ПланСчетов.КраткосрочнаяЗадолженностьПоОплатеТруда, Справочники.ФизическиеЛица.ПустаяСсылка(),,, ПланСчетов.КраткосрочнаяЗадолженностьПоИсполнительнымЛистам, Справочники.Контрагенты.ПустаяСсылка(),,);	
...
Процедура НачальноеЗаполнениеСправочникаКлассификаторСтранМира()
	...
	КазахстанОбъект.Наименование	   = НСтр("ru = 'КАЗАХСТАН'");
	КазахстанОбъект.НаименованиеПолное = НСтр("ru = 'Республика Казахстан'");
...
Процедура ЗаполнитьСведенияОГруппахФАНУ()	
	...
	// I группа
	ГруппаФА = НайтиСоздатьГуппуФАНУ(НСтр("ru = 'Здания, сооружения (за исключением нефтянных, газовых скважин и передаточных устройств)'"),
							НСтр("ru = 'Здания, сооружения, за исключением нефтяных, газовых скважин и передаточных устройств'"),
							"I", Перечисления.ВидыНалоговогоУчетаВГруппахФА.ПоОбъектам);
	СоздатьЗаписьСведенийОГруппахФАНУ(ГруппаФА, 15, 10, 10);
	
	// II группа
	ГруппаФА = НайтиСоздатьГуппуФАНУ(НСтр("ru = 'Машины и оборудование, за исключением машин и оборудования нефтегазодобычи'"),
							НСтр("ru = 'Машины и оборудование, за исключением машин и оборудования нефтегазодобычи, а также компьютеров и оборудования для обработки информации'"),
							"II", Перечисления.ВидыНалоговогоУчетаВГруппахФА.ПоГруппе);
	СоздатьЗаписьСведенийОГруппахФАНУ(ГруппаФА, 25, 25, 25);
	
	// III группа
	ГруппаФА = НайтиСоздатьГуппуФАНУ(НСтр("ru = 'Компьютеры, программное обеспечение и оборудование для обработки информации'"),
							НСтр("ru = 'Компьютеры, программное обеспечение и оборудование для обработки информации'"),
							"III", Перечисления.ВидыНалоговогоУчетаВГруппахФА.ПоГруппе);
	СоздатьЗаписьСведенийОГруппахФАНУ(ГруппаФА, 15, 40, 40);
	
	// IV группа
	ГруппаФА = НайтиСоздатьГуппуФАНУ(НСтр("ru = 'Фиксированные активы, не включенные в другие группы'"),
							НСтр("ru = 'Фиксированные активы, не включенные в другие группы, в том числе нефтяные, газовые скважины, передаточные устройства, машины и оборудование нефтегазодобычи'"),
...
Процедура ЗаполнениеСправочникаВидыПервичныхДокументовНачальнымиДанными()
	...
	НовыйЭлемент.Наименование = НСтр("ru = 'Расходная накладная'");
	НовыйЭлемент.Записать();
	
	НовыйЭлемент = Справочники.ВидыПервичныхДокументов.СоздатьЭлемент();
	НовыйЭлемент.Наименование = НСтр("ru = 'Товарный чек'");
	НовыйЭлемент.Записать();
...
Процедура ЗаполнитьСправочникНоменклатура()
	...
	Элемент = Справочники.НоменклатурныеГруппы.НайтиПоНаименованию(НСтр("ru = 'Основная номенклатурная группа'"), Истина);

	Если Элемент = Справочники.НоменклатурныеГруппы.ПустаяСсылка() Тогда

		Элемент = Справочники.НоменклатурныеГруппы.СоздатьЭлемент();
		Элемент.Наименование = НСтр("ru = 'Основная номенклатурная группа'");
		Элемент.Записать();
	...
	Запись = Набор.Добавить();
	// Группа "Товары"
	Группа = Справочники.Номенклатура.НайтиПоНаименованию(НСтр("ru = 'Товары'"));
	Если Группа = Справочники.Номенклатура.ПустаяСсылка() Тогда
		Группа = Справочники.Номенклатура.СоздатьГруппу();
		Группа.Наименование = НСтр("ru = 'Товары'");
		Группа.Записать();
	КонецЕсли;
	...
	Запись = Набор.Добавить();
	// Группа "Материалы"
	Группа = Справочники.Номенклатура.НайтиПоНаименованию(НСтр("ru = 'Материалы'"));
	Если Группа = Справочники.Номенклатура.ПустаяСсылка() Тогда
		Группа = Справочники.Номенклатура.СоздатьГруппу();
		Группа.Наименование = НСтр("ru = 'Материалы'");
		Группа.Записать();
	КонецЕсли;
	...
	Запись = Набор.Добавить();
	// Группа "Продукция"
	Группа = Справочники.Номенклатура.НайтиПоНаименованию(НСтр("ru = 'Готовая продукция'"));
	Если Группа = Справочники.Номенклатура.ПустаяСсылка() Тогда
		Группа = Справочники.Номенклатура.СоздатьГруппу();
		Группа.Наименование = НСтр("ru = 'Готовая продукция'");
		Группа.Записать();
	КонецЕсли;
	...
	Запись = Набор.Добавить();
	// Группа "Услуги"
	Группа = Справочники.Номенклатура.НайтиПоНаименованию(НСтр("ru = 'Услуги'"));
	Если Группа = Справочники.Номенклатура.ПустаяСсылка() Тогда
		Группа = Справочники.Номенклатура.СоздатьГруппу();
		Группа.Наименование = НСтр("ru = 'Услуги'");
		Группа.Записать();
	КонецЕсли;
...
Процедура УстановитьСвязьМеждуПользователемИПользователемИБ() Экспорт
	...
	Пока ВыборкаПользователи.Следующий() Цикл
		...
		ПользователиСлужебный.ВключитьЗаданиеКонтрольАктивностиПользователейПриНеобходимости(ПользовательОбъект.Ссылка);
...
Процедура ПеренестиФайлыИзХранилищаДополнительнойИнформации() Экспорт
	...
	Пока Выборка.Следующий() Цикл 
		...
		ПрисоединенныйФайл = РаботаСФайлами.ДобавитьФайл(
			...
			,
			НСтр("ru = 'Перенос файлов из справочника ""Хранилище дополнительной информации"" при переходе с редакции 2.0'")
		);
...
Процедура ПереименоватьРегламентированныйОтчетФорма1ТМесячная() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ТаблицаСсылок.Количество() = 0 Тогда
			...
			КонецПопытки;
		Иначе
			ТекстСообщения = НСтр("ru = 'Регламентированный отчет %1 ""%2"" - не может быть удален, т.к. имеются ссылки в информационной базе'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение	
			ТекстСообщения = НСтр("ru = 'при записи документа ""Регламентированный отчет"" %1 ""%2"" произошла ошибка: %3'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			                     	ТекстСообщения, Выборка.Ссылка.Номер, Выборка.Ссылка.НаименованиеОтчета, ОписаниеОшибки()),
									УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
...
Процедура ЗаполнитьРеквизитыПредопределенногоЭлементаКлиентБанк() Экспорт
	...
	Попытка
		...
		ОбъектКлиентБанк.Наименование = НСтр("ru = 'Обработка ""Клиент банка (импорт / экспорт платежных документов)""'");
	...
	Исключение
		...
		ТекстСообщения = НСтр(
		"ru = 'Не удалось обновить элемент ""Обработка ""Клиент банка"""" справочника ""Дополнительные отчеты и обработки"",
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Не удалось обновить ""Обработка ""Клиент банка"""".'"), 
...
Процедура ЗаполнитьРеквизитыПредопределенногоЭлементаВыгрузкаДанныхМТ102() Экспорт
	...
	Попытка
		...
		ОбъектВыгрузкаМТ102.Наименование = НСтр("ru = 'Обработка ""Выгрузка данных в формате МТ-102""'");
	...
	Исключение
		...
		ТекстСообщения = НСтр(
		"ru = 'Не удалось обновить элемент ""Обработка ""Выгрузка данных в формате МТ-102"""" справочника ""Дополнительные отчеты и обработки"",
		|так как при обновлении произошла ошибка:
		|%1'");
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Не удалось обновить ""Обработка ""Выгрузка данных в формате МТ-102"""".'"), 
...
Процедура ЗаполнитьРеквизитЗагружатьКурсИзИнтернетаСправочникаВалюты() Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр(
		"ru = 'Не удалось заполнить реквизит ""Загружать курс из Интернета"" в справочнике ""Валюты"",
		|так как при обновлении произошла ошибка:
		|%1'");
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Не удалось заполнить реквизит ""Загружать курс из Интернета"" в справочнике ""Валюты"".'"), 
...
Процедура ОбновитьРегламентированныеОтчеты(СписокИсключений = Неопределено) Экспорт
	...
	ТекстСообщения = НСтр("ru = 'Обновление регламентированных отчетов.'");
	...
	ТекстСообщения = НСтр("ru = 'Перенумерация элементов справочника ""Регламентированные отчеты""'");
	ЗаписьЖурналаРегистрации(ТекстСообщения,УровеньЖурналаРегистрации.Информация);
	ПеренумероватьСписокРегламентированныхОтчетов();
	
	// Замена внешних регламентированных отчетов на внутренние.
	ТекстСообщения = НСтр("ru = 'Замена внешних отчетов на внутренние в справочнике ""Регламентированные отчеты""'");
	ЗаписьЖурналаРегистрации(ТекстСообщения, УровеньЖурналаРегистрации.Информация);
...
Процедура ПеренумероватьСписокРегламентированныхОтчетов()
	...
	Пока Выборка.Следующий() Цикл
		Если Выборка.ЭтоГруппа = Истина ИЛИ Выборка.Родитель.Ссылка = Справочники.РегламентированныеОтчеты.ПустаяСсылка() Тогда
			...
			Исключение
				ТекстСообщения = НСтр("ru = 'ошибка при перенумерации %1  произошла ошибка: %2'");
				ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
	...
	Если НЕ Результат.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Исключение
				...
				НСтр("ru = 'Не удалось обновить ""Регистр сведений  ""Сведения о корректировке стоимости продукции и товаров"""".'"), 
				УровеньЖурналаРегистрации.Ошибка, , , Комментарий);					
...
Процедура ЗаполнитьЕдиницуИзмеренияНалоговойБазыПараметровРасчетаТранспортногоНалога() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ТекстСообщения = НСтр("ru = 'при записи параметров расчета транспортного для основного средства %1  произошла ошибка: %2'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура ЗаполнитьПериодВРегистреСчетаФактурыПрекратившиеДействие() Экспорт
	...
	Если НЕ Результат.Пустой() Тогда
		...
		ЗаголовокОшибки = НСтр("ru = 'Не удалось заполнить поле ""Период"" в регистре сведений  ""Сведения о корректировке стоимости продукции и товаров"".'"); 
...
Процедура ЗаполнитьНаименованиеСправочникНомераГТД() Экспорт
	...
	Пока ВыборкаЭлементов.Следующий() Цикл
		...
		Попытка
			СправочникОбъект.Записать();
		Исключение
			ТекстСообщения = НСтр("ru = 'при записи источника происхождения %1  произошла ошибка: %2'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура ОтключитьИспользованиеВнешнегоКлассификатораКодаТНВЭД() Экспорт
	...
	Пока ВыборкаДанных.Следующий() Цикл
		...
		Попытка
			МенеджерЗаписи.Записать();
		Исключение
			ТекстСообщения = НСтр("ru = 'при записи макета классификатора кода ТНВЭД регистра сведений ""Пользовательские макеты печатных форм "" произошла ошибка: %1'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20170401() Экспорт
	...
	Исключение
		ТекстСообщения = НСтр("ru='Операция не выполнена'");
		Комментарий = НСтр("ru = 'При записи данных в регистр ""Ставки рефинансирования НБ"" произошла ошибка:
		|%1'");
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20170606() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20170606';
 	СтавкаНБ.Размер = 10.5;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20170822() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20170822';
 	СтавкаНБ.Размер = 10.25;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20180116() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20180116';
 	СтавкаНБ.Размер = 9.75;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20180605() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20180417';
 	СтавкаНБ.Размер = 9.25;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20220224() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20220224';
 	СтавкаНБ.Размер = 13.5;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20220726() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20220726';
 	СтавкаНБ.Размер = 14.5;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20221206() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20221206';
 	СтавкаНБ.Размер = 16.75;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20230828() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20230828';
 	СтавкаНБ.Размер = 16.5;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20231127() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20231127';
 	СтавкаНБ.Размер = 15.75;
...
Процедура ДобавитьСведенияОСтавкеРефинансированияНБ20240122() Экспорт
	...
	СтавкаНБ = РегистрыСведений.СтавкаРефинансированияНБ.СоздатьМенеджерЗаписи();
 	...
 	СтавкаНБ.Период = '20240122';
 	СтавкаНБ.Размер = 15.25;
...
Процедура ЗаполнитьНаименованиеПолноеВГруппахФАНУ()	Экспорт
	...
	// I группа
	НайтиЗаполнитьГруппуФАНУ("I", НСтр("ru = 'Здания, сооружения, за исключением нефтяных, газовых скважин и передаточных устройств'"));						
	
	// II группа
	НайтиЗаполнитьГруппуФАНУ("II", НСтр("ru = 'Машины и оборудование, за исключением машин и оборудования нефтегазодобычи, а также компьютеров и оборудования для обработки информации'"));
	
	// III группа
	НайтиЗаполнитьГруппуФАНУ("III",Нстр("ru = 'Компьютеры, программное обеспечение и оборудование для обработки информации'"));
							
	// IV группа
	НайтиЗаполнитьГруппуФАНУ("IV", НСтр("ru = 'Фиксированные активы, не включенные в другие группы, в том числе нефтяные, газовые скважины, передаточные устройства, машины и оборудование нефтегазодобычи'"));
...
Процедура НайтиЗаполнитьГруппуФАНУ(Код, НаименованиеПолное)
	...
	Если НЕ Ссылка.Пустая() Тогда
		...
		Попытка
			СправочникОбъект.Записать();
		Исключение
			ТекстСообщения = НСтр("ru='При заполнении полного наименования в  %1  произошла ошибка: %2'");
	...
	Попытка
		...
		Для Каждого Выборка Из ТаблицаКатегорийСвойств Цикл
			...
			Если МассивТипов.Количество() = 0 Тогда
				Комментарий = НСтр("ru = 'Для %1 ""%2"" не удалось сопоставить тип значения.'");
				Комментарий = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					Комментарий, ?(Выборка.ЭтоСвойство, НСтр("ru = 'свойства'"), НСтр("ru = 'категории'")), Выборка.Наименование);
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Обновление информационной базы. Перенос Категорий и Свойств'"), УровеньЖурналаРегистрации.Предупреждение, , , Комментарий);				
				Продолжить;
			КонецЕсли;
...
Процедура ПереносПризводственногоРеглКалендаряВКалендарныеГрафики() Экспорт
	...
	Для Каждого СтрокаКалендаря Из ТаблицаДанных Цикл
		...
		Если ВидДня = Неопределено Тогда
			...
			Комментарий = НСтр("ru = 'Вид дня %1 не найден в перечислении ""Виды дней производственного календаря"". 
			|Вид дня установлен в значение ""Рабочий""'");
			
			Комментарий = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Комментарий, СтрокаКалендаря.ВидДня);
			
			ЗаписьЖурналаРегистрации(Комментарий, УровеньЖурналаРегистрации.Предупреждение, , , Комментарий);				
			ОбщегоНазначения.СообщитьПользователю(Комментарий);		
		КонецЕсли;
	...
	Исключение
		...
		Комментарий = НСтр("ru = 'При записи набора данных регистра ""Данные производственных календарей"" произошла ошибка:
		|%1'");
...
Процедура ЗаполнитьРеквизитыНалогНаДобавленнуюСтоимостьЗаНерезидента() Экспорт
	...
	Исключение
		ТекстСообщения = НСтр("ru='при записи элемента справчоника %1  произошла ошибка: %2'");
...
Процедура УстановитьНовыеКодыНеПредопределеннымЭлементамПВХ(ИмяПВХ)
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			Объект.Записать();
		Исключение
			ТекстСообщения = НСтр("ru='при записи элемента плана видов характеристик %1  произошла ошибка: %2'");
...
Процедура СкорректироватьДвиженияРазовыеУдержания() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ТекстСообщения = НСтр("ru='При записи движений документа %1  произошла ошибка: %2'");
...
Процедура ОбновитьНастройкиОтчетовОСМС()
	...
	Для Каждого СтрокаНастройки Из НастройкиОтчетов Цикл
		...
		Исключение
			Сообщить("Хранилище не очищено " + ОписаниеОшибки()); 
		КонецПопытки;
	КонецЦикла;
	УстановитьПривилегированныйРежим(Ложь);
		...
		Если Счетчик >= КоличествоДокументовВОднойИтерации Тогда
			Если ТранзакцияАктивна() Тогда
				...
				Исключение
					...
					ЗаписьЖурналаРегистрации(
						НСтр("ru = 'Обновление информационной базы. Замена ссылок на счета'"),
			...
			Если НЕ ОбъектИзмененияВИзмерении Тогда 
				...
				Если НаборЗаписей.Выбран() Тогда
					...
					Попытка
						...
						ЗаписьЖурналаРегистрации(
							НСтр("ru = 'Обновление информационной базы. Замена ссылок на счета. Регистры сведений'"),
				...
				Для Каждого СсылкаНаСчет Из Ссылка.Ссылка Цикл
					...
					Если ИмяКоллекцииРегистров = "РегистрБухгалтерии" И УдаляемыеЗаписи.Количество() > 0 Тогда
						Для Каждого УдаляемаяЗапись из УдаляемыеЗаписи Цикл
							...
							ЗаписьЖурналаРегистрации(
								НСтр("ru = 'Обновление информационной базы. Замена ссылок на счета. " + ИмяКоллекцииОбъектовМД + "'"),
								УровеньЖурналаРегистрации.Информация,,, Комментарий);				
							ОбщегоНазначения.СообщитьПользователю(Комментарий);
						КонецЦикла;
					КонецЕсли;
		...
		Для Каждого АвансовыйОтчет Из ТаблицаАвансовыеОтчетыДляИзмененияПроводок Цикл
			...
			Если НаборБУИзменен Тогда
				...
				Попытка
					...
					ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Обновление информационной базы. Замена ссылок на счета. Документы'"),
					УровеньЖурналаРегистрации.Информация,,, Комментарий);				
					ОбщегоНазначения.СообщитьПользователю(Комментарий);
				Исключение
...
Функция ПолучитьТаблицуЗаменыПроводок(МассивОбъектов)
	...
	Запрос.УстановитьПараметр("Содержание", НСтр("ru = 'Отложенное принятие НДС к зачету'"));
...
Процедура УстановитьКонстантыОграниченийДоступНаУровнеЗаписей() Экспорт 
	Если Константы.УдалитьИспользоватьОграниченияПравДоступаНаУровнеЗаписей.Получить() Тогда
		...
		Константы.ОграничиватьДоступНаУровнеЗаписейФизическиеЛица.Установить(ПараметрыСеанса.УдалитьИспользоватьОграничениеПоФизическиеЛица);
	КонецЕсли;	
КонецПроцедуры
...
Процедура ЗаполнениеРегистраСведенийЗначениеГруппДоступаПоУмолчанию() Экспорт 
	Если Не ПолучитьФункциональнуюОпцию("ОграничиватьДоступНаУровнеЗаписей") Тогда
		...
		Для Каждого СтрокаНабораЗаписей Из НаборЗаписей Цикл
			Если СтрокаНабораЗаписей.ГруппаДоступа <> Справочники.ГруппыДоступа.Администраторы Тогда
...
Процедура ОтключитьИспользованиеВнешнегоКлассификатораКодыСтрокНалоговыхДеклараций() Экспорт
	...
	Пока ВыборкаДанных.Следующий() Цикл
		...
		Попытка
			МенеджерЗаписи.Записать();
		Исключение
			ТекстСообщения = НСтр("ru = 'при записи макета Классификатор кодов строк Декларации регистра сведений ""Пользовательские макеты печатных форм "" произошла ошибка: %1'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			ТекстСообщения, ОписаниеОшибки()),
			УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));						
		КонецПопытки;	
...
Процедура ЗаменитьВнешнююОбработкуОбменСНТНаВстроенную() Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр(
		"ru = 'Не удалось обновить значение константы ""Использовать внешний модуль обмена СНТ"",
		|так как при обновлении произошла ошибка:
		|%1'");
...
Процедура КорректировкаСтавокБезНДСнеРК() Экспорт
	...
	Пока ВыборкаСтавки.Следующий() Цикл
		...
		Попытка
			...
			Комментарий = НСтр("ru = 'Для ставки НДС ""%1"" снят признак ""Для освобожденного оборота""'");
			Комментарий = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Комментарий, ВыборкаСтавки.Ссылка);
			
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Обновление информационной базы. Обработка элементов справочника ""Ставки НДС""'"),
				УровеньЖурналаРегистрации.Информация,,, Комментарий);				
				
		Исключение
			
			ТекстСообщения = НСтр("ru = 'При записи ставки НДС ""%1"" произошла ошибка: %2'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
...
Процедура РегламентированныйОтчет300ФормаИзмененитьИмяСохраненногоОтчета() Экспорт 
	...
	Пока ВыборкаЗапроса.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Обновление информационной базы'"), УровеньЖурналаРегистрации.Ошибка,,, Сообщение);
		КонецПопытки;
	...
	Если НЕ Результат.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Не удалось обновить ""Регистр сведений  ""Учетная политика (налоговый учет)"""".'"),
				УровеньЖурналаРегистрации.Ошибка, , , Комментарий);
...
Процедура ЗаменитьНаименованиеДокументовУдостоверяющихЛичность() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			СправочникОбъект.Записать();
		Исключение
			ТекстСообщения = НСтр("ru = 'при записи документа удостоверяющего личность %1  произошла ошибка: %2'");
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			ТекстСообщения, Выборка.Ссылка, ОписаниеОшибки()),
			УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));			
		КонецПопытки;
...
Процедура ЗаполнитьРегистрСведенияОФизическихЛицахУчастникахВОВ() Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр(
			"ru = 'при записи набора данных ""Сведения о физ. лицах участниках ВОВ и приравненных к ним"" произошла ошибка: 
			|%1");
			...
			ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Не удалось обновить ""Регистр сведений  ""Сведения о физ. лицах участниках ВОВ и приравненных к ним"""".'"), 
			УровеньЖурналаРегистрации.Ошибка, , , Комментарий);					
...
Процедура ЗаполнениеДокументаПартииВИсточникахПроисхожденияФОтложенно(Параметры) Экспорт
	...
	Пока ВыборкаПустыеДокументыПартии.Следующий() Цикл 
		Если  ВыборкаПустыеДокументыПартии.НетПрихода Тогда
			ТекстСообщения = НСтр("ru='Не изменена запись движения документа %1 в регистр ""Товары на виртуальных складах"": нет партиеобразующего документа'");
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстСообщения, ВыборкаПустыеДокументыПартии.Регистратор, ОписаниеОшибки());
		...
		Исключение
			ТекстСообщения = НСтр("ru='При записи документа партии %1 в регистр ""Товары на виртуальных складах"" произошла ошибка: %2'");
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстСообщения, ВыборкаПустыеДокументыПартии.Регистратор, ОписаниеОшибки());
			ЗаписьЖурналаРегистрации(ТекстСообщения, УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	...
	Иначе
		...
		Если ЗаписейОбработано = 0 И ПроблемныхЗаписей <> 0 Тогда
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Процедуре заполнения документов партий в записях регистра ""Товары на виртуальных складах"" (отложенно)
					|не удалось заполнить документ партии:  у %1 записей.'"), 
					ПроблемныхЗаписей);
			ВызватьИсключение ТекстСообщения;
		Иначе
			ТекстСообщения = СтрШаблон(
					НСтр("ru = 'Процедура  заполнения документов партий в записях регистра ""Товары на виртуальных складах"" (отложенно)
						|обработала очередную порцию записей: %1 записей'"), 
						ЗаписейОбработано);
			ЗаписьЖурналаРегистрации(
				ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), 
				УровеньЖурналаРегистрации.Информация,
	...
	Пока Выборка.Следующий() Цикл 
		...
		Если СтруктураСклонения <> Неопределено и ТипЗнч(СтруктураСклонения) = Тип("Структура") Тогда
			...
			Исключение
				...
				ТекстСообщения = НСтр("ru='При записи склонений физического лица %1  произошла ошибка: %2'");
		...
		Иначе
			ТекстСообщения = СтрШаблон(
					НСтр("ru = 'Процедура записи склонения физ.лиц (отложенно)
						|обработала очередную порцию элементов справочника ""Физические лица"": %1 элементов'"), 
						ОбъектовОбработано);
			ЗаписьЖурналаРегистрации(
				ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), 
				УровеньЖурналаРегистрации.Информация,
...
Процедура ЗаполнитьНастройкиВидовНалоговВНалоговомУчете() Экспорт
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось заполнить РС ""Настройки видов налогов в налоговом учете"" по причине: %1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Предупреждение,
		...
		Для Каждого СтрокаНастроекОтчетов Из НастройкиОтчетов Цикл
			Попытка
				...
				ХранилищеПользовательскихНастроекОтчетов.Сохранить(
					...
					СтрокаНастроекОтчетов.Пользователь);
			Исключение
				ТекстСообщения = СтрШаблон(НСтр("ru='Настройки отчета %1 не обновлены!'"), ИмяОтчета);
				ЗаписьЖурналаРегистрации(ТекстСообщения, УровеньЖурналаРегистрации.Ошибка, , , ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			КонецПопытки;
		КонецЦикла;
		УстановитьПривилегированныйРежим(Ложь);
