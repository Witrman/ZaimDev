...
Функция ЭтоДокументСсылкаСчетФактураПолученный(ТипДокумента) Экспорт
	...
	Если ТипДокумента = Тип("ДокументСсылка.СчетФактураПолученный") Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;	
...
// см. ЭСФКлиентСервер.ДоступенНовыйМетодАутентификации
//
...
Функция ВидЭСФ(Знач СсылкаСчетФактураПолученный) Экспорт
	...
	ВидСчетаФактуры = СсылкаСчетФактураПолученный.ВидСчетаФактуры;
	
	Если ВидСчетаФактуры = ПредопределенноеЗначение("Перечисление.ВидыСчетовФактур.Обычный") Тогда	
		
		ВидЭСФ = ПредопределенноеЗначение("Перечисление.ВидыЭСФ.Обычный");
		
	ИначеЕсли ВидСчетаФактуры = ПредопределенноеЗначение("Перечисление.ВидыСчетовФактур.Дополнительный") Тогда 
		
		ВидЭСФ = ПредопределенноеЗначение("Перечисление.ВидыЭСФ.Дополнительный");
		
	ИначеЕсли ВидСчетаФактуры = ПредопределенноеЗначение("Перечисление.ВидыСчетовФактур.Исправленный") Тогда
		
		ВидЭСФ = ПредопределенноеЗначение("Перечисление.ВидыЭСФ.Исправленный");
		
	Иначе
		
		ВидЭСФ = ПредопределенноеЗначение("Перечисление.ВидыЭСФ.ПустаяСсылка");
...
Функция НомерДатаСФ(Знач СсылкаСчетФактураПолученный) Экспорт
	...
	НомерДатаСФ.Вставить("НомерСФ"		, СсылкаСчетФактураПолученный.НомерВходящегоДокумента);
	НомерДатаСФ.Вставить("ДатаСФ"		, СсылкаСчетФактураПолученный.ДатаВходящегоДокумента) ;
...
Функция ПолучитьПредопределенноеЗначениеСтраны() Экспорт
	...
	Возврат ПредопределенноеЗначение("Справочник.КлассификаторСтранМира.Казахстан");
	
КонецФункции

#КонецОбласти 

// См. ЭСФКлиентСервер.КонтейнерМетодов().
