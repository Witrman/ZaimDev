...
Функция ПроверитьНаличиеОбновлений(ПараметрыСервераИнтернета, СвойстваМодуляДляТекущегоРелиза, ШапкаОшибки) Экспорт
	//логика по подписке
	//2 - отправить запрос
	ДанныеАктуальнойВерсии = ЭлектронноеВзаимодействиеССервисамиВызовСервера.ПолучитьТекущуюВерсиюКриптобиблиотеки("1C-ESF",ПараметрыСервераИнтернета.ДополнительныеПараметры.Организация,"", Истина);
	//3 - разобрать ответ
