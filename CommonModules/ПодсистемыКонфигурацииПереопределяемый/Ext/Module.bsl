...
Процедура ПриДобавленииПодсистем(МодулиПодсистем) Экспорт
	...
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыБК");
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыБЭД");
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыЭСФВС");
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыWebKassa");
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыЭАВР");
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыСНТ");
