...
Процедура РазобратьВыпискуБанка(СообщениеОбмена) Экспорт
	...
	ДанныеВыписки = ИнтеграцияПодсистемБКВызовСервера.ПолучитьДанныеВыпискиБанкаТекстовыйФормат(СообщениеОбмена);
	...
	ПараметрыОткрытия.Вставить("РежимПоУмолчанию",                "ГруппаИмпорт");
	...
	ОткрытьФорму("Обработка.КлиентБанкСПоддержкойЭД.Форма", ПараметрыОткрытия);
