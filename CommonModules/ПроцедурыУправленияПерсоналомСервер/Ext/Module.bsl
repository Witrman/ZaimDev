...
Функция РегламентированныйКалендарьЗаполнен(ДатаНач, ДатаКон, ТекстСообщения = "") Экспорт 
	...
	Если НЕ КалендарьЗаполнен Тогда
		ТекстСообщения = НСтр("ru = 'Перед выполнением операции заполните ""Регламентированный производственный календарь"" за '");
		ТекстСообщения = ТекстСообщения + Сообщение + ?(Найти(Сообщение,",")=0," год!"," годы!");
