...
Процедура ПередВыводомСвязанногоОбъекта(Объект, СвойстваОбъекта, Отказ) Экспорт 
	...
	Отказ = ТипЗнч(Объект) = Тип("СправочникСсылка.Номенклатура");
...
Функция ИмяРеквизитаДокумента(ИмяДокумента, Реквизит) Экспорт
	...
	Если Реквизит = "Валюта" И Метаданные.Документы[ИмяДокумента].Реквизиты.Найти(Реквизит) = Неопределено Тогда 
