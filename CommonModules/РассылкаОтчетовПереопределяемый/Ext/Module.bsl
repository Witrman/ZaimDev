...
Процедура ОпределитьИсключаемыеОтчеты(ИсключаемыеОтчеты) Экспорт
	...
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.РегистрНалоговогоУчетаПоИПНиСН);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.РегистрНалоговогоУчетаПоПрименениюИнвестиционныхПреференций);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.РегистрНалоговогоУчетаПоСчетамФактурам);
	ИсключаемыеОтчеты.Добавить(Метаданные.Отчеты.РегистрНалоговогоУчетаПоФА);
