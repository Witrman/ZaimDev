	...
	Если НоваяСтрока Тогда
		Если Элемент.ТекущиеДанные <> Неопределено Тогда
			...
			Если НаборЗаписей.Количество() > 1 Тогда
				ПоследнийПериод = Макс(НаборЗаписей.Получить(НаборЗаписей.Количество() - 2).Период, ДатаЗапрета);
			Иначе
...
Процедура КомандаОК(Команда)
	...
	РедактированиеПериодическихСведенийКлиент.ОповеститьОЗавершении(ЭтаФорма, "СведенияОПенсионномОбеспеченииФизЛиц", ОбъектВладелец);
