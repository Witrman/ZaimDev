...
Процедура ЗаполнитьПоДокументуОснованию(Объект, ДокументОснование) Экспорт
	...
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ОПВВозвратВзносов")
			  ...
			  ИЛИ  ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ВозвратЗарплатыРаботниковОрганизаций") Тогда
	...
	ИначеЕсли ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.ПлатежноеПоручениеИсходящее") Тогда
		...
		Если Результат.Пустой() Тогда
			ТекстСообщения  = НСтр("ru = 'Нет организации, соответсвтующей контрагенту документа-основания'");
		...
		Иначе          			        			
			...
			ТекстСообщения  = НСтр("ru = 'Нет контрагента, соответсвтующего организации документа-основания, контрагент не будет заполнен'");
			ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);					                                             			
		КонецЕсли;
...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.УстановитьПараметр("СодержаниеПокупкаВалюты", НСтр("ru = 'Приобретение иностранной валюты'"));
	Запрос.УстановитьПараметр("СодержаниеПродажаВалюты", НСтр("ru = 'Продажа иностранной валюты'"));
	Запрос.УстановитьПараметр("СодержаниеПрочее"       , НСтр("ru = 'Прочее поступление денежных средств'"));
	...
	Если Реквизиты.ЕстьВозвратПенсионныхВзносов
		...
		ИЛИ Реквизиты.ЕстьВозвратЕдиногоПлатежа Тогда
