...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ИмяТаблицы") Тогда
		ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры, "ИмяТаблицы");
	КонецЕсли;
	Если Параметры.Свойство("СпособЗаполнения") Тогда
		ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры, "СпособЗаполнения");
	КонецЕсли;
