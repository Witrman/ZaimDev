...
Функция ТекстЗапросаВременныеТаблицыДокумента(НомераТаблиц)
	...
	|	ТаблицаОС.ПереоцененнаяСтоимостьБУ - (ТаблицаОС.СтоимостьБУ - ТаблицаОС.АмортизацияБУ - ТаблицаОС.АмортизацияЗаМесяцБУ) КАК СуммаПереоценки,
	|	ВЫБОР
	...
	|	вт_ТаблицаОС.СтоимостьБУ,
	|	вт_ТаблицаОС.АмортизацияБУ,
	|	вт_ТаблицаОС.АмортизацияЗаМесяцБУ,
	|	вт_ТаблицаОС.ПереоцененнаяСтоимостьБУ,
	|	вт_ТаблицаОС.ЛиквидационнаяСтоимостьБУ,
	|	вт_ТаблицаОС.СписываемаяСуммаРезерваЗаМесяцБУ,
	|	вт_ТаблицаОС.СуммаПереоценки,
	|	вт_ТаблицаОС.СуммаПереоценкиСтоимости,
	|	вт_ТаблицаОС.СуммаПереоценкиАмортизации,
