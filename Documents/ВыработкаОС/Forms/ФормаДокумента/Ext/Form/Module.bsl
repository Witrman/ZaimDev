...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Оповестить("Запись_ВыработкаОС", ПараметрыЗаписи, Объект.Ссылка);
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = ПредопределенноеЗначение("РежимЗаписиДокумента.Проведение") Тогда
		КлючеваяОперация = "Документ ""выработка ос"" (проведение)";
...
&НаКлиенте
Процедура ЗаполнитьПоОС(Команда)
	
	КомандаЗаполнитьПоОСНаСервере();
...
&НаСервере
Процедура КомандаЗаполнитьПоОСНаСервере()
	
	Документы.ВыработкаОС.ЗаполнитьТабличнуюПоОС(Объект, ПоддержкаРаботыСоСтруктурнымиПодразделениями);
...
Функция ПолучитьПараметрыОбработкиТабличнойЧасти(ИмяТабличнойЧасти, СинонимТабличнойЧасти)
	...
	СтруктураРеквизитов.Вставить("ПараметрВыработки");
