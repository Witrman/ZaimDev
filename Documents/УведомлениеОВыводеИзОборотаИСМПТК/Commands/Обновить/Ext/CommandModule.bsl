...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ТипЗнч(Источник) = Тип("ФормаКлиентскогоПриложения") Тогда
		...
		Если Источник.ИмяФормы = "Документ.УведомлениеОВыводеИзОборотаИСМПТК.Форма.ФормаДокумента" Тогда
		...
		//БМ_ИСМПТ ТРЕБУЕТСЯ_РАССМОТРЕНИЕ	Фоновая отправка данных УОР в ИС МПТ
		Иначе
