...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ТипЗнч(Источник) = ЭСФКлиентПереопределяемый.ПолучитьТипФормаКлиентскогоПриложения() Тогда
		...
		Если Источник.ИмяФормы = "Документ.ЭСФ.Форма.ФормаДокумента" Тогда
			...
			ЭСФКлиент.ОбновитьДокументыЭСФПоНомеруИДате(ПараметрКоманды, Новый Структура("ЗапускатьФоновоеЗадание", Ложь));
		...
		Иначе
			...
			ЭСФКлиент.ОбновитьДокументыЭСФПоНомеруИДате(ПараметрКоманды, ДополнительныеПараметры);
