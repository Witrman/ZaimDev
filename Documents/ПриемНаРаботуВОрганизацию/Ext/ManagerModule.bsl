...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПриемНаРаботу_ПриказНаСотрудника") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьПриказНаРаботника(МассивОбъектов, ОбъектыПечати),
			,
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПриемНаРаботу_ПриказНаСписокСотрудников") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьПриказНаРаботников(МассивОбъектов, ОбъектыПечати),
			,
...
//
Функция ПечатьПриказНаРаботника(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ПриемНаРаботуВОрганизацию.ПФ_MXL_ПриказНаРаботника");
...
//
Функция ПечатьПриказНаРаботников(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	// запоминаем области макета
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ПриемНаРаботуВОрганизацию.ПФ_MXL_ПриказНаРаботников");
