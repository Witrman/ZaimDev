...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.УстановитьПараметр("СодержаниеНМА",             НСтр("ru = 'Списана амортизация'"));	
...
Функция ПечатьДА1(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока ШапкаДокумента.Следующий() Цикл
		...
		СтрокаТаблицы1.Параметры.ДатаВыпуска 		     = Формат(ДанныеНМА.ДатаПриобретения, "ДЛФ=Д");
		...
		//Приказ.Параметры.ДокументОснованиеВид 	= НСтр("ru = 'приказа (распоряжения)'");
		//Приказ.Параметры.ДокументОснованиеДата 	= """_____"""+"________________________ 20_____"+НСтр("ru = 'года'");
		...
		ТекстОбъектОсновныхСредств = НСтр("ru = 'Долгосрочный актив'");
