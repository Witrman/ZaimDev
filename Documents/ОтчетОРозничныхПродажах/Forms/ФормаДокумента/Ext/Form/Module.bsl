...
Процедура СформироватьНадписьЦеныИВалюта(Форма)
	...
	Если Форма.ИспользоватьТипыЦен Тогда
		СтрокаЦеныИВалюта = СтрокаЦеныИВалюта + НСтр("ru = 'Тип цен: '");
		Если ЗначениеЗаполнено(Форма.Объект.ТипЦен) Тогда
			СтрокаЦеныИВалюта = СтрокаЦеныИВалюта + Форма.Объект.ТипЦен;
		Иначе
			СтрокаЦеныИВалюта = СтрокаЦеныИВалюта + НСтр("ru = '<не указан>'");
		КонецЕсли;
	КонецЕсли;
	...
	Если Объект.УчитыватьНДС Тогда
		...
		СтрокаЦеныИВалюта = СтрокаЦеныИВалюта + ?(ЗначениеЗаполнено(СтрокаЦеныИВалюта), НСтр("ru = ', НДС (в т.ч.)'"), НСтр("ru = 'НДС (в т.ч.)'"));
	Иначе
		СтрокаЦеныИВалюта = СтрокаЦеныИВалюта + ?(ЗначениеЗаполнено(СтрокаЦеныИВалюта), НСтр("ru = ', Не учитывать НДС'"), НСтр("ru = 'Не учитывать НДС'")); 
	КонецЕсли;
	
	Если Объект.УчитыватьАкциз Тогда
		Форма.Элементы.ГруппаИтогиАкциз.ПодчиненныеЭлементы.ИтогоВсегоАкциз.Заголовок = "Акциз (в т.ч.)";		
		СтрокаЦеныИВалюта = СтрокаЦеныИВалюта + ?(ЗначениеЗаполнено(СтрокаЦеныИВалюта), НСтр("ru = ', Акциз (в т.ч.)'"), НСтр("ru = 'Акциз (в т.ч.)'"));
	КонецЕсли;
