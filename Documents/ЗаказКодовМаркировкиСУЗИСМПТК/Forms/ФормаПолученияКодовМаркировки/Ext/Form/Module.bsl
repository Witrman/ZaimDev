...
Процедура УправлениеЭлементамиФормы()
	...
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ПолучитьКодыМаркировки", 		  "Доступность", ?(ЭтаФорма.РазмерБлокаКодов = 0, Ложь, Истина));
	
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТаблицаКодовЗаказаНоменклатура",   "Видимость", ОтображатьДанныеПоНоменклатуре);
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТаблицаКодовЗаказаХарактеристика", "Видимость", ОтображатьДанныеПоНоменклатуре);
