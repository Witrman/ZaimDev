...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	КлючеваяОперация = "Документ ""социальное страхование возврат из фондов"" (запись)";
...
Процедура СоциальныеОтчисленияФизЛицоНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если (ТипЗнч(ТекущаяСтрока.ФизЛицо) = Тип("Неопределено")
		...
		И Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСОВозвратОтчислений.ВозвратВзносовОСМС") Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПодготовитьФормуНаСервере()
	...
	Если Объект.ВидОперации <> Перечисления.ВидыОперацийСОВозвратОтчислений.ВозвратВзносовОСМС Тогда
...
Процедура ЗаполнитьПоДокументуОснованиюНаСервере()
	...
	Если ТипЗнч(Объект.ДокументОснование) = Тип("ДокументСсылка.СОПеречислениеВФонды") Тогда
		
		Документы.СОВозвратОтчислений.ЗаполнитьПоСОПеречислениеВФонды(Объект, Объект.ДокументОснование);
...
Процедура УстановитьПараметрыВыбораДокументаОснования(Элемент, ВидОперации)
	...
	МассивПараметровВыбора.Добавить(Новый ПараметрВыбора("Отбор.ВидОперации", Документы.СОВозвратОтчислений.ДоступныеДокументыОснования(ВидОперации)));
