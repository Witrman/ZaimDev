...
Функция ПечатьДА3(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока Док.Следующий() Цикл
		...
		ОбластьМакета.Параметры.ДокументОснованиеДата  = НСтр("ru = '""____""________________20__года' ");
		ОбластьМакета.Параметры.ДокументОснованиеВид   = НСтр("ru = 'приказом (распоряжением)___________________________' ");
		ОбластьМакета.Параметры.ДокументОснованиеНомер = Формат("_______");
		ТабДокумент.Вывести(ОбластьМакета);
		
		ОбластьМакета							= Макет.ПолучитьОбласть("СписокОсмотренных");
		ОбластьМакета.Параметры.ПроизвелаОсмотр = НСтр("ru = 'на основании ________________ произвела осмотр' ");
