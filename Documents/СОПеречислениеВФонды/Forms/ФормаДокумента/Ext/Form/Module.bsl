...
Процедура ПодготовитьСправкуФормы(Форма) 
	...
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСОПеречислениеВФонды.ПеречислениеВзносовОСМС") Тогда 
		ВидВзносаОтчисления = "Взносов ОСМС";
		ТекстПорядокЗаполнения = "<B>Порядок заполнения</B> <A id=АктивизироватьЭУ href=""V8:ПорядокЗаполнения""><P id=ПорядокЗаполнения style=""DISPLAY:inline"">" 
								+ ?(Объект.ПорядокЗаполнения = 0, "по сотрудникам", "по прочим лицам") + "</P></A>.";
	Иначе
		ВидВзносаОтчисления = "Отчислений ОСМС";
	КонецЕсли;
	...
	Если Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюСО.ПоЗадолженностиЗаМесяц") Тогда
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по задолженности " + ВидВзносаОтчисления + " за <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияСО + "</P></A>).";
	...
	ИначеЕсли Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюСО.ПоОстаткамЗадолженностиНаКонецМесяца") Тогда		
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по остаткам задолженности " + ВидВзносаОтчисления + " по <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияСО + "</P></A>&nbsp;(включительно)).";		
	...
	ИначеЕсли Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюСО.ПоЗадолженностиЗаМесяцПоНУ") Тогда		
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по задолженности " + ВидВзносаОтчисления + " за <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияСО + "</P></A>&nbsp;, удержанной по удельному весу).";
	...
	ИначеЕсли Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюСО.ПоОстаткамЗадолженностиНаКонецМесяцаПоНУ") Тогда		
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по остаткам задолженности " + ВидВзносаОтчисления + " по <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияСО + "</P></A>&nbsp;(включительно), удержанной по удельному весу).";
	...
	Иначе
		ВидПлатежаТекст = "(прочие суммы " + ВидВзносаОтчисления + ").";
	КонецЕсли;
...
Процедура УстановитьВидимостьПорядкаЗаполнения(Форма)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Форма.Элементы, "ПорядокЗаполнения", "Видимость", Форма.Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСОПеречислениеВФонды.ПеречислениеВзносовОСМС"));
...
Процедура ВидОперацииПриИзмененииНаСервере()
	...
	Если Объект.ВидОперации <> Перечисления.ВидыОперацийСОПеречислениеВФонды.ПеречислениеВзносовОСМС И Объект.ПорядокЗаполнения > 0 Тогда
