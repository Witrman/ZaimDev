...
Процедура ЗаполнитьПоОстаткамНаСервере()
	...
	Если РезультатЗапроса.Пустой() Тогда
		...
		ТекстСообщения = "На счете """ + ПланыСчетов.Типовой.МатериалыПринятыеВПереработкуВПроизводстве.Код + "-"
		+ ПланыСчетов.Типовой.МатериалыПринятыеВПереработкуВПроизводстве.Наименование + """" + " нет остатков!";
...
Процедура ЗаполнитьПоОстаткамСчетаНаСервере()
	...
	Если РезультатЗапроса.Пустой() Тогда
		...
		ТекстСообщения = "На счете """ + ПланыСчетов.Типовой.ПроизводствоИзДавальческогоСырья.Код + "-"
		+ ПланыСчетов.Типовой.ПроизводствоИзДавальческогоСырья.Наименование + """" + " нет остатков!";
