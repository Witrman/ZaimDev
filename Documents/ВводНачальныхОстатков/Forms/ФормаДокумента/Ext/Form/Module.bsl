...
Процедура ИзменитьРасчетыСКонтрагентами(Команда)
	...
	ИзменитьТабличнуюЧасть("РасчетыСКонтрагентами", "Расчеты с контрагентами");
...
Процедура ИзменитьРасчетыПоНалогамИСборам(Команда)
	...
	ИзменитьТабличнуюЧасть("РасчетыПоНалогамИСборам", "Расчеты по налогам и сборам");
...
Процедура ИзменитьРасчетыСПодотчетнымиЛицами(Команда)
	...
	ИзменитьТабличнуюЧасть("РасчетыСПодотчетнымиЛицами", "Расчеты с подотчетными лицами");
...
Процедура ИзменитьЗапасы(Команда)
	...
	ИзменитьТабличнуюЧасть("Запасы", "Запасы");
...
Процедура ИзменитьТоварыОрганизаций(Команда)
	...
	ИзменитьТабличнуюЧасть("ТоварыОрганизаций", "Товары организаций");
