...
Процедура ИзменитьУслуги(Команда)
	...
	ИзменитьТабличнуюЧастьУслуги("Услуги", "Услуги");
...
Процедура ИзменитьПродукция(Команда)
	...
	ИзменитьТабличнуюЧастьПродукция("Продукция", "Продукция");
...
Процедура ИзменитьВозвратныеОтходы(Команда)
	...
	ИзменитьТабличнуюЧастьВозвратныеОтходы("ВозвратныеОтходы", "Возвратные отходы");
