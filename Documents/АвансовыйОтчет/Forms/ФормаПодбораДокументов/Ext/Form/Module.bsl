...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыводимыеДокументы.Добавить("ПоступлениеТоваровУслуг", "Поступление ТМЗ и услуг",   Истина);
	ВыводимыеДокументы.Добавить("ПоступлениеДопРасходов",  "Поступление доп. расходов", Истина);
	ВыводимыеДокументы.Добавить("ПоступлениеНМА",          "Поступление НМА",           Истина);
