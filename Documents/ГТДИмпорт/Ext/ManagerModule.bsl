...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.УстановитьПараметр("СодержаниеПошлинаСпец", НСтр("ru = 'Таможенная пошлина (спец.)'"));
	...
	Запрос.УстановитьПараметр("СодержаниеНДС",         НСтр("ru = 'НДС по импорту'"));
	Запрос.УстановитьПараметр("СодержаниеНДСВал",      НСтр("ru = 'НДС по импорту (в валюте)'"));
	Запрос.УстановитьПараметр("СодержаниеВыделенНДС",         НСтр("ru = 'НДС'"));
	Запрос.УстановитьПараметр("СодержаниеВыделенНДСВал",      НСтр("ru = 'НДС (в валюте)'"));
	Запрос.УстановитьПараметр("СодержаниеПринятНДСПоИмпорту", НСтр("ru = 'Принятие НДС в зачет, уплаченного по импорту'"));
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если НужноПечататьМакет Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьГТДИмпорт(МассивОбъектов, ОбъектыПечати),
			,
	...
	Если НужноПечататьМакет Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьГТДИмпортДопРасходы(МассивОбъектов, ОбъектыПечати),
			,
	...
	Если НужноПечататьМакет Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьГТДИмпортДопРасходыПоКонтрагентам(МассивОбъектов, ОбъектыПечати),
			,
...
Функция ПечатьГТДИмпорт(МассивОбъектов, ОбъектыПечати = Неопределено) Экспорт
	...
	Макет  = УправлениеПечатью.МакетПечатнойФормы("Документ.ГТДИмпорт.ПФ_MXL_ГТДИмпорт");
	...
	Пока ВыборкаОбщиеИтоги.Следующий() Цикл
		...
		ОбластьЗаголовка.Параметры.ТекстЗаголовка = РаботаСДиалогами.СформироватьЗаголовокДокумента(ВыборкаОбщиеИтоги.Ссылка, НСтр("ru = 'ГТД по импорту'"));
		...
		ОбластьШапки.Параметры.СтрокаНДС = ?(ВыборкаОбщиеИтоги.НДСВключенВСтоимость, НСтр("ru = 'НДС (включен в стоимость ТМЗ)'"),"НДС");
		...
		Пока ВыборкаРазделы.Следующий() Цикл
			...
			ПредставлениеРаздела = НСтр("ru = 'Раздел №" + СокрЛП(ВыборкаРазделы.НомерРаздела) + 
...
// разработанной методистами
Функция ПечатьГТДИмпортДопРасходы(МассивОбъектов, ОбъектыПечати = Неопределено) Экспорт
	...
	Макет  = УправлениеПечатью.МакетПечатнойФормы("Документ.ГТДИмпорт.ПФ_MXL_ГТДИмпорт_ДопРасходы");
...
// разработанной методистами
Функция ПечатьГТДИмпортДопРасходыПоКонтрагентам(МассивОбъектов, ОбъектыПечати = Неопределено) Экспорт
	...
	Макет  = УправлениеПечатью.МакетПечатнойФормы("Документ.ГТДИмпорт.ПФ_MXL_ГТДИмпорт_ДопРасходы_ПоКонтрагентам");
	...
	Пока ВыборкаДопРасходыИтоги.Следующий() Цикл
		...
		ОбластьЗаголовка = Макет.ПолучитьОбласть("Заголовок");	
		ОбластьЗаголовка.Параметры.ТекстЗаголовка = РаботаСДиалогами.СформироватьЗаголовокДокумента(ВыборкаДопРасходыИтоги.Ссылка, НСтр("ru = 'Дополнительные расходы к ГТД по импорту'"));
