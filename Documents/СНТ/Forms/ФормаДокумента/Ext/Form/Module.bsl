...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() И Объект.ТипСНТ <> Перечисления.ТипыСНТ.Исправленная Тогда
...
Процедура УправлениеФормой()
	...
	ЕстьПеремещениеИмпорт = СНТСервер.ПроверитьПеремещениеИмпорт(Объект);
	...
	ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Перемещение") ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами") Тогда
	...
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТоварыВСИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТоварыИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЭтиловыйСпиртИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВиноматериалИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ПивоПивныеНапиткиИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "АлкогольнаяПродукцияКромеПиваИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДанныеПоНефтепродуктамИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДанныеПоБиотопливуИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТабачнаяПродукцияИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДругиеТоварыЦифроваяМаркировкаИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТоварыЭкспортныйКонтрольИсточникПроисхожденияПолучатель", "Видимость", (?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК"))));
	...
	Если НЕ Объект.ПредоставленВБумажномВиде Тогда
	...
	Для Каждого СтрокаСоответствия Из СоответствиеНомеровТаблицИНазванийСНТ Цикл
		...
		ЭСФКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, СтрокаСоответствия.Значение + "ДополнительныйИдентификаторПолучатель" , "Видимость", ?(ЕстьПеремещениеИмпорт, Ложь, Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК")));
...
Процедура УстановитьВидимостьКнопокИзмененияСтатуса()
	...
	СответвствиеСтатусов = СНТСервер.РазрешенныеДействияПоСтатусамСНТ(Объект.Направление, Объект.ВидОперации, Объект, Объект.ВидПеремещения);
	...
	СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаАннулироватьПодтверждение"	, "Видимость", СответвствиеСтатусов[СНТКлиентСервер.ДействиеАннуллироватьПодтверждение()][Объект.Статус]);
...
Процедура ИзменитьКоманднуюПанельДокумента()
	...
	Если Объект.Направление = Перечисления.НаправленияСНТ.Входящий Тогда
		...
		Если НЕ Объект.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров Тогда
			СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьЭСФИСФ", "Видимость", Ложь);
		КонецЕсли;
		
	ИначеЕсли Объект.Направление = Перечисления.НаправленияСНТ.Исходящий Тогда
		
		Если (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Ввоз") И Объект.Статус = ПредопределенноеЗначение("Перечисление.СтатусыСНТ.Подтвержден")) ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами") Тогда
			СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаДокументСНТПолучитьИдентификаторыТоваров", "Видимость", Истина);
			Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами") Тогда
				СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьЭСФИСФ", "Видимость", Ложь);
			Иначе
				СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьЭСФИСФ", "Видимость", Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров"));
			КонецЕсли;
		Иначе
			СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаДокументСНТПолучитьИдентификаторыТоваров", "Видимость", Ложь);
		КонецЕсли;
		
		Если Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами") И Объект.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС") Тогда
			СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьЭСФИСФ", "Видимость", Истина);
		КонецЕсли;
		...
		СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаДокументОснованиеСоздать", "Видимость", Объект.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз);
	КонецЕсли;
	...
	Если Объект.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ Тогда
		СНТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСоздатьЭСФИСФ", "Видимость", Ложь);
	КонецЕсли;
...
Процедура ИсточникПроисхожденияТовараПриИзменении(СтрокаТабличнойЧасти)
	...
	Дата = Объект.ДатаОтгрузкиТовара;
	...
	Если Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") Тогда
		//Очищение поля "Идентификатор товара в ИС ЭСФ" в документах на возврат исходящий оставляем без перезаполнения,
		//то есть как изначально заполнился при создании на основании.
		//Это поле не должно меняться так как возврат оформляем именно составной идентификтор с ID на складе поставщика.
...
Процедура ИсточникПроисхожденияТовараНачалоВыбора(ТабличнаяЧасть, Товар, Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СкладДляОтбора = ПредопределенноеЗначение("Справочник.ВиртуальныеСклады.ПустаяСсылка");
	
	Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий")
		И Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") 
		И (Объект.ПоставщикРозничнаяРеализация ИЛИ Объект.ПоставщикНерезидент ИЛИ Объект.ПоставщикФизическоеЛицо ИЛИ Объект.ПоставщикМалаяТорговаяТочка) Тогда
		
		СкладДляОтбора = Объект.СкладПолучатель;
		
	Иначе 
		
		СкладДляОтбора = Объект.СкладОтправитель;
...
&НаКлиенте
Процедура ЗаполнитьФиксированнымЗначением(Команда)
	
	ТоварыЭкспортныйКонтрольПроверитьВыделенныеСтроки(Команда.Имя);
...
Процедура РассчитатьСуммуТабЧасти(СтрокаТабличнойЧасти, НаименованиеКоличества, ТабличнаяЧасть) 
	...
	Если СтрокаТабличнойЧасти <> Неопределено Тогда
		...
		ИначеЕсли ТабличнаяЧасть = "АлкогольнаяПродукцияКромеПива" И (СтрокаТабличнойЧасти.Крепость >= 0 И СтавкаАкциза >= 0) Тогда
			Если Лев(СтрокаТабличнойЧасти.КодТНВЭД, 4) = "2204" И Объект.ДатаОтгрузкиТовара >= Дата(2022,1,1) Тогда
				СтрокаТабличнойЧасти.СуммаАкциза = Окр(СтавкаАкциза * СтрокаТабличнойЧасти.Количество, 2); //Количество (в литрах)
			ИначеЕсли (Лев(СтрокаТабличнойЧасти.КодТНВЭД, 4) = "2204" ИЛИ Лев(СтрокаТабличнойЧасти.КодТНВЭД, 4) = "2205" ИЛИ Лев(СтрокаТабличнойЧасти.КодТНВЭД, 6) = "220600") И Объект.ДатаОтгрузкиТовара < Дата(2022,1,1) Тогда	
				СтрокаТабличнойЧасти.СуммаАкциза = Окр(СтавкаАкциза * СтрокаТабличнойЧасти.Количество, 2); //Количество (в литрах)
			Иначе
				Если СтрокаТабличнойЧасти.Крепость = 0 И СтавкаАкциза <> 0 Тогда
					ТекстСообщения = НСтр("ru = 'Для расчёта суммы акциза необходимо заполнить поле ""Крепость"".'");
...
Процедура РассчитатьЦенуТабЧасти(СтрокаТабличнойЧасти, НаименованиеКоличества) 
	...
	Если СтрокаТабличнойЧасти <> Неопределено Тогда
		...
		Если ЗначениеЗаполнено(СтрокаТабличнойЧасти[НаименованиеКоличества]) Тогда
			...
			СтрокаТабличнойЧасти.Цена = Окр(СтрокаТабличнойЧасти.СуммаБезНалогов /СтрокаТабличнойЧасти[НаименованиеКоличества], 2);
...
Процедура ПеревозчикПриИзмененииНаСервере()
	...
	Если Элементы.ФормаРедактироватьНедоступныеРеквизиты.Пометка Тогда
		...
		ЗаполнитьЗначенияСвойств(Объект, СтруктураДанных, "ПеревозчикИдентификатор, ПеревозчикНаименование, ПеревозчикНерезидент");
...
Процедура ПолучательПриИзмененииНаСервере()
	...
	Если Элементы.ФормаРедактироватьНедоступныеРеквизиты.Пометка Тогда
		...
		ЗаполнитьЗначенияСвойств(Объект, СтруктураДанных, "Получатель, ПолучательИдентификатор, ПолучательНаименование, ПолучательНерезидент, ПолучательБИНСтруктурногоПодразделения, ПолучательКодСтраны, ПолучательКодСтраныДоставки");
		...
		ИначеЕсли НЕ ЗначениеЗаполнено(Объект.ПолучательБИНСтруктурногоПодразделения) И НЕ ТипЗнч(Объект.Получатель) = ВСКлиентСерверПереопределяемый.ТипКонтрагент() Тогда
...
Процедура ПоставщикПриИзмененииНаСервере()
	...
	Если Элементы.ФормаРедактироватьНедоступныеРеквизиты.Пометка Тогда
		...
		Если Объект.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз Тогда
			ЗаполнитьЗначенияСвойств(Объект, СтруктураДанных, "ПоставщикИдентификатор, ПоставщикНаименование, ПоставщикНерезидент, АдресОтправки");
		Иначе	
			ЗаполнитьЗначенияСвойств(Объект, СтруктураДанных, "ПоставщикИдентификатор, ПоставщикНаименование, ПоставщикНерезидент, ПоставщикКодСтраны, ПоставщикКодСтраныОтправки");
		КонецЕсли;
	...
	Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") И Объект.ПоставщикНерезидент Тогда
		Если ТипЗнч(Объект.Получатель) = Тип("СправочникСсылка.Организации") И НЕ ЗначениеЗаполнено(Объект.Организация) Тогда
			Объект.Организация = Объект.Получатель;
		ИначеЕсли ТипЗнч(Объект.Получатель) = ВСКлиентСерверПереопределяемый.ТипПодразделенияОрганизаций() Тогда
	...
	ИначеЕсли Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") И НЕ Объект.ПоставщикНерезидент Тогда
		Если ТипЗнч(Объект.Поставщик) = Тип("СправочникСсылка.Организации") И НЕ ЗначениеЗаполнено(Объект.Организация) Тогда
...
Процедура КодСтраныНачалоВыбораЗавершение(Результат, Параметры) Экспорт
	...
	КодСтраныНачалоВыбораЗавершениеНаСервере(Результат, Параметры);
	
КонецПроцедуры


&НаСервере
Процедура КодСтраныНачалоВыбораЗавершениеНаСервере(Результат, Параметры)
...
Процедура УстановитьДоступностьРеквизитов()
	...
	ДоступностьИсточников = (Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") 
							...
							(Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий")
							И Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров"))
							//И (Объект.ПоставщикРозничнаяРеализация ИЛИ Объект.ПоставщикНерезидент ИЛИ Объект.ПоставщикФизическоеЛицо ИЛИ Объект.ПоставщикМалаяТорговаяТочка))
							ИЛИ 
							(Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий")
							И Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") 
							И Объект.ПоставщикМалаяТорговаяТочка);
...
Функция НовыйМассивИменНедоступныхЭлементов()
	...
	Массив.Добавить("ВидПеремещения");
	...
	Массив.Добавить("ПоставщикМалаяТорговаяТочка");
	Массив.Добавить("ПоставщикЗалогодержательХранитель");
	...
	Массив.Добавить("ПолучательМалаяТорговаяТочка");
	Массив.Добавить("ПолучательЗалогодержательХранитель");
	...
	Массив.Добавить("ПрочийТранспорт");
...
Функция НовыйМассивМассивИменНедоступныхКоманд()
	...
	Массив.Добавить("ТоварыЭкспортныйКонтрольЗаполнитьФиксированнымЗначением");
	Массив.Добавить("ТоварыЭкспортныйКонтрольЗаполнитьФиксированнымЗначениемКМ");
	Массив.Добавить("ТоварыЭкспортныйКонтрольЗаполнитьПоТоварам");
	Массив.Добавить("ТоварыЭкспортныйКонтрольЗаполнитьПоТоварамКМ");
...
Процедура СформироватьПредставлениеСостояния()
	...
	ИначеЕсли Объект.Состояние = Перечисления.СостоянияСНТ.ЗаблокированИСЭСФ Тогда
		
		ПредставлениеСостояния = НСтр("ru = 'Заблокирован ИС ЭСФ'");
...
Процедура ПолучательРозничнаяРеализацияПриИзменении(Элемент)
	...
	Если Объект.ПолучательРозничнаяРеализация Тогда
		Если НЕ ЗначениеЗаполнено(Объект.ПолучательНаименование) И НЕ ЗначениеЗаполнено(Объект.Получатель)Тогда
			Объект.ПолучательНаименование = "Розничная реализация";
		ИначеЕсли ЗначениеЗаполнено(Объект.Получатель) Тогда
			ПолноеНаименованиеПолучателя = ЗначениеРеквизитаОбъекта(Объект.Получатель, "НаименованиеПолное");
			Объект.ПолучательНаименование = ПолноеНаименованиеПолучателя;
		Иначе
...
&НаКлиенте
Процедура ПоставщикРозничнаяРеализацияПриИзменении(Элемент)
	
	Если Объект.ПоставщикРозничнаяРеализация Тогда
		Объект.ПоставщикНаименование = "Розничная реализация";
	Иначе
		Объект.ПоставщикНаименование = "";
	КонецЕсли;
...
Процедура ПроверитьСписокТоваровНеПодлежащихУчетуНаВС()
	...
	СписокЭДВССписаниеТоваровНеВС.ЗагрузитьЗначения(ПолучитьМассивЭДВСКонвертацийСписаниеТоваровНеВС(Объект.Ссылка));
	
	СформироватьПредставлениеЭДВССписаниеТоваровНеВС(ЭтаФорма);
...
Функция ПолучитьТаблицуТоваровНеВС()
	...
	Запрос.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	               ...
	               |ГДЕ
	               |	СНТТоварыЭкспортныйКонтроль.Ссылка = &ТекущийСНТ
	               ...
	               |	ТоварыНаВиртуальныхСкладахОстатки.ИсточникПроисхождения КАК ИсточникПроисхождения,
	               ...
	               |	ТоварыНаВиртуальныхСкладахОстатки.КоличествоОстаток КАК КоличествоОстаток
	               |ИЗ
...
Процедура СкладПолучательНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ИначеЕсли ЗначениеЗаполнено(Объект.ПолучательБИНСтруктурногоПодразделения) И ТипЗнч(Объект.Получатель) = ВСКлиентСерверПереопределяемый.ТипКонтрагент() Тогда
		
		//Отправитель Контрагент с указанием реквизитов головного контрагента
		ОтборОрганизация = Новый Массив;
		ОтборОрганизация.Добавить(Объект.Получатель);
		ОтборОрганизация.Добавить(Объект.Грузополучатель);
		
	ИначеЕсли ТипЗнч(Объект.Получатель) = Тип("СправочникСсылка.Организации") Тогда
		
		УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре = ЗначениеРеквизитаОбъекта(Объект.Организация, "УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре");
		Если УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре = Истина Тогда
			//Отправитель Филиал(Организация) выделенный на отдельный баланс с указанием реквизитов головной организации
			ОтборОрганизация = Объект.Организация; 
		Иначе
			ОтборОрганизация = Объект.Получатель;
		КонецЕсли;
		
	ИначеЕсли ТипЗнч(Объект.Получатель) = ВСКлиентСерверПереопределяемый.ТипКонтрагент() Тогда 
		//В реквизитах получателя справочник контрагент (реализация, возврат ЮЛ-ЮЛ)
		ОтборОрганизация = Объект.Получатель;
		
	Иначе
		//В реквизитах получателя справочник организация
		ОтборОрганизация = Объект.Организация;
	...
	Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") Тогда
		...
		ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Реализация")
			И (Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") И НЕ (Объект.ПоставщикРозничнаяРеализация ИЛИ Объект.ПоставщикНерезидент ИЛИ Объект.ПоставщикФизическоеЛицо ИЛИ Объект.ПоставщикМалаяТорговаяТочка)) Тогда
		...
		ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами") Тогда
			...
			ПолучательЭтоПодразделение = ТипЗнч(Объект.Получатель) = ВСКлиентСерверПереопределяемый.ТипПодразделенияОрганизаций();
			Если ПолучательЭтоПодразделение Тогда
				УказыватьРеквизитыГоловнойОрганизации 	= ЗначениеРеквизитаОбъекта(Объект.Получатель, "УказыватьРеквизитыГоловнойОрганизации");
			Иначе
				УказыватьРеквизитыГоловнойОрганизации 	= Ложь;
			КонецЕсли;
			
			Если ПолучательЭтоПодразделение И УказыватьРеквизитыГоловнойОрганизации Тогда 
				ОтборОрганизация = ЗначениеРеквизитаОбъекта(Объект.Получатель, ВСКлиентСерверПереопределяемый.ИмяВладельцаПодразделенияОрганизации()) 
			ИначеЕсли ПолучательЭтоПодразделение И НЕ УказыватьРеквизитыГоловнойОрганизации Тогда 
				ОтборОрганизация = Объект.Получатель;
			Иначе
				ОтборОрганизация = Новый Массив;
				ОтборОрганизация.Добавить(Объект.Получатель);
	...
	ИначеЕсли Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий")
		И Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров")
		И Объект.ПоставщикМалаяТорговаяТочка
		И ТипЗнч(Объект.Получатель) = ВСКлиентСерверПереопределяемый.ТипКонтрагент() Тогда
...
Процедура СкладОтправкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") Тогда
		...
		Если (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Перемещение")
			...
			ИЛИ Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Вывоз"))
			И НЕ(Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") И (Объект.ПоставщикРозничныйРеализатор ИЛИ Объект.ПоставщикМалаяТорговаяТочка))Тогда
			...
			Иначе
				УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре = ЗначениеРеквизитаОбъекта(Объект.Организация, "УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре"); 
				Если УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре = Истина Тогда
					ОтборОрганизация = Объект.Организация; //Отправитель Филиал выделенный на отдельный баланс с указанием реквизитов головной организации
				Иначе
		...
		ИначеЕсли Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Реализация") 
			И Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров")
			И (Объект.ПоставщикРозничныйРеализатор ИЛИ Объект.ПоставщикМалаяТорговаяТочка) Тогда
			
			Отбор = Новый Структура;
			Отбор.Вставить("Контрагент", Объект.Поставщик);
			ПараметрыФормыВыбора.Вставить("Отбор", Отбор);
	...
	ИначеЕсли Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий")
		И Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров")
		И Объект.ПоставщикМалаяТорговаяТочка 
		И ТипЗнч(Объект.Поставщик) = Тип("СправочникСсылка.Организации") Тогда
...
#Область СозданиеЭДВСКонвертацияМеждуРазнымиЕИИСписаниеТоваров
...
&НаКлиенте
Процедура ПослеЗакрытияВопросаВводаНаОснованииЭДВССписание(Результат, ДопПараметры) Экспорт
	...
	Если Объект.Проведен Тогда
		ОформитьКонвертациюЭДВСНаСписаниеЗавершение(КодВозвратаДиалога.ОК, Неопределено);
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура ПредставлениеТоварыНеПодлежащиеВСНажатие(Элемент, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	
	//++ НЕ ЭСФ
	Если СписокЭДВССписаниеТоваровНеВС.Количество() > 1 Тогда
		
		ПараметрыФормы = Новый Структура;	
		ПараметрыФормы.Вставить("Отбор", Новый Структура("Ссылка", Новый ФиксированныйМассив(СписокЭДВССписаниеТоваровНеВС.ВыгрузитьЗначения())));
		
		ОткрытьФорму("Документ.ЭлектронныйДокументВС.Форма.ФормаСписка", ПараметрыФормы,ЭтаФорма, Истина,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		
	ИначеЕсли СписокЭДВССписаниеТоваровНеВС.Количество() = 1 Тогда	
		
		ПоказатьЗначение(,СписокЭДВССписаниеТоваровНеВС[0].Значение);
		
	Иначе
		
		ОформитьКонвертациюЭДВСНаСписаниеЗавершение = Новый ОписаниеОповещения("ОформитьКонвертациюЭДВСНаСписаниеЗавершение", ЭтаФорма);
		
		Если (НЕ Объект.Проведен) И (НЕ Объект.ПометкаУдаления) Тогда
			
			ТекстВопроса = НСтр("ru='ЭДВС  нельзя вводить на основании не проведенного документа! Провести документ?'");
			ПослеЗакрытияВопросаВводаНаОсновании = Новый ОписаниеОповещения("ПослеЗакрытияВопросаВводаНаОснованииЭДВССписание", ЭтаФорма);
			ПоказатьВопрос(ПослеЗакрытияВопросаВводаНаОсновании, ТекстВопроса, РежимДиалогаВопрос.ДаНет, 0); 
			
		ИначеЕсли ЭтотОбъект.Модифицированность Тогда 
			ПослеЗакрытияВопросаВводаНаОснованииЭДВССписание(КодВозвратаДиалога.Да, Параметры);
		Иначе
			ОформитьКонвертациюЭДВСНаСписаниеЗавершение(КодВозвратаДиалога.ОК, Неопределено);
		КонецЕсли;
...
&НаКлиенте
Процедура ОформитьКонвертациюЭДВСНаСписаниеЗавершение(РезультатВопроса, ДополнительныеПараметры) Экспорт 
...
&НаКлиентеНаСервереБезКонтекста
Процедура СформироватьПредставлениеЭДВССписаниеТоваровНеВС(Форма)
			
	СписокЭДВССписаниеТоваровНеВС = Форма.СписокЭДВССписаниеТоваровНеВС;
	
	Если СписокЭДВССписаниеТоваровНеВС.Количество() = 0 Тогда
		Форма.ПредставлениеТоварыНеПодлежащиеВС 	= НСтр("ru = 'Обнаружены товары, не подлежащие учету на ВС. Требуется оформить ЭДВС.'");
		Форма.Элементы.ПредставлениеТоварыНеПодлежащиеВС.ЦветТекста = ЭСФКлиентСервер.ЦветКрасный();
	ИначеЕсли СписокЭДВССписаниеТоваровНеВС.Количество() > 1 Тогда
		ТекстПредставления 							= НСтр("ru='ЭДВС по списанию товаров, не подлежащих учету на ВС: (%1)'");
		ТекстПредставления 							= ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстПредставления, СписокЭДВССписаниеТоваровНеВС.Количество());
		Форма.ПредставлениеТоварыНеПодлежащиеВС 					= ТекстПредставления;
		Форма.Элементы.ПредставлениеТоварыНеПодлежащиеВС.ЦветТекста = ЭСФКлиентСервер.ЦветСиний();
	Иначе 
		ТекстПредставления 							= НСтр("ru=' ЭДВС по списанию товаров,не подлежащих учету на ВС: %1'");
		ТекстПредставления 							= ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(ТекстПредставления, СписокЭДВССписаниеТоваровНеВС[0].Значение);
		Форма.ПредставлениеТоварыНеПодлежащиеВС 					= ТекстПредставления;
		Форма.Элементы.ПредставлениеТоварыНеПодлежащиеВС.ЦветТекста = ЭСФКлиентСервер.ЦветСиний();
	КонецЕсли;
...
Процедура ПроверитьНаличиеКоэффициентаПересчета(ИмяТабличнойЧасти = "",  ЕстьКоэффициентПересчета = Ложь)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	вт_ТоварыВсе.НомерСтроки,
	|	вт_ТоварыВсе.КоэффициентПересчета,
	|	вт_ТоварыВсе.ЕдиницаИзмерения,
	|	вт_ТоварыВсе.ЕдиницаИзмеренияХраненияОстатков
	|ПОМЕСТИТЬ вт_Товары
	|ИЗ
	|	вт_ТоварыВсе КАК вт_ТоварыВсе
	|ГДЕ
	|	вт_ТоварыВсе.ИдентификаторТовара <> &ИдентификаторТовараНеВС
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ ПЕРВЫЕ 1
	...
	Запрос.УстановитьПараметр("ИдентификаторТовараНеВС", "1");
...
&НаСервереБезКонтекста
Функция ПолучитьМассивЭДВСКонвертацийЕИ(ДокументСНТ)
	...
	|ГДЕ
	|	ЭлектронныйДокументВС.ДокументОснование = &ДокументСНТ
	...
	Запрос.УстановитьПараметр("ДокументСНТ", ДокументСНТ);
...
&НаСервереБезКонтекста
Функция ПолучитьМассивЭДВСКонвертацийСписаниеТоваровНеВС(ДокументСНТ)
	...
	|ГДЕ
	|	ЭлектронныйДокументВС.ДокументОснование = &ДокументСНТ
	|	И ЭлектронныйДокументВС.ТипФормы = ЗНАЧЕНИЕ(Перечисление.ТипыФормВС.СписаниеТоваровНеВС)
	|	";
...
Процедура СоздатьДокументЭДВС(Команда)
	...
	Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий") И НЕ Объект.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") Тогда
...
Процедура ПроверитьСписокТоваровНаПеремещениеЭДВС()
	...
	Если Объект.Проведен И Объект.Направление = Перечисления.НаправленияСНТ.Входящий 
		И ((Объект.Статус = Перечисления.СтатусыСНТ.Подтвержден И НЕ Объект.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И НЕ Объект.ПоставщикМалаяТорговаяТочка) ИЛИ Объект.ПолучательМалаяТорговаяТочка)
...
&НаКлиенте
Процедура ДатаОтгрузкиТовараПриИзменении(Элемент)
	
	Если Объект.ЕстьАлкоголь Тогда
		Если Объект.АлкогольнаяПродукцияКромеПива.Количество() > 0 Тогда
			ТекстВопроса = НСтр("ru='При изменении даты отгрузки товара необходимо пересчитать сумму акциза в табличной части ""Раздел G5. Алкогольная продукция (кроме пива и пивного напитка)""! Пересчитать?'");
			ПослеЗакрытияВопросаПересчитатьСуммуАкциза = Новый ОписаниеОповещения("ПослеЗакрытияВопросаПересчитатьСуммуАкциза", ЭтаФорма);
			ПоказатьВопрос(ПослеЗакрытияВопросаПересчитатьСуммуАкциза, ТекстВопроса, РежимДиалогаВопрос.ДаНет, 0);
		КонецЕсли;
	КонецЕсли;
...
&НаКлиенте
Процедура ПослеЗакрытияВопросаПересчитатьСуммуАкциза(Результат, ДопПараметры) Экспорт
	
	Если Результат = КодВозвратаДиалога.Да Тогда
		Для каждого Строка Из Объект.АлкогольнаяПродукцияКромеПива Цикл
			НаименованиеКоличества = "КоличествоБутылок";
			РассчитатьСуммуТабЧасти(Строка, НаименованиеКоличества, Элементы.АлкогольнаяпродукцияКромеПива.Имя);
			
			ДанныеСтрокиАкцизы = СНТКлиентПереопределяемый.РассчитатьСуммуТабЧасти(Строка, НаименованиеКоличества);
			Если ДанныеСтрокиАкцизы <> Неопределено Тогда
				ЗаполнитьЗначенияСвойств(Строка, ДанныеСтрокиАкцизы);
			КонецЕсли;
		КонецЦикла;
	КонецЕсли;
...
&НаКлиенте
Процедура ТоварыЭкспортныйКонтрольИсточникПроисхожденияПриИзменении(Элемент)
	ИсточникПроисхожденияТовараПриИзменении(Элементы.ТоварыЭкспортныйКонтроль.ТекущиеДанные);
КонецПроцедуры

&НаКлиенте
Процедура ТоварыЭкспортныйКонтрольИсточникПроисхожденияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	ИсточникПроисхожденияТовараНачалоВыбора("ТоварыЭкспортныйКонтроль", "Товар", Элемент, ДанныеВыбора, СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура ТоварыЭкспортныйКонтрольПроверитьВыделенныеСтроки(ИмяКоманды)
	
	ВыделенныеСтроки = Элементы.ТоварыЭкспортныйКонтроль.ВыделенныеСтроки;
	
	Если ВыделенныеСтроки.Количество() = 0 Тогда
		
		ТекстОшибки = НСтр("ru='В табличной части G10. Данные по товарам, подлежащим экспортному контролю (двойного назначения, военного назначения) нет выбраных строк для заполнения'");
		ЭСФКлиентСерверПереопределяемый.СообщитьПользователю(ТекстОшибки);
		Возврат;
	...
	Для Каждого ИдентификаторСтроки Из ВыделенныеСтроки Цикл
		...
		ВыделеннаяСтрока = Объект.ТоварыЭкспортныйКонтроль.НайтиПоИдентификатору(ИдентификаторСтроки);
		Если ЗначениеЗаполнено(ВыделеннаяСтрока.ДополнительнаяИнформация) Тогда
	...
	СтруктураЗаполнения.Вставить("ИмяКоманды",ИмяКоманды);
	СтруктураЗаполнения.Вставить("ВыделенныеСтроки",ВыделенныеСтроки);
	СтруктураЗаполнения.Вставить("ФиксированнаяСтрокаДопИнформация","");
	
	Если ЕстьЗаполненныеСтроки Тогда
		
		ТекстВопроса = НСтр("ru = 'Перед заполнением дополнительная информация в выделенных строках табличной части будет очищена. Продолжить?'");
		ДополнительныеПараметры = Новый Структура;
		ОписаниеОповещения = Новый ОписаниеОповещения("ТоварыЭкспортныйКонтрольПроверитьВыделенныеСтрокиВопрос", ЭтотОбъект,СтруктураЗаполнения);
		ПоказатьВопрос(ОписаниеОповещения, ТекстВопроса, РежимДиалогаВопрос.ДаНет,, КодВозвратаДиалога.Да);
		
	Иначе
		
		ТоварыЭкспортныйКонтрольЗаполнитьДополнительнаяИнформация(СтруктураЗаполнения);
...
&НаКлиенте
Процедура ТоварыЭкспортныйКонтрольПроверитьВыделенныеСтрокиВопрос(Результат, ДопПараметры) Экспорт
	
	Если Результат = КодВозвратаДиалога.Да Тогда
		ТоварыЭкспортныйКонтрольЗаполнитьДополнительнаяИнформация(ДопПараметры);
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура ТоварыЭкспортныйКонтрольЗаполнитьДополнительнаяИнформация(СтруктураЗаполнения)
	
	Если СтруктураЗаполнения.ИмяКоманды = "ЗаполнитьФиксированнымЗначением" Тогда
	
		ОповещениеТоварыЭкспортныйКонтрольВводСтрокиДополнительнаяИнформация = 
			Новый ОписаниеОповещения("ТоварыЭкспортныйКонтрольВводСтрокиДополнительнаяИнформация",
				ЭтотОбъект,СтруктураЗаполнения);
			
		ПоказатьВводСтроки(
			ОповещениеТоварыЭкспортныйКонтрольВводСтрокиДополнительнаяИнформация,
			,
			НСтр("ru = 'Введите данные для заполнения дополнительной информации'"),
			255);
	ИначеЕсли СтруктураЗаполнения.ИмяКоманды = "ЗаполнитьПоТоварам" Тогда
		ТоварыЭкспортныйКонтрольЗаполнитьДополнительнаяИнформацияНаСервере(СтруктураЗаполнения);
	КонецЕсли;
	
КонецПроцедуры

&НаКлиенте
Процедура ТоварыЭкспортныйКонтрольВводСтрокиДополнительнаяИнформация(СтрокаВвода, ДопПараметр) Экспорт
	Если НЕ СтрокаВвода = Неопределено Тогда
		ДопПараметр.ФиксированнаяСтрокаДопИнформация = СтрокаВвода;
		ТоварыЭкспортныйКонтрольЗаполнитьДополнительнаяИнформацияНаСервере(ДопПараметр);
	КонецЕсли;
КонецПроцедуры

&НаСервере
Процедура ТоварыЭкспортныйКонтрольЗаполнитьДополнительнаяИнформацияНаСервере(СтруктураЗаполнения)
	
	Если СтруктураЗаполнения.ИмяКоманды = "ЗаполнитьФиксированнымЗначением"  Тогда
		
		Для Каждого ИдентификаторСтроки Из СтруктураЗаполнения.ВыделенныеСтроки Цикл
			
			ВыделеннаяСтрока = Объект.ТоварыЭкспортныйКонтроль.НайтиПоИдентификатору(ИдентификаторСтроки);
			ВыделеннаяСтрока.ДополнительнаяИнформация = СтруктураЗаполнения.ФиксированнаяСтрокаДопИнформация;
	...
	ИначеЕсли СтруктураЗаполнения.ИмяКоманды = "ЗаполнитьПоТоварам" Тогда
		...
		Для Каждого ИдентификаторСтроки Из СтруктураЗаполнения.ВыделенныеСтроки Цикл
			...
			ВыделеннаяСтрока = Объект.ТоварыЭкспортныйКонтроль.НайтиПоИдентификатору(ИдентификаторСтроки);
			Если ЗначениеЗаполнено(ВыделеннаяСтрока.Товар) Тогда
				МассивТоваров.Добавить(ВыделеннаяСтрока.Товар);
			КонецЕсли;
			
		КонецЦикла;
		
		СоответствиеДополнительнойИнформации = 
			СНТСерверПереопределяемый.ПолучитьДанныеДляЗаполненияДополнительнойИнформацииТоварыЭкспортныйКонтроль(МассивТоваров);
		
		Для Каждого ИдентификаторСтроки Из СтруктураЗаполнения.ВыделенныеСтроки Цикл
			
			ВыделеннаяСтрока = Объект.ТоварыЭкспортныйКонтроль.НайтиПоИдентификатору(ИдентификаторСтроки);
			ВыделеннаяСтрока.ДополнительнаяИнформация = СоответствиеДополнительнойИнформации[ВыделеннаяСтрока.Товар];
