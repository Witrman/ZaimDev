...
Функция ПечатьЗаявлениеНаВозвратЕдиногоПлатежа(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока ВыборкаПоРегистратору.Следующий() Цикл
        ...
        ОбластьМакетаШапка.Параметры.ДатаПлатежногоДокумента =  Формат(ВыборкаПоРегистратору.ДатаДокумента, "ДФ=dd.MM.yyyy");
    ...
    Пока ВыборкаПоРегистратору.Следующий() Цикл
        ...
        Если ВыборкаСтрокРаб <> Неопределено Тогда
            ...
            Пока ВыборкаСтрокРаб.Следующий() Цикл
                ...
                ОбластьМакетаШапка.Параметры.ДатаРождения =  Формат(ВыборкаСтрокРаб.ДатаРождения, "ДФ=dd.MM.yyyy");
                ОбластьМакетаШапка.Параметры.ДатаРождения =  Формат(ВыборкаСтрокРаб.ДатаРождения, "ДФ=dd.MM.yyyy");
