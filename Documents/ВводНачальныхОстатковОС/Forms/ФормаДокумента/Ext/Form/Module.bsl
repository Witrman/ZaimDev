...
Процедура ЗаполнитьТабИтогов(Форма)
	...
	ДобавитьСтрокуВТабИтогов(Форма, Истина, "ОСПервоначальнаяСтоимостьБУ",           "Первоначальная стоимость (БУ)");
	ДобавитьСтрокуВТабИтогов(Форма, Истина, "ОСТекущаяСтоимостьБУ",                  "Текущая стоимость (БУ)");
	ДобавитьСтрокуВТабИтогов(Форма, Истина, "ОСНакопленнаяАмортизацияБУ",            "Накопленная амортизация (износ) БУ");
	ДобавитьСтрокуВТабИтогов(Форма, Форма.Объект.ОтражатьВБухгалтерскомУчете, "ОССтоимостьДляВычисленияАмортизацииБУ", "Стоимость для вычисления амортизации (БУ)");
...
Процедура ПослеЗакрытияВопросаОчисткиТЧ(Ответ, ДополнительныеПараметры) Экспорт
	...
	ПоказатьВводЗначения(ОповещениеВыбораГруппы, , "Выберите группу ОС...", Новый ОписаниеТипов("ПеречислениеСсылка.ГруппыОС")); 
