	...
	Для Каждого ТекСтрока Из ОС Цикл
		...
		Если ЭтотОбъект.ОтражатьВБухгалтерскомУчете Тогда
			...
			Если Не ЗначениеЗаполнено(ТекСтрока.НомерДокументаПринятияКУчетуРегл) Тогда
				ТекстСообщения = ОбщегоНазначенияБККлиентСервер.ПолучитьТекстСообщения("Колонка",, НСтр("ru = 'Номер документа принятия к учету (БУ)'"), ТекСтрока.НомерСтроки, "ОС");
			...
			Если Не ЗначениеЗаполнено(ТекСтрока.НазваниеДокументаПринятияКУчетуРегл) Тогда
				ТекстСообщения = ОбщегоНазначенияБККлиентСервер.ПолучитьТекстСообщения("Колонка",, НСтр("ru = 'Название документа принятия к учету (БУ)'"), ТекСтрока.НомерСтроки, "ОС");
			...
			Если Не ЗначениеЗаполнено(ТекСтрока.СостояниеПринятияКУчетуРегл) Тогда
				ТекстСообщения = ОбщегоНазначенияБККлиентСервер.ПолучитьТекстСообщения("Колонка",, НСтр("ru = 'Событие принятия к учету'"), ТекСтрока.НомерСтроки, "ОС");
			...
			Если Не ЗначениеЗаполнено(ТекСтрока.СпособПоступленияРегл) Тогда
				ТекстСообщения = ОбщегоНазначенияБККлиентСервер.ПолучитьТекстСообщения("Колонка",, НСтр("ru = 'Способ поступления'"), ТекСтрока.НомерСтроки, "ОС");
