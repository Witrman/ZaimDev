...
Процедура ПодготовитьСправкуФормы(Форма) 
	...
	Если Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюОПВ.ПоЗадолженностиЗаМесяц") Тогда
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по задолженности " + ВидОПВ + " за <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияОПВ + "</P></A>).";
	...
	ИначеЕсли Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюОПВ.ПоОстаткамЗадолженностиНаКонецМесяца") Тогда		
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по остаткам задолженности " + ВидОПВ + " по <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияОПВ + "</P></A>&nbsp;(включительно)).";		
	...
	ИначеЕсли Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюОПВ.ПоЗадолженностиЗаМесяцПоНУ") Тогда		
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по задолженности " + ВидОПВ + " за <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияОПВ + "</P></A>&nbsp;, удержанной по удельному весу).";
	...
	ИначеЕсли Объект.СпособРасчетаСуммКПеречислению = ПредопределенноеЗначение("Перечисление.СпособыРасчетаСуммКПеречислениюОПВ.ПоОстаткамЗадолженностиНаКонецМесяцаПоНУ") Тогда		
		...
		ТекстСпособаВыплат = ТекстСпособаВыплат + "</P></A>&nbsp;(по остаткам задолженности " + ВидОПВ + " по <A id=АктивизироватьЭУ href=""V8:МесяцНачисленияСтрокой""><P id=ПериодРегистрации style=""DISPLAY:inline"">" + ИППериодПеречисленияОПВ + "</P></A>&nbsp;(включительно), удержанной по удельному весу).";
	...
	Иначе
		ВидПлатежаТекст = "(прочие суммы взносов).";
	КонецЕсли;
