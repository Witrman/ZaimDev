		...
		Попытка
			...
			Иначе
				...
				Иначе
					...
					//ЗаписьЖурналаРегистрации("ОбновлениИБ.ЗаполнитьДатуПодписанияГЗПриОбновлении", УровеньЖурналаРегистрации.Информация,,,ТекстСообщения);
					ЗаписьЖурналаРегистрации("Обновление ИБ. Документ ""Акт об оказании производственных услуг"". Заполнение даты подписания ГЗ", УровеньЖурналаРегистрации.Информация,,,ТекстСообщения);
