...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ПараметрыПроведения.ИзменениеПараметровНачисленияАмортизацииОСРеквизитыТаблицаОС.Количество() <> 0 Тогда 
		УчетОС.СформироватьДвиженияПараметрыАмортизацииОСБухгалтерскийУчет(ПараметрыПроведения.ИзменениеПараметровНачисленияАмортизацииОСРеквизитыТаблицаОС,
												Движения, Отказ);
	КонецЕсли;
	
	Если ПараметрыПроведения.ИзменениеПараметровНачисленияАмортизацииОСРеквизитыТаблицаОС.Количество() <> 0 Тогда 
		УчетОС.СформироватьДвиженияРегистрацияСобытияОС(ПараметрыПроведения.ИзменениеПараметровНачисленияАмортизацииОСРеквизитыТаблицаОС, 
