...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПечатьКомплектацияОС") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьКомплектацияОС(МассивОбъектов, ОбъектыПечати),
			,
...
//
Функция ПечатьКомплектацияОС(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.КомплектацияОС.ПФ_MXL_КомплектацияОС");
	...
	Пока ШапкаДокумента.Следующий() Цикл
		...
		ТекстКомплектацияОсновныхСредств 				= НСтр("ru = 'Комплектация основных средств'");
