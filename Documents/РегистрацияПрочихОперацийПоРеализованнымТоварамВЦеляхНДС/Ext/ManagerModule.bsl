...
Процедура ЗаполнитьДокументПоДокументуОснованию(Объект, Основание) Экспорт
...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	СодержаниеДокумента = НСтр("ru = '%1 НДС %2: %3'");	
	КорректировкаСодержание = ?(Реквизиты.КорректировкаОборота, НСтр("ru = 'Корректировка'"), "");
