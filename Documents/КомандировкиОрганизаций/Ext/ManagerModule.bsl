...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "КомандировочноеУдостоверение") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			ПечатьКомандировочноеУдостоверение(МассивОбъектов, ОбъектыПечати),
			,
...
//
Функция ПечатьКомандировочноеУдостоверение(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.КомандировкиОрганизаций.ПФ_MXL_Удостоверение");
		...
		Пока ВыборкаРаботники.Следующий() Цикл
			...
			Пока ВложеннаяВыборка.Следующий() Цикл
				...
				Если ЗначениеЗаполнено(ВложеннаяВыборка.ДокументСерия) Тогда
					РеквизитыПаспорта = РеквизитыПаспорта + ?(ЗначениеЗаполнено(РеквизитыПаспорта), ", ", "") + "серия " + ВложеннаяВыборка.ДокументСерия;
				КонецЕсли;
				...
				Если ЗначениеЗаполнено(ВложеннаяВыборка.ДокументДатаВыдачи) Тогда
					РеквизитыПаспорта = РеквизитыПаспорта + ?(ЗначениеЗаполнено(РеквизитыПаспорта), ", ", "") + Формат(ВложеннаяВыборка.ДокументДатаВыдачи, "ДФ='дд.ММ.гггг'");
				КонецЕсли;
				
				Если ЗначениеЗаполнено(ВложеннаяВыборка.ДокументКемВыдан) Тогда
					РеквизитыПаспорта = РеквизитыПаспорта + ?(ЗначениеЗаполнено(РеквизитыПаспорта), ", ", "") + "выд. "+ СокрЛП(ВложеннаяВыборка.ДокументКемВыдан);
				КонецЕсли;
...
Функция ПечатьПриказ(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	// запоминаем области макета
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.КомандировкиОрганизаций.ПФ_MXL_Приказ");
