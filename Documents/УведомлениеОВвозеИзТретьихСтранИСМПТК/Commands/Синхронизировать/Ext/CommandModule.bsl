...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПараметрыФормы.Вставить("ЗапускатьФоновоеЗадание", ИнтеграцияИСМПТККлиентСерверПереопределяемый.ИспользоватьФоновуюОтправкуДокументовИСМПТ());
	ПараметрыФормы.Вставить("РежимЗапуска", "СинхронизацияСИСМПТ");
	ПараметрыФормы.Вставить("ВидыДокументов", "УведомленияОВвозеИмпорт");
