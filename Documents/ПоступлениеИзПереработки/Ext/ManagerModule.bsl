...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ) Экспорт
	...
	Запрос.УстановитьПараметр("Содержание", НСтр("ru='Отнесение на затраты услуги по переработке'"));
	...
	Запрос.УстановитьПараметр("СодержаниеУслуг",	  НСтр("ru = 'Выпуск продукции'"));
	Запрос.УстановитьПараметр("СинонимИспользованныеМатериалы", НСтр("ru = 'Использованные материалы'"));
	Запрос.УстановитьПараметр("СинонимВозращенныеМатериалы", НСтр("ru = 'Возращенные материалы'"));
	Запрос.УстановитьПараметр("СодержаниеВозращенныеМатериалы", НСтр("ru = 'Возврат сырья из переработки'"));
