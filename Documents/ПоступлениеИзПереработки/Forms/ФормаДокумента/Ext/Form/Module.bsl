...
Процедура ИзменитьТовары(Команда)
	...
	ИзменитьТабличнуюЧастьТовары("Продукция", "Продукция");
...
Процедура ИзменитьИспользованныеМатериалы(Команда)
	...
	ИзменитьТабличнуюЧастьИспользованныеМатериалы("ИспользованныеМатериалы", "Использованные материалы");
...
Процедура ИзменитьВозвращенныеМатериалы(Команда)
	...
	ИзменитьТабличнуюЧастьВозвращенныеМатериалы("ВозвращенныеМатериалы", "Возвращенные материалы");
...
Процедура ВозвращенныеМатериалыПодбор(Команда)
	...
	ПараметрыПодбора = ПолучитьПараметрыПодбора("ВозвращенныеМатериалы");
...
Процедура ИспользованныеМатериалыПодбор(Команда)
	...
	ПараметрыПодбора = ПолучитьПараметрыПодбора("ИспользованныеМатериалы");
	Если ПараметрыПодбора <> Неопределено Тогда
		ОткрытьФорму("Обработка.ПодборНоменклатуры.Форма.ОсновнаяФорма", ПараметрыПодбора,
			ЭтаФорма, УникальныйИдентификатор);
	КонецЕсли;
