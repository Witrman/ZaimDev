...
Функция ПечатьПриказНаКаждогоСотрудника(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.УвольнениеИзОрганизаций.ПФ_MXL_Приказ");
...
Функция ПечатьПриказНаСписокСотрудников(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	// запоминаем области макета
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.УвольнениеИзОрганизаций.ПФ_MXL_ПриказСписком");
