...
Процедура УправлениеФормой(Форма)
    ...
    Элементы.ГруппаСчетСписанияЗатрат.Видимость = Форма.ПоказыватьВДокументахСчетаУчета;
...
Процедура ЗаполнитьСчетаУчетаНаСервере()
	Документы.СписаниеОС.ЗаполнитьСчетаУчетаВТабличнойЧасти(Объект);
КонецПроцедуры
...
Процедура ЗаполнитьДляСпискаОСНаСервере()
	...
	Документы.СписаниеОС.ЗаполнитьДляСпискаОСНаСервере(Объект);	
	ЗаполнитьДобавленныеКолонкиТаблиц();
...
Процедура ЗаполнитьПоДокументуОснованиюНаСервере()
	Документы.СписаниеОС.ЗаполнитьПоДокументуОснованию(Объект, Объект.ДокументОснование);		
КонецПроцедуры
