...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИсточникВыбора.ИмяФормы = "Документ.ИзменениеСостоянияОС.Форма.ФормаНастройкиДокумента" Тогда
		ОбработкаДанныхФормыНастройкиДокумента(ВыбранноеЗначение);	
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = ПредопределенноеЗначение("РежимЗаписиДокумента.Проведение") Тогда
		КлючеваяОперация = "Документ ""изменение состояния ос"" (проведение)";
...
Процедура Настройка(Команда)
	...
	СтруктураПараметров.Вставить("ИзменениеЗемельногоНалога"	 , Объект.ИзменениеЗемельногоНалога);
	СтруктураПараметров.Вставить("ИзменениеИмущественногоНалога" , Объект.ИзменениеИмущественногоНалога);
	СтруктураПараметров.Вставить("ИзменениеНачисленияАмортизации", Объект.ИзменениеНачисленияАмортизации);
	СтруктураПараметров.Вставить("ИзменениеТранспортногоНалога"	 , Объект.ИзменениеТранспортногоНалога);

	ФормаРедактированияСтроки = ОткрытьФорму("Документ.ИзменениеСостоянияОС.Форма.ФормаНастройкиДокумента",
...
Процедура ЗаполнитьТекущимиДанными(Команда)
	...
	Иначе 
		...
		ЗаполнитьТекущимиДаннымиСервере();
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ОСНачислятьАмортизацию.Видимость 		= Объект.ИзменениеНачисленияАмортизации;
	Элементы.ОСОбъектИмущественногоНалога.Видимость = Объект.ИзменениеИмущественногоНалога;
	Элементы.ОСОбъектТранспортногоНалога.Видимость  = Объект.ИзменениеТранспортногоНалога;
	Элементы.ОСОбъектЗемельногоНалога.Видимость     = Объект.ИзменениеЗемельногоНалога;
...
&НаКлиенте
Процедура ОбработкаДанныхФормыНастройкиДокумента(ДанныеФормы)

	Если НЕ ТипЗнч(ДанныеФормы) = Тип("Структура") Тогда
		Возврат;
	КонецЕсли;
	
	Элементы.ОСНачислятьАмортизацию.Видимость 		= ДанныеФормы.ИзменениеНачисленияАмортизации;
	Элементы.ОСОбъектИмущественногоНалога.Видимость = ДанныеФормы.ИзменениеИмущественногоНалога;
	Элементы.ОСОбъектТранспортногоНалога.Видимость  = ДанныеФормы.ИзменениеТранспортногоНалога;
	Элементы.ОСОбъектЗемельногоНалога.Видимость     = ДанныеФормы.ИзменениеЗемельногоНалога;
	
	Объект.ИзменениеЗемельногоНалога      = ДанныеФормы.ИзменениеЗемельногоНалога;
	Объект.ИзменениеИмущественногоНалога  = ДанныеФормы.ИзменениеИмущественногоНалога;
	Объект.ИзменениеНачисленияАмортизации = ДанныеФормы.ИзменениеНачисленияАмортизации;
	Объект.ИзменениеТранспортногоНалога   = ДанныеФормы.ИзменениеТранспортногоНалога;
...
&НаСервере
Процедура ЗаполнитьТекущимиДаннымиСервере()
	
	Документы.ИзменениеСостоянияОС.ЗаполнитьТабличнуюЧастьТекущимиДанными(Объект);
...
Функция ПолучитьПараметрыОбработкиТабличнойЧасти(ИмяТабличнойЧасти, СинонимТабличнойЧасти)
	...
	Если Объект.ИзменениеНачисленияАмортизации Тогда
		СтруктураРеквизитов.Вставить("НачислятьАмортизацию");
	КонецЕсли;
	
	Если Объект.ИзменениеЗемельногоНалога Тогда
		СтруктураРеквизитов.Вставить("ОбъектЗемельногоНалога");
	КонецЕсли;
	
	Если Объект.ИзменениеИмущественногоНалога Тогда
		СтруктураРеквизитов.Вставить("ОбъектИмущественногоНалога");
	КонецЕсли;
	
	Если Объект.ИзменениеТранспортногоНалога Тогда
