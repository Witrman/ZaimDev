...
Функция ИзменяемыеРеквизиты(Источник)
	...
	СтруктураПараметров.Вставить("ГосучреждениеКодТоваров",                  Источник.ГосучреждениеКодТоваров);
	СтруктураПараметров.Вставить("ГосучреждениеНазначениеПлатежа",           Источник.ГосучреждениеНазначениеПлатежа);
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент И Модифицированность Тогда
		СтруктураРезультат = Новый Структура("
			|ГосучреждениеКодТоваров, 
			|ГосучреждениеНазначениеПлатежа");
