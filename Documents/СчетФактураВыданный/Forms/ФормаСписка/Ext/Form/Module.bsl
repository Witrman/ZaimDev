...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭСФСервер.СписокСчетовФактурПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ЭСФКлиент.СписокСчетовФактурОбработкаОповещения(ЭтаФорма, "Список", ИмяСобытия, Параметр, Источник);
