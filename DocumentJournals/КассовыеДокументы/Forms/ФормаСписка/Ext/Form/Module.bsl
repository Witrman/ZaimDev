...
&НаКлиенте
Процедура КассоваяКнига(Команда)
	
	ТекущиеДанные = Элементы.Список.ТекущиеДанные;
	
	Если НЕ ТекущиеДанные = Неопределено Тогда
		ТекущаяОрганизация = ПолучитьТекущуюОрганизациюНаСервере(ТекущиеДанные);
		ОткрытьФорму("Отчет.КассоваяКнига.Форма.ФормаОтчета", Новый Структура("Организация, РежимРасшифровки", ТекущаяОрганизация, Истина));
	КонецЕсли;
...
&НаСервере
Функция ПолучитьТекущуюОрганизациюНаСервере(ТекущиеДанные)
