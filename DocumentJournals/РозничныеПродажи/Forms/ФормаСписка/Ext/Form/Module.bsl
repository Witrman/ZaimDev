...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеКассовойСменойДоступно = Истина;//КассовыеСменыВызовСервераБП.ДоступноУправлениеКассовойСменой();
...
Процедура СоздатьРозничнаяПродажаЧек(Команда)
	...
	СтруктураОтбора = ОбщегоНазначенияБКВызовСервера.ЗначенияЗаполненияДинамическогоСписка(Список.КомпоновщикНастроек);
	СтруктураОтбора.Вставить(ПредопределенноеЗначение("Перечисление.ВидыОперацийРозничнаяПродажа.Продажа"));
	ОткрытьФорму("Документ.ЧекККМ.Форма.ФормаДокумента", Новый Структура("ЗначенияЗаполнения", СтруктураОтбора), ЭтотОбъект);
...
Процедура СоздатьВозвратПоЧеку(Команда)
	...
	ОткрытьФорму("Документ.ЧекККМ.Форма.ФормаДокумента", СтруктураПараметров, ЭтотОбъект);
...
Процедура НастроитьВидимостьЭлементовФормы()
	...
	ДоступСозданиеРозничнойПродажи = ПравоДоступа("ИнтерактивноеДобавление", Метаданные.Документы.ЧекККМ);
	
	Если ОбщегоНазначения.ОбъектМетаданныхДоступенПоФункциональнымОпциям(Метаданные.Документы.ЧекККМ) Тогда
...
Процедура ПроверитьНаличиеПодключеннойКассовойТехники()
	...
	ПодключеннаяКассоваяТехника = МенеджерОборудованияВызовСервера.ОборудованиеПоПараметрам(ПоддерживаемыеТипыОборудования);
...
Функция ПараметрыПодменюУправленияКассовойСменой()
	...
	ПоддерживаемыеТипыОборудования.Добавить("ПринтерЧеков");
	ПоддерживаемыеТипыОборудования.Добавить("ККТ"); //Контрольно-кассовая техника
	СписокДоступныхУстройств = МенеджерОборудованияВызовСервера.ОборудованиеПоПараметрам(ПоддерживаемыеТипыОборудования);
