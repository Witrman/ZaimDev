...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""справка-расчет ""списание рбп"""" (формирование)");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Справка-расчет списания расходов будущих периодов %1'");
...
Функция ПодготовитьПараметрыОтчета()
	...
	ИначеЕсли Отчет.НаборПоказателейОтчета = 3 Тогда
		...
		Если ВыводитьПодписи Тогда
			ТекстПримечание = НСтр("ru = 'ПР: Постоянные разницы в оценке стоимости активов и обязательств.  ВР: Временные разницы в оценке стоимости активов и обязательств.'");
			Если ВыводитьПодписиРуководителей Тогда
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Отчет.НаборПоказателейОтчета <> 3 Тогда
		СписокПолей.Добавить("НачОстатокВР");
		СписокПолей.Добавить("НачОстатокПР");
		СписокПолей.Добавить("КонОстатокВР");
		СписокПолей.Добавить("КонОстатокПР");
		СписокПолей.Добавить("СуммаВР");
		СписокПолей.Добавить("СуммаПР");
	КонецЕсли;
