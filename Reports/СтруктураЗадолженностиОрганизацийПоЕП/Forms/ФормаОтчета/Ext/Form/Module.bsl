...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""структура задолженности организаций по ЕП"" (формирование)");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Структура задолженности организаций по ЕП %1'");
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	Если ЗаполняемыеНастройки.Свойство("Показатели") И ЗаполняемыеНастройки.Показатели Тогда
		...
		СписокПоказателей.Добавить("Исчислено"      , НСтр("ru = 'Исчислено'"));
		СписокПоказателей.Добавить("Перечислено"    , НСтр("ru = 'Перечислено'"));
		СписокПоказателей.Добавить("Возврат"        , НСтр("ru = 'Возврат'"));
		СписокПоказателей.Добавить("СальдоКонечное" , НСтр("ru = 'Сальдо конечное'"));
		СписокПоказателей.Добавить("СуммаПлатежаЗаСчетРаботника", НСтр("ru = 'Единый платеж (за счет работника):'"));
		СписокПоказателей.Добавить("ОПВ"    		, НСтр("ru = 'ОПВ (в т.ч.)'"));
		СписокПоказателей.Добавить("ИПН"    		, НСтр("ru = 'ИПН (в т.ч.)'"));
		СписокПоказателей.Добавить("ВОСМС"    		, НСтр("ru = 'ВОСМС (в т.ч.)'"));
		СписокПоказателей.Добавить("СуммаПлатежаЗаСчетРаботодателя", НСтр("ru = 'Единый платеж (за счет работодателя):'"));
		СписокПоказателей.Добавить("СО"    			, НСтр("ru = 'СО (в т.ч.)'"));
		СписокПоказателей.Добавить("ООСМС"    		, НСтр("ru = 'ООСМС (в т.ч )'"));
		СписокПоказателей.Добавить("ОПВР"    		, НСтр("ru = 'ОПВР (в т.ч )'"));
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.СтруктураЗадолженностиОрганизацийПоЕП.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
