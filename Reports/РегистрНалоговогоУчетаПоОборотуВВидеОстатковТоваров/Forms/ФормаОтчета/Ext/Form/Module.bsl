...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = ?(Отчет.ВидОтчета = "НалоговыйРегистр", НСтр("ru = 'Налоговый регистр по обороту в виде остатков товаров для целей исчисления налога на добавленную стоимость %1%2'"),
	НСтр("ru = 'Отчет по обороту в виде остатков товаров для целей исчисления налога на добавленную стоимость %1%2'"));
