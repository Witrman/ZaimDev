...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""структура задолженности организаций по со"" (формирование)"); 
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Структура задолженности организаций по СО %1'");
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.СтруктураЗадолженностиОрганизацийПоСО.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
