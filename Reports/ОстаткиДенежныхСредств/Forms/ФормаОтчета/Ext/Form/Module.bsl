...
Процедура ОтборыПравоеЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТипЗнч(ТекущаяСтрока.ЛевоеЗначение) = Тип("ПолеКомпоновкиДанных")
		И ТекущаяСтрока.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ВидДенежныхСредств")
		...
		Если ТипЗнч(ТекущаяСтрока.ПравоеЗначение) = Тип("СписокЗначений") Тогда
			...
			ТекущаяСтрока.ПравоеЗначение.ДоступныеЗначения.Добавить(НСтр("ru = 'Деньги в кассе'"), НСтр("ru = 'Деньги в кассе'"));
			ТекущаяСтрока.ПравоеЗначение.ДоступныеЗначения.Добавить(НСтр("ru = 'Деньги на расчетных счетах'"), НСтр("ru = 'Деньги на расчетных счетах'"));
			ТекущаяСтрока.ПравоеЗначение.ДоступныеЗначения.Добавить(НСтр("ru = 'Деньги у подотчетных лиц'"), НСтр("ru = 'Деньги у подотчетных лиц'"));
			
		КонецЕсли;
		
		Элемент.СписокВыбора.Очистить();
		
		Элемент.СписокВыбора.Добавить(НСтр("ru = 'Деньги в кассе'"), НСтр("ru = 'Деньги в кассе'"));
		Элемент.СписокВыбора.Добавить(НСтр("ru = 'Деньги на расчетных счетах'"), НСтр("ru = 'Деньги на расчетных счетах'"));
		Элемент.СписокВыбора.Добавить(НСтр("ru = 'Деньги у подотчетных лиц'"), НСтр("ru = 'Деньги у подотчетных лиц'"));
...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""остатки денежных средств"" (формирование)");
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	Если ЗаполняемыеНастройки.Свойство("Группировка") Тогда
		Если ЗаполняемыеНастройки.Группировка Тогда
			...
			НоваяСтрока = Отчет.ГруппировкаКолонок.Добавить();
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.ОстаткиДенежныхСредств.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
