...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Для Каждого ДополнительноеПоле Из ПараметрыОтчета.ДополнительныеПоля Цикл 
		Если ДополнительноеПоле.Использование Тогда 
			Если ДополнительноеПоле.Поле = "ДатаОборота" ИЛИ ДополнительноеПоле.Поле = "КрайнийСрокВыпискиЭСФ" ИЛИ ДополнительноеПоле.Поле = "ОсталосьДней" Тогда
				Продолжить;
			КонецЕсли;
	...
	ГруппаДанныеВыпискиЭСФ = КомпоновщикНастроек.Настройки.Выбор.Элементы.Добавить(Тип("ГруппаВыбранныхПолейКомпоновкиДанных"));
	ГруппаДанныеВыпискиЭСФ.Заголовок     = "Своевременность выписки ЭСФ";
	ГруппаДанныеВыпискиЭСФ.Использование = НЕ ПараметрыОтчета.ВидОтчета = "НаличиеДокументовРеализации";
	...
	Для Каждого Показатель Из ПараметрыОтчета.Показатели Цикл
		Если Показатель.Использование Тогда
			...
			Если Показатель.Поле = "СФСуммаНДСРегл" ИЛИ Показатель.Поле = "СФОборотПоРеализацииРегл" Тогда
	...
	Для Каждого ДопПоле Из ПараметрыОтчета.ДополнительныеПоля Цикл
		Если ДопПоле.Использование Тогда      
			Если ДопПоле.Поле = "ДатаОборота" ИЛИ ДопПоле.Поле = "КрайнийСрокВыпискиЭСФ" ИЛИ ДопПоле.Поле = "ОсталосьДней" Тогда
				БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(ГруппаДанныеВыпискиЭСФ, ДопПоле.Поле);
			КонецЕсли;
		КонецЕсли;
	КонецЦикла;
...
Функция ПолучитьСписокВидовДокументовОснованияСФ(ВидСчетФактуры = "СчетФактураВыданный")
