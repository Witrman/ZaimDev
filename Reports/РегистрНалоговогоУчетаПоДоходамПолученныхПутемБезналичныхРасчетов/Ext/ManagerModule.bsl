...
Процедура ПриВыводеЗаголовка(ПараметрыОтчета,Результат) Экспорт
	...
	ОбластьЗаголовок.Параметры.НомерПриложения  = "12";
	...
	ОбластьЗаголовокТаблицы.Параметры.ЗаголовокТаблицы = ПолучитьТекстЗаголовкаТаблицы();
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт
	...
	ЗаголовокОтчета = НСтр("ru = 'Налоговый регистр по учету доходов, в том числе полученных путем безналичных расчетов '");
...
Функция ПолучитьТекстЗаголовкаТаблицы() Экспорт
	
	ЗаголовокОтчета = НСтр("ru = 'Учет доходов, получаемых путем безналичных расчетов для индивидуальных предпринимателей,'") + Символы.ПС +  
			НСтр("ru = 'применяющих специальный налоговый режим на основе патента '");
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	СписокПунктовМеню.Добавить("РегистрНалоговогоУчетаПоДоходамПолученныхПутемБезналичныхРасчетов", НСтр("ru = 'Регистр налогового учета по доходам, полученных путем безналичных расчетов'"));
	ИДРасшифровки = "РегистрНалоговогоУчетаПоДоходамПолученныхПутемБезналичныхРасчетов";
