...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отчет.ДанныеПоПодразделам = Истина;
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ СТРАНИЦЫ ОБЩИЕНАСТРОЙКИ

&НаКлиенте
Процедура ПоЗабалансовымСчетамПриИзменении(Элемент)
...
&НаКлиенте
Процедура ДанныеПоПодразделамПриИзменении(Элемент)
...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""шахматная ведомость (бух.)"" (формирование)"); 
...
Функция ПодготовитьПараметрыОтчета()
	...
	ПараметрыОтчета.Вставить("ПоВалютам"                             , Отчет.ПоВалютам);
	ПараметрыОтчета.Вставить("ДанныеПоПодразделам"                   , Отчет.ДанныеПоПодразделам);
	ПараметрыОтчета.Вставить("ПоСубсчетам"                           , Отчет.ПоСубсчетам);
	ПараметрыОтчета.Вставить("ПоЗабалансовымСчетам"                  , Отчет.ПоЗабалансовымСчетам);
