...
&НаКлиенте
Процедура ПоказательКоличествоНУПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательКоличествоПРПриИзменении(Элемент)
...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""отчет по проводкам (налоговый)"" (формирование)"); 
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Отчет по проводкам (налоговый учет) %1'");
