...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""контрольная ведомость отражения зарплаты в регламентированном учете"" (формирование)");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Контрольная ведомость отражения зарплаты в регламентированном учете %1'");
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.КонтрольнаяВедомостьОтраженияЗарплатыВРегУчете.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
