...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""справка-расчет ""распределение косвенных расходов"""" (формирование)");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Справка-расчет распределения косвенных расходов %1'");
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Отчет.НаборПоказателейОтчета <> 3 Тогда
		СписокПолей.Добавить("СуммаБазыПР");
		СписокПолей.Добавить("СуммаПР");
		СписокПолей.Добавить("КоэффициентПР");
	КонецЕсли;
