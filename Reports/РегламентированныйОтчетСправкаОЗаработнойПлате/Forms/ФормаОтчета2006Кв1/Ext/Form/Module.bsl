...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "ФормаОтчета2006Кв1";
...
Процедура ВывестиВДокумент(СписокСохранения)
	...
	Макет = Отчет.ПолучитьМакет("МакетФормаОтчета2006Кв1");
...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Пока Выборка.Следующий() Цикл
		...
		СписокСохранения.Вставить("СуммаКВыплате_" + НомерСтроки, Выборка.Заработок - Выборка.ОПВ - Выборка.ИПН);
	КонецЦикла;	
	...
	СписокСохранения.Вставить("ИтогоСуммаКВыплате", ИтогоЗаработок - ИтогоОПВ - ИтогоИПН);
