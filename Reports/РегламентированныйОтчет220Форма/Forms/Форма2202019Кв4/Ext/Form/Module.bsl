...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма2202019Кв4";
	КодФормы 		= "Форма220";
	...
	СтруктураРеквизитовФормы.КодСтрокиРасходыПоКурсовойРазнице = "220.00.020.K";
...
Процедура Форма220РасчетНаСервере(ИмяЯчейки, ЗначениеЯчейки, ТекИмяФормы, Изменено = Истина)
	...
	ИмяОбластиБ = "s_220_00_006";
	СтруктураА.Вставить(ИмяОбластиА);
	СтруктураА.Вставить(ИмяОбластиБ);
	s_220_00_003 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_220_00_003", СтруктураА, Форма220ПолеТабличногоДокументаСтраница1, Ложь);		
	...
	////Рассчитаем ячейку s_220_00_003. Чтобы не происходило занижения доходов, учтем в ней сумму строки s_220_00_006
	//
	//СтруктураА = Новый Структура;
	//ИмяОбластиА = "s_220_00_006";
	//СтруктураА.Вставить(ИмяОбластиА);			
	//s_220_00_003 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_220_00_003", СтруктураА, Форма220ПолеТабличногоДокументаСтраница1, Ложь);		
	//
	//РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_003", s_220_00_003, ?(Изменено, Форма220ПолеТабличногоДокументаСтраница1, Неопределено));
	...
	// 220.00.007 Корректировка доходов и вычетов - разность подстрок
	Корректировка = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_007_1")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_007_2");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_007", Окр(Корректировка), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница1, Неопределено));		
	
	//Рассчитаем ячейку 220.00.011.III
	НомерНач = КодСимвола("a");
	НомерКон = КодСимвола("h");
	ИтогЗначение = 0 ;
	Для ИмяЯчейки = НомерНач  По НомерКон Цикл
		ИмяГрафы = "s_220_00_011_3_" + Символ(ИмяЯчейки);
		ИтогЗначение = ИтогЗначение + РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, ИмяГрафы); 
	КонецЦикла;
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_011_3", ИтогЗначение, ?(Изменено, Форма220ПолеТабличногоДокументаСтраница2, Неопределено));			
	
	//Рассчитаем ячейку 220.00.011
	ИтогЗначение = 0;
	Значение_011I    = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_1"); 
	Значение_011II   = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_2"); 
	Значение_011III  = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_3"); 
	Значение_011IV   = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_4"); 
	Значение_011V    = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_5"); 
	Значение_011VI   = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_6"); 
	Значение_011VII  = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_7"); 
	Значение_011VIII = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_8"); 
	Значение_011IX   = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_011_9"); 
	
	ИтогЗначение11 = (Значение_011I - Значение_011II + Значение_011III + Значение_011IV + Значение_011V - Значение_011VI - Значение_011VII
	- Значение_011VIII - Значение_011IX);
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_011", Окр(ИтогЗначение11), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница2, Неопределено));			
	
	
	//Рассчитаем ячейку 220.00.017.  Вычеты по фиксированным активам (220.04.011 + 220.04.012)   	
	ИтогЗначение = 0;
	...
	ИтогЗначение019 = ЯчейкаСтрока011 + ЯчейкаСтрока012;// + ЯчейкаСтрока029_1; т.к. значение в строке 029_1 - справочные данные по правилам заполнения
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_019", Окр(ИтогЗначение019), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница2, Неопределено));			
	
	// 220.00.021. ВСЕГО ВЫЧЕТОВ (сумма с 220.00.011 по 220.00.020)
	ВсегоВычетов = 0;
	Для Н = 11 По 20 Цикл
		ИмяГрафы = "s_220_00_0" + Формат(Н, "ЧЦ=2; ЧВН=");
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_021", Окр(ВсегоВычетов), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница2, Неопределено));			
	
	// 220.00.010 После расчета 220.00.021
	
	// 220.00.010 Корректировка доходов индивидуального предпринимателя,полученных совокупно за налоговый период, с учетом доходов,
	// не подлежащих налогообложению, и корректировки, а также корректировки доходов и вычетов, в т.ч. в соответствии с трансфертным ценнобразованием
	//(220.00.004 - 220.00.005 + или - 220.00.006 - 220.00.21 - 220.00.007 + 220.00.008 - 220.00.009)
	СГДИтог = СГД 	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_005")
	+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_006")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_021")
	+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_007")
	+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_008")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_009");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_010", СГДИтог, ?(Изменено, Форма220ПолеТабличногоДокументаСтраница1, Неопределено));			
	
	
	// Рассчитаем ячейку 220.00.025 
	
	ИтогЗначение25 = 0;
	Значение_025I    = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_025_1"); 
	Значение_025II   = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_025_2"); 
	Значение_025III  = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_025_3"); 
	
	ИтогЗначение25 = Значение_025I + Значение_025II + Значение_025III;
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_025", Окр(ИтогЗначение25), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница2, Неопределено));			
	
	
	
	// 220.00.026. ВСЕГО НАЛОГОВЫХ ВЫЧЕТОВ (сумма с 220.00.022 по 220.00.025)
	ВсегоНалоговыхВычетов = 0;
	Для Н = 22 По 25 Цикл
		ИмяГрафы = "s_220_00_0" + Формат(Н, "ЧЦ=2; ЧВН=");
		ВсегоНалоговыхВычетов = ВсегоНалоговыхВычетов + РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных,ИмяГрафы);
	КонецЦикла;	
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_026", Окр(ВсегоНалоговыхВычетов), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница2, Неопределено));		
	...
	// 220.00.029 ВСЕГО ОБЛАГАЕМОГО ДОХОДА (УБЫТКА) ИНДИВИДУАЛЬНОГО ПРЕДПРИНИМАТЕЛЯ (220.00.010 – 220.00.028)
	ВсегоОблагаемыйДоход = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_010")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_028");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_029", Окр(ВсегоОблагаемыйДоход), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	
	// 220.00.031 ИТОГО НАЛОГООБЛАГАЕМОГО ДОХОДА (УБЫТКА) ИНДИВИДУАЛЬНОГО ПРЕДПРИНИМАТЕЛЯ С УЧЕТОМ КИК (220.00.029 – 220.00.030)
	ВсегоОблагаемыйДоходСКИК = ВсегоОблагаемыйДоход
	+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_030");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_031", Окр(ВсегоОблагаемыйДоходСКИК), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	
	// 220.00.032 Убыток, подлежащий переносу (220.00.031 + 220.03.008I)
	// в строке 220.00.032 указывается убыток, подлежащий переносу в соответствии с пунктом 1 статьи 300 Налогового кодекса. 
	// Если строка 220.00.031 имеет отрицательное значение, строка 220.00.032 определяется как сумма модуля строки 220.00.031 и строки 220.03.008 I. 
	// Если строка 220.00.031 имеет положительное значение, в строку 220.00.032 переносится строка 220.03.008 I;
	Строка008_1 = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "Строка008_1");
	Строка044 	= РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_031");
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_032", Окр(УбытокКПереносу), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	//220.00.033  Уменьшение облагаемого дохода индивидуального предпринимателя (220.00.033I + 220.00.033II)
	УменьшениеНОД = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_033_1")
	+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_033_2");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_033", Окр(УменьшениеНОД), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	// 220.00.034	Облагаемый доход индивидуального предпринимателя с учетом уменьшения (220.00.031 - 220.00.033)																																																			
	НОДСУчетомУменьшения = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_031")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_033");
	Если НОДСУчетомУменьшения < 0 Тогда
		НОДСУчетомУменьшения = 0;
	КонецЕсли;	
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_034", Окр(НОДСУчетомУменьшения), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	// 220.00.036 ОБЛАГАЕМЫЙ ДОХОД ИНДИВИДУАЛЬНОГО ПРЕДПРИНИМАТЕЛЯ С УЧЕТОМ ПЕРЕНЕСЕННЫХ УБЫТКОВ (220.00.034 - 220.00.035)
	НОДСУчетомУбытков = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_034")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_035");
	
	Если НОДСУчетомУбытков < 0 Тогда					
		НОДСУчетомУбытков = 0;
	КонецЕсли;	
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_036", Окр(НОДСУчетомУбытков), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	
	// 220.00.039 ИТОГО ОБЛАГАЕМАЯ СУММА ДОХОДА ИНДИВИДУАЛЬНОГО ПРЕДПРИНИМАТЕЛЯ (220.00.036 - 220.00.037 - 220.00.038 - 220.00.026)
	ИтогоОблагаемаяСумма = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_036")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_037")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_038")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_026");
	
	Если ИтогоОблагаемаяСумма < 0 Тогда					
		ИтогоОблагаемаяСумма = 0;
	КонецЕсли;	
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_039", Окр(ИтогоОблагаемаяСумма), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	
	// 220.00.041 ИПН с облагаемого дохода (220.00.039 х 220.00.040)																						
	ИПН = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_039")
	* РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_040")/100;
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_041", Окр(ИПН), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	// 220.00.042	Исчисленная сумма ИПН (220.00.041 - 220.00.042 I  - 220.00.042 II - 220.00.042 III - 220.00.040 IV - 220.00.040 V - 220.00.040 VI)
	ИПНИсчисленный = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_041")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042_1")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042_2")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042_3")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042_4")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042_5")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042_6");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_042", Окр(ИПНИсчисленный), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
	
	
	// 220.00.044 ВСЕГО НАЛОГА К УПЛАТЕ (220.00.042 - 220.00.043)																						
	ВсегоНалогаКУплате = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_042")
	- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_220_00_043");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_00_044", Окр(ВсегоНалогаКУплате), ?(Изменено, Форма220ПолеТабличногоДокументаСтраница3, Неопределено));			
...
Процедура Форма220_04РасчетНаСервере(ИмяЯчейки, ЗначениеЯчейки, ТекИмяФормы, Изменено = Истина)
	...
	Для Н = 1 По 4 Цикл
		...
		РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_04_005"+ "_" + Н, Окр(ИтогЗначение), ?(Изменено, ЭтотОбъект["Форма220_04ПолеТабличногоДокументаСтраница1"], Неопределено));		
	КонецЦикла;
	...
	Для Н = 1 По 4 Цикл
		...
		ИтогЗначение = ИтогЗначение + РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, ИмяГрафы); 
	КонецЦикла;
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_04_005", Окр(ИтогЗначение), ?(Изменено, ЭтотОбъект["Форма220_04ПолеТабличногоДокументаСтраница1"], Неопределено));		
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_04_011" + "_" + Н, Окр(ИтогЗначение), ?(Изменено, ЭтотОбъект["Форма220_04ПолеТабличногоДокументаСтраница2"], Неопределено));		
	...
	Для Н = 1 По 4 Цикл
		...
		ИтогЗначение = ИтогЗначение + РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, ИмяГрафы); 
	КонецЦикла;
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_220_04_011" , Окр(ИтогЗначение), ?(Изменено, ЭтотОбъект["Форма220_04ПолеТабличногоДокументаСтраница2"], Неопределено));		
...
Функция Форма220ПолучитьСписокКодовСтрокВключаемыхВРасшифровку(ИмяЯчейки)
	...
	Если ИмяЯчейки = "220.00.011.VIII" Тогда 
		
		КодыСтрокРасшифровки.Добавить("220.00.011.VIII");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIA");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIB");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIC");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIID");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIE");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIF");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIG");
		КодыСтрокРасшифровки.Добавить("220.00.011.IIIH");
	...
	ИначеЕсли ИмяЯчейки = "220.00.027" Тогда 
		
		КодыСтрокРасшифровки.Добавить("220.00.027.I");
		КодыСтрокРасшифровки.Добавить("220.00.027.II");
		
	ИначеЕсли ИмяЯчейки = "220.00.003" Тогда
		
		КодыСтрокРасшифровки.Добавить("220.00.003");
		КодыСтрокРасшифровки.Добавить("220.00.005");
		КодыСтрокРасшифровки.Добавить("220.00.006");
...
Функция Форма220ПолучитьСписокКодовДоходов()
	...
	СписокДохКодовСтрок.Добавить("220.00.027.I");
...
Функция Форма220ПолучитьСписокКодовИсключенийИзРасшифровки()
	...
	СписокКодовДляИсключения.Добавить("s_220_00_010");
	СписокКодовДляИсключения.Добавить("s_220_00_011");
	СписокКодовДляИсключения.Добавить("s_220_00_011_1");	
	СписокКодовДляИсключения.Добавить("s_220_00_011_2");	
	СписокКодовДляИсключения.Добавить("s_220_00_011_3");	
	
	//СписокКодовДляИсключения.Добавить("s_220_00_017_1");
	
	СписокКодовДляИсключения.Добавить("s_220_00_021");
	СписокКодовДляИсключения.Добавить("s_220_00_007");
	СписокКодовДляИсключения.Добавить("s_220_00_026");
	
	СписокКодовДляИсключения.Добавить("s_220_00_029");
	СписокКодовДляИсключения.Добавить("s_220_00_031");
	...
	СписокКодовДляИсключения.Добавить("s_220_00_042_3");
	СписокКодовДляИсключения.Добавить("s_220_00_042_4");
	СписокКодовДляИсключения.Добавить("s_220_00_043");
	СписокКодовДляИсключения.Добавить("s_220_00_044");
...
Функция ПолучитьАдресМакетаСКД(Знач ИмяРаздела, ТекстЗапроса = "")
	...
	Если КодФормы = "Форма220" Тогда
		...
		ОбщаяСКД = РеквизитФормыВЗначение("ОтчетОбъект").ПолучитьМакет("МакетСКДФорма2202019Кв4");
...
Процедура Форма220РасшифровкаСКД(ИмяЯчейки, МетодРасшифровки)
	...
	Если СокрЛП(ИмяЯчейки)	 = "220.00.011.IV" Тогда		
	...
	ИначеЕсли СокрЛП(ИмяЯчейки)	 = "220.00.011.V" Тогда		
	...
	ИначеЕсли СокрЛП(ИмяЯчейки)	 = "220.00.011.VI" Тогда				
	...
	ИначеЕсли СокрЛП(ИмяЯчейки)	 = "220.00.011.VII" Тогда		
	...
	ИначеЕсли СокрЛП(ИмяЯчейки)	 = "220.00.011.VIII" Тогда		
	...
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "КодСтрокЗП",              "220.00.011.IV");
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "КодСтрокиA",              "220.00.011.IIIA");
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "КодСтрокиРБП",            "220.00.011%");
	...
	Если ИмяЯчейки = "220.00.011.IIIA" Тогда 
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "КодСтрокиКоррВычетов", "220.00.007.II");
	КонецЕсли;
	
	Если ИмяЯчейки = "220.00.025.I" Тогда 
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "ВидВычета", ПредопределенноеЗначение("Справочник.ВычетыИПН.ДобровольныеПенсионныеВзносы"));
	ИначеЕсли ИмяЯчейки = "220.00.025.II" Тогда 
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "ВидВычета", ПредопределенноеЗначение("Справочник.ВычетыИПН.НаОплатуМедицинскихУслуг"));
	ИначеЕсли ИмяЯчейки = "220.00.025.III" Тогда 
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьПараметр(МассивПараметровДанных, "ВидВычета", ПредопределенноеЗначение("Справочник.ВычетыИПН.ПогашениеВознагражденияПоЖилищнымЗаймам"));
	КонецЕсли;
	...
	Если Лев(ИмяЯчейки,10)	 = "220.00.024" Тогда
		
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(ПользовательскиеПоля, "ВидВычета", "Вид вычета");
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(ПользовательскиеПоля, "РазмерМЗП", "Размер МЗП");
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(ПользовательскиеПоля, "КоличествоМЗП", "Количество МЗП/месяцев");
	...
	ИначеЕсли Лев(ИмяЯчейки,10)	 = "220.00.025" Тогда
		...
		Если ИмяЯчейки = "220.00.025.II" Тогда	
...
Процедура Форма220_01Расшифровка(ИмяЯчейки, ОбщаяРасшифровка)
	...
	Если ОбщаяРасшифровка Тогда 
		...
		КодДляРасшифровки.Добавить("220.00.011.IIIA");
		КодДляРасшифровки.Добавить("220.00.011.IIIB");
		КодДляРасшифровки.Добавить("220.00.011.IIIC"); 
		КодДляРасшифровки.Добавить("220.00.011.IIID");
		КодДляРасшифровки.Добавить("220.00.011.IIIE"); 
		КодДляРасшифровки.Добавить("220.00.011.IIIF");
		КодДляРасшифровки.Добавить("220.00.011.IIIG");		
		КодДляРасшифровки.Добавить("220.00.011.IIIH");
...
Функция ЗаполнитьВФонеНаСервере(Перезаполнить)
	...
	Иначе
		...
		ИДРедакцииОтчета = "Форма2202019Кв4";
