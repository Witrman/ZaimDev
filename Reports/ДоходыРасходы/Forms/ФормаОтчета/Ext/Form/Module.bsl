...
Процедура ОтборыПравоеЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТипЗнч(ТекущаяСтрока.ЛевоеЗначение) = Тип("ПолеКомпоновкиДанных")
		И ТекущаяСтрока.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Вид")
		...
		Если ТипЗнч(ТекущаяСтрока.ПравоеЗначение) = Тип("СписокЗначений") Тогда
			...
			ТекущаяСтрока.ПравоеЗначение.ДоступныеЗначения.Добавить(НСтр("ru = 'Доходы без НДС'"), НСтр("ru = 'Доходы без НДС'"));
			ТекущаяСтрока.ПравоеЗначение.ДоступныеЗначения.Добавить(НСтр("ru = 'Расходы'"), НСтр("ru = 'Расходы'"));
			ТекущаяСтрока.ПравоеЗначение.ДоступныеЗначения.Добавить(НСтр("ru = 'Прибыль (убыток)'"), НСтр("ru = 'Прибыль (убыток)'"));
			
		КонецЕсли;
		
		Элемент.СписокВыбора.Очистить();
		
		Элемент.СписокВыбора.Добавить(НСтр("ru = 'Доходы без НДС'"), НСтр("ru = 'Доходы без НДС'"));
		Элемент.СписокВыбора.Добавить(НСтр("ru = 'Расходы'"), НСтр("ru = 'Расходы'"));
		Элемент.СписокВыбора.Добавить(НСтр("ru = 'Прибыль (убыток)'"), НСтр("ru = 'Прибыль (убыток)'"));
...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""доходы и расходы (прибыль и убыток)"" (формирование)");
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	Если ЗаполняемыеНастройки.Свойство("Группировка") Тогда
		Если ЗаполняемыеНастройки.Группировка Тогда
			...
			НоваяСтрока = Отчет.Группировка.Добавить();
			НоваяСтрока.Поле           = "Вид";
			НоваяСтрока.Использование  = Истина;
			НоваяСтрока.Представление  = НСтр("ru = 'Вид'");
			НоваяСтрока.ТипГруппировки = Перечисления.ТипДетализацииСтандартныхОтчетов.Элементы;	
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.ДоходыРасходы.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
