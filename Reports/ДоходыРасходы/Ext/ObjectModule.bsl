...
Процедура ПриОпределенииПараметровВыбора(Форма, СвойстваНастройки) Экспорт
	...
	Если СвойстваНастройки.Тип = "ЭлементОтбора" Тогда
		...
		Если ИмяОтбора = "Вид" Тогда
			ЗначенияДляВыбора = Новый СписокЗначений;
			ЗначенияДляВыбора.ТипЗначения = Новый ОписаниеТипов("Строка");
			ЗначенияДляВыбора.Добавить(НСтр("ru = 'Доходы без НДС'"), НСтр("ru = 'Доходы без НДС'"));
			ЗначенияДляВыбора.Добавить(НСтр("ru = 'Расходы'"), НСтр("ru = 'Расходы'"));
			ЗначенияДляВыбора.Добавить(НСтр("ru = 'Прибыль (убыток)'"), НСтр("ru = 'Прибыль (убыток)'"));
