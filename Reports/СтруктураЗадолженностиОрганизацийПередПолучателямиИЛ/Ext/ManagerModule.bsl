...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета, ОрганизацияВНачале = Истина) Экспорт
	...
	ЗаголовокОтчета = НСтр("ru = 'Структура задолженности организаций перед получателями ИЛ %1'");
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Если ЗначениеЗаполнено(ПараметрыОтчета.КонецПериода) Тогда
		Граница = Новый Граница(КонецДня(ПараметрыОтчета.КонецПериода), ВидГраницы.Включая);
		БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "КонецПериода", Граница);
	Иначе
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	Для Каждого СтрокаПоказатели Из ДанныеОтчета.Объект.Показатели Цикл
		Если СтрокаПоказатели.Использование 
			И (СтрокаПоказатели.Поле = "ВсегоНачислено" 
				ИЛИ СтрокаПоказатели.Поле = "ВсегоВыплачено" 
				ИЛИ СтрокаПоказатели.Поле = "ВсегоСальдоНачальное"
				ИЛИ СтрокаПоказатели.Поле = "ВсегоСальдоКонечное")Тогда
	...
	СписокПунктовМеню.Добавить("СтруктураЗадолженностиОрганизацийПередПолучателямиИЛ", "СтруктураЗадолженностиОрганизацийПередПолучателямиИЛ");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("СтруктураЗадолженностиОрганизацийПередПолучателямиИЛ", ПользовательскиеНастройки);
