...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма1002019Кв4";
	КодФормы 		= "Форма100";
	...
	СтруктураРеквизитовФормы.КодСтрокиДоходОтКурсовойРазницы   = "100.00.014.K";
...
////////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ТАБЛИЧНОГО ПОЛЯ   Форма100ПолеТабличногоДокументаСтраница7

&НаКлиенте
Процедура Форма100ПолеТабличногоДокументаСтраница7ПриИзмененииСодержимогоОбласти(Элемент, Область)
...
Процедура ВыгрузитьВXML(Команда)
	...
	// Открыта возможность выгрузки за 2019 и 2020 гг. в свзяи с тем, что версия выгрузки в этот период не менялась и при реализации формы за 2019 возможность сохранения и выгрузки за 2020 для пользователей была доступна.
...
Процедура Форма100ЗаполнитьАвтоНаСервере(Перезаполнить = Ложь) 
	...
	СписокКодовОбластей.Добавить("s_100_00_016_1");
	СписокКодовОбластей.Добавить("s_100_00_016_2");
	СписокКодовОбластей.Добавить("s_100_00_016_3");
	СписокКодовОбластей.Добавить("s_100_00_016_4");
	СписокКодовОбластей.Добавить("s_100_00_016_5");
	СписокКодовОбластей.Добавить("s_100_00_016_6");
	СписокКодовОбластей.Добавить("s_100_00_016_7");
	СписокКодовОбластей.Добавить("s_100_00_016_8");
	СписокКодовОбластей.Добавить("s_100_00_016_9");
	СписокКодовОбластей.Добавить("s_100_00_016_10");
	СписокКодовОбластей.Добавить("s_100_00_016_11");
	СписокКодовОбластей.Добавить("s_100_00_016_12");
	СписокКодовОбластей.Добавить("s_100_00_016_13");
	СписокКодовОбластей.Добавить("s_100_00_016_14");
	СписокКодовОбластей.Добавить("s_100_00_016_15");
	СписокКодовОбластей.Добавить("s_100_00_016_16");
	СписокКодовОбластей.Добавить("s_100_00_016_17");
	СписокКодовОбластей.Добавить("s_100_00_016_18");
	СписокКодовОбластей.Добавить("s_100_00_016_19");
	СписокКодовОбластей.Добавить("s_100_00_016_20");
	СписокКодовОбластей.Добавить("s_100_00_016_21");
	СписокКодовОбластей.Добавить("s_100_00_016_22");
	СписокКодовОбластей.Добавить("s_100_00_016_23");
	СписокКодовОбластей.Добавить("s_100_00_016_24");
	СписокКодовОбластей.Добавить("s_100_00_016_25");
	...
	СписокКодовОбластей.Добавить("s_100_00_037_1");
	СписокКодовОбластей.Добавить("s_100_00_037_2");
	...
	СписокКодовОбластей.Добавить("s_100_00_052_1");
	СписокКодовОбластей.Добавить("s_100_00_052_1a");
	СписокКодовОбластей.Добавить("s_100_00_052_1b");
	СписокКодовОбластей.Добавить("s_100_00_052_2");
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_056", Окр(?(СтавкаКПН <> NULL, СтавкаКПН, 0)), Форма100ПолеТабличногоДокументаСтраница6);
...
Процедура Форма100РасчетНаСервере(ИмяЯчейки, ЗначениеЯчейки, ТекИмяФормы, Изменено = Истина)
	...
	Если Изменено Тогда
		...
		s_100_00_007 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_100_00_007", СтруктураА, Форма100ПолеТабличногоДокументаСтраница2, Ложь);		
	КонецЕсли;

	//Рассчитаем ячейку s_100_00_016, с учетом входящих в нее s_100_00_016_1 - s_100_00_016_25
	СтруктураА = Новый Структура;
			
	СтруктураА.Вставить("s_100_00_016_1");
	СтруктураА.Вставить("s_100_00_016_2");
	СтруктураА.Вставить("s_100_00_016_3");
	СтруктураА.Вставить("s_100_00_016_4");
	СтруктураА.Вставить("s_100_00_016_5");
	СтруктураА.Вставить("s_100_00_016_6");
	СтруктураА.Вставить("s_100_00_016_7");
	СтруктураА.Вставить("s_100_00_016_8");
	СтруктураА.Вставить("s_100_00_016_9");
	СтруктураА.Вставить("s_100_00_016_10");
	СтруктураА.Вставить("s_100_00_016_11");
	СтруктураА.Вставить("s_100_00_016_12");
	СтруктураА.Вставить("s_100_00_016_13");
	СтруктураА.Вставить("s_100_00_016_14");
	СтруктураА.Вставить("s_100_00_016_15");
	СтруктураА.Вставить("s_100_00_016_16");
	СтруктураА.Вставить("s_100_00_016_17");
	СтруктураА.Вставить("s_100_00_016_18");
	СтруктураА.Вставить("s_100_00_016_19");
	СтруктураА.Вставить("s_100_00_016_20");
	СтруктураА.Вставить("s_100_00_016_21");
	СтруктураА.Вставить("s_100_00_016_22");
	СтруктураА.Вставить("s_100_00_016_23");
	СтруктураА.Вставить("s_100_00_016_24");
	СтруктураА.Вставить("s_100_00_016_25");
	...
	// В ячейке "Строка016_0" содержится итоговое значение строки 100.00.016 за вычетом подстроки 100.00.016.XXIII
	// для учета в строке 100.00.014
	ЯчейкаСтрока016_0 = s_100_00_016 - РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_016_23");
	...
	// В ячейке "Строка016_23" содержится значение подстроки 100.00.016.XXIII
	// для учета в строке 100.00.013
	ЯчейкаСтрока016_23 = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_016_23");
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_018", СГДСУчетомКорректировок, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница3, Неопределено));
	...
	КонецЦикла;
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_019_3", ИтогЗначение, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница4, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_019", ИтогЗначение, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница4, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_026", ИтогЗначение, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница4, Неопределено));
	...
	Если Изменено Тогда
		...
		s_100_00_028 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_100_00_028", СтруктураА, Форма100ПолеТабличногоДокументаСтраница5, Ложь);		
	КонецЕсли;

	//Рассчитаем ячейку s_100_00_037, с учетом входящей в нее s_100_00_037_1 и s_100_00_037_2
	
	Если Изменено Тогда
		СтруктураА = Новый Структура;
		СтруктураА.Вставить("s_100_00_037_1");
		СтруктураА.Вставить("s_100_00_037_2");
	
		s_100_00_037 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_100_00_037", СтруктураА, Форма100ПолеТабличногоДокументаСтраница5, Ложь);		
	КонецЕсли;
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_040_1", Вычеты, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_040", ВсегоВычетов, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_041", КорректировкаДоходовВычетов, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_044", НОД, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	...
	Если Изменено Тогда
		...
		s_100_00_046 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_100_00_046", СтруктураА, Форма100ПолеТабличногоДокументаСтраница6, Истина);		
	КонецЕсли;
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_047", НОДСУчетомИностранногоДохода, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));

	// Рассчитаем строку 100.00.049 Итого налогооблагаемого дохода/убытка (100.00.047 + 100.00.048)
	ИтогоНОД = НОДСУчетомИностранногоДохода 
		+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_048");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_049", ИтогоНОД, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	
	// Рассчитаем строку 100.00.051. Убыток, подлежащий переносу (100.00.049 + 100.00.050 + 100.02.008_1). строку 049 и 050 учитываем, только если они отрицательная

	Убыток = ?(ИтогоНОД < 0, -ИтогоНОД, 0) 
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_051", Убыток, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	
	// Рассчитаем строку 100.00.052_I. 	
	
	Если Изменено Тогда
		СтруктураА = Новый Структура;
		СтруктураА.Вставить("s_100_00_052_1a");
		СтруктураА.Вставить("s_100_00_052_1b");
		s_100_00_052_1 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_100_00_052_1", СтруктураА, Форма100ПолеТабличногоДокументаСтраница6, Ложь);		
	КонецЕсли;
	
	// Рассчитаем строку 100.00.052. Уменьшение НОД по п. 1, 2 и 4 ст. 288
	Если Изменено Тогда
		СтруктураА = Новый Структура;
		СтруктураА.Вставить("s_100_00_052_1");
		СтруктураА.Вставить("s_100_00_052_2");
		s_100_00_052 = АвтоматическийРасчетПоСтрокам(ТекИмяФормы, ТаблицаДанных, "s_100_00_052", СтруктураА, Форма100ПолеТабличногоДокументаСтраница6, Истина);		
	КонецЕсли;
	
	// Рассчитаем строку 100.00.053. НОД  с учетом уменьшения: s_100_00_049 - s_100_00_052 
	// В случае если строка 100.00.052 больше строки 100.00.049, в строке 100.00.053 указывается ноль
	НОДсУчетомУменьшения = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_049")
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_053", НОДсУчетомУменьшения, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_055", НОДсУчетомУбытков, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница6, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_057", КПН, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница7, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_058", ИсчисленныйКПН, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница7, Неопределено));
	...
	ИсчисленныйКПНСУчетомУменьшения = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_058")
		- РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_059_1");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_059", ИсчисленныйКПНСУчетомУменьшения, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница7, Неопределено));
	...
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_060", ЧистыйДоход, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница7, Неопределено));
	...
	// Определяется как 100.00.059 + 100.00.061 I + 100.00.061 II.

	ИтоговыйКПН = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_059")
		+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_061_1")
		+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_100_00_061_2_2");
	
	РегламентированнаяОтчетность.ПередатьЗначениеВТаблицуДанных(ТаблицаДанных, "s_100_00_062", ИтоговыйКПН, ?(Изменено, Форма100ПолеТабличногоДокументаСтраница7, Неопределено));
...
Функция Форма100ПолучитьСписокКодовДоходов()
	...
	СписокДохКодовСтрок.Добавить("100.00.016.I");
	СписокДохКодовСтрок.Добавить("100.00.016.II");
	СписокДохКодовСтрок.Добавить("100.00.016.III");
	СписокДохКодовСтрок.Добавить("100.00.016.IV");
	СписокДохКодовСтрок.Добавить("100.00.016.V");
	СписокДохКодовСтрок.Добавить("100.00.016.VI");
	СписокДохКодовСтрок.Добавить("100.00.016.VII");
	СписокДохКодовСтрок.Добавить("100.00.016.VIII");
	СписокДохКодовСтрок.Добавить("100.00.016.IX");
	СписокДохКодовСтрок.Добавить("100.00.016.X");
	СписокДохКодовСтрок.Добавить("100.00.016.XI");
	СписокДохКодовСтрок.Добавить("100.00.016.XII");
	СписокДохКодовСтрок.Добавить("100.00.016.XIII");
	СписокДохКодовСтрок.Добавить("100.00.016.XIV");
	СписокДохКодовСтрок.Добавить("100.00.016.XV");
	СписокДохКодовСтрок.Добавить("100.00.016.XVI");
	СписокДохКодовСтрок.Добавить("100.00.016.XVII");
	СписокДохКодовСтрок.Добавить("100.00.016.XVIII");
	СписокДохКодовСтрок.Добавить("100.00.016.XIX");
	СписокДохКодовСтрок.Добавить("100.00.016.XX");
	СписокДохКодовСтрок.Добавить("100.00.016.XXI");
	СписокДохКодовСтрок.Добавить("100.00.016.XXII");
	СписокДохКодовСтрок.Добавить("100.00.016.XXIII");
	СписокДохКодовСтрок.Добавить("100.00.016.XXIV");
	СписокДохКодовСтрок.Добавить("100.00.016.XXV");
	...
	СписокДохКодовСтрок.Добавить("100.00.052.I"); 
	СписокДохКодовСтрок.Добавить("100.00.052.IA");
	СписокДохКодовСтрок.Добавить("100.00.052.IB");
	СписокДохКодовСтрок.Добавить("100.00.052.II"); 	
...
Функция Форма100ПолучитьСписокКодовРасходов()
	...
	СписокРасКодовСтрок.Добавить("100.00.052.I"); 
	СписокРасКодовСтрок.Добавить("100.00.052.IA");
	СписокРасКодовСтрок.Добавить("100.00.052.IB");
	СписокРасКодовСтрок.Добавить("100.00.052.II"); 	
...
Функция Форма100ПолучитьСписокКодовСтрокБезРасшифровки()
	...
	СписокКодовДляИсключения.Добавить("s_100_00_052_1");
	СписокКодовДляИсключения.Добавить("s_100_00_052_1a");
	СписокКодовДляИсключения.Добавить("s_100_00_052_1b");
	СписокКодовДляИсключения.Добавить("s_100_00_052_2"); 	
	...
	СписокКодовДляИсключения.Добавить("s_100_00_059_1"); 
...
Функция Форма100ПолучитьСписокКодовСтрокВключаемыхВРасшифровку(ИмяЯчейки)
	...
	ИначеЕсли ИмяЯчейки = "100.00.016" Тогда
		...
		КодыСтрокРасшифровки.Добавить("100.00.016.I");
		КодыСтрокРасшифровки.Добавить("100.00.016.II");
		КодыСтрокРасшифровки.Добавить("100.00.016.III");
		КодыСтрокРасшифровки.Добавить("100.00.016.IV");
		КодыСтрокРасшифровки.Добавить("100.00.016.V");
		КодыСтрокРасшифровки.Добавить("100.00.016.VI");
		КодыСтрокРасшифровки.Добавить("100.00.016.VII");
		КодыСтрокРасшифровки.Добавить("100.00.016.VIII");
		КодыСтрокРасшифровки.Добавить("100.00.016.IX");
		КодыСтрокРасшифровки.Добавить("100.00.016.X");
		КодыСтрокРасшифровки.Добавить("100.00.016.XI");
		КодыСтрокРасшифровки.Добавить("100.00.016.XII");
		КодыСтрокРасшифровки.Добавить("100.00.016.XIII");
		КодыСтрокРасшифровки.Добавить("100.00.016.XIV");
		КодыСтрокРасшифровки.Добавить("100.00.016.XV");
		КодыСтрокРасшифровки.Добавить("100.00.016.XVI");
		КодыСтрокРасшифровки.Добавить("100.00.016.XVII");
		КодыСтрокРасшифровки.Добавить("100.00.016.XVIII");
		КодыСтрокРасшифровки.Добавить("100.00.016.XIX");
		КодыСтрокРасшифровки.Добавить("100.00.016.XX");
		КодыСтрокРасшифровки.Добавить("100.00.016.XXI");
		КодыСтрокРасшифровки.Добавить("100.00.016.XXII");
		КодыСтрокРасшифровки.Добавить("100.00.016.XXIII");
		КодыСтрокРасшифровки.Добавить("100.00.016.XXIV");
		КодыСтрокРасшифровки.Добавить("100.00.016.XXV");
		
	ИначеЕсли ИмяЯчейки = "100.00.052" Тогда 
		КодыСтрокРасшифровки.Добавить("100.00.052.I");
		КодыСтрокРасшифровки.Добавить("100.00.052.II");
		
	ИначеЕсли ИмяЯчейки = "100.00.013" Тогда
		КодыСтрокРасшифровки.Добавить("100.00.013");
		КодыСтрокРасшифровки.Добавить("100.00.016.XXIII");
		
	ИначеЕсли ИмяЯчейки = "100.00.014" ИЛИ ИмяЯчейки = "100.00.035" Тогда
...
Функция ПолучитьАдресМакетаСКД(Знач ИмяРаздела, ТекстЗапроса = "", СписокСчетов = Неопределено, СписокКодовСтрок = Неопределено)
	...
	Если КодФормы = "Форма100" Тогда 
		ОбщаяСКД = РеквизитФормыВЗначение("ОтчетОбъект").ПолучитьМакет("МакетСКДФорма1002019Кв4");
...
Процедура Форма100РасшифровкаСКД(ИмяЯчейки, МетодРасшифровки)                          	
	...
	Если Лев(ИмяЯчейки,10) = "100.00.014" ИЛИ Лев(ИмяЯчейки,10) = "100.00.035" Тогда
