...
Процедура ИзменитьПериод(Шаг)
	...
	Если ПолеВыбораПериодичность = ПредопределенноеЗначение("Перечисление.Периодичность.Год") Тогда  // ежеквартально
...
Процедура ОткрытьВыбраннуюФорму(ОбновитьПараметрыОткрытойФормы = Ложь)
	...
	ПараметрыФормы.Вставить("мДатаКонцаПериодаОтчета",  КонецДня(мДатаКонцаПериодаОтчета));
	...
	ПараметрыФормы.Вставить("мДатаКонцаСравнительногоПериодаОтчета", КонецДня(мДатаКонцаСравнительногоПериодаОтчета));
