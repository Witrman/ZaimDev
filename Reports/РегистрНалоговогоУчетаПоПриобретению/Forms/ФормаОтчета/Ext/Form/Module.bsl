...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = ?(Отчет.ВидОтчета = "НалоговыйРегистр", НСтр("ru = 'Регистр налогового учета по приобретению'"),
	НСтр("ru = 'Отчет по приобретенным товарам'"));
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Режим = "Группировка" Тогда
		СписокПолей.Добавить("СуммаДокументаВсего");
		СписокПолей.Добавить("СуммаНДСДокумента");
