...
&НаКлиенте
Процедура ПоказательПервоначальнаяСтоимостьПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательСтоимостьДляВычисленияАмортизацииПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательСтоимостьНачальныйОстатокПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательАмортизацияНачальныйОстатокПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательСтоимостьОборотДтПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательАмортизацияОборотПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательСтоимостьОборотКтПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательСтоимостьНаКонецПериодаПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательАмортизацияКонечныйОстатокПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательОстаточнаяСтоимостьПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказательОстаточнаяСтоимостьНачПриИзменении(Элемент)
...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""ведомость амортизации нма за период (бух.)"" (формирование)");
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	Если ЗаполняемыеНастройки.Свойство("Показатели") И ЗаполняемыеНастройки.Показатели Тогда
		...
		Отчет.ПоказательПервоначальнаяСтоимость           = Истина;
		Отчет.ПоказательСтоимостьДляВычисленияАмортизации = Истина;
		Отчет.ПоказательСтоимостьНачальныйОстаток         = Истина;
		Отчет.ПоказательАмортизацияНачальныйОстаток       = Истина;
		Отчет.ПоказательСтоимостьОборотДт                 = Истина;
		Отчет.ПоказательАмортизацияОборот                 = Истина;
		Отчет.ПоказательСтоимостьОборотКт                 = Истина;
		Отчет.ПоказательСтоимостьНаКонецПериода           = Истина;
		Отчет.ПоказательАмортизацияКонечныйОстаток        = Истина;
		Отчет.ПоказательОстаточнаяСтоимость               = Истина;
		Отчет.ПоказательОстаточнаяСтоимостьНач            = Истина;
...
Функция ПодготовитьПараметрыОтчета()
	...
	ПараметрыОтчета.Вставить("ПоказательПервоначальнаяСтоимость"          , Отчет.ПоказательПервоначальнаяСтоимость);
	ПараметрыОтчета.Вставить("ПоказательСтоимостьДляВычисленияАмортизации", Отчет.ПоказательСтоимостьДляВычисленияАмортизации);
	ПараметрыОтчета.Вставить("ПоказательСтоимостьНачальныйОстаток"        , Отчет.ПоказательСтоимостьНачальныйОстаток);
	ПараметрыОтчета.Вставить("ПоказательАмортизацияНачальныйОстаток"      , Отчет.ПоказательАмортизацияНачальныйОстаток);
	ПараметрыОтчета.Вставить("ПоказательСтоимостьОборотДт"                , Отчет.ПоказательСтоимостьОборотДт);
	ПараметрыОтчета.Вставить("ПоказательАмортизацияОборот"                , Отчет.ПоказательАмортизацияОборот);
	ПараметрыОтчета.Вставить("ПоказательСтоимостьОборотКт"                , Отчет.ПоказательСтоимостьОборотКт);
	ПараметрыОтчета.Вставить("ПоказательСтоимостьНаКонецПериода"          , Отчет.ПоказательСтоимостьНаКонецПериода);
	ПараметрыОтчета.Вставить("ПоказательАмортизацияКонечныйОстаток"       , Отчет.ПоказательАмортизацияКонечныйОстаток);
	ПараметрыОтчета.Вставить("ПоказательОстаточнаяСтоимость"              , Отчет.ПоказательОстаточнаяСтоимость);
	ПараметрыОтчета.Вставить("ПоказательОстаточнаяСтоимостьНач"           , Отчет.ПоказательОстаточнаяСтоимостьнач);
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Режим = "Выбор" ИЛИ Режим = "Группировка" ИЛИ Режим = "Отбор" Тогда
		...
		СписокПолей.Добавить("ПоказательБУ");
