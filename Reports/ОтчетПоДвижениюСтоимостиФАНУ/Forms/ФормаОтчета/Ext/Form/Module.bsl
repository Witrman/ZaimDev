...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""отчет по движению стоимости фа(ну)"" (формирование)"); 
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Режим = "Группировка" Тогда
		...
		СписокПолей.Добавить("ИтоговаяСтоимостьГруппыНУ");
	КонецЕсли;
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.ОтчетПоДвижениюСтоимостиФАНУ.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
