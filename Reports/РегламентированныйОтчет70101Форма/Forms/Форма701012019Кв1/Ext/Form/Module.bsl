...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма701012019Кв1";
	КодФормы 		= "Форма70101";
...
Функция ПолучитьАдресМакетаСКД(знач ИмяРаздела)
	ОбщаяСКД = РеквизитФормыВЗначение("ОтчетОбъект").ПолучитьМакет("МакетСКДФорма70101019Кв1");
...
Процедура Форма70101РасшифровкаИмуществоДополнительныйСКД(ПользовательскиеНастройки)
	...
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(ПользовательскиеПоля, "БалансоваяСтоимостьВыбывших", "Балансовая стоимость выбывших");
