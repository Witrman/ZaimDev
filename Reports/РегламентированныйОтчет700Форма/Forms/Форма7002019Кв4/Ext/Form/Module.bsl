...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма7002019Кв4";
	КодФормы 		= "Форма700";
...
Функция СформироватьСтуктуруСтавокНалогаНаТранспортНаСервере() Экспорт
	...
	Область = МакетСтавок.Области["Строка2019"];
...
Функция ПолучитьАдресМакетаСКД(знач ИмяРаздела)
	...
	ОбщаяСКД = РеквизитФормыВЗначение("ОтчетОбъект").ПолучитьМакет("МакетСКДФорма7002019Кв4");
...
Процедура Форма700_01СформироватьРасшифровку()
	...
	ОткрытьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "Форма7002019Кв4", "ФормаРасшифровки"), ПараметрыФормы);
