...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "ФормаОтчета2018Кв3";
...
Функция НачатьЗамерВремени()
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("СтандартныеПодсистемы.ОценкаПроизводительности") Тогда
		...
		КлючеваяОперация = "Регламентированный отчет ""справка о суммах дохода и осуществленных пенсионных взносов"" (заполнение)";
...
Процедура ВывестиВДокумент(СписокСохранения)
	...
	Макет = Отчет.ПолучитьМакет("МакетФормаОтчета2018Кв3");
...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если СтруктураРеквизитовФормы.мСохраненныйДок = Неопределено Тогда
		...
		Иначе // новый документ
			...
			ОтчетОбъект.ПоказыватьЗаголовок = "Приложение4";
		КонецЕсли;
...
Процедура СохранитьДанныеНаСервере()
	...
	СписокСохранения.Вставить("ВерсияФормы", "01/07/2018");
	...
	КлючеваяОперация = "Документ ""регламентированный отчет справка о суммах дохода и осуществленных пенсионных взносов"" (запись)'";
