...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	ТекущийНаборПоказателей = "" + ПараметрыОтчета.ПоказательБУ + ПараметрыОтчета.ПоказательКоличество + ПараметрыОтчета.ПоказательНУ + ПараметрыОтчета.ПоказательКоличествоНУ + ПараметрыОтчета.ПоказательПР + ПараметрыОтчета.ПоказательКоличествоПР + ПараметрыОтчета.ПоказательВР;
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Если МакетПроводки.Количество() = 1 Тогда
		...
		ПараметрыОтчета.Вставить("МакетПроводок", МакетПроводки.Имя);
	КонецЕсли;
...
Процедура ПередВыводомЭлементаРезультата(ПараметрыОтчета, МакетКомпоновки, ДанныеРасшифровки, ЭлементРезультата, Отказ = Ложь) Экспорт
	...
	Если ЭлементРезультата.Макет = ПараметрыОтчета.МакетПроводок Тогда 
