...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма3002015Кв1";
	КодФормы 		= "Форма300";
...
Процедура ВыгрузитьВXML(Команда)
	...
	Если 2015 < ГодФормирования Тогда 
...
Процедура Форма300РасчетНаСервере(знач ИмяЯчейки, знач ЗначениеЯчейки)
	...
	АвтоматическийРасчетПоСтрокам(ТаблицаДанных, "s_300_00_016_a", Новый Структура("s_300_00_016_1_a, s_300_00_016_2_a, s_300_00_016_3_a"),Ложь, Форма300ПолеТабличногоДокументаСтраница2);
	АвтоматическийРасчетПоСтрокам(ТаблицаДанных, "s_300_00_016_b", Новый Структура("s_300_00_016_1_b, s_300_00_016_2_b, s_300_00_016_3_b"),Ложь, Форма300ПолеТабличногоДокументаСтраница2);
...
Процедура Форма300ЗаполнитьАвтоНаСервере(Перезаполнить = Ложь) 
	...
	Для Каждого Строка Из ТаблицаРезультата Цикл
		...
		ИначеЕсли ОбластьНачало = "s_300_00_016_i" ИЛИ ОбластьНачало = "s_300_00_016_ii" ИЛИ ОбластьНачало = "s_300_00_016_iii" Тогда			
	...
	Знач300_00_016А = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_300_00_016_a")
					...
					+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_300_00_016_3_a");
	...
	Знач300_00_016B = РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_300_00_016_b")
					...
					+ РегламентированнаяОтчетность.ЗначениеТаблицыДанныхОбычнойФормы(ТаблицаДанных, "s_300_00_016_3_b");
...
Процедура Форма300_01РасчетНаСервере(знач ИмяЯчейки, знач ЗначениеЯчейки)	
	...
	Если мСтруктураЗначений <> Неопределено
		...
		И мСтруктураЗначений.Свойство("s_300_01_001_4") Тогда
		...
		s_300_01_001 = s_300_01_001 - s_300_01_001_1_до + s_300_01_001_1 - s_300_01_001_2_до + s_300_01_001_2 - s_300_01_001_3_до + s_300_01_001_3 - s_300_01_001_4_до + s_300_01_001_4;			
		
	Иначе
		s_300_01_001 = s_300_01_001 + s_300_01_001_1 + s_300_01_001_2 + s_300_01_001_3 + s_300_01_001_4;
	КонецЕсли;
	...
	Если s_300_01_001 < s_300_01_001_1 + s_300_01_001_2 + s_300_01_001_3 + s_300_01_001_4 Тогда
...
Функция ПолучитьАдресМакетаСКД(знач ИмяРаздела)
	ОбщаяСКД = РеквизитФормыВЗначение("ОтчетОбъект").ПолучитьМакет("МакетСКДФорма3002015Кв1");
...
Функция ПолучитьПараметрыВыгрузкиВExcel(ИмяФормы)
	...
	Если ИмяФормы = "Форма300_03" Тогда
		ПараметрыВыгрузки.ИмяФайлаШаблона = "SONO_300_03_2015.xls";
	...
	ИначеЕсли ИмяФормы = "Форма300_07" Тогда
		ПараметрыВыгрузки.ИмяФайлаШаблона = "SONO_300_07_2015.xls";
	...
	ИначеЕсли ИмяФормы = "Форма300_08" Тогда
		ПараметрыВыгрузки.ИмяФайлаШаблона = "SONO_300_08_2015.xls";
	...
	ИначеЕсли Найти(ИмяФормы, "Форма300_09")>0 Тогда
		ПараметрыВыгрузки.ИмяФайлаШаблона = "SONO_300_09_2015.xls";
