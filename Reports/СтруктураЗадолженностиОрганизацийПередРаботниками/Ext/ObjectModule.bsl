...
Процедура ПередЗагрузкойНастроекВКомпоновщик(Контекст, КлючСхемы, КлючВарианта, НовыеНастройкиКД, НовыеПользовательскиеНастройкиКД) Экспорт
	...
	Если НовыеНастройкиКД <> Неопределено Тогда
		ПолеЗадепонировано = Новый ПолеКомпоновкиДанных("Задепонировано"); 
		ЭлементыДляОбработки = Новый Массив;
		Для Каждого ВыбранныйЭлемент Из НовыеНастройкиКД.Выбор.Элементы Цикл
			Если ВыбранныйЭлемент.Поле = ПолеЗадепонировано Тогда
				ЭлементыДляОбработки.Добавить(ВыбранныйЭлемент);
			КонецЕсли;
		КонецЦикла;
		Если ПолучитьФункциональнуюОпцию("ИспользоватьДепонированиеЗаработнойПлаты") Тогда
			Если ЭлементыДляОбработки.Количество() = 0 Тогда
				ДобавляемыйЭлемент               = НовыеНастройкиКД.Выбор.Элементы.Вставить(3, Тип("ВыбранноеПолеКомпоновкиДанных"));
				ДобавляемыйЭлемент.Поле          = ПолеЗадепонировано;
				ДобавляемыйЭлемент.Использование = Истина;
			КонецЕсли;
		Иначе
			Для Каждого УдаляемыйЭлемент Из ЭлементыДляОбработки Цикл
				НовыеНастройкиКД.Выбор.Элементы.Удалить(УдаляемыйЭлемент);
			КонецЦикла;
		КонецЕсли;
	КонецЕсли;
