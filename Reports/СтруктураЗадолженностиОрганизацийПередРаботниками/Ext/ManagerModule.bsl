...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	Для Каждого СтрокаПоказатели Из ДанныеОтчета.Объект.Показатели Цикл
		Если СтрокаПоказатели.Использование 
			И (СтрокаПоказатели.Поле = "СальдоНачальное" 
				ИЛИ СтрокаПоказатели.Поле = "Начислено"
				ИЛИ СтрокаПоказатели.Поле = "Выплачено"
				ИЛИ СтрокаПоказатели.Поле = "Задепонировано"
	...
	СписокПунктовМеню.Добавить("СтруктураЗадолженностиОрганизацийПередРаботниками", "СтруктураЗадолженностиОрганизацийПередРаботниками");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("СтруктураЗадолженностиОрганизацийПередРаботниками", ПользовательскиеНастройки);
