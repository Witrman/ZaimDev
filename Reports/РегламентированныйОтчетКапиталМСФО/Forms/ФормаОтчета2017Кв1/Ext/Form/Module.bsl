...
Процедура ЗаполнитьАвтоНаСервере()
	...
	Пока Выборка.Следующий() Цикл
		...
		ИначеЕсли  ЕстьЭлементПеречисленияВМетаданных("ПереводАмортизацииОтПереоценкиОсновныхСредств")
			И Субконто = Перечисления.ВидыИзмененийВСобственномКапитале.ПереводАмортизацииОтПереоценкиОсновныхСредств Тогда
