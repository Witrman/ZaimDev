...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""просроченная задолженность поставщикам"" (формирование)"); 
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.ПросроченнаяЗадолженностьПоставщикам.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
