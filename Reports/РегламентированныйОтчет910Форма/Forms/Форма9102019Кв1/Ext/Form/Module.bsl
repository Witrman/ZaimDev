...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма9102019Кв1";
	КодФормы 		= "Форма910";
...
Процедура Форма910Расшифровка(НомерЯчейки, МесяцЯчейки)
	...
	Если СтруктураРеквизитовФормы.ЕстьРегистрБУ И НомерЯчейки = 1 Тогда
		ПоказатьРасшифроку910АнализСубконто();
	Иначе	
...
Процедура Форма910Расчет(Изменено = Ложь, ИмяОбласти = Неопределено)
		...
		Если НЕ СтруктураРеквизитовФормы.мЕжемесячныйРасчетВзносовИОтчисленийЗаИП Тогда
			...
			КонецЕсли;	
				...
				Если s_910_00_010_1 > 0 Тогда
					s_910_00_011_1 = Окр(Мин(s_910_00_010_1, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_010_2 > 0 Тогда
					s_910_00_011_2 = Окр(Мин(s_910_00_010_2, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_010_3 > 0 Тогда
					s_910_00_011_3 = Окр(Мин(s_910_00_010_3, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_010_4 > 0 Тогда
					s_910_00_011_4 = Окр(Мин(s_910_00_010_4, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_010_5 > 0 Тогда
					s_910_00_011_5 = Окр(Мин(s_910_00_010_5, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_010_6 > 0 Тогда
					s_910_00_011_6 = Окр(Мин(s_910_00_010_6, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
	...
	Если СтруктураРеквизитовФормы.мНалогоплательщикЯвляетсяИП И Дата(2019,12,31)< НачалоДня(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета) Тогда
		// В 2019 году ежемесячная сумма взносов ИП составляет 2 446 тенге (24 459 * 2 * 0,05)
...
&НаКлиенте
Процедура ПоказатьРасшифроку910АнализСубконто()	
