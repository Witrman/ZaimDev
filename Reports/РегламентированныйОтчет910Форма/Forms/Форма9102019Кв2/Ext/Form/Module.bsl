...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма9102019Кв2";
	КодФормы 		= "Форма910";
...
Процедура ВосстановитьСохраненныеДанные()	
	...
	Если НЕ СтруктураРеквизитовФормы.Свойство("мСтавкаВОСМС") Тогда
		СтруктураРеквизитовФормы.Вставить("мСтавкаВОСМС", ПроцедурыНалоговогоУчета.ПолучитьСтавкуОСМС(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, "Взносы", Перечисления.ЮрФизЛицо.ЮрЛицо,  ОтчетОбъект.Налогоплательщик));
	КонецЕсли; 
		...
		Если НЕ СтруктураРеквизитовФормы.мЕжемесячныйРасчетВзносовИОтчисленийЗаИП Тогда
			...
			КонецЕсли;	
				...
				Если s_910_00_012_1 > 0 Тогда
					s_910_00_013_1 = Окр(Мин(s_910_00_012_1, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_012_2 > 0 Тогда
					s_910_00_013_2 = Окр(Мин(s_910_00_012_2, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_012_3 > 0 Тогда
					s_910_00_013_3 = Окр(Мин(s_910_00_012_3, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_012_4 > 0 Тогда
					s_910_00_013_4 = Окр(Мин(s_910_00_012_4, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_012_5 > 0 Тогда
					s_910_00_013_5 = Окр(Мин(s_910_00_012_5, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
				
				Если s_910_00_012_6 > 0 Тогда
					s_910_00_013_6 = Окр(Мин(s_910_00_012_6, 7 * СтруктураРеквизитовФормы.мРазмерМЗП) * СтруктураРеквизитовФормы.мСтавкаСО / 100);
				КонецЕсли;
		...
		Если НЕ СтруктураРеквизитовФормы.мЕжемесячныйРасчетВзносовИОтчисленийЗаИП Тогда
			Если ИмяОбласти = "s_910_00_001" Или ИмяОбласти = Неопределено Тогда
				...
				Если СтруктураРеквизитовФормы.мМесяцЗаполнения = 1 Тогда
					...
					s_910_00_014_6 = Макс(ДоходЗаМесяц, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
...
Процедура ИнициализироватьВспомогательныеПеременные(ОтчетОбъект, СтруктураРеквизитовФормы) Экспорт
	...
	Если НЕ СтруктураРеквизитовФормы.Свойство("мСтавкаВОСМС") Тогда
		СтруктураРеквизитовФормы.Вставить("мСтавкаВОСМС", ПроцедурыНалоговогоУчета.ПолучитьСтавкуОСМС(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, "Взносы", Перечисления.ЮрФизЛицо.ЮрЛицо, ОтчетОбъект.Налогоплательщик));
	Иначе
		СтруктураРеквизитовФормы.мСтавкаВОСМС = ПроцедурыНалоговогоУчета.ПолучитьСтавкуОСМС(СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета, "Взносы", Перечисления.ЮрФизЛицо.ЮрЛицо, ОтчетОбъект.Налогоплательщик);
	КонецЕсли;
