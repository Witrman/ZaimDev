...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма9102017Кв2";
	КодФормы 		= "Форма910";
...
Процедура ВыгрузитьВXML(Команда)
	...
	Если Дата(2017,12,31)< НачалоДня(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
...
Функция Форма910РассчитатьДанныеФормы(ВыдаватьСообщения = Ложь) 
	...
	/////////////////////////////////////////////////////////
	// Раздел. Исчисление отчислений на обязательное социальное медицинское страхование
	
	// Доходы, облагаемые ООСМС
	Если ОтразитьВзносыОСМСПоДоговорамГПХ Тогда
		ВносыОСМСПоДоговорамГПХ = "Объединить Все 
		|	ВЫБРАТЬ
		|	Периоды.НачалоМесяца,
		|	СУММА(ВЫБОР
...
Процедура Форма910Расчет(Изменено = Ложь, ИмяОбласти = Неопределено)
	...
	Если СтруктураРеквизитовФормы.мНалогоплательщикЯвляетсяИП Тогда
		...
		s_910_00_012_1 = Макс(s_910_00_012_1, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
		...
		s_910_00_012_2 = Макс(s_910_00_012_2, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
		...
		s_910_00_012_3 = Макс(s_910_00_012_3, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
		...
		s_910_00_012_4 = Макс(s_910_00_012_4, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
		...
		s_910_00_012_5 = Макс(s_910_00_012_5, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
		...
		s_910_00_012_6 = Макс(s_910_00_012_6, СтруктураРеквизитовФормы.мРазмерМЗПДляЦелейНалогообложения);
	...
	Если СтруктураРеквизитовФормы.мНалогоплательщикЯвляетсяИП Тогда
		// В 2017 году ежемесячная сумма взносов ИП составляет 2 446 тенге (24 459 * 2 * 0,05)
