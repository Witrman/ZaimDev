...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма9102017Кв1";
	КодФормы 		= "Форма910";
...
Процедура ВыгрузитьВXML(Команда)
	...
	Если Дата(2017,06,30)< НачалоДня(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) Тогда 
...
Процедура Форма910Расчет(Изменено = Ложь, ИмяОбласти = Неопределено)
	...
	s_910_00_009 = Окр(Макс(s_910_00_007 * 0.5 - Окр(s_910_00_011) - Окр(s_910_00_021), 0));
