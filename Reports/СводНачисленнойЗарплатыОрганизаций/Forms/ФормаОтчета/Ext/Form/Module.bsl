...
&НаКлиенте
Процедура СводныеДанныеПоОрганизациямПриИзменении(Элемент)
...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""свод начислений и удержаний"" (формирование)");
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Свод начислений и удержаний организаций %1'");
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	Если ИБФайловая Тогда
		...
		Отчеты.СводНачисленнойЗарплатыОрганизаций.СформироватьОтчет(ПараметрыОтчета, АдресХранилища);
		РезультатВыполнения = Новый Структура("ЗаданиеВыполнено", Истина);
	Иначе
		РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
			УникальныйИдентификатор,
			"Отчеты.СводНачисленнойЗарплатыОрганизаций.СформироватьОтчет",
			ПараметрыОтчета,
...
Функция ПодготовитьПараметрыОтчета()
	...
	ПараметрыОтчета.Вставить("СводныеДанныеПоОрганизациям" , Отчет.СводныеДанныеПоОрганизациям);
