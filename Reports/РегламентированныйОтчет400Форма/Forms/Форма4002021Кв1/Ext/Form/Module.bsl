...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма4002021Кв1";
	КодФормы 		= "Форма400"; 		
	...
	мВыбраннаяФорма = "Форма4002021Кв1"; // могла восстановиться из данных сохраненной ранее формы
...
Процедура Форма400_03ЗаполнитьАвтоНаСервере(Перезаполнить = Ложь)
	...
	Пока ВыборкаПоВидамТМЗ.Следующий() Цикл
		Для Каждого ЭлементСтруктуры Из СтруктураФормы Цикл
			...
			ТаблицаСтрокГруппы = ЭлементСтруктуры.Значение.Строки;
			ОбщиеЭлементыГруппы = ЭлементСтруктуры.Значение.ШапкаИПодвал;                    				
			ОбластьФ400_03_016 = ОбщиеЭлементыГруппы.Найти("Ф400_03_016", "ИмяОбласти");
			...
			Если ИмяГруппы = "ЛистA" Тогда
				...
				Элемент.Ф400_03_016 = Окр(ИтоговаяСуммаАкциза);
	...
	//заполняем данные для передачи итогов в "Шапку и подвал"
	Если Не ОбластьФ400_03_016 = Неопределено Тогда
		ОбластьФ400_03_016.Значение = ТаблицаСтрокГруппы.Итог("Ф400_03_016");			
	КонецЕсли; 
...
Процедура Форма400_03РасчетНаСервере(Инд, Колонка, ТекИмяФормы)
	...
	//рассчитаем ячейку 400.03.011 I и II
	...
	Знач011_a_2 	= ?(ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_011_a_2 = Неопределено, 0, ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_011_a_2);
	Знач011_b_2	= ?(ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_011_b_2 = Неопределено, 0, ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_011_b_2);
	Знач011_c_2	= Окр(Знач011_a_2 * Знач011_b_2);
	
	ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_011_2 = Знач011_c_2;
	Форма400_03ПолеТабличногоДокументаЛистA.Области["Ф400_03_011_2__"+ Строка(Инд)].Значение = Знач011_c_2;
	...
	//рассчитаем ячейку 400.04.016
	Знач014 = ?(ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_014 = Неопределено, 0, ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_014);
	Знач015 = ?(ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_015 = Неопределено, 0, ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_015);
	
	Знач016 = Знач014 - Знач015;
		
	ТаблицаСтрокГруппы.Получить(Индекс).Ф400_03_016 = Знач016;
	Форма400_03ПолеТабличногоДокументаЛистA.Области["Ф400_03_016__"+ Строка(Инд)].Значение = Знач016;	
