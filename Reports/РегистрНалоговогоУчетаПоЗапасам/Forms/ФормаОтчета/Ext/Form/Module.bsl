...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = ?(Отчет.ВидОтчета = "НалоговыйРегистр", НСтр("ru = 'Налоговый регистр по учету запасов %1 %2'"),
	НСтр("ru = 'Отчет по учету запасов %1 %2'"));
...
Функция ПодготовитьПараметрыОтчета()
	...
	ПараметрыОтчета.Вставить("ВидОтчета"             				 , Отчет.ВидОтчета);
	ПараметрыОтчета.Вставить("ВидыСубконто"             			 , ПланыВидовХарактеристик.ВидыСубконтоТиповые.Номенклатура);
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Режим = "Группировка" Тогда
		СписокПолей.Добавить("КоличествоНачальныйОстаток");
		СписокПолей.Добавить("СуммаКонечныйОстаток");
		СписокПолей.Добавить("КоличествоКонечныйОстаток");
		СписокПолей.Добавить("СуммаНачальныйОстаток");
		СписокПолей.Добавить("СуммаИзрасходовано");
		СписокПолей.Добавить("КоличествоИзрасходовано");
		СписокПолей.Добавить("КоличествоРеализовано");
		СписокПолей.Добавить("СуммаРеализовано");
		СписокПолей.Добавить("КоличествоВыбыло");
		СписокПолей.Добавить("СуммаВыбыло");
		СписокПолей.Добавить("КоличествоДт");
		СписокПолей.Добавить("СуммаДт");
