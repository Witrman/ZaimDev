...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""Оборотно-сальдовая ведомость по счету (налоговый)"" (формирование)"); 
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ru = 'Оборотно-сальдовая ведомость по счету (налоговый учет) %1 %2'");
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	ИначеЕсли Режим = "Отбор" Тогда
		Если НЕ Отчет.ПоказательКоличество Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.КоличествоОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.КоличествоОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоКонечныйОстатокКт");
		Иначе	
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНачальныйРазвернутыйОстатокКт");
				СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоКонечныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоКонечныйРазвернутыйОстатокКт");
			...
			КонецЕсли;
		КонецЕсли;
		Если НЕ Отчет.ПоказательКоличествоНУ Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.КоличествоНУОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.КоличествоНУОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНУНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНУНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоНУКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоНУКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНУНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНУНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоНУКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоНУКонечныйОстатокКт");
		Иначе
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНУНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоНУНачальныйРазвернутыйОстатокКт");
			...
			КонецЕсли;
		КонецЕсли;
		Если НЕ Отчет.ПоказательКоличествоПР Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.КоличествоПРОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.КоличествоПРОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоПРНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоПРНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоПРКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоПРКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоПРНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоПРНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоПРКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.КоличествоПРКонечныйОстатокКт");
		Иначе
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоПРНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.КоличествоПРНачальныйРазвернутыйОстатокКт");
		...
		Если НЕ Отчет.ПоказательБУ Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.БУОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.БУОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.БУНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.БУНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.БУКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.БУКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.БУНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.БУНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.БУКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.БУКонечныйОстатокКт");
		Иначе
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.БУНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.БУНачальныйРазвернутыйОстатокКт");
			...
			КонецЕсли;
		КонецЕсли;
		Если НЕ Отчет.ПоказательВР Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.ВРОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.ВРОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ВРНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ВРНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ВРКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ВРКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ВРНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ВРНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ВРКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ВРНачальныйОстатокКт");
		Иначе
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.ВРНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.ВРНачальныйРазвернутыйОстатокКт");
			...
			КонецЕсли;
		КонецЕсли;
		Если НЕ Отчет.ПоказательНУ Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.НУОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.НУОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.НУНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.НУНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.НУКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.НУКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.НУНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.НУНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.НУКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.НУКонечныйОстатокКт");
		Иначе
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.НУНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.НУНачальныйРазвернутыйОстатокКт");
			...
			КонецЕсли;
		КонецЕсли;
		Если НЕ Отчет.ПоказательПР Тогда
			СписокПолей.Добавить("ОборотыЗаПериод.ПРОборотДт");
			СписокПолей.Добавить("ОборотыЗаПериод.ПРОборотКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ПРНачальныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ПРНачальныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ПРКонечныйРазвернутыйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ПРКонечныйРазвернутыйОстатокКт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ПРНачальныйОстатокДт");
			СписокПолей.Добавить("СальдоНаНачалоПериода.ПРНачальныйОстатокКт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ПРКонечныйОстатокДт");
			СписокПолей.Добавить("СальдоНаКонецПериода.ПРКонечныйОстатокКт");
		Иначе
			Если НЕ Отчет.ПоказательРазвернутоеСальдо Тогда
				СписокПолей.Добавить("СальдоНаНачалоПериода.ПРНачальныйРазвернутыйОстатокДт");
				СписокПолей.Добавить("СальдоНаНачалоПериода.ПРНачальныйРазвернутыйОстатокКт");
