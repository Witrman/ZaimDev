...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "Отчет ""расход денежных средств"" (формирование)"); 
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	СписокПолей.Добавить("Приоритет");
	...
	Если Режим = "Выбор" ИЛИ Режим = "Отбор" Тогда
		СписокПолей.Добавить("ВидРасхода");;
	КонецЕсли;
...
Процедура ОткрытьФормуВариантыОтчета()
	...
	ОткрытьФорму("Отчет.РасходДенежныхСредств.ФормаОбъекта", ПараметрыФормы, ВладелецФормы);
