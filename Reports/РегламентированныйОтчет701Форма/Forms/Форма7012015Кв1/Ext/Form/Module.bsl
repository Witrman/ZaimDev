...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма7012015Кв1";
	КодФормы 		= "Форма701";
...
Процедура Форма701ЗаполнитьАвто(Перезаполнить = Ложь)               
	...
	СтруктураСтавокНалога = СформироватьСтуктуруСтавокНалогаНаТранспорт("2015");
...
Процедура Расшифровка(Команда)
	...
	ОткрытьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "Форма7012015Кв1", "ФормаРасшифровки"), ПараметрыФормы);
