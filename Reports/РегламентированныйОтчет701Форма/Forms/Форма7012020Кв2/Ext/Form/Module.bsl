...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма7012020Кв2";
	КодФормы 		= "Форма701";
...
Процедура Форма701ЗаполнитьАвто(Перезаполнить = Ложь)               
	...
	СтруктураСтавокНалога = СформироватьСтуктуруСтавокНалогаНаТранспорт("2020");
...
Процедура Расшифровка(Команда)
	...
	Если ТекущийЭлемент.ТекущаяОбласть.ЦветФона = ЦветРасшифровки Тогда 
		...
		ОткрытьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "Форма7012020Кв2", "ФормаРасшифровки"), ПараметрыФормы);
	Иначе	
