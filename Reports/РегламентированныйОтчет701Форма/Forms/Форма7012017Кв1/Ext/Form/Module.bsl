...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	мВыбраннаяФорма = "Форма7012017Кв1";
	КодФормы 		= "Форма701";
...
Процедура Форма701ЗаполнитьАвто(Перезаполнить = Ложь)               
	...
	СтруктураСтавокНалога = СформироватьСтуктуруСтавокНалогаНаТранспорт("2017");
...
Процедура Расшифровка(Команда)
	...
	ОткрытьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "Форма7012017Кв1", "ФормаРасшифровки"), ПараметрыФормы);
