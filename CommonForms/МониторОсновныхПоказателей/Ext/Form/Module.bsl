...
Функция ПолучитьСтруктуруРасшифровки(Раздел)
	...
	ИначеЕсли Раздел = Перечисления.РазделыМонитораРуководителя.ПросроченнаяЗадолженностьПокупателей Тогда
		...
		Интервал7.Вставить("Представление", "До 7 дней");
		...
		Интервал15.Вставить("Представление", "От 8 До 15 дней");
		...
		Интервал30.Вставить("Представление", "От 16 До 30 дней");
		...
		Интервал60.Вставить("Представление", "От 31 До 60 дней");
		...
		Интервал90.Вставить("Представление", "От 61 До 90 дней");
