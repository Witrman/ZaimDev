...
Процедура ОбновитьЭлементыФормыНастроекНаСервере(ПараметрыОбновления = Неопределено)
	...
	РеквизитыФормыБК = ПолучитьСписокРеквизитовФормыБК();
	Если ПараметрыОбновления <> Неопределено Тогда
		ПараметрыОбновления.Вставить("РеквизитыФормыБК", РеквизитыФормыБК);
	КонецЕсли;
...
Процедура ОбновитьИнформациюОВариантеОтчета()
	...
	НастройкиОтчета.ИмяИсходногоВарианта = Неопределено;
	...
	НастройкиОтчета.ИмяИсходногоВарианта = ?(Выборка.Пользовательский, Выборка.КлючПредопределенногоВарианта, КлючТекущегоВарианта);
