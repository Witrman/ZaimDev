...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ТипОбъекта = "ВозвратТоваровПоставщику" Тогда
		ОбщегоНазначенияБККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаПокупатель", "Заголовок", "Реквизиты доставки");					
	КонецЕсли; 
...
Процедура ОбновитьПредставлениеЭлемента(ИмяОбновляемогоЭлемента)
	...
	ИначеЕсли ИмяОбновляемогоЭлемента = "СпособОтправленияПоКлассификатору" Тогда
		...
		Иначе
			...
			Если ПустаяСтрока(НаименованиеСтроки) Тогда
				Элементы.ДекорацияРасшифровкаСпособОтправленияПоКлассификатору.Заголовок = НСтр("ru ='строка с кодом " + СокрЛП(СпособОтправленияПоКлассификатору) + " не найдена.'");
			Иначе
