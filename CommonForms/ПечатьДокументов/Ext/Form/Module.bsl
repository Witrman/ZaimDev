...
Функция ПодписиИПечатиТабличногоДокумента(ТабличныйДокумент)
	...
	Для Каждого Рисунок Из ТабличныйДокумент.Рисунки Цикл
		Если УправлениеПечатью.ЭтоПодписьИлиПечать(Рисунок) Тогда
			ОписаниеРисунка = Новый Структура("Лево,Верх,Ширина,Высота,Картинка,Владелец,ЦветФона,Имя,Линия,РазмерКартинки");
			// В ОписаниеРисунка добавлено свойство РазмерКартинки, без него искажаются пропорции рисунков
			// при включеной настройке УправлениеПечатью.НастройкиПечати().СкрыватьПодписиИПечатиДляРедактирования
			// Форма снята с полной поддержки БСП
