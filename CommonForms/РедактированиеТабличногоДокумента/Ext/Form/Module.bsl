...
Процедура УстановитьНачальныеНастройкиФормы()
	...
	Если Не Элементы.ТабличныйДокумент.Редактирование Тогда
		Элементы.КнопкаДоступныеПоля.Видимость     = Ложь;
		Элементы.ГруппаПоляИОператоры.Видимость    = Ложь;
		Элементы.ТекущееЗначение.ТолькоПросмотр    = Истина;
		Элементы.ТекстСлеваСверху.ТолькоПросмотр   = Истина;
		Элементы.ТекстВЦентреСверху.ТолькоПросмотр = Истина;
		Элементы.ТекстСправаСверху.ТолькоПросмотр  = Истина;
		Элементы.ТекстСлеваСнизу.ТолькоПросмотр    = Истина;
		Элементы.ТекстВЦентреСнизу.ТолькоПросмотр  = Истина;
		Элементы.ТекстСправаСнизу.ТолькоПросмотр   = Истина;
	КонецЕсли;
