...
Процедура ЗаполнитьТаблицыТекущихEmailКонтактов()
	...
	|	ЕСТЬNULL(ВЫРАЗИТЬ(КонтактнаяИнформация.Представление КАК СТРОКА(100)), """") КАК АдресЭП,
	|	КонтактыВидыКИ.Вид,
	|	КонтактыВидыКИ.ВидНаименование КАК ВидНаименование
	|ИЗ
	|	ПользователиВидыКИ КАК КонтактыВидыКИ
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.КонтактнаяИнформация КАК КонтактнаяИнформация
	|		ПО КонтактыВидыКИ.Контакт = КонтактнаяИнформация.Объект
	...
	Для каждого ЭлементМассиваОписания Из МассивОписанияТиповКонтактов Цикл
		...
		|ВЫБРАТЬ
		|	КонтактыВидыКИ.Контакт,
	    |	ЕСТЬNULL(ВЫРАЗИТЬ(КонтактнаяИнформация.Представление КАК СТРОКА(100)), """"),
		|	КонтактыВидыКИ.Вид,
		...
		|			И КонтактыВидыКИ.Контакт = КонтактнаяИнформация.Объект";
