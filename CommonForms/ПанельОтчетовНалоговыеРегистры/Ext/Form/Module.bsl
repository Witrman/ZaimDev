...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = "Панель регистров налогового учета";
...
Процедура ДоходыНажатие(Элемент)
	...
	//Отчет = ПолучитьВариантОтчета(Элемент.Имя);
	//   ПараметрыОткрытия = Новый Структура ("КлючВарианта", Отчет.КлючВарианта);
	//	
	//ОткрытьФорму("Отчет." + Отчет.Имяотчета + ".Форма", ПараметрыОткрытия, Неопределено, Истина);

	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "ПроизвольныйОтчет");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоДоходам" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);

КонецПроцедуры

&НаСервере
Функция ПолучитьВариантОтчета(НадписьИмя)
	
	Отбор = Новый Структура("ИмяЭлемента", НадписьИмя);
	ТаблицаВариантовОтчетов  = СформироватьТаблицуОтчетов();
	СтрокаТаблицыОтчетов = ТаблицаОтчетов.НайтиСтроки(Отбор);
	Возврат  СтрокаТаблицыОтчетов;
	
КонецФункции

&НаСервере
Функция СформироватьТаблицуОтчетов()
	
	ТаблицаВариантовОтчетов = Новый ТаблицаЗначений;
	ТаблицаВариантовОтчетов.Колонки.Добавить("ИмяОтчета");
	ТаблицаВариантовОтчетов.Колонки.Добавить("КлючВарианта");
	ТаблицаВариантовОтчетов.Колонки.Добавить("ИмяЭлемента");

	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНалоговогоУчетаПоДоходам";
	СтрокаТаблицыОтчетов.КлючВарианта = "ПроизвольныйОтчет";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "Доходы";
	
	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНалоговогоУчетаПоДоходам";
	СтрокаТаблицыОтчетов.КлючВарианта = "НалоговыйРегистр";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "РегистрНалоговогоУчетаПоДоходам";

	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНалоговогоУчетаПоПриобретению";
	СтрокаТаблицыОтчетов.КлючВарианта = "ПроизвольныйОтчет";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "УчетПриобретенныхТМЗ";

	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНалоговогоУчетаПоПриобретению";
	СтрокаТаблицыОтчетов.КлючВарианта = "НалоговыйРегистр";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "РегистрНалоговогоУчетаПоПриобретению";

	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНалоговогоУчетаПоЗапасам";
	СтрокаТаблицыОтчетов.КлючВарианта = "ПроизвольныйОтчет";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "УчетЗапасов";

	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНалоговогоУчетаПоЗапасам";
	СтрокаТаблицыОтчетов.КлючВарианта = "НалоговыйРегистр";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "РегистрНалоговогоУчетаПоЗапасам";

    СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНДСПоОтнесениюВЗачет";
	СтрокаТаблицыОтчетов.КлючВарианта = "ПроизвольныйОтчет";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "УчетНДСДоПостановки";

	СтрокаТаблицыОтчетов = ТаблицаВариантовОтчетов.Добавить();
	СтрокаТаблицыОтчетов.ИмяОтчета = "РегистрНДСПоОтнесениюВЗачет";
	СтрокаТаблицыОтчетов.КлючВарианта = "НалоговыйРегистр";
	СтрокаТаблицыОтчетов.ИмяЭлемента = "РегистрНДСПоОтнесениюВЗачет";
...
&НаКлиенте
Процедура РегистрНалоговогоУчетаПоДоходам12Нажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ПараметрыОткрытия.Вставить("ПараметрНомерПриложения","Приложение12");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоДоходам" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура РегистрНалоговогоУчетаПоПриобретениюНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоПриобретению" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура УчетПриобретенныхТМЗНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "ПроизвольныйОтчет");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоПриобретению" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура РегистрНалоговогоУчетаПоЗапасамНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоЗапасам" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура УчетЗапасовНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "ПроизвольныйОтчет");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоЗапасам" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура РегистрНДСПоОтнесениюВЗачетНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ОткрытьФорму("Отчет." + "РегистрНДСПоОтнесениюВЗачет" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура УчетНДСДоПостановкиНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "ПроизвольныйОтчет");
	ОткрытьФорму("Отчет." + "РегистрНДСПоОтнесениюВЗачет" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура РегистрНДСНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоОборотуВВидеОстатковТоваров" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура УчетНДСПриСнятииНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "ПроизвольныйОтчет");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоОборотуВВидеОстатковТоваров" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура РегистрНалоговогоУчетаПоДоходамБезналНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоДоходамПолученныхПутемБезналичныхРасчетов" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура ДоходыБезналНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "ПроизвольныйОтчет");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоДоходамПолученныхПутемБезналичныхРасчетов" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры

&НаКлиенте
Процедура РегистрНалоговогоУчетаПоДоходамДляИПНажатие(Элемент)
	ПараметрыОткрытия = Новый Структура ("ПараметрВидОтчета", "НалоговыйРегистр");
	ПараметрыОткрытия.Вставить("ПараметрНомерПриложения","Приложение20");
	ОткрытьФорму("Отчет." + "РегистрНалоговогоУчетаПоДоходам" + ".Форма", ПараметрыОткрытия, Неопределено, Истина);
КонецПроцедуры
