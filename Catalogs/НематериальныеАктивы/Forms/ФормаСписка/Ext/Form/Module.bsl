...
Процедура ВыводДанныхСписка()
	...
	Если НЕ ЭСФСервер.ВедетсяУчетПоТоварамНаВС(ТекущаяДата()) Тогда
		...
		|	СправочникНематериальныеАктивы.КодКОФ,
		|	СправочникНематериальныеАктивы.ИдентификаторТовараЭСФ,
		|	СправочникНематериальныеАктивы.КодТНВЭД,
		|	СправочникНематериальныеАктивы.ДополнительныеРеквизиты.(
		|		Ссылка КАК Ссылка,
