...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок = ЭтаФорма.Заголовок + " (" + ?(ЗначениеЗаполнено(Объект.Владелец), ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Владелец, "Наименование"), "Владелец не задан") + ")";
...
Процедура ЗаполнитьТекстКорреспондента(ДанныеОбъекта, ТекстКорреспондента)
	...
	Если ЗначениеЗаполнено(ДанныеОбъекта.БанкДляРасчетов) Тогда
		СтрКорреспондента = СтрКорреспондента + НСтр("ru=' р/с '") + ДанныеОбъекта.НомерСчета + СтрДанныеПоБанку;		
...
Процедура ЗаполнитьСписокПрограммКлиентБанка()
	...
	СписокВыбора.Добавить("Банк ТуранАлем клиент, v.1.0", "Банк ТуранАлем клиент, v.1.0");
	СписокВыбора.Добавить("Банк ""ЦентрКредит"" Интернет-Клиент", "Банк ""ЦентрКредит"" Интернет-Клиент");
	СписокВыбора.Добавить("HalykBank Банк-Клиент", "HalykBank Банк-Клиент");
	СписокВыбора.Добавить("HalykBank Интернет-Клиент", "HalykBank Интернет-Клиент");
