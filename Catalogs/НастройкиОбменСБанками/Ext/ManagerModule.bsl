...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	И
	|	НЕ НастройкиОбменСБанками.УдалитьВерсияВнешнейКомпоненты = """"
	|СГРУППИРОВАТЬ ПО
	|	НастройкиОбменСБанками.Ссылка
	|
	|ОБЪЕДИНИТЬ
	...
	|	И
	|	НЕ НастройкиОбменСБанкамиСертификатыПодписейОрганизации.Ссылка.ИспользуетсяКриптография
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ
	...
	|	Справочник.НастройкиОбменСБанками КАК НастройкиОбменСБанками
	|ГДЕ
	|	НастройкиОбменСБанками.ПрограммаБанка В (ЗНАЧЕНИЕ(Перечисление.ПрограммыБанка.СбербанкОнлайн),
	|		ЗНАЧЕНИЕ(Перечисление.ПрограммыБанка.ОбменЧерезВК),
	|		ЗНАЧЕНИЕ(Перечисление.ПрограммыБанка.ОбменЧерезДопОбработку))
...
Функция ПолучитьНастройкиОбмена(ПараметрыПолученияНастроек)
	...
	Заголовки.Вставить("Bic", ЭлектронноеВзаимодействиеПереопределяемый.РеквизитыБанка(ПараметрыПолученияНастроек.Банк).Код);
