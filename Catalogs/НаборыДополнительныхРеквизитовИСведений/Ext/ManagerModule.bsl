...
Процедура ЗаполнитьНаборОтчетОРозничныхПродажах() Экспорт
	
	ОтчетОРозничныхПродажах = Справочники.НаборыДополнительныхРеквизитовИСведений.Документ_ОтчетОРозничныхПродажах.ПолучитьОбъект();
	
	ОтчетОРозничныхПродажах.Наименование = "Отчет о розничных продажах";
	ОтчетОРозничныхПродажах.Используется = Истина;
	
	Попытка
		ОтчетОРозничныхПродажах.Записать();
	Исключение
		Комментарий = НСтр("ru = 'Не удалось записать элемент справочника Наборы дополнительных реквизитов и сведений'");
...
Процедура ЗаполнитьНаборЧекККМ() Экспорт
	
	ЧекККМ = Справочники.НаборыДополнительныхРеквизитовИСведений.Документ_ЧекККМ.ПолучитьОбъект();
	
	ЧекККМ.Наименование = "Розничная продажа (чек)";
	ЧекККМ.Используется = Истина;
