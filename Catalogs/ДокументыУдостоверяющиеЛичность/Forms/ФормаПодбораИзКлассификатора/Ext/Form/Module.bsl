...
Процедура ПолеТабличногоДокументаОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Иначе 
		...
		ПоказатьВопрос(Оповещение, НСтр("ru = 'В справочнике ""Документы, удостоверяющие личность"" уже существует элемент с наименованием """ + Наименование + """! Открыть существующий?'"), Режим, 0);
