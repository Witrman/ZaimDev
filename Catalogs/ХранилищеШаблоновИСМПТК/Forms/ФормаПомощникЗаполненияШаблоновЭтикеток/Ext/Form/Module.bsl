...
Процедура УправлениеЭлементамиФормы()
	...
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаПотребительская",		 "Видимость", ЗаполнятьШаблонПотребительскойУпаковки);
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаЛогистическаяЭтикетка", "Видимость", ЗаполнятьШаблонЛогистическойУпаковки);
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаКоличествоЭкземпляров", "Видимость", ЗаполнятьКоличествоЭкземпляров);
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаСохранитьЗначения",		 "Видимость", ЗаполнятьШаблонПотребительскойУпаковки);
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ФормаВосстановитьЗначения", 	 "Видимость", ЗаполнятьШаблонПотребительскойУпаковки);
