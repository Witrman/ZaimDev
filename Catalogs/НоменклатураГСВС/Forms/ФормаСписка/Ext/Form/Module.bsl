...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Элементы.ФормаСправочникНоменклатураГСВСЗагрузитьСправочникПолностью.Видимость = ПолучитьФункциональнуюОпцию("ИспользоватьОбменВС");	
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ЗагрузкаГСВС_Выполнена" И ЭтаФорма.КлючУникальности = Источник Тогда
		...
		Если Вопрос("Выполнена загрузка ГСВС. Обработать элементы номенклатуры, с изменившимися кодами ТН ВЭД?", РежимДиалогаВопрос.ДаНет, , , "Загрузка ГСВС") = КодВозвратаДиалога.Да Тогда
