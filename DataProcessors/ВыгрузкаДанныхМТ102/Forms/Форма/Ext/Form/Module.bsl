...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВидОперацииДокумента = "ПеречислениеСоциальныхОтчислений" Тогда
		ПолеPERIODвЗаголовке = УстановитьЗначениеПоляPERIODвЗаголовке(ОбработкаОбъект);
	КонецЕсли;
...
Процедура Выгрузить(Команда)
	...
	АдресСтруктурыФайловВоВременномХранилище = ВыгрузитьНаСервере(ФормироватьОтдельныеФайлы, ВключатьПолеFT, ВключатьПолеPSO, ВключатьПолеPRT, ПолеPERIODвЗаголовке);;
...
&НаСервереБезКонтекста
Функция УстановитьЗначениеПоляPERIODвЗаголовке(ОбработкаОбъект)
...
&НаСервере
Функция ВыгрузитьНаСервере(ФормироватьОтдельныеФайлы, ВключатьПолеFT, ВключатьПолеPSO, ВключатьПолеPRT, ПолеPERIODвЗаголовке)
	
	ОбработкаОбъект = РеквизитФормыВЗначение("Объект");
	Возврат ОбработкаОбъект.СоздатьФайлВФорматеМТ(ФормироватьОтдельныеФайлы, ВключатьПолеFT, ВключатьПолеPSO, ВключатьПолеPRT, ПолеPERIODвЗаголовке, УникальныйИдентификатор, ВозможностьВыбораФайлов);
