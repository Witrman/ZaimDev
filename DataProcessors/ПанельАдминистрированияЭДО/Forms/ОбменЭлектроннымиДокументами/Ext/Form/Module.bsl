...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуетсяНесколькоОрганизацийЭД = Ложь;
	...
	Если РазделениеВключено И ЕстьКлиентЭДО Тогда
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "РегистрацияВзаимодействия" Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВключитьДиалог", "Видимость",
			РазделениеВключено И Не Параметр И ОповещатьОСобытияхЭДО И ЕстьКлиентЭДО);
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВключитеДиалог", "Видимость",
			РазделениеВключено И Не Параметр И ОповещатьОСобытияхЭДО И Не ЕстьКлиентЭДО);
...
Процедура ОповещатьОСобытияхЭДОПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"ВключитьДиалог", "Видимость", РазделениеВключено И Не Обсуждения И ОповещатьОСобытияхЭДО И ЕстьКлиентЭДО);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"ВключитеДиалог", "Видимость", РазделениеВключено И Не Обсуждения И ОповещатьОСобытияхЭДО И НЕ ЕстьКлиентЭДО);
...
Процедура ПрочитатьУстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если ЕстьОбменСКонтрагентами
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВключитьДиалог", "Видимость",
			РазделениеВключено И Не Обсуждения И ОповещатьОСобытияхЭДО И ЕстьКлиентЭДО);
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВключитеДиалог", "Видимость",
			РазделениеВключено И Не Обсуждения И ОповещатьОСобытияхЭДО И НЕ ЕстьКлиентЭДО И Константа_ИспользоватьОбменЭД);
	...
	Если ЕстьТорговыеПредложения
		И (РеквизитПутьКДанным = "Константа_ПоказыватьПодсказкиПокупателейБизнесСеть" ИЛИ РеквизитПутьКДанным = "") Тогда
		
		Константа_ПоказыватьПодсказкиПокупателейБизнесСеть = Константы["ПоказыватьПодсказкиПокупателейБизнесСеть"].Получить();
	КонецЕсли;
	
	Если ЕстьТорговыеПредложения
		И (РеквизитПутьКДанным = "Константа_ПоказыватьПодсказкиПоставщиковБизнесСеть" ИЛИ РеквизитПутьКДанным = "") Тогда
		
		Константа_ПоказыватьПодсказкиПоставщиковБизнесСеть = Константы["ПоказыватьПодсказкиПоставщиковБизнесСеть"].Получить();
	КонецЕсли;
