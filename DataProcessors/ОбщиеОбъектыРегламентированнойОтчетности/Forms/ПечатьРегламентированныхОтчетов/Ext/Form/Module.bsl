...
Процедура СформироватьТекстПодсказки()
	...
	ТекстСтатистики = НСтр("ru = 'Выбрано %1 из %2 %3.%4Для печати требуется %5 %6 бумаги'");
	ТекстСтатистики = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстСтатистики,
		КоличествоТаблДок, КоличествоЛистовВсего, ТекстЛистовВсего, Символы.ПС, КоличествоЛистовТребуется, ТекстЛистовТребуется);
