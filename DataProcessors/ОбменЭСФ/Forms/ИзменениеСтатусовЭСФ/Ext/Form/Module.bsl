...
Процедура ИзменитьСтатусЭСФ(Команда)
	...
	ЭСФКлиент.ОпределитьНеобходимостьВводаДанныхИСЭСФ(КоллекцияСгруппированныхЭСФ, ИзменитьСтатусЭСФЗавершение);
...
Функция ОтклонитьИсправленныеИлиДополнительныеИлиОтозванныеЭСФ(ДанныеПрофиляИСЭСФ, ДанныеКлючаЭЦП)
	...
	Если КоллекцияРезультатовОтклоненияОтозванных = Неопределено ИЛИ КоллекцияРезультатовОтклоненияДополнительныхИлиИсправленных = Неопределено Тогда
		
		КоллекцияРезультатовИзмененияСтатусов = Неопределено;
