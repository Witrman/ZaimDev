...
Процедура УправлениеФормой() 
	...
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДанныеФайловКодАгрегата", "Видимость", ФайлыСРазделителями);
	
	ИнтерфейсИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаРазделитель", "Доступность", ФайлыСРазделителями);
