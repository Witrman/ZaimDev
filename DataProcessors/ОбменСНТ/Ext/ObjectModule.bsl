...
Перем КэшированнаяФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2;
...
Процедура ДокументСНТ_ОбработкаЗаполнения(ОбъектСНТ, ДанныеЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если ТипЗнч(МассивДанныхДляЗаполнения) = Тип("Массив") И МассивДанныхДляЗаполнения.Количество() > 0 Тогда
		...
		Для каждого СтруктураДокумента Из МассивДанныхДляЗаполнения Цикл
			...
			//Заполняем табличную часть "ТоварыЭкспортныйКонтроль"
			Для Каждого СтрокаТЧ Из СтруктураДокумента.ТоварыЭкспортныйКонтроль Цикл
				
				НовыйДокументСНТ.ЕстьТоварыЭК = Истина;
				
				НоваяСтрокаТЧ = НовыйДокументСНТ.ТоварыЭкспортныйКонтроль.Добавить();
				ЗаполнитьЗначенияСвойств(НоваяСтрокаТЧ,СтрокаТЧ);
				НоваяСтрокаТЧ.ДополнительныйИдентификатор = СтрокаТЧ.ИсточникПроисхождения.ДополнительныйИдентификатор;
...
Процедура ДокументСНТ_ОбработкаПроведения(ОбъектСНТ, Отказ, РежимПроведения) Экспорт
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий Тогда
		...
		Если (СНТСервер.ПроверитьСтатусНеТребуетПодтверждения(ОбъектСНТ)) 
			...
			ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отклонен ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отозван ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ) 
			Тогда
		...
		ИначеЕсли НЕ(СНТСервер.ПроверитьСтатусНеТребуетПодтверждения(ОбъектСНТ))
			И НЕ (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отклонен ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отозван ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ) Тогда 
		...
		Если (СНТСервер.ПроверитьСтатусНеТребуетПодтверждения(ОбъектСНТ))
			...
			ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отклонен ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отозван ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ) 
			И (НЕ ЗначениеЗаполнено(ОбъектСНТ.СкладПолучатель) И НЕ(ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий И ОбъектСНТ.ПоставщикМалаяТорговаяТочка И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)) Тогда
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий 
		И ((ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз И НЕ(ОбъектСНТ.ПоставщикФизическоеЛицо И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)) ИЛИ ОбъектСНТ.ПоставщикМалаяТорговаяТочка)
		И НЕ ОбъектСНТ.ПредоставленВБумажномВиде
		И (НЕ (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден 
				ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отклонен 
				ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ)) Тогда 
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий 
		И (ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами И ОбъектСНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК)
		И НЕ (ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ПодтвержденПолучателем ИЛИ ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ОтклоненПолучателем ИЛИ ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ЗаблокированИСЭСФ) 
	Тогда 
		ЭСФКлиентСервер.СообщитьПользователю(НСтр("ru = 'Документ не проведен, движения не сформированы. Проведение документа разрешено только в статусах ""Подтвержден"" или ""Отклонен""  '"));
		Отказ = Истина;
	КонецЕсли;
	...
	Если ((ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий И НЕ ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И НЕ ОбъектСНТ.ПоставщикМалаяТорговаяТочка)
		...
		И (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден 
			...
			ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ) 
	...
	ЕстьПеремещениеИмпорт = СНТСервер.ПроверитьПеремещениеИмпорт(ОбъектСНТ);
	
	//Обработка входящих СНТ, а также исходящих СНТ по импорту
	Если (((ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий И НЕ СНТСервер.ПроверитьСтатусНеТребуетПодтверждения(ОбъектСНТ) И НЕ ОбъектСНТ.ПредоставленВБумажномВиде)
			ИЛИ (ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз 
					И НЕ ОбъектСНТ.ПоставщикРозничнаяРеализация)
			ИЛИ ЕстьПеремещениеИмпорт))
			И (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Аннулирован ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ) Тогда
	...
	//а также исходящих СНТ, не требующих подтверждения с датой аннулирования (приход)
	...
	#Область ПолучениеДанныхДляРозничногоРеализаторПриВозврате
	
	ДатаСвязанногоСНТ = Дата(1,1,1);
	ПоставщикРозничныйРеализаторНаВозвратПроведение = Ложь;
	Если ОбъектСНТ.ПоставщикРозничныйРеализатор И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И ОбъектСНТ.ТоварыВС.Количество() > 0 Тогда
		
		Если ЗначениеЗаполнено(ОбъектСНТ.СвязанныйСНТ) Тогда
			ДатаСвязанногоСНТ = ЭСФСерверПереопределяемый.ЗначениеРеквизитаОбъекта(ОбъектСНТ.СвязанныйСНТ, "Дата");
			Если ДатаСвязанногоСНТ < СНТСерверПереопределяемый.ДатаВводаМТТ() Тогда
				ПоставщикРозничныйРеализаторНаВозвратПроведение = Истина;
			КонецЕсли;
		КонецЕсли;
	...
	//Обработка входящих СНТ с видом возврат от розничного покупателя, физ.лица и нерезидента
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И НЕ ОбъектСНТ.ПредоставленВБумажномВиде
		И (ПоставщикРозничныйРеализаторНаВозвратПроведение) ИЛИ (ОбъектСНТ.ПоставщикРозничнаяРеализация ИЛИ (ОбъектСНТ.ПоставщикФизическоеЛицо И НЕ ОбъектСНТ.ПоставщикНерезидент)) Тогда
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий И СНТСервер.ПроверитьСтатусНеТребуетПодтверждения(ОбъектСНТ) Тогда
		...
		Если ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отозван ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отклонен Тогда
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий 
		...
		И НЕ ЕстьПеремещениеИмпорт
		И (НЕ ОбъектСНТ.ПоставщикРозничнаяРеализация И НЕ ОбъектСНТ.ПоставщикФизическоеЛицо И НЕ ОбъектСНТ.ПоставщикМалаяТорговаяТочка И НЕ((ОбъектСНТ.ПоставщикРозничныйРеализатор И ОбъектСНТ.Дата < СНТСерверПереопределяемый.ДатаВводаМТТ()))) Тогда
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации <> Перечисления.ВидыОперацийСНТ.Ввоз
		...
		//И НЕ ОбъектСНТ.ПоставщикРозничнаяРеализация И НЕ ОбъектСНТ.ПоставщикФизическоеЛицо И НЕ ОбъектСНТ.ПолучательНерезидент И НЕ ОбъектСНТ.ПоставщикНерезидент И НЕ ОбъектСНТ.ПоставщикМалаяТорговаяТочка
		И НЕ ОбъектСНТ.ПоставщикРозничнаяРеализация И НЕ ОбъектСНТ.ПоставщикФизическоеЛицо И НЕ ОбъектСНТ.ПолучательНерезидент И НЕ ОбъектСНТ.ПоставщикНерезидент И НЕ ОбъектСНТ.ПоставщикМалаяТорговаяТочка
		И НЕ (ОбъектСНТ.ПоставщикРозничныйРеализатор И ОбъектСНТ.Дата < СНТСерверПереопределяемый.ДатаВводаМТТ())
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации <> Перечисления.ВидыОперацийСНТ.Ввоз
		...
		И (ОбъектСНТ.ПоставщикРозничнаяРеализация ИЛИ ОбъектСНТ.ПоставщикФизическоеЛицо ИЛИ ОбъектСНТ.ПолучательНерезидент ИЛИ ОбъектСНТ.ПоставщикНерезидент ИЛИ ОбъектСНТ.ПоставщикМалаяТорговаяТочка
		
			ИЛИ ((ОбъектСНТ.ПоставщикРозничныйРеализатор И ОбъектСНТ.Дата < СНТСерверПереопределяемый.ДатаВводаМТТ())
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И НЕ ОбъектСНТ.ПредоставленВБумажномВиде
		...
		ИЛИ СНТСервер.ПроверитьСтатусНеТребуетПодтверждения(ОбъектСНТ))
		И ОбъектСНТ.Статус <> Перечисления.СтатусыСНТ.Черновик Тогда
		
		Если ОбъектСНТ.ВидПеремещения <> ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС") И ОбъектСНТ.ВидПеремещения <> ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ИноеПеремещение") Тогда
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации <> Перечисления.ВидыОперацийСНТ.Ввоз 
		И НЕ ОбъектСНТ.ПредоставленВБумажномВиде 
		И НЕ ЕстьПеремещениеИмпорт
		И (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден ИЛИ ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.ЗаблокированИСЭСФ) Тогда
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ПредоставленВБумажномВиде И НЕ ОбъектСНТ.ПричинаВыпискиНаБумажномНосителе = Перечисления.ПричиныВыпискиСФНаБумаге.ОтсутствиеТребованиеПоВыписке Тогда
		...
		ИначеЕсли ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Отозван Тогда 
		...
		ИначеЕсли ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Аннулирован Тогда
...
Процедура ДокументСНТ_ПередЗаписью(ОбъектСНТ, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	Если ОбъектСНТ.ПолучательФизическоеЛицо И Не ЗначениеЗаполнено(ОбъектСНТ.АдресДоставки) Тогда
		ОбъектСНТ.АдресДоставки = НСтр("ru = 'Адрес неизвестен'");
	ИначеЕсли ОбъектСНТ.ПоставщикФизическоеЛицо И Не ЗначениеЗаполнено(ОбъектСНТ.АдресОтправки) Тогда
	...
	Если НЕ Отказ И РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий
			И (ОбъектСНТ.ВидОперации <> Перечисления.ВидыОперацийСНТ.Ввоз ИЛИ ОбъектСНТ.ПредоставленВБумажномВиде) 
			И НЕ СНТСервер.ПроверитьПеремещениеИмпорт(ОбъектСНТ) Тогда
		...
		ИначеЕсли ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ((ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз И НЕ ОбъектСНТ.ПредоставленВБумажномВиде)
			ИЛИ СНТСервер.ПроверитьПеремещениеИмпорт(ОбъектСНТ))
			И (НЕ (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден 
...
Процедура ДокументСопоставлениеСНТиФНО_ОбработкаЗаполнения(ОбъектСопоставление, ДанныеЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ОбъектСопоставление.Организация) Тогда
		ОбъектСопоставление.Организация = Справочники.Организации.ОрганизацияПоУмолчанию();
		СтруктураДанных = ВССерверПереопределяемый.ПолучитьРеквизитыОрганизации(ОбъектСопоставление.Организация, "Отправитель",);
		ОбъектСопоставление.ИдентификационныйНомер = СтруктураДанных.ОтправительИдентификатор;		
	КонецЕсли;
...
Процедура ДокументСопоставлениеСНТиФНО_ОбработкаПроведения(ОбъектСопоставление, Отказ, РежимПроведения) Экспорт
	...
	// Выполнить заполнение остатка в ТЧ документа с учётом остатка по регистру "Товары на виртуальных складах"
	СНТСерверПереопределяемый.ПроверкаЗаполненияОстаткаТоваровВС(ОбъектСопоставление, "ТоварыСНТ", Отказ);
...
Функция ЗаполнитьSNT_ДобавитьБазовыеСведенияОТоваре(products, ТоварыСтрока, Фабрика, ИмяТабличнойЧасти, СНТ)
	...
	Если ИмяТабличнойЧасти = "ЭтиловыйСпирт" ИЛИ ИмяТабличнойЧасти = "Виноматериал" ИЛИ ИмяТабличнойЧасти = "АлкогольнаяпродукцияКромеПива" ИЛИ ИмяТабличнойЧасти = "ТабачнаяПродукция" Тогда
			product.pinCode = ТоварыСтрока.ПинКод; // ПИН-код
	КонецЕсли;
	
	Если ИмяТабличнойЧасти = "ДанныеПоНефтепродуктам" Тогда
		Если ЗначениеЗаполнено(ТоварыСтрока.ПинКод) Тогда
			product.pinCode = ТоварыСтрока.ПинКод; // ПИН-код
		КонецЕсли;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ТоварыСтрока.СуммаНДС) ИЛИ ТоварыСтрока.СтавкаНДСЧисло = 0 ИЛИ ТоварыСтрока.Цена = 0 Тогда
	...
	Если ИмяТабличнойЧасти = "ТоварыВС" ИЛИ ИмяТабличнойЧасти = "ЭтиловыйСпирт" ИЛИ ИмяТабличнойЧасти = "Виноматериал"
		...
		Если ИмяТабличнойЧасти = "ДругиеТоварыЦифроваяМаркировка" Тогда 
			product.gtinCode = ТоварыСтрока.GTIN; //27.10.2021 этот тэг для ТЧ G9 обязательный Код товара (GTIN)
		Иначе
...
Процедура ЗаполнитьSNT_Версия1(Знач СНТ, Знач Фабрика, SNT)// Отправка СНТ
	...
	Если СНТ.ДругиеТоварыЦифроваяМаркировка.Количество() > 0 Тогда
		...
		Если ЗначениеЗаполнено(СНТ.ДатаРегистрацииИСМПТ) Тогда
			SNT.digitalMarkingNotificationDate = СокрЛП(Формат(СНТ.ДатаРегистрацииИСМПТ, "ДФ=dd.MM.yyyy; ДП=01.01.0001"));// Дата Акта/Уведомления по цифровой маркировке (A 4.2.1)
		КонецЕсли;
	КонецЕсли;
	...
	КонецЕсли;
	Если ЗначениеЗаполнено(СНТ.АдресОтправки) Тогда
	...
	УстановитьСтатусКонтрагента(Фабрика, СНТ.ПоставщикМалаяТорговаяТочка, "SMALL_RETAIL_OUTLET", seller);
	УстановитьСтатусКонтрагента(Фабрика, СНТ.ПоставщикЗалогодержательХранитель, "PAWNEE_CUSTODIAN", seller);
	...
	УстановитьСтатусКонтрагента(Фабрика, СНТ.ПолучательМалаяТорговаяТочка, "SMALL_RETAIL_OUTLET", customer);
	УстановитьСтатусКонтрагента(Фабрика, СНТ.ПолучательЗалогодержательХранитель, "PAWNEE_CUSTODIAN", customer);
	...
	УстановитьВидТранспорта(Фабрика, СНТ.ПрочийТранспорт, "OTHER", shippingInfo);
	...
	Если СНТ.ВоздушныйТранспорт И ЗначениеЗаполнено(СНТ.НомерБорта) Тогда
	...
	Если СНТ.ТоварыЭкспортныйКонтроль.Количество() > 0 Тогда
		...
		Для Каждого ТоварыСтрока Из СНТ.ТоварыЭкспортныйКонтроль Цикл
			...
			Если ЗначениеЗаполнено(СокрЛП(ТоварыСтрока.НомерЛицензии)) Тогда
				product.permissiveDocumentNumber = СокрЛП(ТоварыСтрока.НомерЛицензии); // Номер Лицензия/Разрешение документа (G10 4)
			КонецЕсли;
			
			Если ЗначениеЗаполнено(ТоварыСтрока.ДатаВыдачиЛицензии) Тогда
			...
			Если ЗначениеЗаполнено(ТоварыСтрока.ДатаОкончанияЛицензии) Тогда
...
// Возвращает коллекцию СНТ, сгруппированных по структурным единицам.
...
Функция Переопределяемый_СгруппироватьСНТПоСтруктурнымЕдиницам(Знач МассивСНТ, ОткрыватьСессиюФилиаломПолучателем = Ложь) Экспорт
	...
	|			ТОГДА СНТ.Поставщик
	|		КОГДА СНТ.Организация.УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре
	|				И СНТ.Направление = ЗНАЧЕНИЕ(Перечисление.НаправленияСНТ.Исходящий)
	|				И СНТ.ВидОперации <> ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.Ввоз)
	|				И СНТ.ТипСНТ <> ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
	|			ТОГДА СНТ.Поставщик /////7.5 Ввоз товаров на территорию СЭЗ
	|		КОГДА СНТ.Организация.УказыватьРеквизитыГоловнойОрганизацииВСчетеФактуре
	|				И СНТ.Направление = ЗНАЧЕНИЕ(Перечисление.НаправленияСНТ.Исходящий)
	|				И (СНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.Ввоз)
...
КонецФункции
 ...
 Функция ОтправитьИсходящиеSnt(ВерсияВС, Знач КоллекцияSntXML, Знач КоллекцияПодписей, Знач ПрофильИСЭСФ, Знач ОткрытыйКлючЭЦП, ИдентификаторСессии = Неопределено) Экспорт
	...
	РезультатОтправки = ЭлектронноеВзаимодействиеССервисами.ОтправитьИсходящиеSnt(КоллекцияSntXML, ПредельныйРазмерПакетаИсходящих,
	ОбщийРазмерКолекцииНаОтправку, КоличествоПакетов, ВерсияВС, КоллекцияПодписей, ПрофильИСЭСФ, ОткрытыйКлючЭЦП, ИдентификаторСессии);
	...
	Если ТипЗнч(РезультатОтправки) = Тип("Соответствие") И РезультатОтправки.Количество() > 0 Тогда	
		...
		// Обновим статусы отправленных СНТ, после завершения отправки всех пакетов
...
Процедура ОбновитьДокументыСНТПослеОтправки(Знач РезультатОтправки, Знач ПрофильИСЭСФ, Знач ИдентификаторСессии = Неопределено, Знач ВерсияИСЭСФ)
	...
	// Создать и заполнить массив идентификаторов отправленных СНТ. 
	...
	// При отправке исправленных СНТ, автоматически становятся аннулированными в ИС ЭСФ.
	// Для того, чтобы информация об аннулировании отобразилась в 1С, 
	// необходимо обновить статусы исправляемых СНТ.
	...
	Если КоличествоСНТ > ПредельныйРазмерПакетаСНТ Тогда
		...
		Для Каждого СтрокаМассива Из МассивИдентификаторовСНТ Цикл
			...
			// Выполнить обновление статусов отправленных СНТ.
...
Функция ПроверитьСНТ(СсылкаСНТ) Экспорт
	...
	Попытка
		...
		СНТСерверПереопределяемый.СверитьЧисловыеДанныеСНТиПервичногоДокумента(ОбъектСНТ, РезультатПроверки);
	Исключение
...
Процедура ПроверитьРазличныеДанныеСНТ(ОбъектСНТ, РезультатПроверки) Экспорт
	...
	#Область РазделАОбщийРаздел
	
	// Проверка расхода товара при аннулировании подтверждения снт на импорт
	Если ОбъектСНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Ввоз") И ЗначениеЗаполнено(ОбъектСНТ.ВидВвоза) 
		И ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Подтвержден Тогда
		
		РезультатПроверки = СНТСервер.ПроверитьВозможностьАннулироватьПодтверждение(ОбъектСНТ);
	...
	#Область РазделBРеквизитыПоставщика
	...
	Если ОбъектСНТ.ВидОперации <> ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Ввоз")
		...
		И НЕ ОбъектСНТ.ПоставщикРозничнаяРеализация 
		И НЕ ОбъектСНТ.ПоставщикМалаяТорговаяТочка
		И НЕ ОбъектСНТ.ПоставщикНерезидент
		И НЕ ОбъектСНТ.ПоставщикФизическоеЛицо Тогда
	...
	Если ОбъектСНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Перемещение")
		...
		ИЛИ ОбъектСНТ.ПоставщикМедиатор ИЛИ ОбъектСНТ.ПоставщикНотариус ИЛИ ОбъектСНТ.ПоставщикМалаяТорговаяТочка
	...
	Если ОбъектСНТ.ПоставщикЗалогодержательХранитель И ОбъектСНТ.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") Тогда
		ТекстСообщения = НСтр("ru = 'В СНТ на возврат товаров категория «Залогодержатель/хранитель» доступна только в разделе «С. Реквизиты получателя»'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	#КонецОбласти
	
	#Область РазделСРеквизитыПолучателя
	...
	Если НЕ ЗначениеЗаполнено(ОбъектСНТ.ПолучательКодСтраныДоставки) Тогда
		ТекстСообщения = НСтр("ru = 'С. Не заполнен код страны доставки/поставки.'"); 
		РезультатПроверки.ЗапрещающиеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	
	Если ОбъектСНТ.ПолучательНерезидент 
		И (ОбъектСНТ.ПолучательКодСтраныДоставки = "AM" ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки = "KG"
			ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки = "RU" ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки = "BY")
		И НЕ ЗначениеЗаполнено(ОбъектСНТ.ПолучательИдентификатор) 
		И ОбъектСНТ.ТипСНТ <> Перечисления.ТипыСНТ.ВозвратТоваров Тогда
		ТекстСообщения = НСтр("ru = 'С. Поле ИИН/БИН получателя является обязательным для заполнения при вывозе товаров в страны ЕАЭС.'"); 
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
		
	Если ОбъектСНТ.ПолучательНерезидент И ЗначениеЗаполнено(ОбъектСНТ.ПолучательИдентификатор) 
		И (ОбъектСНТ.ПолучательКодСтраныДоставки = "AM" ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки = "KG"
			ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки = "RU" ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки = "BY") Тогда
		
		Если ОбъектСНТ.ПолучательКодСтраныДоставки = "AM" И СтрДлина(ОбъектСНТ.ПолучательИдентификатор) <> 8 Тогда
			ТекстСообщения = НСтр("ru = 'С. ИИН/БИН для кода регистрации получателя ""AM"" должно быть указано ""8"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ПолучательКодСтраныДоставки = "BY" И СтрДлина(ОбъектСНТ.ПолучательИдентификатор) <> 9 Тогда
			ТекстСообщения = НСтр("ru = 'С. ИИН/БИН для кода регистрации получателя ""BY"" должно быть указано ""9"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ПолучательКодСтраныДоставки = "KG" И СтрДлина(ОбъектСНТ.ПолучательИдентификатор) <> 14 Тогда
			ТекстСообщения = НСтр("ru = 'С. ИИН/БИН для кода регистрации получателя ""KG"" должно быть указано ""14"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ПолучательКодСтраныДоставки = "RU" И (СтрДлина(ОбъектСНТ.ПолучательИдентификатор) <> 10 И СтрДлина(ОбъектСНТ.ПолучательИдентификатор) <> 12 )Тогда
			ТекстСообщения = НСтр("ru = 'С. ИИН/БИН для кода регистрации получателя ""RU"" должно быть указано ""10"" или ""12"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
	КонецЕсли;

	Если НЕ ЗначениеЗаполнено(ОбъектСНТ.АдресДоставки) И (НЕ ОбъектСНТ.ПолучательРозничнаяРеализация 
		ИЛИ (ЗначениеЗаполнено(ОбъектСНТ.ПолучательИдентификатор) И ОбъектСНТ.ПолучательРозничнаяРеализация))Тогда
	...
	Если НЕ ЗначениеЗаполнено(ОбъектСНТ.ПолучательКодСтраны) Тогда
		ТекстСообщения = НСтр("ru = 'С. Не указан код страны регистрации получателя.'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	...
	Если ОбъектСНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Перемещение")
		...
		ИЛИ ОбъектСНТ.ПолучательМедиатор ИЛИ ОбъектСНТ.ПолучательНотариус ИЛИ ОбъектСНТ.ПолучательМалаяТорговаяТочка
	...
	Если ОбъектСНТ.ПолучательЗалогодержательХранитель 
		И (ОбъектСНТ.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.Первичная") ИЛИ ОбъектСНТ.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.Исправленная")) Тогда
		ТекстСообщения = НСтр("ru = 'В первичной и исправленной СНТ категория «Залогодержатель/хранитель» доступна только в разделе «В. Реквизиты поставщика»'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;

	#КонецОбласти
	
	#Область РазделDРеквизитыГрузоотправителяГрузополучателя
	...
	Если ОбъектСНТ.ГрузоотправительНерезидент И НЕ ЗначениеЗаполнено(ОбъектСНТ.ГрузоотправительИдентификатор) 
		И (ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "AM" ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "KG"
			ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "RU" ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "BY") Тогда
		ТекстСообщения = НСтр("ru = 'D. Поле ИИН/БИН грузоотправителя является обязательным для заполнения при вывозе товаров в страны ЕАЭС.'"); 
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	
	Если ОбъектСНТ.ГрузоотправительНерезидент И ЗначениеЗаполнено(ОбъектСНТ.ГрузоотправительИдентификатор) 
		И (ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "AM" ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "KG"
			ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "RU" ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "BY") Тогда
		
		Если ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "AM" И СтрДлина(ОбъектСНТ.ГрузоотправительИдентификатор) <> 8 Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузоотправителя ""AM"" должно быть указано ""8"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "BY" И СтрДлина(ОбъектСНТ.ГрузоотправительИдентификатор) <> 9 Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузоотправителя ""BY"" должно быть указано ""9"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "KG" И СтрДлина(ОбъектСНТ.ГрузоотправительИдентификатор) <> 14 Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузоотправителя ""KG"" должно быть указано ""14"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ГрузоотправительКодСтраныОтправки = "RU" И (СтрДлина(ОбъектСНТ.ГрузоотправительИдентификатор) <> 10 И СтрДлина(ОбъектСНТ.ГрузоотправительИдентификатор) <> 12 )Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузоотправителя ""RU"" должно быть указано ""10"" или ""12"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
	КонецЕсли;
	
	Если ОбъектСНТ.ГрузополучательНерезидент И НЕ ЗначениеЗаполнено(ОбъектСНТ.ГрузополучательИдентификатор) 
		И (ОбъектСНТ.ГрузополучательКодСтраныОтправки = "AM" ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки = "KG"
			ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки = "RU" ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки = "BY") Тогда
		ТекстСообщения = НСтр("ru = 'D. Поле ИИН/БИН грузополучателя является обязательным для заполнения при вывозе товаров в страны ЕАЭС.'"); 
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	
	Если ОбъектСНТ.ГрузополучательНерезидент И ЗначениеЗаполнено(ОбъектСНТ.ГрузополучательИдентификатор) 
		И (ОбъектСНТ.ГрузополучательКодСтраныОтправки = "AM" ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки = "KG"
			ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки = "RU" ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки = "BY") Тогда
		
		Если ОбъектСНТ.ГрузополучательКодСтраныОтправки = "AM" И СтрДлина(ОбъектСНТ.ГрузополучательИдентификатор) <> 8 Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузополучателя ""AM"" должно быть указано ""8"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ГрузополучательКодСтраныОтправки = "BY" И СтрДлина(ОбъектСНТ.ГрузополучательИдентификатор) <> 9 Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузополучателя ""BY"" должно быть указано ""9"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ГрузополучательКодСтраныОтправки = "KG" И СтрДлина(ОбъектСНТ.ГрузополучательИдентификатор) <> 14 Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузополучателя ""KG"" должно быть указано ""14"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
		
		Если ОбъектСНТ.ГрузополучательКодСтраныОтправки = "RU" И (СтрДлина(ОбъектСНТ.ГрузополучательИдентификатор) <> 10 И СтрДлина(ОбъектСНТ.ГрузополучательИдентификатор) <> 12 )Тогда
			ТекстСообщения = НСтр("ru = 'D. ИИН/БИН для кода регистрации грузополучателя ""RU"" должно быть указано ""10"" или ""12"" знаков.'"); 
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
		КонецЕсли;
	...
	#Область РазделЕСведенияПоПеревозке
	
	Если (ОбъектСНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Ввоз") 
		ИЛИ ОбъектСНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Вывоз") 
		ИЛИ ОбъектСНТ.ПоставщикКодСтраныОтправки <> "KZ"
		ИЛИ ОбъектСНТ.ПолучательКодСтраныДоставки <> "KZ"
		ИЛИ ОбъектСНТ.ГрузоотправительКодСтраныОтправки <> "KZ"
		ИЛИ ОбъектСНТ.ГрузополучательКодСтраныОтправки <> "KZ")
		И НЕ ОбъектСНТ.АвтомобильныйТранспорт
		И НЕ ОбъектСНТ.ЖелезнодорожныйТранспорт 
		И НЕ ОбъектСНТ.ВоздушныйТранспорт
		И НЕ ОбъектСНТ.Трубопровод
		И НЕ ОбъектСНТ.МорскойТранспорт
		И НЕ ОбъектСНТ.Мультимодальный
		И НЕ ОбъектСНТ.ПрочийТранспорт 
		И ОбъектСНТ.ТипСНТ <> ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров") Тогда
		
		ТекстСообщения = НСтр("ru = 'Е. Вид транспорта обязателен для заполнения, если не указан код KZ в следующих полях: ""Код страны отправки/отгрузки"", ""Код страны доставки/поставки"", ""Код страны отправки"", ""Код страны доставки"".'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	...
	#Область РазделFДоговорF1ДоговорВрамкахУСДСРП
	...
	Если ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПоставщикДата) И НЕ ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПоставщикНомер) Тогда
		ТекстСообщения = НСтр("ru = 'F1. Отсутствует номер документа, определяющего поверенного (оператора) поставщика.'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПоставщикНомер) И НЕ ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПоставщикДата) Тогда
		ТекстСообщения = НСтр("ru = 'F1. Отсутствует дата документа, определяющего поверенного (оператора) поставщика.'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПолучательДата) И НЕ ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПолучательНомер) Тогда
		ТекстСообщения = НСтр("ru = 'F1. Отсутствует номер документа, определяющего поверенного (оператора) получателя.'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПолучательНомер) И НЕ ЗначениеЗаполнено(ОбъектСНТ.ДоговорВРамкахУСДПолучательДата) Тогда
		ТекстСообщения = НСтр("ru = 'F1. Отсутствует дата документа, определяющего поверенного (оператора) получателя.'");
		РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	КонецЕсли;
	...
	Если (ОбъектСНТ.ЭтиловыйСпирт.Количество() > 0 ИЛИ ОбъектСНТ.Виноматериал.Количество() > 0
		ИЛИ ОбъектСНТ.ПивоПивныеНапитки.Количество() > 0 ИЛИ ОбъектСНТ.АлкогольнаяпродукцияКромеПива.Количество() > 0) Тогда
		
		Если ЗначениеЗаполнено(ОбъектСНТ.НомерЛицензииПоставщика) И СтрДлина(ОбъектСНТ.НомерЛицензииПоставщика) < 6 Тогда
			
			ТекстСообщения = НСтр("ru = 'G. Данные по алкогольной продукции. Не корректный номер лицензии поставщика, номер должен быть не меньше 6 символов и содержать только цифры.'");
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
			
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ОбъектСНТ.НомерЛицензииПолучателя) И СтрДлина(ОбъектСНТ.НомерЛицензииПолучателя) < 6  Тогда
			
			ТекстСообщения = НСтр("ru = 'G. Данные по алкогольной продукции. Не корректный номер лицензии получателя, номер должен быть не меньше 6 символов и содержать только цифры.'");
			РезультатПроверки.УведомительныеОшибки.Добавить(ТекстСообщения);
	...
	#Область РазделLСведенияПоОтпускуТовара
	...
	#Область РазделОСправочныеСведения
...
Процедура ПроверитьТаблицуТовары(ОбъектСНТ, ТаблицаТоваров, НаименованиеТабличнойЧасти, ПредставлениеТабличнойЧасти, СтруктураРеквизитов, РезультатПроверки) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Не ЗначениеЗаполнено(Выборка.СуммаБезНалогов) И ЗначениеЗаполнено(Выборка.Цена) Тогда
		...
		Если Не ЗначениеЗаполнено(Выборка.Сумма) И ЗначениеЗаполнено(Выборка.Цена) Тогда
		...
		Если ЗначениеЗаполнено(Выборка.СтавкаНДСЧисло) И НЕ ЗначениеЗаполнено(Выборка.СуммаНДС) И ЗначениеЗаполнено(Выборка.Цена) Тогда
		...
		Если (НЕ ОбъектСНТ.ВидВвоза = ПредопределенноеЗначение("Перечисление.ВидыВвозаСНТ.Импорт") 
			...
			И НЕ ОбъектСНТ.ВидВвоза = ПредопределенноеЗначение("Перечисление.ВидыВвозаСНТ.ВременныйВвоз")
			И НЕ СНТСервер.ПроверитьПеремещениеИмпорт(ОбъектСНТ))
		...
		Если (НаименованиеТабличнойЧасти = "ЭтиловыйСпирт" 
			ИЛИ НаименованиеТабличнойЧасти = "Виноматериал"
			ИЛИ НаименованиеТабличнойЧасти = "АлкогольнаяпродукцияКромеПива"
			ИЛИ (НаименованиеТабличнойЧасти = "ДанныеПоНефтепродуктам" И НЕ(ОбъектСНТ.ВидПеремещения = ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС")
																			И ОбъектСНТ.ТипПоставщикаG6 = "4")) //«В переделах одного лица в рамках ЕАЭС» и значением «Импортер» в поле «Тип поставщика»
			ИЛИ НаименованиеТабличнойЧасти = "ТабачнаяПродукция")
		...
		Если НаименованиеТабличнойЧасти = "ТабачнаяПродукция" Тогда
			Если (Выборка.ЕдиницаИзмеренияКод <> "796") И (Выборка.ЕдиницаИзмеренияКод <> "166") И (Выборка.ЕдиницаИзмеренияКод <> "111") 
				И (Выборка.ЕдиницаИзмеренияКод <> "5111") И (Выборка.ЕдиницаИзмеренияКод <> "8751") И (Выборка.ЕдиницаИзмеренияКод <> "992") 
		...
		Если НаименованиеТабличнойЧасти = "ТоварыЭкспортныйКонтроль" Тогда
			...
			Если (ЗначениеЗаполнено(Выборка.НомерЛицензии) 
				И (НЕ ЗначениеЗаполнено(Выборка.ДатаВыдачиЛицензии)
				ИЛИ НЕ ЗначениеЗаполнено(Выборка.ДатаОкончанияЛицензии)))
				
				ИЛИ (ЗначениеЗаполнено(Выборка.ДатаВыдачиЛицензии) 
				И (НЕ ЗначениеЗаполнено(Выборка.НомерЛицензии)
				ИЛИ НЕ ЗначениеЗаполнено(Выборка.ДатаОкончанияЛицензии)))
				
				ИЛИ (ЗначениеЗаполнено(Выборка.ДатаОкончанияЛицензии) 
				И (НЕ ЗначениеЗаполнено(Выборка.НомерЛицензии)
				ИЛИ НЕ ЗначениеЗаполнено(Выборка.ДатаВыдачиЛицензии))) Тогда
				
				ТекстСообщения = НСтр("ru = '%2. Данные по разрешительному документу заполнены не полностью в строке №%1.'"); 
				ТекстСообщения = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(
				ТекстСообщения, Выборка.НомерСтроки, ПредставлениеТабличнойЧасти);
		...
		Если ЗначениеЗаполнено(Выборка.СтавкаНДС) И Выборка.СтавкаНДС = Справочники.СтавкиНДС.НайтиПоНаименованию(НСтр("ru = 'без НДС - не РК'")) Тогда
			
			ТекстСообщения = НСтр("ru = '%2. В строке №%1 ставка НДС с признаком ""Местом реализации не является РК"" используется при выписке ЭСФ по операции реализации не на территории РК. Рекомендуем указать другую ставку НДС.'"); 
			ТекстСообщения = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(
			ТекстСообщения, Выборка.НомерСтроки, ПредставлениеТабличнойЧасти);
...
Функция СоздатьXMLДляИмпортаВИСЭСФ(Знач МассивСНТ) Экспорт
	...
	ВерсияИСЭСФ = ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().АктуальнаяВерсияИСЭСФ();
...
Функция ПолучитьНовыеСНТ(ПараметрыВыгрузки) Экспорт
	...
	Для Каждого СтруктураПрофиляСинхронизации Из МассивДанныхПрофилейИСЭСФ Цикл
		...
		ПараметрыМетодаВходящихСНТ = СНТСервер.ПолучитьПараметрыМетода(ДанныеПрофиля.СтруктурнаяЕдиница.Ссылка, ВРег("querySntUpdates"), Перечисления.НаправленияСНТ.Входящий);
		ПараметрыМетодаИсходящихСНТ = СНТСервер.ПолучитьПараметрыМетода(ДанныеПрофиля.СтруктурнаяЕдиница.Ссылка, ВРег("querySntUpdates"), Перечисления.НаправленияСНТ.Исходящий);
		
		ЗаполнитьСведенияОДатеСинхронизации(ПараметрыМетодаВходящихСНТ, ПараметрыМетодаИсходящихСНТ, ДанныеПрофиля, СоответствиеПараметровСинхронизации);
		...
		МассивСНТДляПолученияИдентификаторовТоваров = Новый Массив(); // накапливаем ссылки СНТ, чтобы отправить завтрос на получение идентификаторов товаров
		...
		ЭтоПоследняяПорция = Ложь;
		Пока НЕ ЭтоПоследняяПорция Цикл
			Текст = НСтр("ru = '%ТекущаяДата% (Шаг %Номер% из %Количество%) Получение новых и обновление состояния исходящих СНТ. Профиль: %ПрофильИСЭСФ%.'");
			Текст = СтрЗаменить(Текст, "%ТекущаяДата%",  ТекущаяДата());
			Текст = СтрЗаменить(Текст, "%ПрофильИСЭСФ%", ПредставлениеПрофиля);
			Текст = СтрЗаменить(Текст, "%Номер%",        НомерШага);
			Текст = СтрЗаменить(Текст, "%Количество%",   КоличествоШагов);
			...
			ЭтоПоследняяПорция = ПолучитьДанныеНовыхСНТ(Перечисления.НаправленияСНТ.Исходящий, СтруктураПрофиляСинхронизации, Ложь, Ложь, ИдентификаторСессии, ВерсияВС, ПараметрыМетодаИсходящихСНТ, МассивИдентификаторовДляОбновленияСтатусаПриема, МассивСНТДляПолученияИдентификаторовТоваров);
		КонецЦикла;
...
Функция ПолучитьДанныеНовыхСНТ(Знач НаправлениеСНТ, Знач ПрофильИСЭСФ, Знач ПолучитьОднуПорцию, Знач ТолькоСоздатьОбновитьФайлы, ИдентификаторСессии, ВерсияИСЭСФ, ПараметрыМетода, МассивИдентификаторовДляОбновленияСтатусаПриема = Неопределено, МассивЭСФДляПолученияИдентификаторовТоваров = Неопределено) Экспорт
	...
	Пока НЕ ПоследнийБлок И (LastEventDate<>ПредыдущийLastEventDate ИЛИ lastSntId<>ПредыдущийlastSntId) Цикл
		...
		ЗапросXML = СтрЗаменить(ЗапросXML, "[direction]", СНТКлиентСервер.НаправлениеИСЭСФ(НаправлениеСНТ));
...
Процедура СоздатьОбновитьПолучаемыеСНТ(Знач sntInfoList, Знач НаправлениеСНТ, Знач СтруктурнаяЕдиница, Знач УчитыватьВсеСтатусыСНТ, МассивИсключаемыхИД = Неопределено, Знач Провести = Ложь, МассивЭСФДляПолученияИдентификаторовТоваров = Неопределено, МассивСНТДляПодтвержденияПолученияВходящихСНТ = Неопределено, Пользователь = Неопределено, МассивСНТДляПолученияДанныхПоСопоставлению = Неопределено) Экспорт
	...
	Попытка
		...
		Для Каждого ОбъектСНТ Из МассивСНТ Цикл
			//данная проверка для документов СНТ на импорт, когда аннулирование подтверждения было на портале и затем с помощью обновить получили изменения документа.
			Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз
				И ОбъектСНТ.Статус <> Перечисления.СтатусыСНТ.Подтвержден Тогда
				
				// Очистить в документе СНТ на импорт идентификатор товара и источник происхождения, так как на сервере данные были аннулированы.
				Если НЕ ОбъектСНТ.Ссылка.Пустая() Тогда
					МассивНаименованийТабличныхЧастей = ПолучитьМассивНаименованийТабличныхЧастейСНТ();
					МассивКолонокТабличныхЧастей = Новый Массив;
					МассивКолонокТабличныхЧастей.Добавить("ДополнительныйИдентификатор");
					МассивКолонокТабличныхЧастей.Добавить("ИсточникПроисхождения");
					
					Для Каждого НаименованиеТабличнойЧасти Из МассивНаименованийТабличныхЧастей Цикл
						Для Каждого Товар Из ОбъектСНТ[НаименованиеТабличнойЧасти] Цикл 
							Для Каждого Колонка Из МассивКолонокТабличныхЧастей Цикл 
								Товар[Колонка] = Неопределено;
							КонецЦикла;
						КонецЦикла;
					КонецЦикла;
				КонецЕсли;
				Если ОбъектСНТ.Проведен Тогда
					ОбъектСНТ.Записать(РежимЗаписиДокумента.ОтменаПроведения);
				КонецЕсли;
		...
		Для Каждого ОбъектСНТ Из МассивСНТ Цикл
			...
			Если ТипЗнч(МассивСНТДляПодтвержденияПолученияВходящихСНТ) = Тип("Массив") Тогда
				...
				Если ОбъектСНТ.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий") И 
					НЕ (ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И ОбъектСНТ.ПоставщикМалаяТорговаяТочка) Тогда // исключаем документы на возврат для МТТ, которые выписал поставщик
...
Функция НовыйМассивЗагружаемыхСНТ(Знач sntInfoList, Знач СтруктурнаяЕдиница, Знач ТолькоСуществующиеСНТ, Знач УчитыватьВсеСтатусыЭСФ, Пользователь = Неопределено)
	...
	// Создать массив старых и новых объектов СНТ.
	// Если ТолькоСуществующиеСНТ, то только старых объектов СНТ.
...
Процедура ЗаполнитьСНТ_Версия1(Знач SntInfo, Знач СтруктурнаяЕдиница, Знач НаправлениеСНТ, СНТ) Экспорт //Получение СНТ
	...
	СНТ.ВалютаКод = СНТСервер.ПолучитьСвойство(Snt, "currencyCode", "KZT");
	СНТ.КурсВалюты = СНТСервер.ПолучитьСвойство(Snt, "currencyRate", 1);
	...
	Если statuses <> Неопределено Тогда	
		...
		Если statusList <> Неопределено Тогда	
			...
			СоответствиеСтатусовПоставщика.Вставить("SMALL_RETAIL_OUTLET", "МалаяТорговаяТочка");
			СоответствиеСтатусовПоставщика.Вставить("PAWNEE_CUSTODIAN", "ЗалогодержательХранитель");
	...
	Если statuses <> Неопределено Тогда	
		...
		Если statusList <> Неопределено Тогда	
			...
			СоответствиеСтатусовПолучателя.Вставить("SMALL_RETAIL_OUTLET", "МалаяТорговаяТочка");
			СоответствиеСтатусовПолучателя.Вставить("PAWNEE_CUSTODIAN", "ЗалогодержательХранитель");
	...
	Если transferType <> Неопределено Тогда
		...
		Если СНТ.ВидПеремещения <> ПредопределенноеЗначение("Перечисление.ВидыПеремещенияСНТ.ПустаяСсылка") И СНТ.ПоставщикИдентификатор <> СНТ.ПолучательИдентификатор Тогда
			СНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами");
		Иначе
	...
	Если shippingInfo <> Неопределено Тогда
		...
		Если transportTypes <> Неопределено Тогда	
			...
			Если transportTypeList <> Неопределено Тогда	
				...
				СоответствиеВидовТранспорта.Вставить("OTHER", "ПрочийТранспорт");
	...
	//если хотя бы для одной строки любой табличной части товаров ожидается сопоставление, 
	//тогда заполняем соответсвующий статус в СНТ, далее другие строки и/или таблицы не проверяем
	ОжидаетсяВыполнениеСопоставления = Ложь;
	...
	Если productSet <> Неопределено Тогда
		...
		Если products <> Неопределено Тогда
			...
			Для Каждого ТоварXDTO Из СписокТоваров Цикл
				...
				Если Не ОжидаетсяВыполнениеСопоставления Тогда
					ЗаполнитьСтатусУведомленияПоСопоставлениюДляСНТ(НаправлениеСНТ, СНТ, ТоварСтрока);
					ОжидаетсяВыполнениеСопоставления = ?(СНТ.СтатусСопоставленияДляСНТ = Перечисления.СтатусыСопоставленияДляСНТ.ОжидаетсяСопоставлениеИмпортёра, Истина, Ложь);
				КонецЕсли;
			КонецЦикла;
		КонецЕсли;
	КонецЕсли;
	...
	Если otherProductWithDigitalMarkSet <> Неопределено Тогда
		...
		Если products <> Неопределено Тогда
			...
			Для Каждого ТоварXDTO Из СписокТоваров Цикл
				...
				ТоварСтрока = ЗаполнитьСНТ_ДобавитьБазовыеСведенияОТоваре(ТоварXDTO, ТоварСтрока);
				ТоварСтрока.Количество = СНТСервер.ПолучитьСвойство(ТоварXDTO, "packageQuantity", 0); // Количество потребительских упаковок(в штуках) (G9 6)
				Если Не ОжидаетсяВыполнениеСопоставления Тогда
					ЗаполнитьСтатусУведомленияПоСопоставлениюДляСНТ(НаправлениеСНТ, СНТ, ТоварСтрока);
					ОжидаетсяВыполнениеСопоставления = ?(СНТ.СтатусСопоставленияДляСНТ = Перечисления.СтатусыСопоставленияДляСНТ.ОжидаетсяСопоставлениеИмпортёра, Истина, Ложь);
				КонецЕсли;
	...
	//Раздел К. Данные о грузе, перевозимом на автомобильном транспорте carCargoInfo
	#Область ДанныеОГрузеПеревозимомНаАвтомобильномТранспорте	
	carCargoInfo = СНТСервер.ПолучитьСвойство(Snt, "carCargoInfo", Неопределено);
	
	Если carCargoInfo <> Неопределено Тогда
		
		СНТ.НомерОттискаПломбы = СНТСервер.ПолучитьСвойство(carCargoInfo,"stampPrintNumber", "");
		СНТ.ФИОВодителя = СНТСервер.ПолучитьСвойство(carCargoInfo, "driverFIO", "");
		СНТ.ИИНВодителя = СНТСервер.ПолучитьСвойство(carCargoInfo, "driverTin", "");
		
		//Раздел K1. Сведение о грузе CargoInfo
		cargoInfo = СНТСервер.ПолучитьСвойство(carCargoInfo, "cargoInfo", Неопределено);
		
		Если cargoInfo <> Неопределено Тогда
			
			СведенияОГрузе = ЭСФСервер.СписокXDTOИзОбъектXDTO(cargoInfo.cargoInfo);
			
			Для Каждого ГрузСтрокаXDTO Из СведенияОГрузе Цикл
				
				ГрузСтрока = СНТ.СведенияОГрузе.Добавить();
				
				ГрузСтрока.КлассГруза = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "cargoClass", ""); //Класс груза (K 1.8)
				ГрузСтрока.КодГруза = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "cargoCode", ""); //Код груза (K 1.7)
				ГрузСтрока.НоменклатурныйНомер = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "code", ""); //Номенклатурный номер (код) (K 1.2)
				ГрузСтрока.Документы = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "documents", ""); //С грузом следуют документы (K 1.3)
				ГрузСтрока.МассаБрутто = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "grossWeight", ""); //Масса брутто (т.) (K 1.9)
				ГрузСтрока.МассаНетто = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "netWeight", ""); //Масса нетто (т.) (K 1.10)
				ГрузСтрока.ВидУпаковки = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "packagingType", ""); //Вид упаковки (K 1.4)
				ГрузСтрока.КоличествоМест = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "seatsNumber", ""); //Кол-во мест (K 1.5)
				ГрузСтрока.СпособОпределенияМассы = СНТСервер.ПолучитьСвойство(ГрузСтрокаXDTO, "weightDeterminationType", ""); //Способ опредления массы (K 1.6)
			КонецЦикла;
			
		КонецЕсли; 
		
		//Раздел K2. Погрузочно-разгрузочные операции LoadingUnloadingInfo
		loadingUnloadingInfo = СНТСервер.ПолучитьСвойство(carCargoInfo, "loadingUnloadingInfo", Неопределено);
		
		Если loadingUnloadingInfo <> Неопределено Тогда
			
			ПогрузочноРазгрузочныеОперации = ЭСФСервер.СписокXDTOИзОбъектXDTO(loadingUnloadingInfo.loadingUnloadingInfo);
			
			Для Каждого ПогрузРазгрузОперацCтрокаXDTO Из ПогрузочноРазгрузочныеОперации Цикл
				
				ПогрузРазгрузОперацCтрока = СНТ.ПогрузочноРазгрузочныеОперации.Добавить();
				
				ПогрузРазгрузОперацCтрока.ВремяПрибытия = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "arrivalDate", "01.01.0001"); //Время прибытия (K 2.15)
				ПогрузРазгрузОперацCтрока.ВремяУбытия = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "departureDate", "01.01.0001"); //Время убытия (K 2.16)
				ПогрузРазгрузОперацCтрока.Простой = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "downtime", "");; //Простой (K 2.17)
				ПогрузРазгрузОперацCтрока.ВремяПростоя = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "downtimeDate", "01.01.0001"); //Время простоя (мин.) (K 2.18)
				ПогрузРазгрузОперацCтрока.Исполнитель = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "executor", ""); //Исполнитель (перевозчик, отправитель, получатель) (K 2.12)
				ПогрузРазгрузОперацCтрока.СпособПогрузки = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "loadingType", ""); //Способ погрузки (ручной, нал. мех. грузопод., емк. ковша) (K 2.13)
				ПогрузРазгрузОперацCтрока.КодСпособаПогрузки = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "loadingTypeCode", ""); //Код способа погрузки (K 2.14)
				ПогрузРазгрузОперацCтрока.Наименование = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "name", ""); //Наименов., колич. (K 2.19)
				ПогрузРазгрузОперацCтрока.Операция = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "operation", ""); //Операция (K 2.11)
				ПогрузРазгрузОперацCтрока.ПодписьОтветственногоЛица = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "responsiblePersonSignature", ""); //Подпись ответстственного лица (K 2.20)
				ПогрузРазгрузОперацCтрока.ТранспортныеУслуги = СНТСервер.ПолучитьСвойство(ПогрузРазгрузОперацCтрокаXDTO, "transportServices", ""); //Транспортные услуги (K 2.21)
			КонецЦикла;
			
		КонецЕсли;	
		
		//Раздел K3. Прочие сведения (заполняется перевозчиком) OtherInfo
		otherInfo = СНТСервер.ПолучитьСвойство(carCargoInfo, "otherInfo", Неопределено);
		
		Если otherInfo <> Неопределено Тогда
			
			ПрочиеСведения = ЭСФСервер.СписокXDTOИзОбъектXDTO(otherInfo.otherInfo);
			
			Для Каждого ПрочиеСведенияCтрокаXDTO Из ПрочиеСведения Цикл
				
				ПрочиеСведенияCтрока = СНТ.ПрочиеСведения.Добавить();
				
				ПрочиеСведенияCтрока.ПоправочныйКоэффициентВодитель = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "driverCoefficient", ""); //Поправочный коэффициент (расценка водителя)
				ПрочиеСведенияCтрока.КодЭкспедиции = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "expeditionCode", ""); //Код экспедиции
				ПрочиеСведенияCтрока.РасстояниеПоГруппам1 = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "firstGroupTransportationDistance", ""); //Расстояние перевозок по группам дорог (І гр.) (км.)
				ПрочиеСведенияCтрока.ЗаТранспортныеУслугиКлиент = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "fromClient", ""); //За транспортные услуги с клиента
				ПрочиеСведенияCтрока.РасстояниеПоГруппамГород = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "inCityTransportationDistance", ""); //Расстояние перевозок по группам дорог (в гор.) (км.)
				ПрочиеСведенияCтрока.ПоправочныйКоэффициентОсновнойТариф = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "mainCoefficient", ""); //Поправ. коэфф. (основной тариф)
				ПрочиеСведенияCтрока.Штраф = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "penalty", ""); //Штраф
				ПрочиеСведенияCтрока.РасстояниеПоГруппам2 = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "secondGroupTransportationDistance", ""); //Расстояние перевозок по группам дорог (ІІ гр.) (км.)
				ПрочиеСведенияCтрока.Отметки = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "setActMarks", ""); //Отметки о составленных актах
				ПрочиеСведенияCтрока.РасстояниеПоГруппам3 = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "thirdGroupTransportationDistance", ""); //Расстояние перевозок по группам дорог (ІІІ гр.) (км.)
				ПрочиеСведенияCтрока.ЗаТранспортныеУслугиВодитель = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "toDriver", ""); //За транспортные услуги водителю
				ПрочиеСведенияCтрока.РасстояниеПоГруппамВсего = СНТСервер.ПолучитьСвойство(ПрочиеСведенияCтрокаXDTO, "totalTransportationDistance", ""); //Расстояние перевозок по группам дорог (всего) (км.)
				
			КонецЦикла;
			
		КонецЕсли;
		
		//Раздел К4. Таксировка TaxInfo
		taxInfo = СНТСервер.ПолучитьСвойство(carCargoInfo, "taxInfo", Неопределено);
		
		Если taxInfo <> Неопределено Тогда
			
			Таксировка = ЭСФСервер.СписокXDTOИзОбъектXDTO(taxInfo.taxInfo);
			
			Для Каждого ТаксировкаCтрокаXDTO Из Таксировка Цикл
				
				ТаксировкаCтрока = СНТ.Таксировка.Добавить();
				
				ТаксировкаCтрока.РасчетСтоимости = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "costCalculation", ""); //Расчет стоимости (K 4.2)
				ТаксировкаCтрока.СкидкаПростой = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "discountForDowntime", ""); //Скидка за сокр. простоя (K 4.11)
				ТаксировкаCтрока.ЗаСпецТранспорт = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "forSpecialTransport", ""); //За спец. трансп (K 4.5)
				ТаксировкаCтрока.ЗаТонны = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "forTonns", ""); //За тонны (K 4.3)
				ТаксировкаCтрока.ЗаТранспортныеУслуги = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "forTransportServices", ""); //За трансп. услуги (K 4.6)
				ТаксировкаCтрока.СверхнормативПогруз = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "loading", ""); //Погруз (K 4.8)
				ТаксировкаCтрока.ПогрузочноРазгрузочныеРаботы = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "loadingUnloadingWork", ""); //Погр.-разгр. раб (тонн) (K 4.7)
				ТаксировкаCтрока.ПрочиеДоплаты = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "otherSurcharge", ""); //Прочие доплаты (K 4.10)
				ТаксировкаCтрока.Таксировка = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "tax", ""); //Таксировка (K 4.13)
				ТаксировкаCтрока.Всего = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "total", ""); //Всего (K 4.12)
				ТаксировкаCтрока.Недогруз = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "underload", ""); //Недогруз автомоб. и прицепа (K 4.4)
				ТаксировкаCтрока.СверхнормативРазгруз = СНТСервер.ПолучитьСвойство(ТаксировкаCтрокаXDTO, "unloading", ""); //Разгр (K 4.9)
	...
	Если ogdMarksInfo <> Неопределено Тогда
		...
		СНТ.ФИОСотрудникаОГД = СНТСервер.ПолучитьСвойство(ogdMarksInfo, "ogdEmployeeFullName", ""); // Ф.И.О. сотрудника ОГД /сотрудника уполномоченного органа (организации) (N 88)
		
		sntOgdMarksBody = СНТСервер.ПолучитьСвойство(ogdMarksInfo, "sntOgdMarksBody", "");
		ogdMarks = СНТСервер.ОбъектXDTOИзСтрокиXML(sntOgdMarksBody, ФабрикаXDTO);
		
		//СНТ.ПунктАвтомобильногоПропуска = СНТСервер.ПолучитьСвойство(ogdMarks, "automotiveCheckpointId", ""); // Пункт автомобильного пропуска (N 87)
		СНТ.ДатаВремяПересеченияГосударственнойГраницы = СНТСервер.ПолучитьСвойство(ogdMarks, "borderCrossingDateWithTime", "01.01.0001 00:00:00"); // Дата и время пересечения государственной границы/территории СЭЗ (N 89)
		//Данные о фактическом транспорте (N 90)
		СНТ.МаркаАТСФакт = СНТСервер.ПолучитьСвойство(ogdMarks, "carModel", ""); // Марка АТС (N 90.1)
		СНТ.ГосНомерАТСФакт = СНТСервер.ПолучитьСвойство(ogdMarks, "carStateNumber", ""); // гос.номер АТС (N 90.2)
		СНТ.ФИОВодителяФакт = СНТСервер.ПолучитьСвойство(ogdMarks, "driverFullName", "");// Ф.И.О. водителя (N 90.3)
		СНТ.ИИНВодителяФакт = СНТСервер.ПолучитьСвойство(ogdMarks, "driverIin", "");// ИИН водителя (N 90.4)
...
Функция НайтиСуществующиеСНТПоИдентификаторам(Знач МассивИдентификаторов, Знач СтруктурнаяЕдиница) Экспорт
	...
	// Создать пустую таблицу параметров поиска СНТ.	
	...
	// Заполнить таблицу параметров поиска СНТ.
...
Функция НайтиСсылкиПоЗначениямРеквизитов(Знач ЗначенияРеквизитов, Знач ОбъектМетаданных, Знач ИдентификационныйНомер = Неопределено) Экспорт
	...
	Если ИдентификационныйНомер <> Неопределено И ИмяОбъекта <> "СопоставлениеСНТиФНО" Тогда
		...
		//часть 1 - возвраты МТТ до изменения механизма по табличным частям G2-G8
		...
		Запрос.УстановитьПараметр("ДатаИзмененийМТТ", СНТСерверПереопределяемый.ДатаИзмененийМТТ());
		
		Запрос.Текст = 
		"ВЫБРАТЬ
		|	СНТ.Ссылка КАК Ссылка
		|ПОМЕСТИТЬ ВТ_СНТ_ВозвратОтМТТ
		|ИЗ
		|	Документ.СНТ КАК СНТ
		|ГДЕ
		|	СНТ.Ссылка В(&МассивСНТ)
		...
		|	И ВЫБОР
		|			КОГДА СНТ.СвязанныйСНТ <> ЗНАЧЕНИЕ(Документ.СНТ.ПустаяСсылка)
		|				ТОГДА ЕСТЬNULL(СНТ.СвязанныйСНТ.Дата, ДАТАВРЕМЯ(1, 1, 1)) < &ДатаИзмененийМТТ
		|			ИНАЧЕ СНТ.Дата < &ДатаИзмененийМТТ
		|		КОНЕЦ
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		...
		|	Документ.СНТ КАК СНТ
		|ГДЕ
		|	НЕ (СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров) И СНТ.ПоставщикМалаяТорговаяТочка)
		|	И (СНТ.ПоставщикИдентификатор = &ИдентификационныйНомер ИЛИ СНТ.ПоставщикБИНСтруктурногоПодразделения = &ИдентификационныйНомер)
		|	И СНТ.Направление = &Исходящий
		|	И СНТ.Ссылка В
		|	(ВЫБРАТЬ
		|		ВТ_СНТ_ВозвратОтМТТ.Ссылка КАК Ссылка
		|	ИЗ
		|		ВТ_СНТ_ВозвратОтМТТ КАК ВТ_СНТ_ВозвратОтМТТ)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ РАЗЛИЧНЫЕ
		...
		|ГДЕ
		|	СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
		|	И СНТ.ПоставщикМалаяТорговаяТочка
		|	И ЕСТЬNULL(СНТТоварыВС.НомерСтроки, 0) <> 0
		|	И ((СНТ.ПоставщикИдентификатор = &ИдентификационныйНомер И СНТ.Организация.%ОрганизацияИНН = &ИдентификационныйНомер)
		|			ИЛИ СНТ.ПоставщикБИНСтруктурногоПодразделения = &ИдентификационныйНомер)
		|	И СНТ.Направление = &Входящий
		|	И СНТ.Ссылка В
		|	(ВЫБРАТЬ
		|		ВТ_СНТ_ВозвратОтМТТ.Ссылка КАК Ссылка
		|	ИЗ
		...
		|	СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
		|	И СНТ.ПоставщикМалаяТорговаяТочка
		|	И (СНТ.ЕстьЭтиловыйСпирт ИЛИ
		|		СНТ.ЕстьВиноматериал ИЛИ
		|		СНТ.ЕстьПивоПивныеНапитки ИЛИ
		|		СНТ.ЕстьАлкоголь ИЛИ
		|		СНТ.ЕстьНефтепродукты ИЛИ
		|		СНТ.ЕстьБиотопливо ИЛИ
		|		СНТ.ЕстьТабачныеИзделия ИЛИ
		|		СНТ.ЕстьДругиеТоварыЦифроваяМаркировка ИЛИ
		|		СНТ.ЕстьТоварыЭК)
		|	И ((СНТ.ПолучательИдентификатор = &ИдентификационныйНомер И СНТ.Организация.%ОрганизацияИНН = &ИдентификационныйНомер)
		...
		|		ПО (СНТТоварыВС.Ссылка = СНТ.Ссылка)
		|ГДЕ
		|	НЕ СНТ.ПоставщикМалаяТорговаяТочка	
		|	И (СНТ.Направление = &Входящий 
		...
		ТаблицаСНТПринадлежащихСтруктурнойЕдинице_Часть1 = Запрос.Выполнить().Выгрузить();
		МассивСНТПринадлежащихСтруктурнойЕдинице_Часть1 = ТаблицаСНТПринадлежащихСтруктурнойЕдинице_Часть1.ВыгрузитьКолонку("Ссылка");
		
		//часть 2 - остальные документы и возвраты от МТТ после изменения механизма
		Запрос.Текст = 
		"ВЫБРАТЬ
		|	СНТ.Ссылка КАК Ссылка
		|ПОМЕСТИТЬ ВТ_МассивСНТ
		|ИЗ
		|	Документ.СНТ КАК СНТ
		|ГДЕ
		|	СНТ.Ссылка В(&МассивСНТ)
		...
		|	И СНТ.Ссылка В
		|	(ВЫБРАТЬ
		|		ВТ_МассивСНТ.Ссылка КАК Ссылка
		|	ИЗ
		|		ВТ_МассивСНТ КАК ВТ_МассивСНТ)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ РАЗЛИЧНЫЕ
		...
		|	СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
		|	И СНТ.ПоставщикМалаяТорговаяТочка
		//|	И ЕСТЬNULL(СНТТоварыВС.НомерСтроки, 0) <> 0 Условие не нужно - все табличные части работают по одной логике
		|	И ((СНТ.ПоставщикИдентификатор = &ИдентификационныйНомер И СНТ.Организация.%ОрганизацияИНН = &ИдентификационныйНомер)
		|			ИЛИ СНТ.ПоставщикБИНСтруктурногоПодразделения = &ИдентификационныйНомер)
		|	И СНТ.Направление = &Входящий
		|	И СНТ.Ссылка В
		...
		ЭСФСервер.ЗаменитьИменаРеквизитовПолейЗапросов(Запрос.Текст, СоответсвиеИменРеквизитов);
		ТаблицаСНТПринадлежащихСтруктурнойЕдинице_Часть2 = Запрос.Выполнить().Выгрузить();
		МассивСНТПринадлежащихСтруктурнойЕдинице_Часть2 = ТаблицаСНТПринадлежащихСтруктурнойЕдинице_Часть2.ВыгрузитьКолонку("Ссылка");
		
		//объединям результаты обоих веток
		МассивСНТПринадлежащихСтруктурнойЕдинице = Новый Массив;
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивСНТПринадлежащихСтруктурнойЕдинице, МассивСНТПринадлежащихСтруктурнойЕдинице_Часть1);
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивСНТПринадлежащихСтруктурнойЕдинице, МассивСНТПринадлежащихСтруктурнойЕдинице_Часть2);
...
Функция ОбновитьСтатусыСНТПоИдентификаторам(Знач МассивИдентификаторовСНТ, Знач НаправлениеСНТ, Знач ПрофильИСЭСФ, ИдентификаторСессии, МассивСНТДляПолученияДанныхПоСопоставлению = Неопределено, ОбновлениеСвязаннойСНТ = Ложь) Экспорт
	...
	Если НЕ ЭтоМодульнаяОшибка(ОтветXML, ИнформацияОбОшибке) Тогда
		...
		Если sntSummaryList <> Неопределено Тогда
			...
			//Массив для хранения ссылок на СНТ с типом Отозван, Отклонен, а так же для хранения ссылок при обновлении статуса исправленных СНТ
			КоллекцияСсылокСНТ = Новый Массив;
			
			// Обновить документы СНТ.
			ОтразитьИзмененияСтатусовСНТ(Результат, СтруктурнаяЕдиница,,КоллекцияСсылокСНТ, МассивСНТДляПолученияДанныхПоСопоставлению, НаправлениеСНТ, ОбновлениеСвязаннойСНТ);
			// Обновить документы ЭСФ.
			ОбновитьСтатусыЭСФПриИзмененииСНТ(КоллекцияСсылокСНТ, ИдентификаторСессии, ПрофильИСЭСФ);
			// Обновить связанные документы СНТ при выписки исправленной.
			ОбновитьСтатусыСвязанныхСНТ(КоллекцияСсылокСНТ, ИдентификаторСессии, ПрофильИСЭСФ);
...
Процедура ОбновитьСтатусыСвязанныхСНТ(Знач МассивСНТ, Знач ИдентификаторСессии, Знач ПрофильИСЭСФ)
	
	КоллекцияСНТДляОбновленияЭСФ = Новый Массив;
	ОбновлениеСвязаннойСНТ = Ложь;
	...
	ТекстЗапроса = 
		...
		|ГДЕ
		|	СНТ.Ссылка В(&МассивСНТ)
		|	И СНТ.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.Ошибочный)
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	СвязанныеСНТ.Идентификатор,
		|	СвязанныеСНТ.Направление,
		|	СНТ.ТипСНТ
		|ИЗ
		|	ВТ_СНТ КАК СНТ
		|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.СНТ КАК СвязанныеСНТ
		|		ПО СНТ.СвязанныйСНТ = СвязанныеСНТ.Ссылка
		|ГДЕ
		|	СвязанныеСНТ.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.Аннулирован)";
	...
	КоллекцияСНТДляОбновленияСтатусов = Новый Массив;
	КоллекцияСНТДляОбновленияСтатусовСвязанных = Новый Массив;
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		Если ВыборкаДетальныеЗаписи.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И ЗначениеЗаполнено(ВыборкаДетальныеЗаписи.Направление) 
			И ВыборкаДетальныеЗаписи.Направление = Перечисления.НаправленияСНТ.Входящий Тогда
			
			КоллекцияСНТДляОбновленияСтатусовСвязанных.Добавить(ВыборкаДетальныеЗаписи.Идентификатор)
		Иначе
			КоллекцияСНТДляОбновленияСтатусов.Добавить(ВыборкаДетальныеЗаписи.Идентификатор);
		КонецЕсли;
	КонецЦикла;
		
	Если КоллекцияСНТДляОбновленияСтатусов.Количество() <> 0 Тогда
		//Выполнить обновление статусов отправленных СНТ.
		ОбновлениеСвязаннойСНТ = Истина;
		РезультатОбновленияИсходящихСНТ = ОбновитьСтатусыСНТПоИдентификаторам(КоллекцияСНТДляОбновленияСтатусов, Перечисления.НаправленияСНТ.Исходящий, ПрофильИСЭСФ, ИдентификаторСессии,,ОбновлениеСвязаннойСНТ);
		
		ТекстСообщения = НСтр("ru='Обновлены статусы связанных документов СНТ.'");
		ЭСФКлиентСерверПереопределяемый.СообщитьПользователю(ТекстСообщения);
		ЭСФВызовСервера.СоздатьЗаписьЖурналаРегистрации("ОбменСНТ.ОтразитьИзмененияСтатусовСНТ", "Информация", , , ТекстСообщения);	
	КонецЕсли;
	
	Если КоллекцияСНТДляОбновленияСтатусовСвязанных.Количество() <> 0 Тогда
		//Выполнить обновление статусов связанных отправленных СНТ.
		ОбновлениеСвязаннойСНТ = Истина;
		РезультатОбновленияИсходящихСНТ = ОбновитьСтатусыСНТПоИдентификаторам(КоллекцияСНТДляОбновленияСтатусовСвязанных, Перечисления.НаправленияСНТ.Входящий, ПрофильИСЭСФ, ИдентификаторСессии,,ОбновлениеСвязаннойСНТ);
...
//
Процедура ОтразитьИзмененияСтатусовСНТ(Знач КоллекцияСтатусовСНТ, Знач СтруктурнаяЕдиница, Знач СоответствиеПодписейСНТ = Неопределено, КоллекцияСсылокСНТ = Неопределено, КоллекцияСсылокСНТДляПолученияДанныхПоСопоставлению = Неопределено, Знач НаправлениеСНТ = Неопределено, ОбновлениеСвязаннойСНТ = Ложь, Действие = Неопределено)
		...
		Если НовыеДанныеСтатусовСНТ <> Неопределено Тогда
			...
			Если ОбновитьСНТ Тогда
				...
				Если Действие <> Неопределено Тогда
					Если Действие = "АннуллироватьПодтверждение" Тогда
						// Очистить в документе СНТ на импорт идентификатор товара и источник происхождения, так как на сервере данные были аннулированы.
						Если НЕ ОбъектСНТ.Ссылка.Пустая() Тогда
							МассивНаименованийТабличныхЧастей = ПолучитьМассивНаименованийТабличныхЧастейСНТ();
							МассивКолонокТабличныхЧастей = Новый Массив;
				...
				КонецЕсли;
				Если (ОбъектСНТ.Статус = Перечисления.СтатусыСНТ.Аннулирован И ОбъектСНТ.Проведен И ОбновлениеСвязаннойСНТ) Тогда
					ОбъектСНТ.Записать(РежимЗаписиДокумента.Проведение);
				КонецЕсли;
	...
	Если НЕ (ЗначениеЗаполнено(НаправлениеСНТ) И НаправлениеСНТ = Перечисления.НаправленияСНТ.Входящий) Тогда
		...
		Если НЕ ОбновлениеСвязаннойСНТ Тогда
...
Функция СоздатьЗапросНаИзменениеСтатусовСНТ(Знач Действие, Знач КоллецияДляИзмененияСтатусов, Знач ДанныеКлючаЭЦП, Знач ТипПодписиЭСФ) Экспорт
	...
	ФИОСубъекта = "";
	Если Не ДанныеКлючаЭЦП.Свойство("ФИОСубъекта", ФИОСубъекта) И Действие = СНТКлиентСервер.ДействиеПодтверждение() Тогда
		Если ЭСФВызовСервера.ИспользоватьПодписьНовойКомпоненты() И ЭСФВызовСервера.ИспользоватьВнешнююКриптографиюДляКомпоненты() Тогда
			ДанныеСертификата = ЭСФСерверПовтИсп.ОбработкаОбменЭСФ().СвойстваСертификата_Kalkan(ДанныеКлючаЭЦП.КлючBase64, ДанныеКлючаЭЦП.Пароль);
			Если ДанныеСертификата = Неопределено Тогда
				ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ОбменСНТ.СоздатьЗапросНаИзменениеСтатусовСНТ'"), 
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
				ВызватьИсключение НСтр("ru = 'Не удалось получить данные сертификата.'");
			КонецЕсли;
		Иначе
	...
	Для Каждого ЭлементКоллеции Из КоллецияДляИзмененияСтатусов Цикл
		...
		ИначеЕсли Действие = СНТКлиентСервер.ДействиеАннуллироватьПодтверждение() Тогда
			ТекстДействие = "CANCEL_CONFIRM";
		Иначе
			ЗаписьЖурналаРегистрации(
			НСтр("ru = 'ОбменСНТ.СоздатьЗапросНаИзменениеСтатусовСНТ'"), 
			УровеньЖурналаРегистрации.Ошибка,,,
		...
		Если Действие = СНТКлиентСервер.ДействиеПодтверждение() Тогда
			acceptanceGoodsBodyТекущегоДокумента = СтрЗаменить(acceptanceGoodsBody, "[Подтвердитель]", ФИОСубъекта);
			acceptanceGoodsBodyТекущегоДокумента = СтрЗаменить(acceptanceGoodsBodyТекущегоДокумента, "[ДатаПодтверждения]", ТекущаяДата());
			acceptanceGoodsBodyТекущегоДокумента = СтрЗаменить(acceptanceGoodsBodyТекущегоДокумента, "[ИмяПодтвердителя]", ФИОСубъекта);
...
Функция ВыполнитьЗапросНаИзменениеСтатусовСНТ(Знач Действие, Знач ЗапросXML, Знач ПрофильИСЭСФ, ИдентификаторСессии = Неопределено, СоответствиеПодписейСНТ = Неопределено) Экспорт
	...
	Если НЕ ЭтоМодульнаяОшибка(ОтветXML, ИнформацияОбОшибке) Тогда
		...
		Если changeStatusResultList <> Неопределено Тогда
			...
			ОтразитьИзмененияСтатусовСНТ(КоллекцияСтатусовСНТ, СтруктурнаяЕдиница, СоответствиеПодписейСНТ, КоллекцияСсылокСНТ,,,, Действие);  //, СоответствиеПодписейСНТ, Действие
			ОбновитьСтатусыЭСФПриИзмененииСНТ(КоллекцияСсылокСНТ, ИдентификаторСессии, ПрофильИСЭСФ);
			...
			Если КоллекцияСсылокСНТ.Количество() <> 0 Тогда
				...
				Для Каждого СНТ Из КоллекцияСсылокСНТ Цикл
					Если СНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.Перемещение") 
						ИЛИ СНТ.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров")
						ИЛИ Действие = "АннуллироватьПодтверждение"
						ИЛИ (СНТ.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами") И НЕ СНТ.Проведен
								И НЕ СНТСервер.ПроверитьПеремещениеИмпорт(СНТ)) Тогда
					...
					КонецЕсли;
				КонецЦикла;
				КоллекцияРазделенныхСНТ = СНТСервер.РазделитьМассивСНТ(МассивСНТДляПолученияИдентификаторов);
				
				ОбработкаОбменЭСФ = ЭСФСерверПовтИсп.ОбработкаОбменЭСФ();
				Для Каждого Элемент Из КоллекцияРазделенныхСНТ Цикл
					Если Элемент.значение.Количество() <> 0 Тогда
						...
						ОбработкаОбменЭСФ.ПолучитьИдентификаторыТоваровПоРегНомерамДокументов(Элемент.значение, ПрофильИСЭСФ, , Истина, ДополнительныеПараметры);
					КонецЕсли;
				КонецЦикла;
			КонецЕсли; 
	...
	Иначе
		...
		ЗаписьЖурналаРегистрации(
		НСтр("ru = 'ОбменСНТ.ВыполнитьЗапросНаИзменениеСтатусов'"), 
		УровеньЖурналаРегистрации.Ошибка,,,
		ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Функция ДанныеОшибкиИзмененияСтатусаСНТ(Знач КодОшибки, Знач Действие)
	...
	Иначе
		...
		ДанныеОшибки.Расшифровка = НСтр("ru = 'Выбранное действие не выполнено по причине: '") + ИнформацияОбОшибке.ТекстИБ;
	КонецЕсли;
...
Функция ПечатьСНТ(МассивСНТ, ОбъектыПечати = Неопределено) Экспорт
	...
	|	СНТ.ГрузоотправительДополнительныеСведения,
	...
	|	СНТ.ГрузополучательДополнительныеСведения,
	|	СНТ.Перевозчик,
	...
	Пока ДанныеПоДокументам.Следующий() Цикл
		...
		ДанныеВиноматериал.Сбросить(); 
		ДанныеПиво.Сбросить(); 
		ДанныеАлкогольПр.Сбросить(); 
		ДанныеНефтепродукт.Сбросить(); 
		ДанныеБиотопливо.Сбросить(); 
		ДанныеТабачНеЦифрМарк.Сбросить(); 
		ДанныеДрТоварыЦифрМарк.Сбросить(); 
		ДанныеТоварЭкспертКонтроль.Сбросить(); 
		ДанныеСведенияОГрузе.Сбросить(); 
		ДанныеПогрРазгОперац.Сбросить(); 
		ДанныеПрочиеСведен.Сбросить(); 
		ДанныеТаксировка.Сбросить();
		...
		//вывод QR кода в печатной форме СНТ
		ВывестQRКодВОбласть(ОбластиМакета, ДанныеПоДокументам.РегистрационныйНомерИСЭСФ);
		...
		Пока ДанныеЭтиловыйСпирт.НайтиСледующий(ДанныеПоДокументам.Ссылка) Цикл
			ОбластиМакета.ОбластьРазделG2ШапкаТаблица.Параметры.КодОперацииG2 = ПолучитьНаименованиеОперацииРазделаG(ДанныеПоДокументам.КодОперацииG2);
		...
		Пока ДанныеПиво.НайтиСледующий(ДанныеПоДокументам.Ссылка) Цикл
			ОбластиМакета.ОбластьРазделG4ШапкаТаблица.Параметры.КодОперацииG4 = ПолучитьНаименованиеОперацииРазделаG(ДанныеПоДокументам.КодОперацииG4);
		...
		Пока ДанныеАлкогольПр.НайтиСледующий(ДанныеПоДокументам.Ссылка) Цикл
			ОбластиМакета.ОбластьРазделG5ШапкаТаблица.Параметры.КодОперацииG5 = ПолучитьНаименованиеОперацииРазделаG(ДанныеПоДокументам.КодОперацииG5);
		...
		Пока ДанныеНефтепродукт.НайтиСледующий(ДанныеПоДокументам.Ссылка) Цикл
			...
			ОбластиМакета.ОбластьРазделG6ШапкаТаблица.Параметры.КодОперацииG6 = ПолучитьНаименованиеОперацииРазделаG(ДанныеПоДокументам.КодОперацииG6);
		...
		Пока ДанныеБиотопливо.НайтиСледующий(ДанныеПоДокументам.Ссылка) Цикл
			...
			ОбластиМакета.ОбластьРазделG7ШапкаТаблица.Параметры.КодОперацииG7 = ПолучитьНаименованиеОперацииРазделаG(ДанныеПоДокументам.КодОперацииG7);
		...
		Пока ДанныеТабачНеЦифрМарк.НайтиСледующий(ДанныеПоДокументам.Ссылка) Цикл
			...
			ОбластиМакета.ОбластьРазделG8ШапкаТаблица.Параметры.КодОперацииG8 = ПолучитьНаименованиеОперацииРазделаG(ДанныеПоДокументам.КодОперацииG8);
...
// Выводит в рисунок области макета QR код, сформированный по данным регистрационного номера СНТ.
//
// Параметры:
// 		ОбластиМакета - ТекстовыйДокумент - Области макета печатной формы, который содержат рисунок
// 		ДанныеДляФормированияКода - Строка - Строковые данные для формирования содержания QR кода
//
Процедура ВывестQRКодВОбласть(ОбластиМакета, Знач ДанныеДляФормированияКода)
	
	МакетНастроенДляВыводаQR = Истина;
	Попытка
		//Проверка наличия рисунка в макете для вывода изображения
		РисунокКод = ОбластиМакета.ОбластьРазделA.Рисунки.QRКодСНТ;
	Исключение
		МакетНастроенДляВыводаQR = Ложь;
	КонецПопытки;
	Если МакетНастроенДляВыводаQR Тогда
		РисунокКод.Линия = Новый Линия(ТипЛинииРисункаТабличногоДокумента.НетЛинии);
		Если ЗначениеЗаполнено(ДанныеДляФормированияКода) Тогда
			Попытка
				ДанныеQRКода = СНТСервер.ПолучитьQRКод(ДанныеДляФормированияКода, 3, 150);
				ОблЛоготип = ОбластиМакета.ОбластьРазделA;
				ИмяРисунка = "QRКодСНТ";
				ВывестиЛоготипВТабличныйДокумент(ОблЛоготип, ДанныеQRКода, ИмяРисунка);
			Исключение
				ТекстСообщения = СтрШаблон(НСтр("ru = 'Не удалось вывести QR код в печатную форму СНТ по причине: %1'"), ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
				ЭСФВызовСервера.СоздатьЗаписьЖурналаРегистрации("ОбменСНТ.ВывестQRКодВОбласть", "Ошибка", , , ТекстСообщения);
			КонецПопытки;
		Иначе
			//удаляем рисунок из макета
			ОбластиМакета.ОбластьРазделA.Рисунки.Удалить(РисунокКод);
		КонецЕсли;
	КонецЕсли;
	
КонецПроцедуры //ВывестQRКодВОбласть
...
//
Процедура ВывестиЛоготипВТабличныйДокумент(ОбластьМакета, ДвоичныеДанныеКартинки, ИмяРисунка)
	
	Если Не СНТСервер.ЕстьРеквизитОбъекта(ОбластьМакета.Рисунки, ИмяРисунка) Тогда
		// Картинки логотипа в этой области макета нет.
		Возврат;
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ДвоичныеДанныеКартинки) Тогда
		ОбластьМакета.Рисунки.Удалить(ОбластьМакета.Рисунки.QRКодСНТ);
		Возврат;
	КонецЕсли;
	...
	ОбластьМакета.Рисунки.QRКодСНТ.Картинка = Картинка;
	
КонецПроцедуры

// Получает наименование операции по коду из разделов G. 
// Если для переданного кода не найдено наименование, то возвращается значение самого кода.
//
// Параметры (название, тип, дифференцированное значение)
//    КодОперации - Число - код операции раздела G2-G8 по которому нужно получить Наименование операции
//
// Возвращаемое значение:
//    Строка - Наименование операции для вывода в печатную форму документа СНТ
//
Функция ПолучитьНаименованиеОперацииРазделаG(КодОперации)
	
	НаименованияОпераций = Новый Массив();
	
	МаксимальныйИндекс = 49;
	Для Инд = 0 По МаксимальныйИндекс Цикл
		НаименованияОпераций.Вставить(Инд, "");
	КонецЦикла;
	
	НаименованияОпераций[1]  = НСтр("ru='Отгрузка этилового спирта (ЭС) на производство алкогольной продукции (АП)'");
	НаименованияОпераций[2]  = НСтр("ru='Отгрузка ЭС на медицинские нужды'");
	НаименованияОпераций[3]  = НСтр("ru='Отгрузка ЭС на технические нужды'");
	НаименованияОпераций[5]  = НСтр("ru='Отгрузка АП производителем оптовику'");
	НаименованияОпераций[6]  = НСтр("ru='Отгрузка АП оптовиком оптовику'");
	НаименованияОпераций[7]  = НСтр("ru='Отгрузка АП оптовиком в розницу'");
	НаименованияОпераций[8]  = НСтр("ru='Отгрузка АП оптовиком производителю'");
	НаименованияОпераций[9]  = НСтр("ru='Отгрузка АП розницей оптовику'");
	НаименованияОпераций[10] = НСтр("ru='Отгрузка АП производителем в розницу'");
	НаименованияОпераций[11] = НСтр("ru='Отгрузка АП розницей производителю'");
	НаименованияОпераций[15] = НСтр("ru='Отгрузка на территорию г. Байконур'");
	НаименованияОпераций[19] = НСтр("ru='Отгрузка поставщику нефти'");
	НаименованияОпераций[20] = НСтр("ru='Реализация оптовикам'");
	НаименованияОпераций[21] = НСтр("ru='Реализация в розничную сеть'");
	НаименованияОпераций[22] = НСтр("ru='Конечному потребителю'");
	НаименованияОпераций[25] = НСтр("ru='Отгружено на переработку'");
	НаименованияОпераций[26] = НСтр("ru='Отгрузка на территорию г. Байконур'");
	НаименованияОпераций[28] = НСтр("ru='Отгрузка поставщику прочего сырьям'");
	НаименованияОпераций[29] = НСтр("ru='Реализация комиссионеру'");
	НаименованияОпераций[30] = НСтр("ru='Отгрузка производителю биотоплива'");
	НаименованияОпераций[31] = НСтр("ru='Отгрузка лицам, осуществляющим компаундирование нефтепродуктов'");
	НаименованияОпераций[34] = НСтр("ru='Отгрузка на территорию г. Байконур'");
	НаименованияОпераций[37] = НСтр("ru='Конечному потребителю'");
	НаименованияОпераций[38] = НСтр("ru='Реализация и (или) отгрузка лицом, осуществляющим производство табачных изделий (ТИ) оптовому реализатору'");
	НаименованияОпераций[39] = НСтр("ru='Реализация и (или) отгрузка лицом, осуществляющим производство ТИ розничному реализатору'");
	НаименованияОпераций[40] = НСтр("ru='Реализация и (или) отгрузка лицом, осуществляющим оптовую реализацию ТИ оптовому реализатору'");
	НаименованияОпераций[41] = НСтр("ru='Реализация и (или) отгрузка лицом, осуществляющим оптовую реализацию ТИ розничному реализатору'");
	НаименованияОпераций[42] = НСтр("ru='Реализация и (или) отгрузка ТИ (без заключения договора в письменной форме на основании сделок, исполняемых при их совершении) розничному реализатору'");
	НаименованияОпераций[43] = НСтр("ru='Перемещение/передача ТИ без цели реализации'");
	НаименованияОпераций[44] = НСтр("ru='Конечному потребителю'");
	НаименованияОпераций[48] = НСтр("ru='Конечному потребителю'");
	НаименованияОпераций[49] = НСтр("ru='Утилизация некондиционной алкогольной продукции'");
	
	Если КодОперации <= НаименованияОпераций.ВГраница() Тогда
		Возврат НаименованияОпераций.Получить(КодОперации);
	Иначе
		Возврат КодОперации;
	КонецЕсли;
...
Процедура ЗаполнитьИсходящийЭСФИзСНТ(ПараметрыЗаполнения, ОбъектЭСФ) Экспорт
	
	ОбработкаОбменЭСФ = ЭСФСерверПовтИсп.ОбработкаОбменЭСФ();
	
	ПерезаполнениеЭСФ = Ложь;
	Если ПараметрыЗаполнения.Свойство("ДополнительныеПараметры") Тогда
		ДополнительныеПараметры = ПараметрыЗаполнения.ДополнительныеПараметры;
	КонецЕсли;
	
	//если перезаполнение определено в самих параметрах
	Если ПараметрыЗаполнения.Свойство("ПерезаполнениеЭСФ")  Тогда
		ПерезаполнениеЭСФ = ПараметрыЗаполнения.ПерезаполнениеЭСФ;
	КонецЕсли;
	
	Если ТипЗнч(ДополнительныеПараметры) = Тип("Структура") Тогда
		Если ДополнительныеПараметры.Свойство("ПерезаполнениеЭСФ") И ЗначениеЗаполнено(ДополнительныеПараметры.ПерезаполнениеЭСФ) Тогда
			ПерезаполнениеЭСФ = ДополнительныеПараметры.ПерезаполнениеЭСФ; 
		КонецЕсли;
	Конецесли;
	
	РезультатыЗапросовПоРеквизитам = РезультатЗапросаПоРеквизитамСНТ(ПараметрыЗаполнения);
	ВыборкаРеквизиты = РезультатыЗапросовПоРеквизитам.Выбрать();
	
	//запрос по списку получателей СД/СРП
	ВыборкаПолучателей = СНТСерверПереопределяемый.ВыборкаПолучателейСНТ(ОбъектЭСФ.СчетФактура);
	...
	Пока ВыборкаРеквизиты.Следующий() Цикл
		...
		Если НЕ ЗначениеЗаполнено(ОбъектЭСФ.Номер) Тогда
		...
		Если ПерезаполнениеЭСФ Тогда
			ЗаполнитьЗначенияСвойств(ОбъектЭСФ, ВыборкаРеквизиты, , "ДатаОборота, СчетФактура, Вид");
		Иначе
		...
		// В ЭСФ добавили еще поля для документов поставки, можно указать одновременно до двух документов. Если есть данные по ГЗ или ЭАВР - вставим в последние поля.
		СтруктураНомерИДатаПоставки = ЭСФСерверПереопределяемый.ПолучитьНомерДатуДокументаПоставкиДляЭСФизСНТ(ВыборкаРеквизиты.Поставщик_ДокументПодтверждающийПоставку, ВыборкаРеквизиты.Поставщик_ДокументПодтверждающийПоставкуДата);
		
		Если ЗначениеЗаполнено(СтруктураНомерИДатаПоставки.ДокументПодтверждающийПоставкуНомер) И ЗначениеЗаполнено(СтруктураНомерИДатаПоставки.ДокументПодтверждающийПоставкуДата) Тогда
			ОбъектЭСФ.ДокументПодтверждающийПоставкуАВРНомер = СтруктураНомерИДатаПоставки.ДокументПодтверждающийПоставкуНомер;
			ОбъектЭСФ.ДокументПодтверждающийПоставкуАВРДата = СтруктураНомерИДатаПоставки.ДокументПодтверждающийПоставкуДата;
		КонецЕсли;

		// Заполнить таблицу "Получатели".
		Если ВыборкаРеквизиты.Получатель_УчастникСовместнойДеятельности Или ВыборкаРеквизиты.Получатель_УчастникСРП Тогда
			Пока ВыборкаПолучателей.Следующий() Цикл
				ПолучателиСтрока = ОбъектЭСФ.Получатели.Добавить();
				ЗаполнитьРеквизитыПолучателяИзСНТ(ПолучателиСтрока, ВыборкаПолучателей);
			КонецЦикла;
		Иначе
			ПолучателиСтрока = ОбъектЭСФ.Получатели.Добавить();
		...
		Для Каждого Товар Из Товары Цикл
			...
			// При создании ЭСФ на основании СНТ, если ТоварНаименованиеВРамкахТС заполнено при признаках отличных от 1 и 2, то
			// это поле нужно очищать, иначе ЭСФ не примется порталом.
			Если (Товар.ПризнакПроисхождения <> "1" И Товар.ПризнакПроисхождения <> "2")
				И ЗначениеЗаполнено(Товар.ТоварНаименованиеВРамкахТС)Тогда
		...
		Если ВыборкаРеквизиты.Получатель_УчастникСовместнойДеятельности Или ВыборкаРеквизиты.Получатель_УчастникСРП Тогда
			ЗаполнитьТаблицуТоварыПоПолучателям(ВыборкаПолучателей, ОбъектЭСФ);
		КонецЕсли;
...
Функция РезультатЗапросаПоРеквизитамСНТ(ПараметрыЗаполнения) Экспорт
	...
	Если ТипЗнч(ПараметрыЗаполнения) = Тип("Структура") Тогда
		Если ПараметрыЗаполнения.Свойство("ДокументОснованиеСНТ") Тогда
			СсылкаСНТ = ПараметрыЗаполнения.ДокументОснованиеСНТ;
		КонецЕсли;
		Если ПараметрыЗаполнения.Свойство("ДополнительныеПараметры") Тогда
			ДополнительныеПараметры = ПараметрыЗаполнения.ДополнительныеПараметры;
		КонецЕсли;
		Если ПараметрыЗаполнения.Свойство("ПерезаполнениеЭСФ") И ЗначениеЗаполнено(ПараметрыЗаполнения.ПерезаполнениеЭСФ) Тогда
			ПерезаполнениеЭСФ = ПараметрыЗаполнения.ПерезаполнениеЭСФ; 
		КонецЕсли;
	ИначеЕсли ТипЗнч(ПараметрыЗаполнения) = Тип("ДокументСсылка.СНТ") Тогда 
		СсылкаСНТ = ПараметрыЗаполнения;
	...
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("МассивСНТ", МассивСНТ);
	Запрос.УстановитьПараметр("ПерезаполнениеЭСФ", ПерезаполнениеЭСФ);
	
	АктуальныйСФ = Неопределено;
	АктуальныйЭСФ = Неопределено;
	Если ТипЗнч(ДополнительныеПараметры) = Тип("Структура") Тогда
		Если ДополнительныеПараметры.Свойство("АктуальныйСФ") И ЗначениеЗаполнено(ДополнительныеПараметры.АктуальныйСФ) Тогда
			АктуальныйСФ = ДополнительныеПараметры.АктуальныйСФ; 
		КонецЕсли;
		Если ДополнительныеПараметры.Свойство("АктуальныйЭСФ") И ЗначениеЗаполнено(ДополнительныеПараметры.АктуальныйЭСФ) Тогда
			АктуальныйЭСФ = ДополнительныеПараметры.АктуальныйЭСФ; 
		КонецЕсли;
	Конецесли;
	
	Запрос.УстановитьПараметр("АктуальныйСФ", АктуальныйСФ);
	Запрос.УстановитьПараметр("АктуальныйЭСФ", АктуальныйЭСФ);
		
	ТекстЗапроса = "
	|" + СНТСерверПереопределяемый.ДополнитьТекстЗапросаДляЭСФПеремещениеЕАЭС() + "
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	СНТ.Ссылка КАК Ссылка,
	...
	|	СНТ.ГрузоотправительИдентификатор КАК ГрузоотправительИдентификатор,
	|	СНТ.ГрузоотправительНаименование КАК ГрузоотправительНаименование,
	|	СНТ.Грузоотправитель КАК Грузоотправитель,
	|	СНТ.ГрузоотправительКодСтраныОтправки КАК ГрузоотправительКодСтраны,
	|	ВЫБОР
	|		КОГДА СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
	|			ТОГДА СНТ.АдресДоставки
	|		ИНАЧЕ СНТ.АдресОтправки
	...
	|			ТОГДА вт_ДанныеПоСобственномуКонтрагенту.Грузополучатель
	|		ИНАЧЕ СНТ.Грузополучатель
	|	КОНЕЦ КАК Грузополучатель,
	|	ВЫБОР
	|		КОГДА СНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами)
	|				И СНТ.ВидПеремещения = ЗНАЧЕНИЕ(Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС)
	|			ТОГДА вт_ДанныеПоСобственномуКонтрагенту.ГрузополучательНаименование
	|		ИНАЧЕ СНТ.ГрузополучательНаименование
	...
	|	ВЫБОР
	|		КОГДА СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
	|			ТОГДА СНТ.АдресОтправки
	|		ИНАЧЕ СНТ.АдресДоставки
	|	КОНЕЦ КАК АдресДоставки,
	|	СНТ.ДоговорПоставкиНомер КАК ДоговорПоставкиНомер,
	|	СНТ.ДоговорПоставкиДата КАК ДоговорПоставкиДата,
	|	СНТ.ДоговорПоставкиУсловияПоставки КАК ДоговорПоставкиУсловияПоставки,
	|	СНТ.ДоговорПоставкиУсловияОплаты КАК ДоговорПоставкиУсловияОплаты,
	...
	|	СНТ.ВалютаКод КАК ВалютаКод,
	|	СНТ.КурсВалюты КАК КурсВалюты,
	|	СНТ.ТипПодписи КАК ТипПодписи,
	|	СНТ.ЭЦП КАК ЭЦП,
	|	СНТ.Причина КАК Причина,
	...
	|	КОНЕЦ КАК Склад,
	|	СНТ.СкладОтправкиИдентификатор КАК СкладОтправкиИдентификатор,
	|	ИСТИНА КАК ОтражаетсяВВС,
	|	СНТ.МестоРеализацииНеРК КАК МестоРеализацииНеРК,
	|	СНТ.Поставщик КАК Поставщик,
	|	СНТ.ПоставщикИдентификатор КАК ПоставщикИдентификатор,
	|	СНТ.ПоставщикНаименование КАК ПоставщикНаименование,
	|	СНТ.ПоставщикБИНСтруктурногоПодразделения КАК ПоставщикБИНСтруктурногоПодразделения,
	|	СНТ.ПоставщикБИНРеорганизованногоЛица КАК ПоставщикБИНРеорганизованногоЛица,
	|	СНТ.ПоставщикАдвокат КАК ПоставщикАдвокат,
	|	СНТ.ПоставщикНотариус КАК ПоставщикНотариус,
	|	СНТ.ПоставщикМедиатор КАК ПоставщикМедиатор,
	|	СНТ.ПоставщикЧастныйСудебныйИсполнитель КАК ПоставщикСудебныйИсполнитель,
	|	ЛОЖЬ КАК ПоставщикЭкспортер,
	|	СНТ.ПоставщикФизическоеЛицо КАК ПоставщикФизическоеЛицо,
	|	СНТ.ПоставщикРозничнаяРеализация КАК ПоставщикРозничнаяРеализация,
	|	СНТ.ПоставщикФармацевтическийПроизводитель КАК ПоставщикФармацевтическийПроизводитель,
	|	СНТ.ПоставщикЛизингополучатель КАК ПоставщикЛизингополучатель,
	|	СНТ.ПоставщикЛизингодатель КАК ПоставщикЛизингодатель,
	|	СНТ.ПоставщикДоверитель КАК ПоставщикДоверитель,
	|	СНТ.ПоставщикКомитент КАК ПоставщикКомитент,
	|	СНТ.ПоставщикКомиссионер КАК ПоставщикКомиссионер,
	|	СНТ.ПоставщикУчастникСРП КАК ПоставщикУчастникСРП,
	|	СНТ.ПоставщикУчастникСовместнойДеятельности КАК ПоставщикУчастникСовместнойДеятельности,
	|	СНТ.ПоставщикКодСтраны КАК ПоставщикКодСтраны,
	|	СНТ.ПоставщикНерезидент КАК ПоставщикНерезидентВерсия2,
	|	ВЫБОР
	|		КОГДА СНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами)
	|				И СНТ.ВидПеремещения = ЗНАЧЕНИЕ(Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС)
	|			ТОГДА вт_ДанныеПоСобственномуКонтрагенту.Получатель
	|		ИНАЧЕ СНТ.Получатель
	|	КОНЕЦ КАК Получатель,
	|	СНТ.ПолучательИдентификатор КАК ПолучательИдентификатор,
	|	ВЫБОР
	|		КОГДА СНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами)
	|				И СНТ.ВидПеремещения = ЗНАЧЕНИЕ(Перечисление.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС)
	|			ТОГДА вт_ДанныеПоСобственномуКонтрагенту.ПолучательНаименование
	|		ИНАЧЕ СНТ.ПолучательНаименование
	|	КОНЕЦ КАК ПолучательНаименование,
	|	СНТ.ПолучательНерезидент КАК ПолучательНерезидентВерсия2,
	|	СНТ.ПолучательБИНРеорганизованногоЛица КАК ПолучательБИНРеорганизованногоЛица,
	|	СНТ.ПолучательБИНСтруктурногоПодразделения КАК ПолучательБИНСтруктурногоПодразделения,
	|	СНТ.ПолучательЛизингополучатель КАК ПолучательЛизингополучатель,
	|	СНТ.ПолучательДоверитель КАК ПолучательДоверитель,
	|	СНТ.ПолучательКомитент КАК ПолучательКомитент,
	|	СНТ.ПолучательКомиссионер КАК ПолучательКомиссионер,
	|	СНТ.ПолучательУчастникСРП КАК ПолучательУчастникСРП,
	|	СНТ.ПолучательУчастникСовместнойДеятельности КАК ПолучательУчастникСовместнойДеятельности,
	|	СНТ.ПолучательАдвокат КАК ПолучательАдвокат,
	|	СНТ.ПолучательНотариус КАК ПолучательНотариус,
	|	СНТ.ПолучательМедиатор КАК ПолучательМедиатор,
	...
	|	СНТ.РегистрационныйНомерИСЭСФ КАК РегистрационныйНомерИСЭСФ,
	|	СНТ.ПолучательКодСтраны КАК ПолучательКодСтраны,
	...
	|	СНТ.ТипСНТ КАК ТипСНТ,
	|	СНТ.АвтомобильныйТранспорт КАК АвтомобильныйТранспорт,
	|	СНТ.ГосномерПрицепа КАК ГосномерПрицепа,
	|	СНТ.ЖелезнодорожныйТранспорт КАК ЖелезнодорожныйТранспорт,
	|	СНТ.ВоздушныйТранспорт КАК ВоздушныйТранспорт,
	|	СНТ.МорскойТранспорт КАК МорскойТранспорт,
	|	СНТ.Трубопровод КАК Трубопровод,
	|	СНТ.ПрочийТранспорт КАК ПрочийТранспорт
	|ПОМЕСТИТЬ ДанныеСНТ
	|ИЗ
	|	Документ.СНТ КАК СНТ
	|		ЛЕВОЕ СОЕДИНЕНИЕ вт_ДанныеПоСобственномуКонтрагенту КАК вт_ДанныеПоСобственномуКонтрагенту
	|		ПО СНТ.Ссылка = вт_ДанныеПоСобственномуКонтрагенту.Ссылка
	|ГДЕ
	|	СНТ.Ссылка В(&МассивСНТ)
	|;
	...
	|			ТОГДА ДанныеСНТ.ДатаОтгрузкиТовара
	...
	|       ИЛИ (ДанныеСНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.Ввоз) И ДанныеСНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров))
	|			ТОГДА Истина
	|		ИНАЧЕ Ложь
	...
	|	ВЫБОР
	|		КОГДА ДанныеСНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров) И НЕ ДанныеСНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.Ввоз) 
	|			ТОГДА """"
	|		КОГДА ДанныеСНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров) И  ДанныеСНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.Ввоз) 
	|			ТОГДА ДанныеСНТ.ПоставщикНерезидентВерсия2
	...
	|	ВЫБОР
	|	КОГДА ДанныеСНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров) 
	|		ТОГДА ДанныеСНТ.ПоставщикФизическоеЛицо
	|	КОГДА ДанныеСНТ.ПолучательРозничнаяРеализация ИЛИ ДанныеСНТ.ПоставщикРозничнаяРеализация
	|		ТОГДА Ложь
	...
	|	ВЫБОР
	|		КОГДА ДанныеСНТ.АвтомобильныйТранспорт И ДанныеСНТ.ГосномерПрицепа = """"
	|			ТОГДА ""30""
	|		ИНАЧЕ ВЫБОР
	|		КОГДА ДанныеСНТ.АвтомобильныйТранспорт И ДанныеСНТ.ГосномерПрицепа <> """"
	|			ТОГДА ""31""
	...
	|			ТОГДА ""71""
	|		КОГДА ДанныеСНТ.ПрочийТранспорт
	|			ТОГДА ""99""
	|		ИНАЧЕ """"
	|	КОНЕЦ КОНЕЦ КОНЕЦ КОНЕЦ КОНЕЦ КОНЕЦ КАК СпособОтправленияПоКлассификатору,
	|	ВЫБОР 
...
Функция РезультатЗапросаПоТоварам(СНТ)
	...
	Запрос.УстановитьПараметр("СвязанныйСНТ", СНТ.СвязанныйСНТ);
	//При получении входящих возвратов от покупателя,для  Товаров ВС  данные по ИП нужно брать из ЭСФ
	ЭтоВозвратОтПокупателя = (СНТ.ТипСНТ = ПредопределенноеЗначение("Перечисление.ТипыСНТ.ВозвратТоваров")
				И СНТ.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий"));
	Запрос.УстановитьПараметр("ЭтоВозвратОтПокупателя", ЭтоВозвратОтПокупателя);
	...
	|	ВЫБОР
	|		КОГДА ТоварыВС.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА СНТЭтиловыйСпирт.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА СНТВиноматериал.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА СНТПивоПивныеНапитки.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА АлкогольнаяпродукцияКромеПива.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА ДанныеПоНефтепродуктам.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА ДанныеПоБиотопливу.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА ТабачнаяПродукция.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА ДругиеТоварыЦифроваяМаркировка.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|	ВЫБОР
	|		КОГДА ТоварыЭкспортныйКонтроль.ИдентификаторТовара = ""1""
	|			ТОГДА ЛОЖЬ
	|		ИНАЧЕ ИСТИНА
	|	КОНЕЦ,
	...
	|ПОМЕСТИТЬ ДокументыЭСФТоварыВозврат
	|ИЗ
	|	Документ.ЭСФ КАК ДокЭСФ
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЭСФ.Товары КАК ТоварыЭСФ
	|		ПО ДокЭСФ.Ссылка = ТоварыЭСФ.Ссылка
	|ГДЕ
	|	ДокЭСФ.СНТ = &СвязанныйСНТ
	...
	|	ВЫБОР
	|		КОГДА ТоварыСНТ.ИсточникПроисхождения = ЗНАЧЕНИЕ(Справочник.ИсточникиПроисхождения.ПустаяСсылка)
	|				И &ЭтоВозвратОтПокупателя
	|			ТОГДА ТоварыЭСФ.ИсточникПроисхождения
	|		ИНАЧЕ ТоварыСНТ.ИсточникПроисхождения
	...
	|	ВЫБОР
	|		КОГДА (ИсточникиПроисхождения.ДокументПартии = НЕОПРЕДЕЛЕНО
	|				ИЛИ ИсточникиПроисхождения.ДокументПартии ЕСТЬ NULL)
	|				И &ЭтоВозвратОтПокупателя
	|			ТОГДА ИсточникиПроисхожденияЭСФ.ДокументПартии
	|		ИНАЧЕ ИсточникиПроисхождения.ДокументПартии
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ДокументыЭСФТоварыВозврат КАК ТоварыЭСФ
	|		ПО (ТоварыЭСФ.Товар = ТоварыСНТ.Товар)
	|			И (ТоварыЭСФ.ЕдиницаИзмерения = ТоварыСНТ.ЕдиницаИзмерения)
...
Процедура ЗаполнитьРеквизитыПолучателяИзСНТ(ПолучателиСтрока, ВыборкаРеквизиты)
	...
	ЭСФСерверПереопределяемый.ЗаполнитьБИНФилиалаПокупателя(ПолучателиСтрока, ВыборкаРеквизиты);
...
Функция СоздатьСписокИсходящихЭСФиСФИзСНТ(ПараметрыСоздания) Экспорт
	...
	СписокСозданныхСчетовФактурИЭСФ = СНТСерверПереопределяемый.СоздатьСписокИсходящихЭСФиСФИзСНТ(ПараметрыСоздания);
...
Функция ПроверитьАктуальныйЭСФДляСНТ(МассивСНТ, ПерезаполняемыйЭСФ = Неопределено) Экспорт
	...
	СписокАктуальныйЭСФДляСНТ = СНТСерверПереопределяемый.ПроверитьАктуальныйЭСФДляСНТ(МассивСНТ, ПерезаполняемыйЭСФ);
...
Процедура СравнитьЭСФиСНТ(Знач СопоставляемыйОбъектСНТ, Знач ОбъектЭСФ, РезультатПроверки) Экспорт
	...
	Для Каждого Строка Из ТабличнаяЧастьРеквизит Цикл
		...
		Если Строка.ИмяТабличнойЧастиЭСФ = "Получатели" И Строка.ИмяРеквизитаЭСФ = "БИНФилиала" 
			И  (ОбъектЭСФ[Строка.ИмяТабличнойЧастиЭСФ][0].УчастникСРП ИЛИ ОбъектЭСФ[Строка.ИмяТабличнойЧастиЭСФ][0].УчастникСовместнойДеятельности) Тогда
			Продолжить;
		КонецЕсли;
		
		Если Строка.ИмяТабличнойЧастиЭСФ = "Получатели" И ОбъектЭСФ.Вид = ПредопределенноеЗначение("Перечисление.ВидыЭСФ.Дополнительный") Тогда			
			
			ИмяРеквизитаСНТ = СтрЗаменить(Строка.ИмяРеквизитаСНТ,"Получатель", "Поставщик");
			
			Если ОбъектЭСФ[Строка.ИмяТабличнойЧастиЭСФ][0][Строка.ИмяРеквизитаЭСФ] <> СопоставляемыйОбъектСНТ[ИмяРеквизитаСНТ] Тогда
				Различие = ТаблицаРазличий.Добавить();
				Различие.Сообщение = НСтр("ru = '%1. Отличается значение реквизита ""%2"" от значения реквизита ""%3"" в СНТ.'");
				Различие.Сообщение = ЭСФКлиентСерверПереопределяемый.ПодставитьПараметрыВСтроку(
				Различие.Сообщение, Строка.СинонимРазделаЭСФ, Строка.СинонимРеквизитаЭСФ, Строка.СинонимРеквизитаСНТ);
	...
	Если НЕ ЗначениеЗаполнено(ОбъектЭСФ.ДоговорПорученияПокупателяНомер)
		...
		И НЕ (ОбъектЭСФ.Получатели[0].УчастникСРП ИЛИ ОбъектЭСФ.Получатели[0].УчастникСовместнойДеятельности) 
	...
	Если (((СопоставляемыйОбъектСНТ.ВоздушныйТранспорт) ИЛИ (СопоставляемыйОбъектСНТ.ЖелезнодорожныйТранспорт)
		...
		ИЛИ (СопоставляемыйОбъектСНТ.АвтомобильныйТранспорт) ИЛИ (СопоставляемыйОбъектСНТ.ПрочийТранспорт))
		...
		АвтомобильныйТранспортСПрицепом = ?(ОбъектЭСФ.СпособОтправленияПоКлассификатору = "31" ИЛИ ОбъектЭСФ.СпособОтправленияПоКлассификатору = "32", Истина, Ложь);
		//99 - Прочие, 90 - Транспортное средство, перемещающееся в качестве товара своим ходом
		ПрочийТранспорт = ?(ОбъектЭСФ.СпособОтправленияПоКлассификатору = "90" ИЛИ ОбъектЭСФ.СпособОтправленияПоКлассификатору = "99", Истина, Ложь);
		...
		КонецЕсли;
		Если СопоставляемыйОбъектСНТ.АвтомобильныйТранспорт И АвтомобильныйТранспорт И ЗначениеЗаполнено(СопоставляемыйОбъектСНТ.ГосномерПрицепа) Тогда
			Различие = ТаблицаРазличий.Добавить();
			Различие.Сообщение = Сообщение + """Автомобильный"" в СНТ.";
		КонецЕсли;
		Если СопоставляемыйОбъектСНТ.АвтомобильныйТранспорт И НЕ ЗначениеЗаполнено(СопоставляемыйОбъектСНТ.ГосномерПрицепа) И АвтомобильныйТранспортСПрицепом Тогда
			Различие = ТаблицаРазличий.Добавить();
			Различие.Сообщение = Сообщение + """Автомобильный с указанием прицепа"" в СНТ.";
		КонецЕсли;
		Если СопоставляемыйОбъектСНТ.ПрочийТранспорт И НЕ ПрочийТранспорт Тогда
			Различие = ТаблицаРазличий.Добавить();
			Различие.Сообщение = Сообщение + """Прочий транспорт"" в СНТ.";
		КонецЕсли;
		Если ЗначениеЗаполнено(ОбъектЭСФ.СпособОтправленияПоКлассификатору) И 
			...
			И НЕ СопоставляемыйОбъектСНТ.Трубопровод И НЕ СопоставляемыйОбъектСНТ.МорскойТранспорт 
			И НЕ СопоставляемыйОбъектСНТ.ВоздушныйТранспорт И НЕ СопоставляемыйОбъектСНТ.ПрочийТранспорт)Тогда
			Различие = ТаблицаРазличий.Добавить();
...
Функция ТаблицаУчастниковСД(ВыборкаУчастникиСД)
	...
	Пока ВыборкаУчастникиСД.Следующий() Цикл
		СтрокаТаблицаУчастниковСД = ТаблицаУчастниковСД.Добавить();
		СтрокаТаблицаУчастниковСД.ПолучательИдентификатор = ВыборкаУчастникиСД.Получатель_ПолучательИдентификатор;
		СтрокаТаблицаУчастниковСД.ДоляУчастия = ВыборкаУчастникиСД.Получатель_ДоляУчастия;
	КонецЦикла;
...
Процедура ЗаполнитьТаблицуТоварыПоПолучателям(ВыборкаУчастникиСД, ОбъектЭСФ)
	...
	ТаблицаУчастниковСД = ТаблицаУчастниковСД(ВыборкаУчастникиСД);
	
	Если ТаблицаУчастниковСД <> Неопределено ИЛИ ТаблицаУчастниковСД.Количество() = 0  Тогда
...
Процедура ЗаполнитьТаблицуТоварыПоПолучателямПоТаблицеУчастниковСД(ТаблицаУчастниковСД, ОбъектЭСФ) Экспорт
	...
	Для Каждого СтрокаТовары Из ОбъектЭСФ.Товары Цикл
		...
		Если ПоследняяСтрокаТоварыПоПолучателям = Неопределено Тогда
			Возврат;
		КонецЕсли;
...
Процедура РазделитьМассивПоНаправлениямСНТ(МассивСНТ, МассивВходящихСНТ, МассивИсходящихСНТ)
	...
	Для Каждого СНТ из МассивСНТ Цикл
		...
		ДатаСвязанногоСНТ = Дата(1,1,1);
		ОформлениеВозвратаВАдресМТТПосле23 = Ложь;
		Если СНТ.ПоставщикМалаяТорговаяТочка И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров Тогда
			
			Если ЗначениеЗаполнено(СНТ.СвязанныйСНТ) Тогда
				
				ДатаСвязанногоСНТ = ЭСФСерверПереопределяемый.ЗначениеРеквизитаОбъекта(СНТ.СвязанныйСНТ, "Дата");
				Если ДатаСвязанногоСНТ >= СНТСерверПереопределяемый.ДатаИзмененийМТТ() Тогда
					ОформлениеВозвратаВАдресМТТПосле23 = Истина;
				Иначе
					Если СНТ.ТоварыВС.Количество() > 0
						И СНТ.ЭтиловыйСпирт.Количество() = 0 И СНТ.Виноматериал.Количество() = 0 И СНТ.ПивоПивныеНапитки.Количество() = 0
						И СНТ.АлкогольнаяПродукцияКромеПива.Количество() = 0 И СНТ.ДанныеПоНефтепродуктам.Количество() = 0 И СНТ.ДанныеПоБиотопливу.Количество() = 0
						И СНТ.ТабачнаяПродукция.Количество() = 0 И СНТ.ДругиеТоварыЦифроваяМаркировка.Количество() = 0 И СНТ.ТоварыЭкспортныйКонтроль.Количество() = 0 Тогда
						ОформлениеВозвратаВАдресМТТПосле23 = Истина;
					КонецЕсли;
				КонецЕсли;
				
			Иначе
				//Если в учетной системе еще не заполнен связанный СНТ, то пробуем определить дату по регистрационному номеру связанного СНТ
				Если ЗначениеЗаполнено(СНТ.РегистрационныйНомерСвязанногоСНТ) Тогда
					
					Попытка
						//определяем дату по формату номера СНТ
						ДатаСвязанногоСНТ = Дата(Сред(СНТ.РегистрационныйНомерСвязанногоСНТ, 26, 8));
					Исключение
						ДатаСвязанногоСНТ = Дата(1,1,1);
					КонецПопытки;
					
					Если ЗначениеЗаполнено(ДатаСвязанногоСНТ) И ДатаСвязанногоСНТ >= СНТСерверПереопределяемый.ДатаИзмененийМТТ() Тогда
						ОформлениеВозвратаВАдресМТТПосле23 = Истина;
					ИначеЕсли СНТ.Дата >= СНТСерверПереопределяемый.ДатаИзмененийМТТ() Тогда
						ОформлениеВозвратаВАдресМТТПосле23 = Истина;
					Иначе
						Если СНТ.ТоварыВС.Количество() > 0
							И СНТ.ЭтиловыйСпирт.Количество() = 0 И СНТ.Виноматериал.Количество() = 0 И СНТ.ПивоПивныеНапитки.Количество() = 0
		...
		ИначеЕсли СНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ((СНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз) 
			ИЛИ (СНТ.ПоставщикРозничнаяРеализация И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
			ИЛИ (СНТ.ПоставщикФизическоеЛицо И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
			ИЛИ ОформлениеВозвратаВАдресМТТПосле23 ) Тогда
			МассивВходящихСНТ.Добавить(СНТ);
...
Процедура ЗаполнитьСсылкиНаКонтрагентовИСтруктурныеЕдиницы(Знач НаправлениеСНТ, МассивСНТ)
	...
	Для Каждого СНТ Из МассивСНТ Цикл
		...
		Если НЕ ПустаяСтрока(СНТ.ГрузоотправительИдентификатор)
			И НЕ СНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Перемещение И НЕ СНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК Тогда
		...
		Иначе
			ИдентификационныеНомераСтруктурныхЕдиниц.Добавить(СНТ.ГрузоотправительИдентификатор);
		КонецЕсли;
		Если НЕ ПустаяСтрока(СНТ.ГрузополучательИдентификатор)
			И НЕ СНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Перемещение И НЕ СНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК Тогда
		...
		Если НЕ ПустаяСтрока(СНТ[ИмяРеквизитаКонтрагента+"Идентификатор"])
			И НЕ СНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Перемещение И НЕ СНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК Тогда
			ИдентификационныеНомераКонтрагентов.Добавить(СНТ[ИмяРеквизитаКонтрагента+"Идентификатор"]);
		КонецЕсли;
		Если НЕ ПустаяСтрока(СНТ[ИмяРеквизитаСтруктурнойЕдиницы+"Идентификатор"])
			И НЕ СНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Перемещение И НЕ СНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК Тогда
			ИдентификационныеНомераКонтрагентов.Добавить(СНТ[ИмяРеквизитаСтруктурнойЕдиницы+"Идентификатор"]);
			ИдентификационныеНомераСтруктурныхЕдиниц.Добавить(СНТ[ИмяРеквизитаСтруктурнойЕдиницы+"Идентификатор"]);
		КонецЕсли;
	...
	Для Каждого СНТ Из МассивСНТ Цикл
		...
		Для Каждого ЭлементСоответствияКонтрагентов Из СоответствияКонтрагентов Цикл
			...
			Если СНТ.ГрузополучательИдентификатор = Идентификатор И НаправлениеСНТ <> Перечисления.НаправленияСНТ.Входящий Тогда//НаправлениеСНТ <> Перечисления.НаправленияСНТ.Входящий Тогда
	...
	Для Каждого СНТ Из МассивСНТ Цикл
		...
		Для Каждого ЭлементСоответствияСтруктурныхЕдиниц Из СоответствияСтруктурныхЕдиниц Цикл
			...
			Если СНТ.ГрузоотправительИдентификатор = Идентификатор
					И (НЕ ЗначениеЗаполнено(СНТ.Грузоотправитель) ИЛИ (ЗначениеЗаполнено(СНТ.Грузоотправитель) И СНТ.ПоставщикМалаяТорговаяТочка))
					И (НаправлениеСНТ <> Перечисления.НаправленияСНТ.Исходящий ИЛИ (НаправлениеСНТ = Перечисления.НаправленияСНТ.Исходящий И СНТ.ПоставщикМалаяТорговаяТочка)) Тогда
				СНТ.Грузоотправитель = СтруктурнаяЕдиница;
			КонецЕсли;
			
			Если СНТ.ГрузополучательИдентификатор = Идентификатор И (НаправлениеСНТ <> Перечисления.НаправленияСНТ.Исходящий И НЕ СНТ.ПоставщикМалаяТорговаяТочка) Тогда
				СНТ.Грузополучатель = СтруктурнаяЕдиница;	
			КонецЕсли;
			// Заполнить ссылки на организации в таблице поставщиков или получателей.
			// Данное условие нужно чтоб когда головная организация получает документы филиала(выделенного на отдельный баланс) правильно заполнялись ссылочные поля.
			Если НаправлениеСНТ = Перечисления.НаправленияСНТ.Входящий И СНТ[(ИмяРеквизитаСтруктурнойЕдиницы + "Идентификатор")] = Идентификатор
				И ЗначениеЗаполнено(СНТ.ПолучательБИНСтруктурногоПодразделения) Тогда
				
				СНТ[ИмяРеквизитаСтруктурнойЕдиницы] = СтруктурнаяЕдиница;
				// Найти ссылку на структурную единицу по идентификатору.
				ИдентификаторовИСсылка = НайтиСтруктурнуюЕдиницуПоИдентификационномуНомеру(СНТ.ПолучательБИНСтруктурногоПодразделения);
				Если ИдентификаторовИСсылка.Количество() > 0 Тогда
					СНТ.Организация = ИдентификаторовИСсылка.Ссылка;
				КонецЕсли;
			Иначе
...
//
Функция НайтиСтруктурнуюЕдиницуПоИдентификационномуНомеру(Знач ИдентификационныйНомерСтруктурнойЕдиницы) Экспорт
	...
	|ГДЕ
	|	Организации.%ОрганизацияИНН В(&ИдентификационныйНомерСтруктурныхЕдиниц)
	...
	Запрос.Текст = ТекстЗапроса;
	Запрос.УстановитьПараметр("ИдентификационныйНомерСтруктурныхЕдиниц", ИдентификационныйНомерСтруктурнойЕдиницы);
	РезультатыЗапроса = Запрос.Выполнить().Выбрать();
	
	Результат = Новый Структура;
		
	Пока РезультатыЗапроса.Следующий() Цикл
		Результат.Вставить("Идентификатор", РезультатыЗапроса.Идентификатор);
		Результат.Вставить("Ссылка", РезультатыЗапроса.Ссылка);
	КонецЦикла;
...
Функция НайтиКонтрагентовИСтруктурныеЕдиницыПоИдентификационнымНомерам(
	...
	Пока ВыборкаОрганизации.Следующий() Цикл
		...
		Если РезультатыЗапроса[0].Пустой() Тогда
			Результат.СоответствияКонтрагентов.Вставить(ВыборкаОрганизации.Идентификатор, ВыборкаОрганизации.Ссылка);
		КонецЕсли; 
	КонецЦикла;
...
Процедура ЗаполнитьСсылкиНаЕдиницыИзмеренияИТовары(НаправлениеСНТ, МассивСНТ, МассивНаименованийТабличныхЧастей)
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.КлючиАналитикиУчетаСоответствий КАК КлючиАналитики
	|		ПО ТоварыПоКонтрагентам.ЕдиницаИзмеренияКод = КлючиАналитики.ЕдиницаИзмеренияКод
	|			И ТоварыПоКонтрагентам.ТоварНаименование = КлючиАналитики.ТоварНаименование
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура ЗаполнитьСсылкиНаСвязанныеСНТ(МассивСНТ)
	...
	Для Каждого СНТ Из МассивСНТ Цикл
		Если ЗначениеЗаполнено(СНТ.РегистрационныйНомерСвязанногоСНТ) Тогда
			...
			Если СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И СНТ.Направление = Перечисления.НаправленияСНТ.Входящий Тогда
				Если НЕ СНТ.ПоставщикМалаяТорговаяТочка Тогда
					ОписаниеСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий;
				Иначе
					ОписаниеСНТ.Направление = Перечисления.НаправленияСНТ.Входящий;
				КонецЕсли;
			КонецЕсли;
	...
	Если ПараметрыПоискаДокументовСНТ.Количество() <> 0 Тогда
		...
		// Заполнить ссылки на связанные СНТ.
		Для Каждого СНТ Из МассивСНТ Цикл
			...
			Если ЗначениеЗаполнено(СНТ.РегистрационныйНомерСвязанногоСНТ) Тогда
				...
				// При возврате документ входящий от покупателя, а первичный документ создавал поставщик - исходящий.
				// Если возврат получил МТТ документ входящий (после ввдения нового механизма с 23/12/22), но и первичный документ тоже был входящим
				Если СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И СНТ.Направление = Перечисления.НаправленияСНТ.Входящий Тогда
					Если НЕ СНТ.ПоставщикМалаяТорговаяТочка Тогда
						ПараметрыОтбора.Вставить("Направление", Перечисления.НаправленияСНТ.Исходящий);
					Иначе
						ПараметрыОтбора.Вставить("Направление", Перечисления.НаправленияСНТ.Входящий);
					КонецЕсли;
				КонецЕсли;
...
Процедура ЗаполнитьСсылкиНаВиртуальныеСклады(НаправлениеСНТ, МассивСНТ, СтруктурнаяЕдиница)
	...
	МассивИдентификаторовФилиалов = Новый Массив;
	...
	Для Каждого ОбъектСНТ Из МассивСНТ Цикл
		...
		Если ОбъектСНТ.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий") Тогда
			...
			КонецЕсли;
			Если ЗначениеЗаполнено(ОбъектСНТ.ПолучательБИНСтруктурногоПодразделения) Тогда
				МассивИдентификаторовФилиалов.Добавить(ОбъектСНТ.Организация);
			КонецЕсли;
			
		ИначеЕсли ОбъектСНТ.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий")
					И ((ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Перемещение И ОбъектСНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК)
						ИЛИ (ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз) 
						ИЛИ (ОбъектСНТ.ПоставщикРозничнаяРеализация И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
						ИЛИ (ОбъектСНТ.ПоставщикФизическоеЛицо И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
						ИЛИ (ОбъектСНТ.ПоставщикМалаяТорговаяТочка И ОбъектСНТ.ТипСНТ =Перечисления.ТипыСНТ.ВозвратТоваров И ОбъектСНТ.ТоварыВС.Количество() > 0
								И ОбъектСНТ.ЭтиловыйСпирт.Количество() = 0 И ОбъектСНТ.Виноматериал.Количество() = 0 И ОбъектСНТ.ПивоПивныеНапитки.Количество() = 0
								И ОбъектСНТ.АлкогольнаяПродукцияКромеПива.Количество() = 0 И ОбъектСНТ.ДанныеПоНефтепродуктам.Количество() = 0 И ОбъектСНТ.ДанныеПоБиотопливу.Количество() = 0
								И ОбъектСНТ.ТабачнаяПродукция.Количество() = 0 И ОбъектСНТ.ДругиеТоварыЦифроваяМаркировка.Количество() = 0 И ОбъектСНТ.ТоварыЭкспортныйКонтроль.Количество() = 0)) Тогда
	...
	|ГДЕ
	|	ВиртуальныеСклады.Организация В (&Организация, &Филиал)
	...
	Запрос.УстановитьПараметр("Филиал", МассивИдентификаторовФилиалов);
	...
	Если СоответствиеИдентификаторовСкладов.Количество() > 0 Тогда
		...
		Для Каждого ОбъектСНТ Из МассивСНТ Цикл
			...
			ИначеЕсли ОбъектСНТ.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий")
				И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Перемещение 
				И ОбъектСНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаРК 
				И НЕ ЗначениеЗаполнено(ОбъектСНТ.СкладОтправитель) Тогда
				
				//склад отправителя в пределах одной организации
				...
				//склад получателя в пределах одной организации
				ВиртуальныйСклад = СоответствиеИдентификаторовСкладов.Получить(ОбъектСНТ.СкладДоставкиИдентификатор);
				Если ЗначениеЗаполнено(ВиртуальныйСклад) Тогда
					ОбъектСНТ.СкладПолучатель = ВиртуальныйСклад;
					ОбъектСНТ.АдресДоставки = ВиртуальныйСклад.Адрес;
			...
			ИначеЕсли ОбъектСНТ.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") 
				И ((ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз) 
					ИЛИ (ОбъектСНТ.ПоставщикРозничнаяРеализация И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
					ИЛИ (ОбъектСНТ.ПоставщикФизическоеЛицо И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
					ИЛИ (ОбъектСНТ.ПоставщикМалаяТорговаяТочка И ОбъектСНТ.ТипСНТ =Перечисления.ТипыСНТ.ВозвратТоваров И ОбъектСНТ.ТоварыВС.Количество() > 0
							И ОбъектСНТ.ЭтиловыйСпирт.Количество() = 0 И ОбъектСНТ.Виноматериал.Количество() = 0 И ОбъектСНТ.ПивоПивныеНапитки.Количество() = 0
							И ОбъектСНТ.АлкогольнаяПродукцияКромеПива.Количество() = 0 И ОбъектСНТ.ДанныеПоНефтепродуктам.Количество() = 0 И ОбъектСНТ.ДанныеПоБиотопливу.Количество() = 0
							И ОбъектСНТ.ТабачнаяПродукция.Количество() = 0 И ОбъектСНТ.ДругиеТоварыЦифроваяМаркировка.Количество() = 0 И ОбъектСНТ.ТоварыЭкспортныйКонтроль.Количество() = 0))
				И НЕ ЗначениеЗаполнено(ОбъектСНТ.СкладОтправитель) Тогда
...
Процедура ВосстановитьСсылочныеРеквизитыОдногоСНТ(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, МассивНаименованийТабличныхЧастей)
	...
	Для Каждого НаименованиеТабличнойЧасти Из МассивНаименованийТабличныхЧастей Цикл 
		...
		Если (ИсходныйОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами)
			...
			ВосстановитьСсылкиВРеквизитеТабличнойЧасти(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, НаименованиеТабличнойЧасти, "ИсточникПроисхожденияПолучатель", "НомерСтроки");
			ВосстановитьСсылкиВРеквизитеТабличнойЧасти(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, НаименованиеТабличнойЧасти, "ДополнительныйИдентификаторПолучатель", "НомерСтроки");
		КонецЕсли;
		
		ВосстановитьСсылкиВРеквизитеТабличнойЧасти(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, НаименованиеТабличнойЧасти, "КоэффициентПересчета", "НомерСтроки");
		ВосстановитьСсылкиВРеквизитеТабличнойЧасти(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, НаименованиеТабличнойЧасти, "ЕдиницаИзмеренияХраненияОстатков", "НомерСтроки");
		
		ВосстановитьСсылкиВРеквизитеТабличнойЧасти(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, НаименованиеТабличнойЧасти, "НомерФНО", "НомерСтроки");
		ВосстановитьСсылкиВРеквизитеТабличнойЧасти(ИсходныйОбъектСНТ, ОбновленныйОбъектСНТ, НаименованиеТабличнойЧасти, "НомерПозицииИзФНО", "НомерСтроки");
...
// Определение направления при первичном получении СНТ - используется только если реквизит Направление не заполнен
Функция ОпределитьНаправлениеСНТ(СНТ, СтруктурнаяЕдиница)
	...
	//Если это первичной получение СНТ и в учетной системе еще не заполнен связанный СНТ, то пробуем определить дату по регистрационному номеру связанного СНТ
	ДатаСвязанногоСНТ = Дата(1,1,1);
	ОформлениеВозвратаВАдресМТТПосле23 = Ложь;
	Если СНТ.ПоставщикМалаяТорговаяТочка И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров Тогда
	...
	Если ПрисутствуетВПоставщиках Тогда
		...
		Если НЕ ОформлениеВозвратаВАдресМТТПосле23 Тогда
			
			Если (СНТ.ПоставщикМалаяТорговаяТочка И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И СНТ.ТоварыВС.Количество() > 0
				И СНТ.ЭтиловыйСпирт.Количество() = 0 И СНТ.Виноматериал.Количество() = 0 И СНТ.ПивоПивныеНапитки.Количество() = 0
				И СНТ.АлкогольнаяПродукцияКромеПива.Количество() = 0 И СНТ.ДанныеПоНефтепродуктам.Количество() = 0 И СНТ.ДанныеПоБиотопливу.Количество() = 0
				И СНТ.ТабачнаяПродукция.Количество() = 0 И СНТ.ДругиеТоварыЦифроваяМаркировка.Количество() = 0 И СНТ.ТоварыЭкспортныйКонтроль.Количество() = 0) Тогда
	...
	ИначеЕсли ПрисутствуетВПолучателях Тогда
		...
		Если НЕ ОформлениеВозвратаВАдресМТТПосле23 Тогда
			...
			Если ЗначениеЗаполнено(СНТ.ВидВвоза)
				ИЛИ (СНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ВПределахОдногоЛицаЕАЭС ИЛИ СНТ.ВидПеремещения = Перечисления.ВидыПеремещенияСНТ.ИноеПеремещение)
				ИЛИ (СНТ.ПоставщикРозничнаяРеализация И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
				ИЛИ (СНТ.ПоставщикФизическоеЛицо И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
				ИЛИ (СНТ.ПоставщикМалаяТорговаяТочка И СНТ.ТипСНТ =Перечисления.ТипыСНТ.ВозвратТоваров И СНТ.ТоварыВС.Количество() > 0
				И СНТ.ЭтиловыйСпирт.Количество() = 0 И СНТ.Виноматериал.Количество() = 0 И СНТ.ПивоПивныеНапитки.Количество() = 0
				И СНТ.АлкогольнаяПродукцияКромеПива.Количество() = 0 И СНТ.ДанныеПоНефтепродуктам.Количество() = 0 И СНТ.ДанныеПоБиотопливу.Количество() = 0
				И СНТ.ТабачнаяПродукция.Количество() = 0 И СНТ.ДругиеТоварыЦифроваяМаркировка.Количество() = 0 И СНТ.ТоварыЭкспортныйКонтроль.Количество() = 0)Тогда
				Направление = Перечисления.НаправленияСНТ.Исходящий;
		...
		Иначе
			...
			Если ЗначениеЗаполнено(СНТ.ВидВвоза)
				ИЛИ (СНТ.ПоставщикРозничнаяРеализация И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
				ИЛИ (СНТ.ПоставщикФизическоеЛицо И СНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров)
				ИЛИ (СНТ.ПоставщикМалаяТорговаяТочка И СНТ.ТипСНТ =Перечисления.ТипыСНТ.ВозвратТоваров)Тогда
				Направление = Перечисления.НаправленияСНТ.Исходящий;
			Иначе
				Направление = Перечисления.НаправленияСНТ.Входящий;
			КонецЕсли;
...
Функция ТоварыВССПустымиИдентификаторами(ОбъектСНТ)
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий И НЕ ОбъектСНТ.ПредоставленВБумажномВиде
		ИЛИ (ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз)
...
Функция ПроверитьСНТНаНаличиеИдентификаторовТоваровВС(ОбъектСНТ)
	...
	Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий И НЕ ОбъектСНТ.ПредоставленВБумажномВиде
		...
		И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз)
		ИЛИ СНТСервер.ПроверитьПеремещениеИмпорт(ОбъектСНТ) Тогда
		...
		Для каждого ТабличнаяЧасть Из ПроверяемыеТабличныеЧасти Цикл
			Если ОбъектСНТ[ТабличнаяЧасть].Количество() > 0 Тогда
				Для Каждого Товар Из ОбъектСНТ[ТабличнаяЧасть] Цикл
					Если НЕ ЗначениеЗаполнено(Товар.ДополнительныйИдентификатор) И Товар.ИдентификаторТовара <> "1" Тогда //ИД товара должен быть заполнен, либо если это обычный товар то должен иметь значение = 1
	...
	ИначеЕсли ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами И НЕ СНТСервер.ПроверитьПеремещениеИмпорт(ОбъектСНТ) Тогда
...
Процедура ОбновитьДокументыСНТИзИСЭСФ(Знач МассивСНТ, Знач ДанныеПрофиляИСЭСФ) Экспорт
	...
	ИдентификаторСессии = ЭСФСервер.ОткрытьСессию(ДанныеПрофиляИСЭСФ, ВерсияИСЭСФ);
...
Процедура ОбновитьДокументыСНТПоИдентификатору(Знач МассивСНТ, Знач ПрофильИСЭСФ, ВерсияИСЭСФ, ИдентификаторСессии) Экспорт
	...
	|   И ДокументыСНТ.ТипСНТ <> Значение(Перечисление.ТипыСНТ.ВозвратТоваров)
				...
				Пока НЕ ПоследнийБлок Цикл
					...
					Если НЕ ЭтоМодульнаяОшибка(ОтветXML, ИнформацияОбОшибке) Тогда
						...
						Если SntInfoList <> Неопределено Тогда					
							...
							//////////////////////////////////////////////////////////////////////////
							// Сообщить пользователю, если не удалось найти СНТ по идентификатору.
							
							// Создать и заполнить массив идентификаторов СНТ, которые удалось найти в ИС ЭСФ.
							Для Каждого SntInfo Из SntInfoList Цикл
...
Функция ПодготовитьПараметрыПроведенияСНТ(ДокументСсылка, Отказ) Экспорт
	...
	ВозвратМТТАкциз = Ложь;
	ЕстьПеремещениеИмпорт = СНТСервер.ПроверитьПеремещениеИмпорт(ДокументСсылка);
	#Область ПолучениеДанныхДляМТТиРозничногоРеализатораПриВозврате
	
	ДатаСвязанногоСНТ = Дата(1,1,1);
	ПоставщикМТТНаВозвратПроведение = Ложь;
	ПоставщикРозничныйРеализаторНаВозвратПроведение = Ложь;

	Если ДокументСсылка.Направление = Перечисления.НаправленияСНТ.Входящий 
		И ДокументСсылка.ПоставщикМалаяТорговаяТочка 
		И ДокументСсылка.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров
		И ДокументСсылка.ТоварыВС.Количество() = 0
		
		И (ДокументСсылка.ЭтиловыйСпирт.Количество() <> 0 ИЛИ ДокументСсылка.Виноматериал.Количество() <> 0 ИЛИ ДокументСсылка.ПивоПивныеНапитки.Количество() <> 0
		ИЛИ ДокументСсылка.АлкогольнаяПродукцияКромеПива.Количество() <> 0 ИЛИ ДокументСсылка.ДанныеПоНефтепродуктам.Количество() <> 0 ИЛИ ДокументСсылка.ДанныеПоБиотопливу.Количество() <> 0
		ИЛИ ДокументСсылка.ТабачнаяПродукция.Количество() <> 0 ИЛИ ДокументСсылка.ДругиеТоварыЦифроваяМаркировка.Количество() <> 0 ИЛИ ДокументСсылка.ТоварыЭкспортныйКонтроль.Количество() <> 0) Тогда
		
		Если ЗначениеЗаполнено(ДокументСсылка.СвязанныйСНТ) Тогда
			ДатаСвязанногоСНТ = ЭСФСерверПереопределяемый.ЗначениеРеквизитаОбъекта(ДокументСсылка.СвязанныйСНТ, "Дата");
			Если ДатаСвязанногоСНТ < СНТСерверПереопределяемый.ДатаИзмененийМТТ() Тогда
				ПоставщикМТТНаВозвратПроведение = Истина;
			КонецЕсли;
		КонецЕсли;
		
	КонецЕсли;
	
	Если ДокументСсылка.Направление = Перечисления.НаправленияСНТ.Исходящий 
		И ДокументСсылка.ПоставщикРозничныйРеализатор
		И ДокументСсылка.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И ДокументСсылка.ТоварыВС.Количество() = 0
	...
	Если ПоставщикРозничныйРеализаторНаВозвратПроведение ИЛИ ПоставщикМТТНаВозвратПроведение Тогда
		
		ВозвратМТТАкциз = Истина;
	...
	Запрос.УстановитьПараметр("ВозвратМТТАкциз", ВозвратМТТАкциз);
	...
	Если (Реквизиты.Направление = Перечисления.НаправленияСНТ.Входящий 
			И (НЕ(Реквизиты.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И Реквизиты.ПоставщикМалаяТорговаяТочка) ИЛИ ВозвратМТТАкциз))
		ИЛИ (Реквизиты.Направление = Перечисления.НаправленияСНТ.Исходящий 
			И (Реквизиты.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз ИЛИ (Реквизиты.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И Реквизиты.ПоставщикМалаяТорговаяТочка И НЕ ВозвратМТТАкциз)
				ИЛИ ЕстьПеремещениеИмпорт)) Тогда
		ВидДвижения = ВидДвиженияНакопления.Приход;
	ИначеЕсли Реквизиты.ПоставщикРозничнаяРеализация ИЛИ Реквизиты.ПоставщикФизическоеЛицо 
		ИЛИ (Реквизиты.ПоставщикМалаяТорговаяТочка И НЕ Реквизиты.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И НЕ Реквизиты.Направление = Перечисления.НаправленияСНТ.Входящий) 
		ИЛИ (Реквизиты.ПоставщикРозничныйРеализатор И Реквизиты.ДатаСвязанногоСНТ < СНТСерверПереопределяемый.ДатаВводаМТТ() И НЕ ВозвратМТТАкциз) Тогда
		//для документов возврата от розничного покупателя / физического лица / розничный реализатор с датой первичного документа до 5.02.2022/ малой торговой точки с ТЧ G1
		ВидДвижения = ВидДвиженияНакопления.Приход;
	Иначе
...
Функция ТекстЗапросаРеквизитыДокументаСНТ(НомераТаблиц)
	...
	|	КОНЕЦ КАК Дата,
	|	СНТ.Организация,
	|	ВЫБОР КОГДА СНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами) И ТИПЗНАЧЕНИЯ(СНТ.Получатель) = ТИП(Справочник.Организации) И НЕ &ЕстьПеремещениеИмпорт
	|		ТОГДА СНТ.Получатель
	|		ИНАЧЕ СНТ.Организация
	...
	|					И (СНТ.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийСНТ.Ввоз) ИЛИ &ЕстьПеремещениеИмпорт
	|						ИЛИ СНТ.ТипСНТ = ЗНАЧЕНИЕ(Перечисление.ТипыСНТ.ВозвратТоваров)
	|							И НЕ &ВозвратМТТАкциз
	|							И (СНТ.ПоставщикРозничнаяРеализация
	|								ИЛИ СНТ.ПоставщикМалаяТорговаяТочка
	|								ИЛИ СНТ.ПоставщикФизическоеЛицо
	|								ИЛИ СНТ.ПоставщикРозничныйРеализатор
	|									И ЕСТЬNULL(СНТ.СвязанныйСНТ.Дата, ДАТАВРЕМЯ(1, 1, 1)) < ДАТАВРЕМЯ(2022, 2, 5)))
	|			ТОГДА СНТ.СкладПолучатель
	|		ИНАЧЕ СНТ.СкладОтправитель
	|	КОНЕЦ КАК Склад,
	...
	|	СНТ.ПоставщикРозничнаяРеализация,
	|	СНТ.ПоставщикМалаяТорговаяТочка,
	|	СНТ.ПолучательРозничнаяРеализация,
	|	СНТ.ПолучательФизическоеЛицо,
	|	СНТ.ПолучательНерезидент,
	|	СНТ.ПоставщикНерезидент,
	...
	| УПОРЯДОЧИТЬ ПО 
	|	ВЫБОР КОГДА СНТ.РегистрационныйНомерИСЭСФ <> """"
	|		ТОГДА ИСТИНА
	|	ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ УБЫВ,
	|	СНТ.Дата УБЫВ
	...
	|	ЕСТЬNULL(Реквизиты.СвязанныйСНТ.Дата, ДАТАВРЕМЯ(1,1,1)) КАК ДатаСвязанногоСНТ,
	|	Реквизиты.ТипСНТ,
	|	ВЫБОР
	...
	|	Реквизиты.ПоставщикМалаяТорговаяТочка,
...
Процедура ПровестиВходящиеСНТ(МассивСНТ,Знач НаправлениеСНТ = Неопределено)
	...
	Для Каждого ОбъектСНТ Из МассивСНТ Цикл
		...
		Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий
			И (НЕ(ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ПодтвержденПолучателем ИЛИ ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ОтклоненПолучателем ИЛИ ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ЗаблокированИСЭСФ)) Тогда
			ЭСФКлиентСервер.СообщитьПользователю(НСтр("ru = 'Документ не проведен, движения не сформированы. Проведение документа разрешено только в статусах ""Подтвержден"" или ""Отклонен""  '"));
			ОбъектСНТ.Записать();
			Продолжить;
		КонецЕсли;
		...
		Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ПоставщикМалаяТорговаяТочка И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров
			И (НЕ(ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ПодтвержденПолучателем ИЛИ ОбъектСНТ.Состояние = Перечисления.СостоянияСНТ.ОтклоненПолучателем)) Тогда
			ЭСФКлиентСервер.СообщитьПользователю(НСтр("ru = 'Документ не проведен, движения не сформированы. Проведение документа разрешено только в статусах ""Подтвержден"" или ""Отклонен""'"));
			ОбъектСНТ.Записать();
			Продолжить;
...
Процедура СоздатьОбновитьИсточникиПроисхождения(ОбъектСНТ, ИмяТабличнойЧасти, НомерТабличнойЧасти)
	...
	Для Каждого СтрокаТовар Из ОбъектСНТ[ИмяТабличнойЧасти] Цикл
		...
		Если ТипЗнч(ОбъектСНТ) = Тип("ДокументОбъект.СНТ") Тогда
			...
			//НЕ создаются ИП для товаров НЕ ВС у которых ИД = 1
			Если СтрокаТовар.ПризнакПроисхождения = "6" ИЛИ СтрокаТовар.ИдентификаторТовара = "1" Тогда
				Продолжить;
			КонецЕсли;
			...
			Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий Тогда
				Если ЗначениеЗаполнено(СтрокаТовар.ИдентификаторТовара) И ЗначениеЗаполнено(СтрокаТовар.КодТНВЭД) Тогда
					СтруктураИдентификатора = ВСКлиентСервер.СтруктураИдентификатораТовара(СтрокаТовар.ИдентификаторТовара);
					Если СтруктураИдентификатора.КодТНВЭД <> СтрокаТовар.КодТНВЭД Тогда
						ДанныеПоГСВС = ВССервер.ПолучитьДанныеПоГСВС(ОбъектСНТ.ДатаОтгрузкиТовара, СтруктураИдентификатора.КодГСВСПолный, СтрокаТовар.КодТНВЭД);
						Если ДанныеПоГСВС <> Неопределено Тогда
							СтрокаНомерИП.ГСВС = ДанныеПоГСВС.НоменклатураГСВС;
						КонецЕсли;
					Иначе
						СтрокаНомерИП.ГСВС = ВСВызовСервера.ПолучитьГСВС(СтрокаТовар.ИдентификаторТовара, СтрокаТовар.КодТНВЭД);
					КонецЕсли;
					СтрокаНомерИП.ГСВСТоварПартии = СтруктураИдентификатора.КодГСВСПолный;
				КонецЕсли;
			Иначе
				СтрокаНомерИП.ГСВС = ВСВызовСервера.ПолучитьГСВС(СтрокаТовар.ИдентификаторТовара, СтрокаТовар.КодТНВЭД);
			КонецЕсли;
			...
			Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами 
				И НЕ ЕстьПеремещениеИмпорт Тогда
			...
			Иначе
				...
				Если НЕ ((ОбъектСНТ.ВидВвоза = Перечисления.ВидыВвозаСНТ.Импорт ИЛИ ЕстьПеремещениеИмпорт) И СтрокаТовар.ДополнительныйИдентификатор = 1) Тогда
			...
			Если ИмяТабличнойЧасти = "ТоварыВС" ИЛИ ИмяТабличнойЧасти = "ЭтиловыйСпирт" 
				ИЛИ ИмяТабличнойЧасти = "Виноматериал" ИЛИ ИмяТабличнойЧасти = "ПивоПивныеНапитки" 
				ИЛИ ИмяТабличнойЧасти = "АлкогольнаяПродукцияКромеПива"
				ИЛИ ИмяТабличнойЧасти = "ТабачнаяПродукция"
				ИЛИ ИмяТабличнойЧасти = "ДругиеТоварыЦифроваяМаркировка" Тогда
			...
			Если ИмяТабличнойЧасти <> "Товары" И (ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Входящий 
				ИЛИ (ОбъектСНТ.ВидВвоза = Перечисления.ВидыВвозаСНТ.Импорт И СтрокаТовар.ДополнительныйИдентификатор <> 1)
				ИЛИ (ЕстьПеремещениеИмпорт И СтрокаТовар.ДополнительныйИдентификатор <> 1)
				ИЛИ (НЕ ЕстьПеремещениеИмпорт И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами И СтрокаТовар.ДополнительныйИдентификаторПолучатель <> 1)) Тогда 
			...
			Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз Тогда
				//если возврат от нерезидента, данные берем из документа, которые заполнились из первоначального источника
				Если ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров И ОбъектСНТ.ПоставщикНерезидент Тогда
	...
	Если ТипЗнч(ОбъектСНТ) = Тип("ДокументОбъект.СНТ") Тогда 
		...
		Если ТипСНТ = Перечисления.ТипыСНТ.Исправленная 
			//если возврат от нерезидента (экспорт) и заполнен источник из первоначального СНТ, 
			//Оприходование товара по возврату будет из первоначального источника
			ИЛИ (ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.Ввоз 
			И ОбъектСНТ.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров  И ОбъектСНТ.ПоставщикНерезидент) Тогда
			СравнитьКлючевыеРеквизитыИсправленногоИОсновногоСНТ(ТаблицаИсточниковПроисхождения, ОбъектСНТ,ИмяТабличнойЧасти);
		КонецЕсли;
	КонецЕсли;
	...
	Если ТипЗнч(ОбъектСНТ) = Тип("ДокументОбъект.СНТ") Тогда
		Если ОбъектСНТ.Направление = Перечисления.НаправленияСНТ.Исходящий И ОбъектСНТ.ВидОперации = Перечисления.ВидыОперацийСНТ.ПеремещениеМеждуФилиалами И НЕ ЕстьПеремещениеИмпорт Тогда
...
Процедура СравнитьКлючевыеРеквизитыИсправленногоИОсновногоСНТ(ТаблицаИсточниковПроисхождения, ОбъектКорректировочныйСНТ,ИмяТабличнойЧасти)
	...
	Пока Выборка.Следующий() Цикл
		Если ЗначениеЗаполнено(Выборка.СсылкаИсточникПроисхождения) Тогда
			...
			//в СНТ подставляем источник из основного СНТ
			СтрокаДокумента = ОбъектКорректировочныйСНТ[ИмяТабличнойЧасти].Найти(Выборка.НомерСтроки, "НомерСтроки");
...
Функция ИзмененнаяТаблицаКлючевыхРеквизитов(ТаблицаИсточниковПроисхождения, ОбъектСНТ, ИмяТабличнойЧасти)
	...
	|   ИсточникиПроисхождения.ГСВС КАК ГСВС,
	|//%ПинКод%	ИсточникиПроисхождения.ПинКод КАК ПинКод,
	|	2 КАК Счетчик
	|ПОМЕСТИТЬ ВТ_НовыеДанныеНомераИП
	|ИЗ
	|	&ТаблицаИсточниковПроисхождения КАК ИсточникиПроисхождения
	...
	|		КОГДА ВТ_ДанныеСНТ.Направление = ЗНАЧЕНИЕ(Перечисление.НаправленияСНТ.Входящий)
	|				И ПОДСТРОКА(ТЧТовары.НомерЗаявленияВРамкахТС, 0, 6) = ""KZ-SNT""
	|				И ТЧТовары.НомерФНО <> """"
	|				И ТЧТовары.НомерПозицииИзФНО <> """"
	|			ТОГДА ТЧТовары.НомерФНО
	...
	|		ТЧТовары.ДокументПартии КАК ДокументПартии,
	|		ТЧТовары.СсылкаИсточникПроисхождения КАК СсылкаИсточникПроисхождения,
	...
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ИсточникиПроисхождения КАК ИсточникиПроисхождения
	|			ПО ТЧТовары.СсылкаИсточникПроисхождения = ИсточникиПроисхождения.Ссылка
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|       ИсточникиПроисхождения.ГСВС КАК ГСВС,
	|//%ПинКод%	ИсточникиПроисхождения.ПинКод,
	|		-1
	|	ИЗ
	|		ВТ_ДанныеТЧ КАК ТЧТовары
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ИсточникиПроисхождения КАК ИсточникиПроисхождения
	...
	|		ИсточникиПроисхождения.КодТНВЭД,
	|		ВЫБОР
	|			КОГДА ИсточникиПроисхождения.НомерПозицииИзПервичнойСНТ = """"
	|				ТОГДА ИсточникиПроисхождения.НомерПозицииВДекларацииИлиЗаявлении
	|			ИНАЧЕ ИсточникиПроисхождения.НомерПозицииИзПервичнойСНТ
	|		КОНЕЦ,
	|		ВЫБОР
	|			КОГДА ИсточникиПроисхождения.НомерПервичнойСНТ = """"
	|				ТОГДА ИсточникиПроисхождения.НомерЗаявленияВРамкахТС
	|			ИНАЧЕ ИсточникиПроисхождения.НомерПервичнойСНТ
	|		КОНЕЦ,
	|		ИсточникиПроисхождения.ТоварНаименованиеВРамкахТС,
	...
	Если ИмяТабличнойЧасти = "ТабачнаяПродукция" ИЛИ ИмяТабличнойЧасти = "ДанныеПоНефтепродуктам" 
		ИЛИ ИмяТабличнойЧасти = "АлкогольнаяПродукцияКромеПива" ИЛИ ИмяТабличнойЧасти = "Виноматериал" 
		ИЛИ ИмяТабличнойЧасти = "ЭтиловыйСпирт" Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "//%ПинКод%", "");
	КонецЕсли;
...
Функция ИзмененнаяТаблицаКлючевыхРеквизитовСопоставления(ТаблицаИсточниковПроисхождения, ОбъектСопоставление)
	...
	|		-1 КАК Счетчик
	|	ИЗ
	|		ВТ_ДанныеДокумента КАК ТЧТовары
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ИсточникиПроисхождения КАК ИсточникиПроисхождения
	|			ПО ТЧТовары.СсылкаИсточникПроисхождения = ИсточникиПроисхождения.Ссылка
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
...
Процедура ЗаполнитьТоварыСУчетомИсточниковПроисхождения(Объект, Отказ = Ложь, ИмяТабличнойЧасти = "Товары") Экспорт
	...
	ПараметрыФормы.Вставить("Дата"		 , ?(Объект.ДатаОтгрузкиТовара = Дата(1,1,1), НачалоДня(ТекущаяДата()), Объект.ДатаОтгрузкиТовара));
	...
	Если ТипЗнч(Объект) = Тип("ДокументОбъект.СНТ") Тогда
		...
		ИначеЕсли  Объект.ТипСНТ = Перечисления.ТипыСНТ.ВозвратТоваров 
			И Объект.Направление = Перечисления.НаправленияСНТ.Исходящий Тогда
			Если ТипЗНЧ(Объект.ДокументОснование)  =  СНТСерверПереопределяемый.ПолучитьТипДокументаВозвратОтПокупателя() ИЛИ (Объект.ПоставщикРозничнаяРеализация И ЗНАЧЕНИЕЗаполнено(Объект.СвязанныйСНТ)) Тогда
				ПараметрыФормы.Вставить("СвязанныйСНТ", Объект.СвязанныйСНТ); 
				ПараметрыФормы.Вставить("ЭтоВозвратСНТ", Истина);
			ИначеЕсли ТипЗНЧ(Объект.ДокументОснование)  =  СНТСерверПереопределяемый.ПолучитьТипДокументаВозвратПоставщику() Тогда
				ПараметрыФормы.Вставить("СвязанныйСНТ", Объект.СвязанныйСНТ);
				ПараметрыФормы.Вставить("ЭтоВозвратПоставщику", Истина);
			КонецЕсли;			
		КонецЕсли;
		
		Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Входящий")
			ИЛИ (Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") И Объект.ПоставщикРозничнаяРеализация) Тогда
			ПараметрыФормы.Вставить("Склад", Объект.СкладПолучатель);
		Иначе	
			ПараметрыФормы.Вставить("Склад", Объект.СкладОтправитель);	
		КонецЕсли;
		
		Если Объект.Направление = ПредопределенноеЗначение("Перечисление.НаправленияСНТ.Исходящий") И Объект.ПоставщикРозничнаяРеализация Тогда//НЕ Объект.Ссылка.Пустая() Тогда
			ПараметрыФормы.Вставить("ЭтоРозничнаяРеализация", Объект.ПоставщикРозничнаяРеализация); // если это возврат
		иначе
			ПараметрыФормы.Вставить("ЭтоРозничнаяРеализация", Ложь);
		КонецЕсли; 
...
Процедура ЗаполнитьПустыеПризнакиПроисхождения(ДанныеДляЗаполненияПП, ДокументОбъект)   Экспорт
	...
	|;
	//ВТ таблица с номенклатурой ГСВС
	|////////////////////////////////////////////////////////////////////////////////
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ вт_Товар КАК ДанныеДокументаОбъекта
	...
	|	вт_Товар.ИмяТЧ,
	|	ВЫБОР
	|		КОГДА ВТ_КодыГСВСАктуальные.ПризнакПеречняИзьятий
	|			ТОГДА 1
	|		ИНАЧЕ ВЫБОР
	|				КОГДА НЕ ВТ_КодыГСВСАктуальные.ПризнакПеречняИзьятий
	|					ТОГДА 2
	|				ИНАЧЕ ""Нет данных""
	|			КОНЕЦ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_КодыГСВСАктуальные КАК ВТ_КодыГСВСАктуальные
	|		ПО вт_Товар.КодТНВЭД = ВТ_КодыГСВСАктуальные.КодГСВСПервичный
	|";
...
Функция ПолучитьВСКонтрагента(ПрофильИСЭСФ, МассивКонтрагентов, ВерсияВС = Неопределено) Экспорт
	...
	ТаблицаВС.Колонки.Добавить("ПредставлениеСтатуса", Новый ОписаниеТипов("Строка",,,Новый КвалификаторыСтроки(50)));
		...
		Если НЕ ЭтоМодульнаяОшибка(ОтветXML, ИнформацияОбОшибке) Тогда
			...
			Для Каждого taxpayerStore Из taxpayerStoreList Цикл
				Если taxpayerStore <> Неопределено Тогда
					...
					НоваяСтрока.ПредставлениеСтатуса = ПолучитьПредставлениеСтатусаСклада(НоваяСтрока.status);
				Иначе
	...
	Если ТаблицаВС.Количество() <> 0  Тогда
		...
		|	ТаблицаВС.ПредставлениеСтатуса
		...
		|	ВТ_ТаблицаВС.ПредставлениеСтатуса
		|ИЗ
...
// Возвращает удобное для пользователя представление статуса склада контрагента.
// Не текущий момент обрабатываются два статуса в соответствии с API:
//  "VALID" - "Действует"
//  "INVALID" - "Не действует"
Функция ПолучитьПредставлениеСтатусаСклада(ИсходныйСтатус)
	
	Если СокрЛП(НРег(ИсходныйСтатус)) = "valid" Тогда
		Возврат НСтр("ru = 'Действует'");
	ИначеЕсли СокрЛП(НРег(ИсходныйСтатус)) = "invalid" Тогда
		Возврат НСтр("ru = 'Не действует'");
	Иначе
		Возврат ИсходныйСтатус;
	КонецЕсли;
...
Функция ФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2()
	
	Если КэшированнаяФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2 = Неопределено Тогда
		
		ТекстовыйМакет = ПолучитьМакет("СхемаСопоставлениеСНТ_XML_API_ЭЦП_Версия2");
		ОбъектXDTO = ЭСФСервер.ОбъектXDTOИзСтрокиXML(ТекстовыйМакет.ПолучитьТекст(), ФабрикаXDTO);
		СписокXSD = ЭСФСервер.СписокXDTOИзОбъектXDTO(ОбъектXDTO.Body.queryfnoMatchingXsdResponse.xsdList.xsd);
		КэшированнаяФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2 = ФабрикаXDTOИзСпискаXSD(СписокXSD);
		
	КонецЕсли;
	
	Возврат КэшированнаяФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2;
	
КонецФункции

// В процедуре можно переопределить структуру выгрузки в зависимости от версии ИС ЭСФ
Процедура СоздатьИсходящиеfnoMatching(
	...
	Версия2СопоставлениеСНТиФНО = СНТКлиентСервер.ИспользоватьВерсию2СопоставлениеСНТиФНО();
	
	Если НЕ Версия2СопоставлениеСНТиФНО Тогда
	...
	Иначе
		...
		СоздатьИсходящиеfnoMatching_ВерсияАПИ22(МассивСопоставленийСНТиФНО, 
		УстанавливатьПодпись, 
		ТипПодписи, 
		КоллекцияfnoMatchingXML, 
		КоллекцияSignedContentXML,
...
Процедура СоздатьИсходящиеfnoMatching_ВерсияАПИ11(
	...
	Для Каждого СсылкаСопоставлениеСНТиФНО Из МассивСопоставленийСНТиФНО Цикл
		...
		fnoMatchingXML = "<ns2:fnoMatching xmlns:ns2=""fno.matching"">" + fnoMatchingXML;
		...
		Если УстанавливатьПодпись Тогда
			...
			//Для отправки через API добавляем обертку <invoiceBody>
			fnoMatchingXML = "<fnoMatchingBody><![CDATA[" + fnoMatchingXML + "]]></fnoMatchingBody>";
			// Добавляем заготовку для подписи
...
Процедура СоздатьИсходящиеfnoMatching_ВерсияАПИ22(
	Знач МассивСопоставленийСНТиФНО, 
	Знач УстанавливатьПодпись, 
	Знач ТипПодписиСНТиФНО, 
	КоллекцияfnoMatchingXML, 
	...
	Фабрика = ФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2();
	...
	Для Каждого СсылкаСопоставлениеСНТиФНО Из МассивСопоставленийСНТиФНО Цикл
		...
		fnoMatchingXDTO = НовыйfnoMatchingВерсия2(ОбъектСопоставлениеСНТиФНО, Фабрика, "FnoMatching", ВерсияИСЭСФ);//fnoMatchingXDTO = НовыйfnoMatching(ОбъектСопоставлениеСНТиФНО, Фабрика, "fnoMatchingV1", ВерсияИСЭСФ);
		
		fnoMatchingXML = ЭСФСервер.СтрокаXMLИзОбъектаXDTO(fnoMatchingXDTO, "fnoMatching", Фабрика);
		//=========
		fnoMatchingXML = СтрЗаменить(fnoMatchingXML, "<fnoMatching xmlns=""v1.fnoMatching"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"">", "");
		fnoMatchingXML = СтрЗаменить(fnoMatchingXML, " xmlns=""fno.matching""", "");
...
Процедура ЗаполнитьfnoMatching(Знач СопоставлениеСНТ, Знач Фабрика, fnoMatching, ВерсияСопоставления)// Отправка

	// Cписок документов СНТ
	...
	Для Каждого ДокументСНТ Из СопоставлениеСНТ.СНТ Цикл 
		...
		sourceDocument.registrationNumber = ДокументСНТ.РегистрационныйНомер;// Регистрационный номер СНТ, присвоенный системой ИС ЭСФ
		sourceDocument.date = ЗаписатьДатуJSON(ДокументСНТ.Дата, ФорматДатыJSON.ISO, ВариантЗаписиДатыJSON.ЛокальнаяДатаСоСмещением);// Дата выписки
		sourceDocument.totalSum = ДокументСНТ.Сумма;// Итоговая стоимость всех товарных позиций
		sourceDocument.customerTin = СопоставлениеСНТ.ИдентификационныйНомер;// ИИН получателя
		sourceDocument.documentVersion = "SntV1";// Версия докумена
		...
		Для Каждого СтрокаТоварыСНТ Из МассивТоваров Цикл
			...
			SourceProduct.idx = СтрокаТоварыСНТ.НомерСтрокиВСНТ;// Сквозной идентификатор товарной позиции в СНТ
			SourceProduct.name = СтрокаТоварыСНТ.ТоварНаименование;// Наименование товара
			SourceProduct.tnvedCode = СтрокаТоварыСНТ.КодТНВЭД;// Код ТНвЭД
			SourceProduct.measureUnitCode = СокрЛП(СтрокаТоварыСНТ.ЕдиницаИзмеренияКод);// Код единицы измерения
			SourceProduct.quantity = СтрокаТоварыСНТ.Количество;// Количество товара
			SourceProduct.price = СтрокаТоварыСНТ.Цена;// Цена
			SourceProduct.fnoNumber = СтрокаТоварыСНТ.НомерЗаявленияВРамкахТС;// Регистрационный номер ФНО 328
			SourceProduct.fnoProductNumber = Строка(Формат(СтрокаТоварыСНТ.НомерПозицииВЗаявлении,"ЧГ=0"));// Номер товарной позиции в ФНО 328
	...
	Для Каждого ДокументФНО Из СопоставлениеСНТ.ФНО Цикл
		...
		FnoCompact.registrationNumber = ДокументФНО.РегистрационныйНомер;// Регистрационный номер ФНО 328
		FnoCompact.date = ЗаписатьДатуJSON(ДокументФНО.Дата, ФорматДатыJSON.ISO, ВариантЗаписиДатыJSON.ЛокальнаяДатаСоСмещением);// Дата поступления ФНО 328 в систему ИС ЭСФ
		FnoCompact.totalSum = ДокументФНО.Сумма;// Итоговая стоимость всех товарных позиций
		FnoCompact.customerTin = СопоставлениеСНТ.ИдентификационныйНомер;// ИИН получателя
		...
		Для Каждого СтрокаТоварыФНО Из МассивТоваров Цикл
			...
			FnoProductCompact.name = СтрокаТоварыФНО.ТоварНаименование;// Наименование товара
			FnoProductCompact.tnvedCode = СтрокаТоварыФНО.КодТНВЭД;// Код ТНвЭД
			FnoProductCompact.measureUnitCode = СокрЛП(СтрокаТоварыФНО.ЕдиницаИзмеренияКод);// Код единицы измерения
			FnoProductCompact.quantity = СтрокаТоварыФНО.Количество;// Количество товара
			FnoProductCompact.price = СтрокаТоварыФНО.Цена;// Цена
			FnoProductCompact.fnoNumber = ДокументФНО.РегистрационныйНомер;// Регистрационный номер
...
Функция НовыйfnoMatchingВерсия2(Знач СопоставлениеСНТ, Знач Фабрика, Знач ВерсияСопоставления = "FnoMatching", ВерсияИСЭСФ)
...
Функция ОтправитьПакетИсходящихfnoMatching(ВерсияВС, Знач КоллекцияfnoMatchingXMLПакета, Знач КоллекцияПодписей, Знач ПрофильИСЭСФ, Знач ОткрытыйКлючЭЦП, ИдентификаторСессии = Неопределено) Экспорт
	...
	Для Каждого ЭлементКоллекции Из КоллекцияfnoMatchingXMLПакета Цикл
		...
		Если ЭСФВызовСервера.ИспользоватьПодписьНовойКомпоненты() И НЕ ЭСФВызовСервера.ИспользоватьВнешнююКриптографиюДляКомпоненты() Тогда
			...
			fnoMatchingXML = СтрЗаменить(fnoMatchingXML, "<signatureType></signatureType>", "<signatureType>"+ПрофильИСЭСФ.ТипПодписи+"</signatureType>");
		КонецЕсли;
		fnoMatchingSet = fnoMatchingSet + fnoMatchingXML + Символы.ПС;
		
		Если ЭСФВызовСервера.ИспользоватьПодписьНовойКомпоненты() Тогда
			КоллекцияfnoMatchingXMLПакета.Вставить(ЭлементКоллекции.Ключ, fnoMatchingXML);
		КонецЕсли;
...
Функция ПолучитьОшибкиСопоставлениеСНТсФНОПоИдентификаторам(Знач МассивИдентификаторовСопСНТсФНО, Знач ПрофильИСЭСФ, ИдентификаторСессии, Знач ОбновитьОшибкиВДокументах = Ложь) Экспорт
	...
	Если НЕ ЭтоМодульнаяОшибка(ОтветXML, ИнформацияОбОшибке) Тогда
		...
		ИначеЕсли RecordsCount = 1 Тогда
...
Процедура СоздатьОбновитьПолучаемыеСопоставлениеСНТсФНО (Знач fnoMatchingInfoList, Знач СтруктурнаяЕдиница, Знач УчитыватьВсеСтатусыСопСНТсФНО, МассивИсключаемыхИД = Неопределено, Знач Провести = Ложь, Пользователь = Неопределено) Экспорт
	...
	Попытка
		...
		Для Каждого ОбъектСопСНТсФНО Из МассивСопСНТсФНО Цикл
			Если НЕ ОбъектСопСНТсФНО.Ссылка.Пустая() Тогда
				// Табличные части ФНО и СНТ, не будут обновляться, до реализации метода получения документа Сопоставление СНТ с ФНО сервера.
		...
		Для Каждого ОбъектСопСНТсФНО Из МассивСопСНТсФНО Цикл
			...
			Режим = РежимЗаписиДокумента.Запись;
			Если ОбъектСопСНТсФНО.Статус = Перечисления.СтатусыСопоставленийСНТиФНО.Отмененный Тогда
				Если НЕ ОбъектСопСНТсФНО.Ссылка.Пустая() Тогда
					МассивКолонокТабличныхЧастей = Новый Массив;
					МассивКолонокТабличныхЧастей.Добавить("ИсточникПроисхождения");// Источник происхождения до сопоставления
					МассивКолонокТабличныхЧастей.Добавить("ИсточникПроисхожденияПолучатель");// Источник происхождения после сопоставления
					Для Каждого Товар Из ОбъектСопСНТсФНО.ТоварыСНТ Цикл 
						Для Каждого Колонка Из МассивКолонокТабличныхЧастей Цикл 
							Товар[Колонка] = Неопределено;
						КонецЦикла;
					КонецЦикла;
				КонецЕсли;
				Если ОбъектСопСНТсФНО.Проведен Тогда
					Режим = РежимЗаписиДокумента.ОтменаПроведения;
				КонецЕсли;
			КонецЕсли;
		
			ОбъектСопСНТсФНО.Записать(Режим);
		КонецЦикла;
...
Процедура ЗаполнитьФНО(Знач fnoMatchingInfo, Знач СтруктурнаяЕдиница, СопСНТсФНО) Экспорт //Получение
	...
	Иначе
		Фабрика = ФабрикаСопоставлениеСНТ_XML_API_ЭЦП_Версия2();
		ТипfnoMatching = Фабрика.Тип("v1.fnoMatching", "fnoMatching");
		originalXML = СНТСервер.ПолучитьСвойство(fnoMatchingInfo, "originalXML", Неопределено);
		ТекстfnoMatching = originalXML;
		fnoMatching = СНТСервер.ОбъектXDTOИзСтрокиXML(ТекстfnoMatching, Фабрика, ТипfnoMatching);
	КонецЕсли;
...
Процедура ЗаполнитьИсходящийСНТ(Знач ДокументОснованиеДляЗаполнения, ОбъектСНТ, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если ТипЗнч(МассивДанныхДляЗаполнения) = Тип("Массив") И МассивДанныхДляЗаполнения.Количество() > 0 Тогда
		...
		// Если получатель РозничныйПокупатель
		СНТСерверПереопределяемый.ПолучательРозничныйПокупатель(ОбъектСНТ);
		...
		Для Каждого СтрокаТЧ Из СтруктураДокумента.ТоварыЭкспортныйКонтроль Цикл
			...
			ОбъектСНТ.ЕстьТоварыЭК = Истина;
			
			НоваяСтрокаТЧ = ОбъектСНТ.ТоварыЭкспортныйКонтроль.Добавить();
			ЗаполнитьЗначенияСвойств(НоваяСтрокаТЧ,СтрокаТЧ);
			НоваяСтрокаТЧ.ДополнительныйИдентификатор = СтрокаТЧ.ИсточникПроисхождения.ДополнительныйИдентификатор;
...
Функция ИнициализироватьКлючиАналитикиУчетаНоменклатуры(Знач МассивСНТ, Знач СоздатьНовыеПриОтсутствии) Экспорт
	...
	// бОльшая длина вызывает ошибку на СУБД MS SQL
	//|	ВЫРАЗИТЬ(ВТТаблицаТовары.ТоварНаименование КАК СТРОКА(440)) КАК ТоварНаименование,
	|	ВТТаблицаТовары.ТоварНаименование  КАК ТоварНаименование,
