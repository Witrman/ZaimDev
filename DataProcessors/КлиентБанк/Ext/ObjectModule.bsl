	...
	Если НЕ ВыгружатьВXMLФормате Тогда
		...
		Для Каждого СтрокаСекции из ДокументыНаЭкспорт Цикл
			...
			Если ПустаяСтрока(Буфер) Тогда
				ТекстСообщения = НСтр("ru = 'Документ:" + СокрЛП(СтрокаСекции.Документ) + " не выгружен!'");
			...
			Если ПустаяСтрока(РезультатПроверки) Тогда
				...
				Иначе
					...
					Если ОбъектДокумента.РасшифровкаПлатежа.Количество() > 1 Тогда
						НазваниеОбъекта = ПолучитьПредставлениеОбъекта(ОбъектДокумента);
						ТекстЗамечания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
											НСтр("ru = 'Существующий  %1 содержит больше одной строки в расшифровке платежа!'"), НазваниеОбъекта);
						ТекстСообщения = НСтр("ru = 'Платежный документ """ 
											+ СтрокаСекции.Операция 
											+ """ №" 
											+ СокрЛП(СтрокаСекции.НомерДок) 
											+ " от " 
				...
				Если ЗначениеЗаполнено(ДатаГраницыОбработки) Тогда
					Если НачалоДня(ОбъектДокументаКУдаление.Дата) <= НачалоДня(ДатаГраницыОбработки) Тогда
						ТекстСообщения = НСтр("ru = 'Платежный документ """ 
												...
												+ " не помечен на удаление, так как имеет дату равной или меньшей границы обработки!'");
...
Функция СформироватьСтруктуруЗаголовковЭкспорта()
	...
	СтруктураЗаголовков.Вставить("Готовность",          	  "Готовность");
	
	СтруктураЗаголовков.Вставить("НомерДокумента",     		  "№ Документа");
	СтруктураЗаголовков.Вставить("ДатаДокумента",      		  "Дата");
	СтруктураЗаголовков.Вставить("Операция",           		  "Операция");
	СтруктураЗаголовков.Вставить("СчетОрганизации",           "Эл. Р/с организации");
	СтруктураЗаголовков.Вставить("НомерСчетаОрганизации",     "Р/с организации");
	СтруктураЗаголовков.Вставить("Сумма",                     "Сумма");
	СтруктураЗаголовков.Вставить("СуммаДокумента",            "Сумма");
	
	СтруктураЗаголовков.Вставить("ПенсионныеОтчисления",      "Пенсионные отчисления");
	СтруктураЗаголовков.Вставить("СоциальныеОтчисления",      "Социальные отчисления");
	СтруктураЗаголовков.Вставить("ПеречислениеНаКартСчета",	  "Заработная плата");
	СтруктураЗаголовков.Вставить("ПеречислениеПоИЛ",	  	  "Перечисление по исполнительным листам");
	СтруктураЗаголовков.Вставить("ПеречислениеПодотчетнику",  "Перечисление подотчетнику");
	
	СтруктураЗаголовков.Вставить("Контрагент",                "Контрагент");
	СтруктураЗаголовков.Вставить("ЭлементКонтрагент",         "Контрагент");
	СтруктураЗаголовков.Вставить("СчетКонтрагента",           "Р/с контрагента");
	СтруктураЗаголовков.Вставить("НомерСчетаКонтрагента",     "Р/с контрагента");
	
	СтруктураЗаголовков.Вставить("ПлательщикНаименование",    "Отправитель");
	СтруктураЗаголовков.Вставить("ПлательщикРНН",             "РНН отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикБИН_ИИН",         "БИН / ИИН отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикКБЕ",             "Кбе отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикИИК",             "Расчетный счет отправителя");
	
	СтруктураЗаголовков.Вставить("ПлательщикБанкНаименование","Наименование банка-отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикБанкРНН",         "РНН банка-отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикБанкБИН_ИИН",     "БИН / ИИН банка-отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикБанкБИК",         "БИК банка-отправителя");
	СтруктураЗаголовков.Вставить("ПлательщикБанкИИК",         "ИИК банка-отправителя");
	
	СтруктураЗаголовков.Вставить("ПолучательНаименование",    "Бенефициар");
	СтруктураЗаголовков.Вставить("ПолучательРНН",             "РНН бенефициара");
	СтруктураЗаголовков.Вставить("ПолучательБИН_ИИН",         "БИН / ИИН бенефициара");
	СтруктураЗаголовков.Вставить("ПолучательКБЕ",             "Кбе бенефициара");
	СтруктураЗаголовков.Вставить("ПолучательИИК",             "ИИК бенефициара");
	
	СтруктураЗаголовков.Вставить("ПолучательБанкНаименование", "Наименование банка-получателя");
	СтруктураЗаголовков.Вставить("ПолучательБанкРНН",         "РНН банка-получателя");
	СтруктураЗаголовков.Вставить("ПолучательБанкБИН_ИИН",     "БИН / ИИН банка-получателя");
	СтруктураЗаголовков.Вставить("ПолучательБанкБИК",         "БИК банка-получателя");
	СтруктураЗаголовков.Вставить("ПолучательБанкИИК",         "ИИК банка-получателя");

    СтруктураЗаголовков.Вставить("БанкПосредникНаименование", "Наименование банка-посредника");
	СтруктураЗаголовков.Вставить("БанкПосредникРНН",          "РНН банка-посредника");
	СтруктураЗаголовков.Вставить("БанкПосредникБИН_ИИН",      "БИН / ИИН банка-посредника");
	СтруктураЗаголовков.Вставить("БанкПосредникБИК",          "БИК банка-посредника");
	СтруктураЗаголовков.Вставить("БанкПосредникИИК",          "ИИК банка-посредника");
	
    СтруктураЗаголовков.Вставить("ГЦВПРНН",                   "РНН ГЦВП");
	СтруктураЗаголовков.Вставить("ГЦВПБИН_ИИН",               "БИН / ИИН ГЦВП");
	
	СтруктураЗаголовков.Вставить("ГЦВПИИК",                   "Р/с ГЦВП");
	СтруктураЗаголовков.Вставить("ГЦВПБанкНаименование",      "Наименование банка ГЦВП");
	СтруктураЗаголовков.Вставить("ГЦВПБанкБИК",               "БИК банка ГЦВП");

	СтруктураЗаголовков.Вставить("ДатаПолученияТовара",       "Дата получения товара");
	СтруктураЗаголовков.Вставить("НазначениеПлатежа",         "Назначение платежа");
	
	СтруктураЗаголовков.Вставить("КодНазначенияПлатежа",      "Код назначения платежа");
	СтруктураЗаголовков.Вставить("КодБюджетнойКлассификации", "Код бюджетной классификации");
	СтруктураЗаголовков.Вставить("ДатаВалютирования",         "Дата валютирования");
	
	СтруктураЗаголовков.Вставить("Документ",            	  "Источник");
	СтруктураЗаголовков.Вставить("СекцияДокумент",      	  "Выгрузка");
	
	СтруктураЗаголовков.Вставить("ОписаниеОшибок",      	  "Замечания");
	СтруктураЗаголовков.Вставить("ТипДокумента",        	  "Тип пл. документа");
	СтруктураЗаголовков.Вставить("Проведен",          		  "");
	
	СтруктураЗаголовков.Вставить("СостояниеДокумента", 		  "Состояние документа");
...
Функция СформироватьТекстЗапросаПоСО()
	...
	|	СОПеречислениеВФондыСоциальныеОтчисления.Ссылка.ПериодРегистрации КАК Период
	|ИЗ
...
Функция СформироватьТекстЗапросаПоЗП()
	...
	ТекстЗапроса = "
	|///////////////////////////////////СписокЗарплатаКВыплатеОрганизаций////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	ППИЗП.Ведомость КАК Ведомость
	|ПОМЕСТИТЬ СписокЗарплатаКВыплатеОрганизаций	
	|ИЗ
	|    Документ.ПлатежноеПоручениеИсходящее.ПеречислениеЗаработнойПлаты КАК ППИЗП
	|ГДЕ 	
	|    ППИЗП.Ссылка = &Документ
	|;
	...
	|ГДЕ
	|	ЗарплатаКВыплатеОрганизацийЗарплата.Ссылка В (ВЫБРАТЬ Ведомость ИЗ СписокЗарплатаКВыплатеОрганизаций)
	|СГРУППИРОВАТЬ ПО
...
Функция СформироватьТекстЗапросаПоПеречислениеПодотчетникам()
	...
	|ГДЕ
	|	ПеречислениеВПодотчет.Ссылка = &Документ
	|
	|СГРУППИРОВАТЬ ПО
			...
			Если НЕ ПустаяСтрока(ВыборкаСотрудников.Сотрудник) Тогда
				...
				Если ВидДанных = "ЗП" Тогда
					Если ПустаяСтрока(ВыборкаСотрудников.СотрудникКартСчет) Тогда
						...
						ТекстСообщения = НСтр("ru = 'Не указан номер карт-счета сотрудника: " + СокрЛП(ВыборкаСотрудников.Фамилия) + " " + СокрЛП(ВыборкаСотрудников.Имя) + " " + СокрЛП(ВыборкаСотрудников.Отчество) + "'");
						ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
				...
				ИначеЕсли ПроверятьРНН Тогда // Проверим стоит ли настройка проверки заполненности РНН
					ТекстСообщения = НСтр("ru = 'Не заполнен РНН сотрудника: " + ВыборкаСотрудников.Сотрудник + "'");
					ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
				КонецЕсли;
				...
				ИначеЕсли ПроверятьБИН_ИИН Тогда // Проверим стоит ли настройка проверки заполненности БИН/ИИН
					...
					ТекстСообщения = НСтр("ru = 'Не заполнен ИИН сотрудника: " + ВыборкаСотрудников.Сотрудник + "'");
					ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
				...
				Иначе
					...
					ИначеЕсли ПроверятьРНН Тогда // Проверим стоит ли настройка проверки заполненности РНН
						...
						ТекстСообщения = НСтр("ru = 'Не заполнен СИК сотрудника: " + ВыборкаСотрудников.Сотрудник + "'");
						ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
					...
					Иначе 
						ТекстСообщения = НСтр("ru = 'Не заполнена дата рождения сотрудника " + ВыборкаСотрудников.Сотрудник + "'");
						ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
					КонецЕсли;
				...
				Иначе
					Если ВидДанных = "ЗП" Тогда
						ТекстСообщения = НСтр("ru = 'Не заполнена сумма заработной платы сотрудника: " + ВыборкаСотрудников.Сотрудник + "'");
					Иначе	
...
Процедура ДобавитьДанныеПеречислениеПоИЛ(Буфер, 
	...
	Пока ВыборкаПолучателей.Следующий() Цикл
		Если НЕ ПустаяСтрока(ВыборкаПолучателей.ПолучательПоИЛФИО) Тогда
			...
			ИначеЕсли ПроверятьРНН Тогда // Проверим стоит ли настройка проверки заполненности РНН
				ТекстСообщения = НСтр("ru = 'Не заполнен РНН получателя по исполнительным листам: " + СокрЛП(ВыборкаПолучателей.ПолучательПоИЛФИО) + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
			...
			ИначеЕсли ПроверятьБИН_ИИН Тогда // Проверим стоит ли настройка проверки заполненности БИН/ИИН
				ТекстСообщения = НСтр("ru = 'Не заполнен ИИН получателя по исполнительным листам: " + СокрЛП(ВыборкаПолучателей.ПолучательПоИЛФИО) + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
			///////////////////
			...
			Иначе
				...
				Если ВыборкаПолучателей.ПолучательПоИЛАдрес = NULL Тогда
					ТекстСообщения = НСтр("ru = 'Не заполнен фактический адрес контрагента для пролучателя по ИЛ: " + СокрЛП(ВыборкаПолучателей.ПолучательПоИЛФИО) + "'");
					ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
				КонецЕсли;
			КонецЕсли;
			...
			Иначе 
				ТекстСообщения = НСтр("ru = 'Не заполнена сумма к перечислению по исполнительным листам для получателя: " + СокрЛП(ВыборкаПолучателей.ПолучательПоИЛФИО) + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
	...
	Пока ВыборкаПодотчетников.Следующий() Цикл
		Если НЕ ПустаяСтрока(ВыборкаПодотчетников.НаименованиеФизЛица) Тогда
			...
			ИначеЕсли ПроверятьРНН Тогда // Проверим стоит ли настройка проверки заполненности РНН
				...
				ТекстСообщения = НСтр("ru = 'Не заполнен РНН подотчетника:" + ВыборкаПодотчетников.НаименованиеФизЛица + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			...
			ИначеЕсли ПроверятьБИН_ИИН Тогда // Проверим стоит ли настройка проверки заполненности БИН/ИИН
				...
				ТекстСообщения = НСтр("ru = 'Не заполнен ИИН подотчетника:" + ВыборкаПодотчетников.НаименованиеФизЛица + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			...
			Если ПустаяСтрока(ВыборкаПодотчетников.НомерКартСчета) Тогда
				ТекстСообщения = НСтр("ru = 'Не указан номер карт-счета подотчетника:" + СокрЛП(ВыборкаПодотчетников.НаименованиеФизЛица) + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
			...
			Иначе 
				ТекстСообщения = НСтр("ru = 'Не заполнена сумма выдачи в подотчет для подотчетника:" + СокрЛП(ВыборкаПодотчетников.НаименованиеФизЛица) + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
...
Процедура ЗаписатьДанныеПоСотрудникам(ЗаписьXML, 
	...
	Пока ВыборкаСотрудников.Следующий() Цикл
		Если НЕ ПустаяСтрока(ВыборкаСотрудников.Сотрудник) Тогда
			...
			Если ВидДанных = "ЗП" Тогда
				Если ПустаяСтрока(ВыборкаСотрудников.СотрудникКартСчет) Тогда
					ТекстСообщения = НСтр("ru = 'Не указан номер карт-счета сотрудника:" 
...
Процедура ЗаписатьДанныеПеречислениеПоИЛ(ЗаписьXML,
	...
	Пока ВыборкаПолучателей.Следующий() Цикл
		...
		Если НЕ ПустаяСтрока(ВыборкаПолучателей.ПолучательПоИЛФИО) Тогда
			...
			ИначеЕсли ПроверятьБИН_ИИН Тогда // Проверим стоит ли настройка проверки заполненности БИН/ИИН
				ТекстСообщения = НСтр("ru = 'Не заполнен БИН/ИИН получателя по исполнительным листам:" + СокрЛП(ВыборкаПолучателей.ПолучательПоИЛФИО) + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
...
Процедура ЗаписатьДанныеПеречислениеПодотчетнику(ЗаписьXML, 
	...
	Пока ВыборкаПодотчетников.Следующий() Цикл
		...
		Если НЕ ПустаяСтрока(ВыборкаПодотчетников.НаименованиеФизЛица) Тогда
			...
			Если ПустаяСтрока(ВыборкаПодотчетников.НомерКартСчета) Тогда
				ТекстСообщения = НСтр("ru = 'Не указан номер карт-счета подотчетника:" + ВыборкаПодотчетников.НаименованиеФизЛица + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
			...
			ИначеЕсли ПроверятьБИН_ИИН Тогда // Проверим стоит ли настройка проверки заполненности БИН/ИИН
				ТекстСообщения = НСтр("ru = 'Не заполнен БИН/ИИН подотчетника:" + ВыборкаПодотчетников.НаименованиеФизЛица + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
			///////////////////			  
			...
			Если НЕ ПустаяСтрока(ВыборкаПодотчетников.СуммаКПеречислению) Тогда
				...
				ОбщаяСумма = ОбщаяСумма + ВыборкаПодотчетников.СуммаКПеречислению;
			Иначе 
				ТекстСообщения = НСтр("ru = 'Не заполнена сумма выдачи в подотчет для подотчетника:" + ВыборкаПодотчетников.НаименованиеФизЛица + "'");
				ОбщегоНазначения.СообщитьПользователю(ТекстСообщения);
			КонецЕсли;
...
Функция СформироватьСтруктуруЗаголовковИмпорта()
	...
	СтруктураЗаголовков.Вставить("Проведен",          		  "Проведен");
	СтруктураЗаголовков.Вставить("Загрузить",          		  "_");
	СтруктураЗаголовков.Вставить("Готовность",        	      "Готовность");
	
	СтруктураЗаголовков.Вставить("НомерДок",           		  "№ Документа");
	
	СтруктураЗаголовков.Вставить("НомерДокумента",     		  "Номер");
	СтруктураЗаголовков.Вставить("ДатаДок",            		  "Дата документа");
	СтруктураЗаголовков.Вставить("ДатаДокумента",      	      "Дата (из файла)");
	СтруктураЗаголовков.Вставить("Операция",            	  "Операция");
	СтруктураЗаголовков.Вставить("СчетОрганизации",     	  "Р/с организации");
	СтруктураЗаголовков.Вставить("СуммаДокумента",      	  "Сумма");
	СтруктураЗаголовков.Вставить("Сумма",               	  "Сумма (из файла)");
	
	СтруктураЗаголовков.Вставить("Контрагент",          	  "Контрагент");
	СтруктураЗаголовков.Вставить("СчетКонтрагента",    	 	  "Р/с контрагента");
	
	СтруктураЗаголовков.Вставить("ДатаОперации",        	  "Дата операции");
	СтруктураЗаголовков.Вставить("СуммаПриход",         	  "Сумма приход");
	СтруктураЗаголовков.Вставить("СуммаРасход",         	  "Сумма расход");

	СтруктураЗаголовков.Вставить("Списано",             	  "Дата списания");
	СтруктураЗаголовков.Вставить("ДатаСписано",         	  "Списано");
	СтруктураЗаголовков.Вставить("Поступило",           	  "Дата поступления");
	СтруктураЗаголовков.Вставить("ДатаПоступило",       	  "Поступило");
	...
	СтруктураЗаголовков.Вставить("ПолучательНаименование",    "Бенефициар");
	СтруктураЗаголовков.Вставить("ПолучательРНН",             "Кбе бенефициара");
	СтруктураЗаголовков.Вставить("ПолучательКБЕ",             "ИИК бенефициара");
	СтруктураЗаголовков.Вставить("ПолучательИИК",             "РНН бенефициара");
	...
	Пока Лев(Врег(СокрЛП(СтрокаРазбора)), 14) <> "КОНЕЦДОКУМЕНТА" Цикл
		...
		Если РазобратьТеговуюСтроку(СтрокаРазбора, Тег, Значение) Тогда
			...
			Попытка
				...
				КонецЕсли;
			Исключение
				ТекстСообщения = НСтр("ru = 'Некорректная структура файла импорта, строка " + (Импорт_ТекущаяСтрока - 1) + " : " + Символы.ПС + СтрокаРазбора + "'");
				СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
			КонецПопытки;
...
Процедура РаспознатьДанныеВСтроке_Документ(СтрокаДокумента, Организация, СтруктурноеПодразделение, ИспользоватьГраницуОбработки, ДатаГраницыОбработки)
			...
			Попытка
				...
				Если ВыборкаПоиска[РеквизитДаты] <> "" Тогда
					Если ВыборкаПоиска[РеквизитДаты] <> СтрокаДокумента.ДатаДок Тогда 
						ДобавитьЗамечание(СтрокаДокумента, 1, "Дата входящего документа, загружаемого из файла "+СтрокаДокумента.ДатаДок+" не соответствует дате найденного документа информационной базы "+ВыборкаПоиска[РеквизитДаты]+". Для документа "+ВыборкаПоиска.Ссылка+" будет установлена дата входящего документа "+СтрокаДокумента.ДатаДок+"!");		
					КонецЕсли;
				ИначеЕсли ВыборкаПоиска[РеквизитДатыДоп] <> "" Тогда
					Если ВыборкаПоиска[РеквизитДатыДоп] <> СтрокаДокумента.ДатаДок Тогда 
						ДобавитьЗамечание(СтрокаДокумента, 1, "Дата документа, загружаемого из файла "+СтрокаДокумента.ДатаДок+" не соответствует дате найденного документа информационной базы "+ВыборкаПоиска[РеквизитДатыДоп]+". Для документа "+ВыборкаПоиска.Ссылка+" будет установлена дата "+СтрокаДокумента.ДатаДок+"!");		
					КонецЕсли;
				КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(СтрокаДокумента.Документ) Тогда
		Если ВидДокумента = "ПлатежноеПоручениеИсходящее" ИЛИ ВидДокумента = "ПлатежныйОрдерСписаниеДенежныхСредств" Тогда
			ДобавитьЗамечание(СтрокаДокумента, 1, "Документ не найден в информационной базе! Будет создан документ с номером по банку:"+СтрокаДокумента.НомерДок+" и датой по банку:"+СтрокаДокумента.ДатаДок+"");
		КонецЕсли;
	КонецЕсли;
...
Функция РазобратьФайлИмпортаTXT(ДокументыДляИмпорта,
	...
	Пока Импорт_ТекущаяСтрока <= Импорт_КоличествоСтрок Цикл
		...
		Если Лев(Врег(СокрЛП(Стр)), 14)="СЕКЦИЯДОКУМЕНТ" Тогда
			...
			Иначе
				ТекстСообщения = НСтр("ru = 'Нарушена структура файла импорта, строка " + (Импорт_ТекущаяСтрока - 1) + " : " + Стр + "'");
				СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
				Возврат Ложь;
		...
		ИначеЕсли Лев(Врег(СокрЛП(Стр)), 14)="СЕКЦИЯРАСЧСЧЕТ" Тогда
			...
			Если НЕ ЗагрузитьСекциюРасчСчета(СтрокаРССчетов, Импорт_ТекущаяСтрока, Импорт_КоличествоСтрок, Импорт_МассивСтрок, СтекОповещений) Тогда
				...
				ТекстСообщения = НСтр("ru = 'Нарушена структура файла импорта в секции описания расчетного счета! Строка: " + (Импорт_ТекущаяСтрока - 1) + "'");
				СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
		...
		ИначеЕсли Лев(Врег(СокрЛП(Стр)), 8)="РАСЧСЧЕТ" Тогда
			...
			Если Тег = "РАСЧСЧЕТ" Тогда
				...
				Иначе
					...
					ТекстСообщения = НСтр("ru = 'В заголовке файла импорта указан счет, не принадлежащий организации: " + Значение + "!'");
					СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
...
Процедура ЗаполнитьРеквизитПлатежногоПорученияИсходящее(ОбъектДокумента, ИсходныеДанные, ИмяРеквизита, СтруктураНастроек, Организация, СтруктурноеПодразделение, СтекОповещений)
	...
	Если ИмяРеквизита = "Организация" Тогда
		...
		Если ОбъектДокумента.ДатаВходящегоДокумента <> Дата(1,1,1) И ОбъектДокумента.ДатаВходящегоДокумента <> ИсходныеДанные.ДатаДок Тогда 
			ТекстСообщения = НСтр("ru = В документе:'"
								+ ОбъектДокумента.Ссылка
								+ " значение реквизита ""ДатаВходящегоДокумента"":"""
	...
	ИначеЕсли ИмяРеквизита = "СчетОрганизации" Тогда //заполняется при заполнении Контрагент
		...
		Если ЗначениеЗаполнено(ОбъектДокумента.СчетОрганизации) И ОбъектДокумента.СчетОрганизации <> ИсходныеДанные.СчетОрганизации Тогда 
			ТекстСообщения = НСтр("ru = 'В документе:"
								+ ОбъектДокумента.Ссылка
								+ " значение реквизита ""СчетОрганизации"":"""
	...
	ИначеЕсли ИмяРеквизита = "СуммаДокумента" Тогда
			...
			Если ЗначениеЗаполнено(ОбъектДокумента.СуммаДокумента) И ОбъектДокумента.СуммаДокумента <> ИсходныеДанные.СуммаДокумента Тогда 
				ТекстСообщения = НСтр("ru = ' В документе:"
								+ ОбъектДокумента.Ссылка
								+ " значение реквизита ""СуммаДокумента"":"""
...
Процедура ЗадатьПометкуНаУдаление(ОбъектДляПометки, Пометка, СтекОповещений)
	...
	Попытка
		...
		ТекстСообщения = НСтр("ru = '" + Врег(Лев(НазваниеОбъекта, 1)) + Сред(НазваниеОбъекта, 2) + ": " + НазваниеДействия + ".'");
		СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
			
	Исключение
		
		ТекстСообщения = НСтр("ru = '" + Врег(Лев(НазваниеОбъекта, 1)) + Сред(НазваниеОбъекта, 2)+ ": не " + НазваниеДействия + "! Произошли ошибки при записи!'");
		СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения + Символы.ПС + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())));
...
Функция СоздатьКонтрагента(СтрокаКонтрагент = Неопределено, ТаблицаКонтрагентов = Неопределено, ТекОрганизация, СтекОповещений, ТекВалюта = Неопределено) Экспорт //или СтрокаКонтрагент - строка, или ТаблицаКонтрагентов - ТЗ
	...
	Если Контрагент.Пустая() Тогда
		...
		ТекстСообщения = НСтр("ru = 'Контрагент """ + НовыйЭлемент.Наименование + """ создан.'");
		СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
		...
		Если НЕ ВалютаСчета=Справочники.Валюты.ПустаяСсылка() Тогда         		
			...
			КонецЕсли;			
	   		...
	   		Попытка
        		Объект.Записать();
    		Исключение
				ТекстСообщения = НСтр("ru = 'Не удалось записать объект """ + Объект + """
										|" + ОписаниеОшибки() + "'");
				СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
			КонецПопытки;
...
Процедура ЗаписатьОбъект(ОбъектДляЗаписи, СтрокаСекции, Организация, СтруктураНастроек, СтекОповещений)
	...
	Попытка
		...
		Если ЭтоНовый Тогда
			...
			ТекстСообщения = НСтр("ru = 'Создан " + НазваниеОбъекта + ".'");
			СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
		
		Иначе
			
			ТекстСообщения = НСтр("ru = 'Записан " + НазваниеОбъекта + ".'");
			СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
	...
	Исключение
		...
		Если ОбъектДляЗаписи.ЭтоНовый() Тогда
			...
			ТекстСообщения = НСтр("ru = '" + Врег(Лев(НазваниеОбъекта, 1)) + Сред(НазваниеОбъекта, 2) +  " не создан! Произошли ошибки при записи!'");
			СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения + Символы.ПС + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())));
		
		Иначе
			ТекстСообщения = НСтр("ru = '" + Врег(Лев(НазваниеОбъекта, 1)) + Сред(НазваниеОбъекта, 2) +  " не записан! Произошли ошибки при записи!'");
			СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения + Символы.ПС + ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())));
	...
	Попытка
		...
		Если Проводить Тогда
			...
			ТекстСообщения = НСтр("ru = 'Проведен " + НазваниеОбъекта + ".'");
			СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
	...
	Исключение
		ТекстСообщения = НСтр("ru = '" + Врег(Лев(НазваниеОбъекта, 1)) + Сред(НазваниеОбъекта, 2) + " не проведен! Произошли ошибки при проведении!'");
		СтекОповещений.Добавить(Новый Структура("Текст", ТекстСообщения));
