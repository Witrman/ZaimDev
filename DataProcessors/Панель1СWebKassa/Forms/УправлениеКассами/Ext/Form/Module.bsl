...
Процедура УстановитьВидимостьЭлементов()
	...
	Если НЕ ПравоНастройки Тогда
		ИнтеграцияWebKassaКлиентСерверПереопределяемый.УстановитьСвойствоЭлементаФормы(Элементы, "КассыККМГруппаДобавление"        , "Видимость", Ложь);
		ИнтеграцияWebKassaКлиентСерверПереопределяемый.УстановитьСвойствоЭлементаФормы(Элементы, "АктивацияКассы"                  , "Видимость", Ложь);
		ИнтеграцияWebKassaКлиентСерверПереопределяемый.УстановитьСвойствоЭлементаФормы(Элементы, "СменаПартнера"                   , "Видимость", Ложь);
		ИнтеграцияWebKassaКлиентСерверПереопределяемый.УстановитьСвойствоЭлементаФормы(Элементы, "КассыККМГруппаОФД"               , "Видимость", Ложь);
		ИнтеграцияWebKassaКлиентСерверПереопределяемый.УстановитьСвойствоЭлементаФормы(Элементы, "КассыККМОткрытьЕдиницыИзмерения" , "Видимость", Ложь);
	КонецЕсли;
