...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ИспользоватьОбменВС Тогда
		Элементы.ГруппаВС.Видимость = Ложь;
	КонецЕсли;
	
	ИспользоватьОбменЭСФ = ПолучитьФункциональнуюОпцию("ИспользоватьОбменЭСФ");
	Если Не ИспользоватьОбменЭСФ Тогда
		Элементы.ГруппаЭСФ.Видимость = Ложь;
	КонецЕсли;
	
	Если СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации()  Тогда		
		Элементы.ИспользоватьЭлектронныеАВР.Доступность = Ложь;
		Элементы.ПояснениеИспользованиеАВР.Заголовок = НСтр("ru = 'Данная возможность недоступна в базовой версии программы.'");		
	КонецЕсли;
...
&НаКлиенте
Процедура НастройкаKaspiQR(Команда)
	ОткрытьФорму("РегистрСведений.НастройкиОнлайнПлатежей.ФормаСписка");
КонецПроцедуры

// ЭлектронныеСчетаФактуры

&НаКлиенте
Процедура НастройкаЭСФ(Команда)
	ОткрытьФорму("Обработка.ОбменЭСФ.Форма.НастройкиОбменаЭСФ");
КонецПроцедуры

&НаКлиенте
Процедура ПомощникНастройкиЭСФ(Команда)
	ОткрытьФорму("Обработка.ПомощникНастройкиОбменаЭСФ.Форма");
КонецПроцедуры

&НаКлиенте
Процедура ПомощникСопоставленияСкладовВС(Команда)
	ОткрытьФорму("Обработка.ОбменЭСФ.Форма.СопоставлениеИдСкладов");
КонецПроцедуры

//ВС
&НаКлиенте
Процедура ПомощникПереходаНаУчетТоваровВС(Команда)
...
&НаКлиенте
Процедура НастройкаСНТ(Команда)
...
&НаКлиенте
Процедура НастройкаЭТД(Команда)
	ОткрытьФорму("Обработка.ПанельАдминистрированияЭТД.Форма.МастерНастройкиЭТД");
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьШаблоныТелефонов(Команда)
	ОткрытьФорму("Обработка.РедактированиеКонтактнойИнформации.Форма.ФормаШаблоныТелефонов", , ЭтотОбъект);
КонецПроцедуры
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ЭлектроннаяПодпись") И Пользователи.ЭтоПолноправныйПользователь(, Истина) Тогда
		Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьЭлектронныеПодписи" Или РеквизитПутьКДанным
			= "НаборКонстант.ИспользоватьШифрование" Или РеквизитПутьКДанным = "" 
				И НаборКонстант.Свойство("ИспользоватьЭлектронныеПодписи") И НаборКонстант.Свойство("ИспользоватьШифрование") Тогда
