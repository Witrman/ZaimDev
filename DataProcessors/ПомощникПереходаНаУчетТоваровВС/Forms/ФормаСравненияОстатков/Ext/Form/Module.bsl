...
Процедура СформироватьОтчетНаСервере()
	...
	Если СписокВыбранныхСтруктурныхПодразделений.Количество() = 0 Тогда
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса	,"(ВЫБОР КОГДА ТоварыОрганизацийБУОстатки.СтруктурноеПодразделение = &ПодразделенияОрганизацийПустаяСсылка
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса	,"(ВЫБОР КОГДА ДанныеБУ.СтруктурноеПодразделение = &ПодразделенияОрганизацийПустаяСсылка
		...
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса	,"ДанныеБУ.СтруктурноеПодразделение", "&ПодразделенияОрганизацийПустаяСсылка");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса	,"ТоварыВС.СтруктурноеПодразделение", "&ПодразделенияОрганизацийПустаяСсылка");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса	,"ТоварыОрганизацийБУОстатки.СтруктурноеПодразделение", "&ПодразделенияОрганизацийПустаяСсылка");
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса	,"ТоварыНаВиртуальныхСкладахОстатки.СтруктурноеПодразделение", "&ПодразделенияОрганизацийПустаяСсылка");
	КонецЕсли;
