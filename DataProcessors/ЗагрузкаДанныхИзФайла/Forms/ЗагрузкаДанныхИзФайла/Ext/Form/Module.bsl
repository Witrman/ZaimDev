			...
			Если Колонка <> Неопределено Тогда
				...
				Если ТипКолонки = Тип("Строка") Тогда
					Если Колонка.ТипКолонки.КвалификаторыСтроки.Длина = 0 Тогда
						...
						//Скорректирована строка с отбором для обхода синтаксической ошибки в запросе
						//ОтборГде = ОтборГде + " И СправочникСопоставления." + ИмяКолонкиСправочника + " <> """"";	
						ОтборГде = ОтборГде + ?(ПустаяСтрока(ОтборГде), "", " И ") + "СправочникСопоставления." + ИмяКолонкиСправочника + " <> """"";
					Иначе
						...
						ОтборГде = ОтборГде + ?(ПустаяСтрока(ОтборГде), "", РазделительИ) + " СправочникСопоставления." + ИмяКолонкиСправочника + " <> """"";
					КонецЕсли;
