...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатьКодовМаркировкиИСМПТКПереопределяемый.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЭтикеткаSSCC") Тогда
		...
		ПечатнаяФорма = СформироватьПечатнуюФормуSSCC(МассивОбъектов, ПараметрыПечати);
...
Функция СформироватьПечатнуюФормуSSCC(МассивОбъектов, ПараметрыПечати)
	...
	Макет = ПечатьКодовМаркировкиИСМПТКПереопределяемый.МакетПечатнойФормы("Обработка.ПечатьКодовМаркировкиИСМПТК.SSCC");
